define('src/renderers/Form/Image.tsx', function(require, exports, module) {
  ...
  var react_cropper_1 = tslib_1.__importDefault(require("node_modules/react-cropper/dist/react-cropper"));
  ...
  // @ts-ignore
  var attr_accept_1 = tslib_1.__importDefault(require("node_modules/attr-accept/dist/index"));
  var File_1 = require("src/renderers/Form/File.tsx");
  var Image_1 = tslib_1.__importDefault(require("src/renderers/Image.tsx"));
          ...
          return (react_1.default.createElement("div", { className: cx("ImageControl", className) }, cropFile ? (react_1.default.createElement("div", { className: cx('ImageControl-cropperWrapper') },
              ...
              return (react_1.default.createElement("div", tslib_1.__assign({}, getRootProps({
                  ...
                  isDragActive || isDragAccept || isDragReject ? (react_1.default.createElement("div", { className: cx('ImageControl-acceptTip', {
                      ...
                      }) }, "\u628A\u56FE\u7247\u62D6\u5230\u8FD9\uFF0C\u7136\u540E\u677E\u5F00\u5B8C\u6210\u6DFB\u52A0\uFF01")) : (react_1.default.createElement(react_1.default.Fragment, null,
                      files && files.length
                          ? files.map(function (file, key) { return (react_1.default.createElement("div", { key: file.id || key, className: cx('ImageControl-item', {
                              ...
                              react_1.default.createElement("a", { className: cx('ImageControl-itemClear'), "data-tooltip": "\u79FB\u9664", "data-position": "bottom", onClick: _this.removeFile.bind(_this, file, key) },
                                  react_1.default.createElement(icons_1.Icon, { icon: "close", className: "icon" })),
                              ...
                              react_1.default.createElement("div", { key: "overlay", className: cx('ImageControl-itemOverlay') },
                                  ...
                                  react_1.default.createElement("a", { "data-tooltip": "\u67E5\u770B\u5927\u56FE", "data-position": "bottom", target: "_blank", href: file.url || file.preview, onClick: _this.previewImage.bind(_this, file, key) },
                                      react_1.default.createElement(icons_1.Icon, { icon: "view", className: "icon" })),
                                  !!crop &&
                                      reCropable !== false &&
                                      !disabled ? (react_1.default.createElement("a", { "data-tooltip": "\u88C1\u526A\u56FE\u7247", "data-position": "bottom", onClick: _this.editImage.bind(_this, key) },
  ...
  //# sourceMappingURL=/src/renderers/Form/Image.js.map
