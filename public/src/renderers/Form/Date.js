define('src/renderers/Form/Date.tsx', function(require, exports, module) {
  ...
  var DatePicker_1 = tslib_1.__importDefault(require("src/components/DatePicker.tsx"));
  var DateControl = /** @class */ (function (_super) {
      ...
      DateControl.prototype.render = function () {
          var _a = this.props, className = _a.className, defaultValue = _a.defaultValue, defaultData = _a.defaultData, cx = _a.classnames, rest = tslib_1.__rest(_a, ["className", "defaultValue", "defaultData", "classnames"]);
          return (react_1.default.createElement("div", { className: cx("DateControl", className) },
              react_1.default.createElement(DatePicker_1.default, tslib_1.__assign({}, rest, this.state, { classnames: cx }))));
      };
  ...
  //# sourceMappingURL=/src/renderers/Form/Date.js.map
