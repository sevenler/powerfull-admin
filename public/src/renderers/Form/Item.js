define('src/renderers/Form/Item.tsx', function(require, exports, module) {
  ...
  function asFormItem(config) {
      return function (Control) {
          ...
          var FormItemRenderer = /** @class */ (function (_super) {
              ...
              FormItemRenderer.defaultProps = tslib_1.__assign({ className: '', renderLabel: config.renderLabel, renderDescription: config.renderDescription, sizeMutable: config.sizeMutable, wrap: config.wrap }, Control.defaultProps);
          ...
          hoist_non_react_statics_1.default(FormItemRenderer, Control);
          return FormItemRenderer;
      };
  }
  ...
  //# sourceMappingURL=/src/renderers/Form/Item.js.map
