define('src/renderers/Form/FieldSet.tsx', function(require, exports, module) {
  ...
  var Collapse_1 = tslib_1.__importDefault(require("src/renderers/Collapse.tsx"));
  var FieldSetControl = /** @class */ (function (_super) {
      ...
      FieldSetControl.prototype.renderBody = function () {
          ...
          return (react_1.default.createElement("div", { className: cx("Form--" + (props.mode || formMode || 'normal'), formClassName) }, renderFormItems({ controls: controls }, $path.replace(/^.*form\//, ''), props)));
      };
      FieldSetControl.prototype.render = function () {
          var _a = this.props, controls = _a.controls, className = _a.className, mode = _a.mode, rest = tslib_1.__rest(_a, ["controls", "className", "mode"]);
          return (react_1.default.createElement(Collapse_1.default, tslib_1.__assign({}, rest, { className: className, children: this.renderBody, wrapperComponent: "fieldset", headingComponent: "legend" })));
      };
  ...
  //# sourceMappingURL=/src/renderers/Form/FieldSet.js.map
