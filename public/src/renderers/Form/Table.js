define('src/renderers/Form/Table.tsx', function(require, exports, module) {
  ...
  var omit_1 = tslib_1.__importDefault(require("node_modules/lodash/omit"));
  ...
  var FormTable = /** @class */ (function (_super) {
      ...
      FormTable.prototype.confirmEdit = function () {
          return tslib_1.__awaiter(this, void 0, void 0, function () {
              var _a, value, onChange, scaffold, addApi, updateApi, data, env, subForms, newValue, item, origin, isNew, remote;
              var _this = this;
                  ...
                  switch (_b.label) {
                      ...
                      case 4:
                          if (remote && !remote.ok) {
                              ...
                              item = tslib_1.__assign(tslib_1.__assign({}, (isNew ? addApi : updateApi).replaceData ? {} : item), remote.data);
                          }
      ...
      FormTable.prototype.buildColumns = function (props, isCreateMode) {
          ...
          if (props.addable && props.showAddBtn !== false) {
              btns.push({
                  children: function (_a) {
                      ...
                      return ~_this.state.editIndex ? null : (react_1.default.createElement(Button_1.default, { classPrefix: ns, size: "sm", key: key, level: "link", tooltip: "\u65B0\u589E\u4E00\u884C", tooltipContainer: env && env.getModalContainer ? env.getModalContainer : undefined, onClick: _this.addItem.bind(_this, rowIndex, undefined) },
          ...
          if (props.editable) {
              ...
              btns.push({
                  children: function (_a) {
                      ...
                      return ~_this.state.editIndex || (data && data.__isPlaceholder) ? null : (react_1.default.createElement(Button_1.default, { classPrefix: ns, size: "sm", key: key, level: "link", tooltip: "\u7F16\u8F91\u5F53\u524D\u884C", tooltipContainer: env && env.getModalContainer ? env.getModalContainer : undefined, onClick: function () { return _this.startEdit(rowIndex); } },
              ...
              btns.push({
                  children: function (_a) {
                      var key = _a.key, rowIndex = _a.rowIndex;
                      return _this.state.editIndex === rowIndex ? (react_1.default.createElement(Button_1.default, { classPrefix: ns, size: "sm", key: key, level: "link", tooltip: "\u4FDD\u5B58", tooltipContainer: env && env.getModalContainer ? env.getModalContainer : undefined, onClick: _this.confirmEdit },
              ...
              btns.push({
                  children: function (_a) {
                      var key = _a.key, rowIndex = _a.rowIndex;
                      return _this.state.editIndex === rowIndex ? (react_1.default.createElement(Button_1.default, { classPrefix: ns, size: "sm", key: key, level: "link", tooltip: "\u53D6\u6D88", tooltipContainer: env && env.getModalContainer ? env.getModalContainer : undefined, onClick: _this.cancelEdit },
          ...
          if (props.removable) {
              btns.push({
                  children: function (_a) {
                      var key = _a.key, rowIndex = _a.rowIndex, data = _a.data;
                      return ~_this.state.editIndex || (data && data.__isPlaceholder) ? null : (react_1.default.createElement(Button_1.default, { classPrefix: ns, size: "sm", key: key, level: "link", tooltip: "\u5220\u9664\u5F53\u524D\u884C", tooltipContainer: env && env.getModalContainer ? env.getModalContainer : undefined, onClick: _this.removeItem.bind(_this, rowIndex) },
      ...
      FormTable.prototype.render = function () {
          var _a = this.props, className = _a.className, value = _a.value, showAddBtn = _a.showAddBtn, disabled = _a.disabled, render = _a.render, placeholder = _a.placeholder, draggable = _a.draggable, addable = _a.addable, columnsTogglable = _a.columnsTogglable, combineNum = _a.combineNum;
  ...
  //# sourceMappingURL=/src/renderers/Form/Table.js.map
