define('src/renderers/Form/IconPicker.tsx', function(require, exports, module) {
  ...
  var IconPickerControl = /** @class */ (function (_super) {
      ...
      IconPickerControl.prototype.renderFontIcons = function () {
          var _this = this;
          var _a = this.props, className = _a.className, inputOnly = _a.inputOnly, placeholder = _a.placeholder, cx = _a.classnames, name = _a.name, value = _a.value, noDataTip = _a.noDataTip;
  ...
  //# sourceMappingURL=/src/renderers/Form/IconPicker.js.map
