define('src/renderers/Tasks.tsx', function(require, exports, module) {
  ...
  var react_addons_update_1 = tslib_1.__importDefault(require("node_modules/react-addons-update/index"));
  ...
  var Task = /** @class */ (function (_super) {
      ...
      Task.prototype.submitTask = function (item, index, retry) {
          ...
          this.setState(react_addons_update_1.default(this.state, {
              items: {
                  $splice: [
                      [
                          index,
          ...
          api_1.isEffectiveApi(api, data) &&
              ...
              env
                  ...
                  .catch(function (e) {
                  return _this.setState(react_addons_update_1.default(_this.state, {
                      items: {
                          $splice: [
                              [
                                  index,
  ...
  //# sourceMappingURL=/src/renderers/Tasks.js.map
