define('src/renderers/Table.tsx', function(require, exports, module) {
  ...
  var DropDownButton_1 = tslib_1.__importDefault(require("src/renderers/DropDownButton.tsx"));
  ...
  var table_1 = require("src/store/table.ts");
  ...
  var QuickEdit_1 = tslib_1.__importDefault(require("src/renderers/QuickEdit.tsx"));
  var PopOver_1 = tslib_1.__importDefault(require("src/components/PopOver.tsx"));
  var Copyable_1 = tslib_1.__importDefault(require("src/renderers/Copyable.tsx"));
  ...
  var PopOver_2 = tslib_1.__importDefault(require("src/renderers/PopOver.tsx"));
  var Table = /** @class */ (function (_super) {
      ...
      Table.prototype.handleQuickChange = function (item, values, saveImmediately, savePristine) {
          var _a = this.props, onSave = _a.onSave, propsSaveImmediately = _a.saveImmediately;
      ...
      Table.prototype.affixDetect = function () {
          ...
          var offsetY = (_b = (_a = this.props.affixOffsetTop, (_a !== null && _a !== void 0 ? _a : this.props.env.affixOffsetTop)), (_b !== null && _b !== void 0 ? _b : 0));
      ...
      Table.prototype.renderHeading = function () {
          var _a = this.props, title = _a.title, store = _a.store, hideQuickSaveBtn = _a.hideQuickSaveBtn, data = _a.data, cx = _a.classnames, saveImmediately = _a.saveImmediately;
          if (title ||
              (!saveImmediately && store.modified && !hideQuickSaveBtn) ||
              store.moved) {
              return (react_1.default.createElement("div", { className: cx('Table-heading'), key: "heading" }, !saveImmediately && store.modified && !hideQuickSaveBtn ? (react_1.default.createElement("span", null, "\u5F53\u524D\u6709 " + store.modified + " \u6761\u8BB0\u5F55\u4FEE\u6539\u4E86\u5185\u5BB9, \u4F46\u5E76\u6CA1\u6709\u63D0\u4EA4\u3002\u8BF7\u9009\u62E9:",
      ...
      Table.prototype.renderCell = function (region, column, item, props) {
          ...
          var subProps = tslib_1.__assign(tslib_1.__assign({}, props), { btnDisabled: store.dragging, data: item.locals, value: column.name ? tpl_builtin_1.resolveVariable(column.name, item.data) : undefined, popOverContainer: this.getPopOverContainer, rowSpan: item.rowSpans[column.name], quickEditFormRef: this.subFormRef, prefix: prefix, onImageEnlarge: this.handleImageEnlarge });
      ...
      Table.prototype.renderAffixHeader = function (tableClassName) {
          ...
          return affixHeader ? (react_1.default.createElement("div", { className: cx('Table-fixedTop') },
              ...
              react_1.default.createElement("div", { className: cx('Table-fixedLeft') }, store.leftFixedColumns.length
                  ? this.renderFixedColumns(store.leftFixedColumns, true, tableClassName)
                  : null),
              react_1.default.createElement("div", { className: cx('Table-fixedRight') }, store.rightFixedColumns.length
                  ? this.renderFixedColumns(store.rightFixedColumns, true, tableClassName)
                  : null),
      ...
      Table.prototype.renderFixedColumns = function (columns, headerOnly, tableClassName) {
          var _this = this;
          ...
          return (react_1.default.createElement("table", { className: cx('Table-table', store.combineNum > 0 ? 'Table-table--withCombine' : '', tableClassName) },
              ...
              headerOnly ? null : (react_1.default.createElement("tbody", null, store.rows.length ? (store.rows.map(function (item, rowIndex) {
                  var itemProps = buildItemProps
                      ...
                      : null;
                  return (react_1.default.createElement(TableRow, tslib_1.__assign({}, itemProps, { classPrefix: ns, checkOnItemClick: checkOnItemClick, key: item.id, itemIndex: rowIndex, item: item, itemClassName: cx(rowClassNameExpr
                          ? tpl_1.filter(rowClassNameExpr, item.data)
                          : rowClassName), columns: columns, renderCell: _this.renderCell, render: render, regionPrefix: "fixed/", onCheck: _this.handleCheck, onAction: onAction, onQuickChange: store.dragging ? null : _this.handleQuickChange })));
      ...
      Table.prototype.renderColumnsToggler = function (config) {
          ...
          return (react_1.default.createElement(DropDownButton_1.default, tslib_1.__assign({}, rest, { iconOnly: true, align: config ? config.align : 'left', classnames: cx, classPrefix: ns, key: "columns-toggable", size: "sm", label: react_1.default.createElement("i", { className: "glyphicon glyphicon-th icon-th" }) }), store.toggableColumns.map(function (column) { return (react_1.default.createElement("li", { className: cx('DropDown-menuItem'), key: column.index },
              react_1.default.createElement(Checkbox_1.default, { classPrefix: ns, checked: column.toggled, onChange: column.toggleToggle }, column.label ? render('tpl', column.label) : null))); })));
      };
          ...
          return rows.map(function (item, rowIndex) {
              ...
              var doms = [
                  react_1.default.createElement(TableRow, tslib_1.__assign({}, itemProps, { classPrefix: ns, checkOnItemClick: checkOnItemClick, key: item.id, itemIndex: rowIndex, item: item, itemClassName: cx(rowClassNameExpr
                      ...
                      }), columns: store.filteredColumns, renderCell: _this.renderCell, render: render, onAction: onAction, onCheck: _this.handleCheck, 
                  ...
                  if (store.footable && store.footableColumns.length) {
                      if (item.depth === 1) {
                          doms.push(react_1.default.createElement(TableRow, tslib_1.__assign({}, itemProps, { classPrefix: ns, checkOnItemClick: checkOnItemClick, key: "foot-" + item.id, itemIndex: rowIndex, item: item, itemClassName: cx(rowClassNameExpr
                                  ? tpl_1.filter(rowClassNameExpr, item.data)
                                  : rowClassName), columns: store.footableColumns, renderCell: _this.renderCell, render: render, onAction: onAction, onCheck: _this.handleCheck, footableMode: true, footableColSpan: store.filteredColumns.length, onQuickChange: store.dragging ? null : _this.handleQuickChange })));
                      }
                  }
          ...
          return (react_1.default.createElement("div", { className: cx('Table', className, {
              ...
              react_1.default.createElement("div", { className: cx('Table-contentWrap'), onMouseLeave: this.handleMouseLeave },
                  react_1.default.createElement("div", { className: cx('Table-fixedLeft') }, affixColumns !== false && store.leftFixedColumns.length
                      ? this.renderFixedColumns(store.leftFixedColumns, false, tableClassName)
                      : null),
                  react_1.default.createElement("div", { className: cx('Table-fixedRight') }, affixColumns !== false && store.rightFixedColumns.length
                      ? this.renderFixedColumns(store.rightFixedColumns, false, tableClassName)
                      : null),
  ...
  //# sourceMappingURL=/src/renderers/Table.js.map
