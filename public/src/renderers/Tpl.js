define('src/renderers/Tpl.tsx', function(require, exports, module) {
  ...
  var Tpl = /** @class */ (function (_super) {
      ...
      Tpl.prototype.render = function () {
          var _a = this.props, className = _a.className, wrapperComponent = _a.wrapperComponent, inline = _a.inline, cx = _a.classnames;
          var Component = wrapperComponent || (inline ? 'span' : 'div');
          return (react_1.default.createElement(Component, { children: this.getContent(), ref: this.htmlRef, className: cx('TplField', className) }));
      };
      Tpl.defaultProps = {
          inline: true,
          placeholder: '',
  ...
  //# sourceMappingURL=/src/renderers/Tpl.js.map
