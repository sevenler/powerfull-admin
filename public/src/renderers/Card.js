define('src/renderers/Card.tsx', function(require, exports, module) {
  ...
  var PopOver_1 = tslib_1.__importDefault(require("src/renderers/PopOver.tsx"));
  var Table_1 = require("src/renderers/Table.tsx");
  ...
  var Card = /** @class */ (function (_super) {
      ...
      Card.prototype.render = function () {
          ...
          var heading = null;
          if (header) {
              var highlightTpl = header.highlight, avatarTpl = header.avatar, avatarTextTpl = header.avatarText, titleTpl = header.title, subTitleTpl = header.subTitle, subTitlePlaceholder = header.subTitlePlaceholder, descTpl = header.desc, descPlaceholder = header.descPlaceholder;
  ...
  //# sourceMappingURL=/src/renderers/Card.js.map
