define('src/renderers/CRUD.tsx', function(require, exports, module) {
  ...
  var crud_1 = require("src/store/crud.ts");
  ...
  var CRUD = /** @class */ (function (_super) {
      ...
      CRUD.prototype.handleSelect = function (items, unSelectedItems) {
          ...
          if (keepItemSelectionOnPageChange && store.selectedItems.length) {
              ...
              var notInThisBatch = function (item) {
                  return !find_1.default(thisBatch_1, function (a) { return a[primaryField || 'id'] == item[primaryField || 'id']; });
              };
      ...
      CRUD.prototype.handlQuery = function (values, forceReload) {
          var _a;
          if (forceReload === void 0) { forceReload = false; }
  ...
  //# sourceMappingURL=/src/renderers/CRUD.js.map
