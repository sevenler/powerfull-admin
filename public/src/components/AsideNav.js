define('src/components/AsideNav.tsx', function(require, exports, module) {
  ...
  var AsideNav = /** @class */ (function (_super) {
      ...
      AsideNav.prototype.renderLink = function (link, key, props, depth) {
          ...
          var dom = renderLink(tslib_1.__assign({ link: link, active: link.active, open: link.open, toggleExpand: this.toggleExpand, depth: depth, classnames: cx }, others));
          if (!dom) {
              return;
          }
      ...
      AsideNav.defaultProps = {
          ...
          renderSubLinks: function (link, renderLink, depth, _a) {
              ...
              return link.children && link.children.length ? (react_1.default.createElement("ul", { className: cx('AsideNav-subList') },
                  link.label ? (react_1.default.createElement("li", { key: "subHeader", className: cx('AsideNav-subHeader') },
                      react_1.default.createElement("a", null, link.label))) : null,
  ...
  //# sourceMappingURL=/src/components/AsideNav.js.map
