define('src/components/Html.tsx', function(require, exports, module) {
  ...
  var Html = /** @class */ (function (_super) {
      ...
      Html.prototype.render = function () {
          var _a = this.props, className = _a.className, wrapperComponent = _a.wrapperComponent, inline = _a.inline, ns = _a.classPrefix;
          var Component = wrapperComponent || (inline ? 'span' : 'div');
          return (react_1.default.createElement(Component, { ref: this.htmlRef, className: classnames_1.default(ns + "Html", className) }));
      };
      Html.defaultProps = {
          inline: true
      };
  ...
  //# sourceMappingURL=/src/components/Html.js.map
