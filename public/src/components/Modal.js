define('src/components/Modal.tsx', function(require, exports, module) {
  ...
  var ModalManager_1 = require("src/components/ModalManager.ts");
  ...
  var Modal = /** @class */ (function (_super) {
      ...
      Modal.prototype.render = function () {
          var _this = this;
          var _a = this.props, className = _a.className, contentClassName = _a.contentClassName, children = _a.children, container = _a.container, show = _a.show, size = _a.size, overlay = _a.overlay, ns = _a.classPrefix;
          return (
          // @ts-ignore
          react_1.default.createElement(react_overlays_1.Portal, { container: container },
              react_1.default.createElement(Transition_1.default, { mountOnEnter: true, unmountOnExit: true, in: show, timeout: 500, onExited: this.handleExited, onEntered: this.handleEntered }, function (status) {
                  ...
                  return (react_1.default.createElement("div", { ref: _this.modalRef, role: "dialog", className: classnames_1.default("amis-dialog-widget " + ns + "Modal", (_a = {},
                      ...
                      react_1.default.createElement("div", { className: classnames_1.default(ns + "Modal-content", contentClassName, fadeStyles[status]) }, children)));
              })));
      };
      Modal.defaultProps = {
  ...
  //# sourceMappingURL=/src/components/Modal.js.map
