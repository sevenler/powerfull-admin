define('src/components/TooltipWrapper.tsx', function(require, exports, module) {
  ...
  var Tooltip_1 = tslib_1.__importDefault(require("src/components/Tooltip.tsx"));
      ...
      TooltipWrapper.prototype.render = function () {
          ...
          return [
              ...
              react_1.default.createElement(Overlay_1.default, { key: "overlay", target: this.getTarget, show: this.state.show, onHide: this.handleHide, rootClose: rootClose, placement: placement, container: container },
                  react_1.default.createElement(Tooltip_1.default, { title: typeof tooltip !== 'string' ? tooltip.title : undefined, className: tooltipClassName }, tooltip && tooltip.render ? (tooltip.render()) : tooltip && tooltip.dom ? (tooltip.dom) : (react_1.default.createElement(Html_1.default, { html: typeof tooltip === 'string' ? tooltip : tooltip.content }))))
          ];
      };
  ...
  exports.default = theme_1.themeable(uncontrollable_1.default(TooltipWrapper, {
      show: 'onVisibleChange'
  }));
  //# sourceMappingURL=/src/components/TooltipWrapper.js.map
