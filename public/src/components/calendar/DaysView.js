define('src/components/calendar/DaysView.tsx', function(require, exports, module) {

  "use strict";
  Object.defineProperty(exports, "__esModule", { value: true });
  var tslib_1 = require("node_modules/tslib/tslib");
  // @ts-ignore
  var DaysView_1 = tslib_1.__importDefault(require("node_modules/react-datetime/src/DaysView"));
  ...
  var CustomDaysView = /** @class */ (function (_super) {
      ...
      function CustomDaysView() {
          ...
          _this.confirm = function () {
              var date = _this.props.viewDate.clone();
              _this.props.setDateTimeState({
                  selectedDate: date
              });
              _this.props.onChange(date);
                  ...
                  react_1.default.createElement("tr", null,
                      react_1.default.createElement("td", { colSpan: 7 },
                          ...
                          _this.props.requiredConfirm ? (react_1.default.createElement("div", { key: "button", className: "rdtActions" },
                              react_1.default.createElement("a", { className: "rdtBtn rdtBtnConfirm", onClick: _this.confirm }, "\u786E\u8BA4"),
                              react_1.default.createElement("a", { className: "rdtBtn rdtBtnCancel", onClick: _this.cancel }, "\u53D6\u6D88"))) : null))));
          };
          return _this;
      }
                      ...
                      react_1.default.createElement("th", { colSpan: 7 },
                          react_1.default.createElement("div", { className: "rdtHeader" },
                              ...
                              react_1.default.createElement("div", { className: "rdtCenter" },
                                  react_1.default.createElement("a", { className: "rdtSwitch", onClick: this.props.showView('years') }, date.format('YYYY年')),
                                  react_1.default.createElement("a", { className: "rdtSwitch", onClick: this.props.showView('months') }, date.format('MM月'))),
  ...
  exports.default = CustomDaysView;
  //# sourceMappingURL=/src/components/calendar/DaysView.js.map
