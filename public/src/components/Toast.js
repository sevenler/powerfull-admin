define('src/components/Toast.tsx', function(require, exports, module) {
  ...
  var Html_1 = tslib_1.__importDefault(require("src/components/Html.tsx"));
  ...
  var ToastComponent = /** @class */ (function (_super) {
      ...
      ToastComponent.prototype.render = function () {
          ...
          var _a = this.props, cx = _a.classnames, className = _a.className, timeout = _a.timeout, position = _a.position;
          ...
          return (react_1.default.createElement("div", { className: cx("Toast-wrap Toast-wrap--" + position.replace(/\-(\w)/g, function (_, l) {
              ...
              var _a;
              return (react_1.default.createElement(ToastMessage, { classnames: cx, key: item.id, title: item.title, body: item.body, level: item.level || 'info', timeout: (_a = item.timeout, (_a !== null && _a !== void 0 ? _a : timeout)), closeButton: item.closeButton, onDismiss: _this.handleDismissed.bind(_this, index) }));
          })));
      };
  ...
  var ToastMessage = /** @class */ (function (_super) {
      ...
      ToastMessage.prototype.render = function () {
          var _this = this;
          var _a = this.props, onDismiss = _a.onDismiss, cx = _a.classnames, closeButton = _a.closeButton, title = _a.title, body = _a.body, allowHtml = _a.allowHtml, level = _a.level;
          return (react_1.default.createElement(Transition_1.default, { mountOnEnter: true, unmountOnExit: true, in: this.state.visible, timeout: 750, onEntered: this.handleEntered, onExited: onDismiss }, function (status) {
              return (react_1.default.createElement("div", { className: cx("Toast Toast--" + level, fadeStyles[status]), onMouseEnter: _this.handleMouseEnter, onMouseLeave: _this.handleMouseLeave, onClick: closeButton ? helper_1.noop : _this.close },
                  ...
                  title ? react_1.default.createElement("div", { className: cx('Toast-title') }, title) : null,
  ...
  //# sourceMappingURL=/src/components/Toast.js.map
