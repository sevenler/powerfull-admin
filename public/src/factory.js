define('src/factory.tsx', function(require, exports, module) {
  ...
  var index_1 = require("src/store/index.ts");
  ...
  var hoist_non_react_statics_1 = tslib_1.__importDefault(require("node_modules/hoist-non-react-statics/dist/hoist-non-react-statics.cjs"));
  var omit_1 = tslib_1.__importDefault(require("node_modules/lodash/omit"));
  var difference_1 = tslib_1.__importDefault(require("node_modules/lodash/difference"));
  var isPlainObject_1 = tslib_1.__importDefault(require("node_modules/lodash/isPlainObject"));
  var Scoped_1 = tslib_1.__importDefault(require("src/Scoped.tsx"));
  ...
  var ImageGallery_1 = tslib_1.__importDefault(require("src/components/ImageGallery.tsx"));
  var renderers = [];
  var rendererNames = [];
  var schemaFilters = [];
      ...
      RootRenderer.prototype.render = function () {
          ...
          return (react_1.default.createElement(RootStoreContext.Provider, { value: rootStore },
              react_1.default.createElement(theme_1.ThemeContext.Provider, { value: this.props.theme || 'default' },
                  react_1.default.createElement(ImageGallery_1.default, null, renderChild(pathPrefix || '', isPlainObject_1.default(schema)
  ...
  var SchemaRenderer = /** @class */ (function (_super) {
      ...
      SchemaRenderer.prototype.render = function () {
          ...
          if (Array.isArray(schema)) {
              ...
              return react_1.default.createElement(schema.component, tslib_1.__assign(tslib_1.__assign(tslib_1.__assign({}, rest), schema), { $path: $path, render: this.renderChild }));
          }
              ...
              StoreFactory.prototype.componentWillReceiveProps = function (nextProps) {
                  ...
                  if (renderer.extendsData === false) {
                      ...
                      if (nextProps.store && nextProps.store.data === nextProps.data) {
                          store.initData(helper_1.createObject(nextProps.store.data, helper_1.syncDataFromSuper(store.data, nextProps.store.data, props.scope, nextProps.dataUpdatedAt !== props.dataUpdatedAt, store)));
                      }
  ...
  //# sourceMappingURL=/src/factory.js.map
