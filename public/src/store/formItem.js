define('src/store/formItem.ts', function(require, exports, module) {
  ...
  var helper_2 = require("src/utils/helper.ts");
  ...
  exports.FormItemStore = mobx_state_tree_1.types
      ...
      .views(function (self) {
      function getForm() {
          return mobx_state_tree_1.hasParent(self, 2) ? mobx_state_tree_1.getParent(self, 2) : null;
      }
      function getValue() {
              ...
              switch (_a.label) {
                  ...
                  case 1:
                      ...
                      if (!json.ok) {
                          ...
                          mobx_state_tree_1.getRoot(self).notify('error', self.errors.join(''), json.msgTimeout !== undefined
                              ? {
                                  closeButton: true,
  ...
  //# sourceMappingURL=/src/store/formItem.js.map
