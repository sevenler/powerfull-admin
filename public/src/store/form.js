define('src/store/form.ts', function(require, exports, module) {
  ...
  var errors_1 = require("src/utils/errors.ts");
  ...
  exports.FormStore = service_1.ServiceStore.named('FormStore')
      ...
      var saveRemote = mobx_state_tree_1.flow(function saveRemote(api, data, options) {
          var ret, json, errors_2, ret, e_1, result;
              ...
              switch (_a.label) {
                  ...
                  case 4:
                      ...
                      if (json.status === 422 && json.errors) {
                          errors_2 = json.errors;
                          Object.keys(errors_2).forEach(function (key) {
                              var item = self.getItemById(key);
                              if (item) {
                                  item.setError(errors_2[key]);
                              }
                              else {
                                  self
                                      .getItemsByName(key)
                                      .forEach(function (item) { return item.setError(errors_2[key]); });
                              }
                          });
                  ...
                  case 9:
                      ...
                      if (e_1.type === 'ServerError') {
                          result = e_1.response;
                          mobx_state_tree_1.getRoot(self).notify('error', e_1.message, result.msgTimeout !== undefined
                              ? {
                                  closeButton: true,
  ...
  //# sourceMappingURL=/src/store/form.js.map
