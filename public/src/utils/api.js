define('src/utils/api.ts', function(require, exports, module) {
  ...
  function buildApi(api, data, options) {
      ...
      if (api.method === 'get') {
          ...
          if (api.data) {
              ...
              if (~idx_1) {
                  var params = tslib_1.__assign(tslib_1.__assign({}, qs_1.default.parse(api.url.substring(idx_1 + 1))), api.data);
  ...
  //# sourceMappingURL=/src/utils/api.js.map
