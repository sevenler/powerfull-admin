define('src/utils/helper.ts', function(require, exports, module) {
  ...
  var isObject_1 = tslib_1.__importDefault(require("node_modules/lodash/isObject"));
  var uniq_1 = tslib_1.__importDefault(require("node_modules/lodash/uniq"));
  var tpl_1 = require("src/utils/tpl.ts");
  var autobind_decorator_1 = require("node_modules/autobind-decorator/lib/cjs/index");
  ...
  function syncDataFromSuper(data, superObject, prevSuperObject, force, store) {
      ...
      if (store && store.storeType === 'FormStore') {
          keys = uniq_1.default(store.items.map(function (item) {
  ...
  function difference(object, base) {
      function changes(object, base) {
          ...
          keys.forEach(function (key) {
              ...
              else if (isObject_1.default(a) && isObject_1.default(b)) {
  ...
  //# sourceMappingURL=/src/utils/helper.js.map
