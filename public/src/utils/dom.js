define('src/utils/dom.tsx', function(require, exports, module) {
  ...
  var ownerDocument_1 = tslib_1.__importDefault(require("node_modules/dom-helpers/ownerDocument"));
  var offset_1 = tslib_1.__importDefault(require("node_modules/dom-helpers/query/offset"));
  var position_1 = tslib_1.__importDefault(require("node_modules/dom-helpers/query/position"));
  var scrollTop_1 = tslib_1.__importDefault(require("node_modules/dom-helpers/query/scrollTop"));
  var bsMapping = {
      level: 'bsStyle',
      classPrefix: 'bsClass',
      size: 'bsSize'
  ...
  function getContainerDimensions(containerNode) {
      ...
      if (containerNode.tagName === 'BODY') {
          ...
          (_a = offset_1.default(containerNode), width = _a.width, height = _a.height);
  ...
  function calculatePosition(placement, overlayNode, target, container, padding) {
      ...
      var _a = offset_1.default(overlayNode), overlayHeight = _a.height, overlayWidth = _a.width;
      var clip = overlayNode.getBoundingClientRect();
      var scale = clip.width / overlayNode.offsetWidth;
      // auto 尝试四个方向对齐。
      placement =
          placement === 'auto'
  ...
  //# sourceMappingURL=/src/utils/dom.js.map
