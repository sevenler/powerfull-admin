define('node_modules/monaco-editor/esm/vs/base/browser/htmlContentRenderer', function(require, exports, module) {
  ...
  var marked = tslib_1.__importStar(require("node_modules/monaco-editor/esm/vs/base/common/marked/marked"));
  ...
  var marshalling_js_1 = require("node_modules/monaco-editor/esm/vs/base/common/marshalling");
  ...
  function renderMarkdown(markdown, options) {
      ...
      var _uriMassage = function (part) {
          var data;
          try {
              data = marshalling_js_1.parse(decodeURIComponent(part));
          }
          catch (e) {
              // ignore
          }
          ...
          data = objects_js_1.cloneAndChange(data, function (value) {
      ...
      var _href = function (href) {
          ...
          var uri = uri_js_1.URI.revive(data);
          if (uri.query) {
      ...
      renderer.link = function (href, title, text) {
          ...
          if (href === text) { // raw link case
              text = htmlContent_js_1.removeMarkdownEscapes(text);
          }
          href = _href(href);
          title = htmlContent_js_1.removeMarkdownEscapes(title);
          href = htmlContent_js_1.removeMarkdownEscapes(href);
          if (!href
      ...
      if (options.codeBlockRenderer) {
          renderer.code = function (code, lang) {
              ...
              var id = idGenerator_js_1.defaultGenerator.nextId();
              ...
              return "<div class=\"code\" data-code=\"" + id + "\">" + strings_js_1.escape(code) + "</div>";
          };
      }
