define('node_modules/monaco-editor/esm/vs/base/browser/keyboardEvent', function(require, exports, module) {
  ...
  var StandardKeyboardEvent = /** @class */ (function () {
      ...
      StandardKeyboardEvent.prototype._computeRuntimeKeybinding = function () {
          ...
          return new keyCodes_js_1.SimpleKeybinding(this.ctrlKey, this.shiftKey, this.altKey, this.metaKey, key);
      };
