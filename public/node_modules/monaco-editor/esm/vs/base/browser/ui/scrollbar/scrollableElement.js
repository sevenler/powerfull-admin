define('node_modules/monaco-editor/esm/vs/base/browser/ui/scrollbar/scrollableElement', function(require, exports, module) {
  ...
  ''/*@require node_modules/monaco-editor/esm/vs/base/browser/ui/scrollbar/media/scrollbars.css*/;
  ...
  var horizontalScrollbar_js_1 = require("node_modules/monaco-editor/esm/vs/base/browser/ui/scrollbar/horizontalScrollbar");
  var verticalScrollbar_js_1 = require("node_modules/monaco-editor/esm/vs/base/browser/ui/scrollbar/verticalScrollbar");
  ...
  var scrollable_js_1 = require("node_modules/monaco-editor/esm/vs/base/common/scrollable");
  ...
  var AbstractScrollableElement = /** @class */ (function (_super) {
      ...
      function AbstractScrollableElement(element, options, scrollable) {
          ...
          _this._verticalScrollbar = _this._register(new verticalScrollbar_js_1.VerticalScrollbar(_this._scrollable, _this._options, scrollbarHost));
          _this._horizontalScrollbar = _this._register(new horizontalScrollbar_js_1.HorizontalScrollbar(_this._scrollable, _this._options, scrollbarHost));
          ...
          if (_this._options.useShadows) {
              _this._leftShadowDomNode = fastDomNode_js_1.createFastDomNode(document.createElement('div'));
              _this._leftShadowDomNode.setClassName('shadow');
              _this._domNode.appendChild(_this._leftShadowDomNode.domNode);
              _this._topShadowDomNode = fastDomNode_js_1.createFastDomNode(document.createElement('div'));
              _this._topShadowDomNode.setClassName('shadow');
              _this._domNode.appendChild(_this._topShadowDomNode.domNode);
              _this._topLeftShadowDomNode = fastDomNode_js_1.createFastDomNode(document.createElement('div'));
          ...
          _this._hideTimeout = _this._register(new async_js_1.TimeoutTimer());
      ...
      AbstractScrollableElement.prototype.dispose = function () {
          this._mouseWheelToDispose = lifecycle_js_1.dispose(this._mouseWheelToDispose);
      ...
      AbstractScrollableElement.prototype._setListeningToMouseWheel = function (shouldListen) {
          ...
          if (shouldListen) {
              var onMouseWheel = function (browserEvent) {
                  _this._onMouseWheel(new mouseEvent_js_1.StandardWheelEvent(browserEvent));
              };
  ...
  var ScrollableElement = /** @class */ (function (_super) {
      ...
      function ScrollableElement(element, options) {
          ...
          var scrollable = new scrollable_js_1.Scrollable(0, function (callback) { return dom.scheduleAtNextAnimationFrame(callback); });
