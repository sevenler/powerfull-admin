define('node_modules/monaco-editor/esm/vs/base/browser/ui/tree/abstractTree', function(require, exports, module) {
  ...
  ''/*@require node_modules/monaco-editor/esm/vs/base/browser/ui/tree/media/tree.css*/;
  ...
  var dnd_js_1 = require("node_modules/monaco-editor/esm/vs/base/browser/dnd");
  var arrays_js_1 = require("node_modules/monaco-editor/esm/vs/base/common/arrays");
  var listView_js_1 = require("node_modules/monaco-editor/esm/vs/base/browser/ui/list/listView");
  ...
  var indexTreeModel_js_1 = require("node_modules/monaco-editor/esm/vs/base/browser/ui/tree/indexTreeModel");
  ...
  var numbers_js_1 = require("node_modules/monaco-editor/esm/vs/base/common/numbers");
  function asTreeDragAndDropData(data) {
      if (data instanceof listView_js_1.ElementsDragAndDropData) {
          var nodes = data.elements;
          return new listView_js_1.ElementsDragAndDropData(nodes.map(function (node) { return node.element; }));
      }
      return data;
  }
  var TreeNodeListDragAndDrop = /** @class */ (function () {
      function TreeNodeListDragAndDrop(modelProvider, dnd) {
          ...
          this.dnd = dnd;
          this.autoExpandDisposable = lifecycle_js_1.Disposable.None;
      }
      ...
      TreeNodeListDragAndDrop.prototype.onDragOver = function (data, targetNode, targetIndex, originalEvent, raw) {
          ...
          if (didChangeAutoExpandNode && typeof result !== 'boolean' && result.autoExpand) {
              this.autoExpandDisposable = async_js_1.disposableTimeout(function () {
          ...
          return __assign({}, result, { feedback: arrays_js_1.range(start, start + length) });
      };
  ...
  var TreeRenderer = /** @class */ (function () {
      function TreeRenderer(renderer, onDidChangeCollapseState, options) {
          ...
          event_js_1.Event.map(onDidChangeCollapseState, function (e) { return e.node; })(this.onDidChangeNodeTwistieState, this, this.disposables);
      ...
      TreeRenderer.prototype.updateOptions = function (options) {
          ...
          if (typeof options.indent !== 'undefined') {
              this.indent = numbers_js_1.clamp(options.indent, 0, 40);
          }
      ...
      TreeRenderer.prototype.renderTemplate = function (container) {
          var el = dom_js_1.append(container, dom_js_1.$('.monaco-tl-row'));
          var twistie = dom_js_1.append(el, dom_js_1.$('.monaco-tl-twistie'));
          var contents = dom_js_1.append(el, dom_js_1.$('.monaco-tl-contents'));
      ...
      TreeRenderer.prototype.update = function (node, templateData) {
          ...
          dom_js_1.toggleClass(templateData.twistie, 'collapsible', node.collapsible);
          dom_js_1.toggleClass(templateData.twistie, 'collapsed', node.collapsible && node.collapsed);
          if (node.collapsible) {
  ...
  var TypeFilter = /** @class */ (function () {
      ...
      TypeFilter.prototype.filter = function (element, parentVisibility) {
          if (this._filter) {
              ...
              else if (indexTreeModel_js_1.isFilterResult(result)) {
                  visibility = indexTreeModel_js_1.getVisibleState(result.visibility);
              }
              else {
                  visibility = result;
              }
          ...
          if (this.tree.options.simpleKeyboardNavigation || !this._pattern) {
              this._matchCount++;
              return { data: filters_js_1.FuzzyScore.Default, visibility: true };
          }
          ...
          var score = filters_js_1.fuzzyScore(this._pattern, this._lowercasePattern, 0, labelStr, labelStr.toLowerCase(), 0, true);
          if (!score) {
  ...
  var TypeFilterController = /** @class */ (function () {
      function TypeFilterController(tree, model, view, filter, keyboardNavigationLabelProvider) {
          ...
          this._enabled = false;
          this._pattern = '';
          this._onDidChangeEmptyState = new event_js_1.Emitter();
          this.positionClassName = 'ne';
          this.automaticKeyboardNavigation = true;
          this.triggered = false;
          this._onDidChangePattern = new event_js_1.Emitter();
          this.enabledDisposables = [];
          this.disposables = [];
          this.domNode = dom_js_1.$(".monaco-list-type-filter." + this.positionClassName);
          this.domNode.draggable = true;
          event_js_2.domEvent(this.domNode, 'dragstart')(this.onDragStart, this, this.disposables);
          this.messageDomNode = dom_js_1.append(view.getHTMLElement(), dom_js_1.$(".monaco-list-type-filter-message"));
          this.labelDomNode = dom_js_1.append(this.domNode, dom_js_1.$('span.label'));
          var controls = dom_js_1.append(this.domNode, dom_js_1.$('.controls'));
          this._filterOnType = !!tree.options.filterOnType;
          this.filterOnTypeDomNode = dom_js_1.append(controls, dom_js_1.$('input.filter'));
          this.filterOnTypeDomNode.type = 'checkbox';
          this.filterOnTypeDomNode.checked = this._filterOnType;
          this.filterOnTypeDomNode.tabIndex = -1;
          this.updateFilterOnTypeTitle();
          event_js_2.domEvent(this.filterOnTypeDomNode, 'input')(this.onDidChangeFilterOnType, this, this.disposables);
          this.clearDomNode = dom_js_1.append(controls, dom_js_1.$('button.clear'));
          this.clearDomNode.tabIndex = -1;
          this.clearDomNode.title = nls_js_1.localize('clear', "Clear");
      ...
      TypeFilterController.prototype.enable = function () {
          ...
          var isPrintableCharEvent = this.keyboardNavigationLabelProvider.mightProducePrintableCharacter ? function (e) { return _this.keyboardNavigationLabelProvider.mightProducePrintableCharacter(e); } : function (e) { return listWidget_js_1.mightProducePrintableCharacter(e); };
          var onKeyDown = event_js_1.Event.chain(event_js_2.domEvent(this.view.getHTMLElement(), 'keydown'))
              .filter(function (e) { return !isInputElement(e.target) || e.target === _this.filterOnTypeDomNode; })
              .map(function (e) { return new keyboardEvent_js_1.StandardKeyboardEvent(e); })
              ...
              .filter(function (e) { return isPrintableCharEvent(e) || ((_this.pattern.length > 0 || _this.triggered) && ((e.keyCode === 9 /* Escape */ || e.keyCode === 1 /* Backspace */) && !e.altKey && !e.ctrlKey && !e.metaKey) || (e.keyCode === 1 /* Backspace */ && (platform_js_1.isMacintosh ? (e.altKey && !e.metaKey) : e.ctrlKey) && !e.shiftKey)); })
              .forEach(function (e) { e.stopPropagation(); e.preventDefault(); })
              .event;
          var onClear = event_js_2.domEvent(this.clearDomNode, 'click');
          event_js_1.Event.chain(event_js_1.Event.any(onKeyDown, onClear))
      ...
      TypeFilterController.prototype.disable = function () {
          ...
          this.domNode.remove();
          this.enabledDisposables = lifecycle_js_1.dispose(this.enabledDisposables);
          this.tree.refilter();
          this.render();
          this._enabled = false;
          this.triggered = false;
      ...
      TypeFilterController.prototype.onEventOrInput = function (e) {
          ...
          else if (e instanceof MouseEvent || e.keyCode === 9 /* Escape */ || (e.keyCode === 1 /* Backspace */ && (platform_js_1.isMacintosh ? e.altKey : e.ctrlKey))) {
              this.onInput('');
          }
      ...
      TypeFilterController.prototype.onInput = function (pattern) {
          ...
          this.tree.refilter();
          if (pattern) {
              this.tree.focusNext(0, true, undefined, function (node) { return !filters_js_1.FuzzyScore.isDefault(node.filterData); });
          }
      ...
      TypeFilterController.prototype.onDragStart = function () {
          var _this = this;
          var container = this.view.getHTMLElement();
          var left = dom_js_1.getDomNodePagePosition(container).left;
          ...
          updatePosition();
          dom_js_1.removeClass(this.domNode, positionClassName);
          dom_js_1.addClass(this.domNode, 'dragging');
          disposables.push(lifecycle_js_1.toDisposable(function () { return dom_js_1.removeClass(_this.domNode, 'dragging'); }));
          event_js_2.domEvent(document, 'dragover')(onDragOver, null, disposables);
          event_js_2.domEvent(this.domNode, 'dragend')(onDragEnd, null, disposables);
          dnd_js_1.StaticDND.CurrentDragAndDropData = new dnd_js_1.DragAndDropData('vscode-ui');
          disposables.push(lifecycle_js_1.toDisposable(function () { return dnd_js_1.StaticDND.CurrentDragAndDropData = undefined; }));
      };
      ...
      TypeFilterController.prototype.updateFilterOnTypeTitle = function () {
          if (this.filterOnType) {
              this.filterOnTypeDomNode.title = nls_js_1.localize('disable filter on type', "Disable Filter on Type");
          }
          else {
              this.filterOnTypeDomNode.title = nls_js_1.localize('enable filter on type', "Enable Filter on Type");
          }
      };
      TypeFilterController.prototype.render = function () {
          var noMatches = this.filter.totalCount > 0 && this.filter.matchCount === 0;
          if (this.pattern && this.tree.options.filterOnType && noMatches) {
              this.messageDomNode.textContent = nls_js_1.localize('empty', "No elements found");
              this._empty = true;
          }
          else {
          ...
          dom_js_1.toggleClass(this.domNode, 'no-matches', noMatches);
          this.domNode.title = nls_js_1.localize('found', "Matched {0} out of {1} elements", this.filter.matchCount, this.filter.totalCount);
  ...
  var Trait = /** @class */ (function () {
      ...
      Trait.prototype.set = function (nodes, browserEvent) {
          if (arrays_js_1.equals(this.nodes, nodes)) {
              return;
          }
      ...
      Trait.prototype.onDidModelSplice = function (_a) {
          ...
          if (!this.identityProvider) {
              ...
              this.set(map_js_1.values(set_1));
              return;
          }
  ...
  var TreeNodeListMouseController = /** @class */ (function (_super) {
      ...
      TreeNodeListMouseController.prototype.onPointer = function (e) {
          ...
          var onTwistie = dom_js_1.hasClass(e.browserEvent.target, 'monaco-tl-twistie');
  ...
  }(listWidget_js_1.MouseController));
  /**
  ...
  var TreeNodeList = /** @class */ (function (_super) {
      ...
      TreeNodeList.prototype.splice = function (start, deleteCount, elements) {
          ...
          if (additionalFocus.length > 0) {
              _super.prototype.setFocus.call(this, arrays_js_1.distinctES6(_super.prototype.getFocus.call(this).concat(additionalFocus)));
          }
          if (additionalSelection.length > 0) {
              _super.prototype.setSelection.call(this, arrays_js_1.distinctES6(_super.prototype.getSelection.call(this).concat(additionalSelection)));
          }
      };
  ...
  var AbstractTree = /** @class */ (function () {
      function AbstractTree(container, delegate, renderers, _options) {
          ...
          this.disposables = [];
          this._onWillRefilter = new event_js_1.Emitter();
          this.onWillRefilter = this._onWillRefilter.event;
          this._onDidUpdateOptions = new event_js_1.Emitter();
          var treeDelegate = new ComposedTreeDelegate(delegate);
          var onDidChangeCollapseStateRelay = new event_js_1.Relay();
          ...
          if (_options.keyboardSupport !== false) {
              var onKeyDown = event_js_1.Event.chain(this.view.onKeyDown)
      ...
      Object.defineProperty(AbstractTree.prototype, "onDidOpen", {
          get: function () { return event_js_1.Event.map(this.view.onDidOpen, asTreeEvent); },
          enumerable: true,
          configurable: true
      });
