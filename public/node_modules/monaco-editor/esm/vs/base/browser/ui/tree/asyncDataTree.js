define('node_modules/monaco-editor/esm/vs/base/browser/ui/tree/asyncDataTree', function(require, exports, module) {
  ...
  var DataTreeRenderer = /** @class */ (function () {
      ...
      DataTreeRenderer.prototype.renderTwistie = function (element, twistieElement) {
          dom_js_1.toggleClass(twistieElement, 'loading', element.slow);
          return false;
      };
  ...
  })(exports.ChildrenResolutionReason || (exports.ChildrenResolutionReason = {}));
  ...
  function asTreeElement(node, viewStateContext) {
      ...
      return {
          element: node,
          children: node.hasChildren ? iterator_js_1.Iterator.map(iterator_js_1.Iterator.fromArray(node.children), function (child) { return asTreeElement(child, viewStateContext); }) : [],
  ...
  var AsyncDataTree = /** @class */ (function () {
      function AsyncDataTree(container, delegate, renderers, dataSource, options) {
          ...
          var objectTreeDelegate = new abstractTree_js_1.ComposedTreeDelegate(delegate);
          ...
          this.tree = new objectTree_js_1.ObjectTree(container, objectTreeDelegate, objectTreeRenderers, objectTreeOptions);
      ...
      Object.defineProperty(AsyncDataTree.prototype, "onDidChangeFocus", {
          get: function () { return event_js_1.Event.map(this.tree.onDidChangeFocus, asTreeEvent); },
          enumerable: true,
          configurable: true
      });
      Object.defineProperty(AsyncDataTree.prototype, "onDidChangeSelection", {
          get: function () { return event_js_1.Event.map(this.tree.onDidChangeSelection, asTreeEvent); },
          enumerable: true,
          configurable: true
      });
      Object.defineProperty(AsyncDataTree.prototype, "onDidOpen", {
          get: function () { return event_js_1.Event.map(this.tree.onDidOpen, asTreeEvent); },
          enumerable: true,
          configurable: true
      });
          ...
          return __awaiter(this, void 0, void 0, function () {
              return __generator(this, function (_a) {
                  switch (_a.label) {
                      ...
                      case 1:
                          _a.sent();
                          return [4 /*yield*/, event_js_1.Event.toPromise(this._onDidRender.event)];
                      case 2:
                          _a.sent();
                          _a.label = 3;
                      case 3: return [4 /*yield*/, this.refreshAndRenderNode(this.getDataNode(element), recursive, exports.ChildrenResolutionReason.Refresh, viewStateContext)];
                      case 4:
                          _a.sent();
                          return [2 /*return*/];
                  }
              ...
              return __generator(this, function (_a) {
                  switch (_a.label) {
                      ...
                      case 1:
                          ...
                          if (!(node !== this.root && this.autoExpandSingleChildren && reason === exports.ChildrenResolutionReason.Expand))
                              return [3 /*break*/, 3];
                  ...
                  switch (_a.label) {
                      case 0:
                          ...
                          if (!node.hasChildren) {
                              ...
                              slowTimeout_1 = async_js_1.timeout(800);
                      ...
                      case 3:
                          ...
                          if (errors_js_1.isPromiseCanceledError(err_1)) {
                              return [2 /*return*/, []];
                          }
                          throw err_1;
                      case 4:
      ...
      AsyncDataTree.prototype.doGetChildren = function (node) {
          ...
          result = async_js_1.createCancelablePromise(function () {
      ...
      AsyncDataTree.prototype._onDidChangeCollapseState = function (_a) {
          ...
          if (!node.collapsed && node.element.stale) {
              if (deep) {
                  ...
                  this.refreshAndRenderNode(node.element, false, exports.ChildrenResolutionReason.Expand)
      ...
      AsyncDataTree.prototype.setChildren = function (node, childrenElements, recursive, viewStateContext) {
          ...
          for (var _c = 0, _d = map_js_1.values(nodesToForget); _c < _d.length; _c++) {
              var node_1 = _d[_c];
      ...
      AsyncDataTree.prototype.dispose = function () {
          lifecycle_js_1.dispose(this.disposables);
      };
