define('node_modules/monaco-editor/esm/vs/base/browser/ui/iconLabel/iconLabel', function(require, exports, module) {
  ...
  ''/*@require node_modules/monaco-editor/esm/vs/base/browser/ui/iconLabel/iconlabel.css*/;
  var dom = tslib_1.__importStar(require("node_modules/monaco-editor/esm/vs/base/browser/dom"));
  var highlightedLabel_js_1 = require("node_modules/monaco-editor/esm/vs/base/browser/ui/highlightedlabel/highlightedLabel");
  ...
  var IconLabel = /** @class */ (function (_super) {
      ...
      function IconLabel(container, options) {
          ...
          if (options && options.supportHighlights) {
              _this.labelNode = new highlightedLabel_js_1.HighlightedLabel(dom.append(_this.labelDescriptionContainer.element, dom.$('a.label-name')), !options.donotSupportOcticons);
          }
          else {
          ...
          if (options && options.supportDescriptionHighlights) {
              _this.descriptionNodeFactory = function () { return new highlightedLabel_js_1.HighlightedLabel(dom.append(_this.labelDescriptionContainer.element, dom.$('span.label-description')), !options.donotSupportOcticons); };
          }
          else {
      ...
      IconLabel.prototype.setLabel = function (label, description, options) {
          ...
          if (this.labelNode instanceof highlightedLabel_js_1.HighlightedLabel) {
          ...
          if (description || this.descriptionNode) {
              ...
              if (this.descriptionNode instanceof highlightedLabel_js_1.HighlightedLabel) {
