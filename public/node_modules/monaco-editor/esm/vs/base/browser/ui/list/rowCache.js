define('node_modules/monaco-editor/esm/vs/base/browser/ui/list/rowCache', function(require, exports, module) {
  ...
  var RowCache = /** @class */ (function () {
      ...
      RowCache.prototype.alloc = function (templateId) {
          ...
          if (!result) {
              var domNode = dom_js_1.$('.monaco-list-row');
      ...
      RowCache.prototype.releaseRow = function (row) {
          ...
          if (domNode) {
              dom_js_1.removeClass(domNode, 'scrolling');
