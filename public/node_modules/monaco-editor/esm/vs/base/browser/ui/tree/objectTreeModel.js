define('node_modules/monaco-editor/esm/vs/base/browser/ui/tree/objectTreeModel', function(require, exports, module) {
  ...
  var ObjectTreeModel = /** @class */ (function () {
      function ObjectTreeModel(list, options) {
          ...
          this.nodes = new Map();
          this.model = new indexTreeModel_js_1.IndexTreeModel(list, null, options);
      ...
      ObjectTreeModel.prototype.preserveCollapseState = function (elements) {
          var _this = this;
          var iterator = elements ? iterator_js_1.getSequenceIterator(elements) : iterator_js_1.Iterator.empty();
          if (this.sorter) {
              iterator = iterator_js_1.Iterator.fromArray(iterator_js_1.Iterator.collect(iterator).sort(this.sorter.compare.bind(this.sorter)));
          }
          return iterator_js_1.Iterator.map(iterator, function (treeElement) {
