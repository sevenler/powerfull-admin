define('node_modules/monaco-editor/esm/vs/base/browser/ui/scrollbar/abstractScrollbar', function(require, exports, module) {
  ...
  var scrollbarArrow_js_1 = require("node_modules/monaco-editor/esm/vs/base/browser/ui/scrollbar/scrollbarArrow");
  var scrollbarVisibilityController_js_1 = require("node_modules/monaco-editor/esm/vs/base/browser/ui/scrollbar/scrollbarVisibilityController");
  ...
  var AbstractScrollbar = /** @class */ (function (_super) {
      ...
      function AbstractScrollbar(opts) {
          ...
          _this._visibilityController = _this._register(new scrollbarVisibilityController_js_1.ScrollbarVisibilityController(opts.visibility, 'visible scrollbar ' + opts.extraScrollbarClassName, 'invisible scrollbar ' + opts.extraScrollbarClassName));
          _this._mouseMoveMonitor = _this._register(new globalMouseMoveMonitor_js_1.GlobalMouseMoveMonitor());
      ...
      AbstractScrollbar.prototype._createArrow = function (opts) {
          var arrow = this._register(new scrollbarArrow_js_1.ScrollbarArrow(opts));
      ...
      AbstractScrollbar.prototype._createSlider = function (top, left, width, height) {
          var _this = this;
          this.slider = fastDomNode_js_1.createFastDomNode(document.createElement('div'));
      ...
      AbstractScrollbar.prototype._sliderMouseDown = function (e, onDragFinished) {
          ...
          this._mouseMoveMonitor.startMonitoring(globalMouseMoveMonitor_js_1.standardMouseMoveMerger, function (mouseMoveData) {
