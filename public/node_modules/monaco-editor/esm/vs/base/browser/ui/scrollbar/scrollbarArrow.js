define('node_modules/monaco-editor/esm/vs/base/browser/ui/scrollbar/scrollbarArrow', function(require, exports, module) {
  ...
  var ScrollbarArrow = /** @class */ (function (_super) {
      ...
      function ScrollbarArrow(opts) {
          ...
          _this._mousedownRepeatTimer = _this._register(new async_js_1.IntervalTimer());
          _this._mousedownScheduleRepeatTimer = _this._register(new async_js_1.TimeoutTimer());
          return _this;
      }
