define('node_modules/monaco-editor/esm/vs/base/browser/ui/actionbar/actionbar', function(require, exports, module) {
  ...
  ''/*@require node_modules/monaco-editor/esm/vs/base/browser/ui/actionbar/actionbar.css*/;
  ...
  var BaseActionItem = /** @class */ (function (_super) {
      ...
      BaseActionItem.prototype.render = function (container) {
          ...
          touch_js_1.Gesture.addTarget(container);
          var enableDragging = this.options && this.options.draggable;
          if (enableDragging) {
              container.draggable = true;
          }
          this._register(DOM.addDisposableListener(this.element, touch_js_1.EventType.Tap, function (e) { return _this.onClick(e); }));
  ...
  var ActionBar = /** @class */ (function (_super) {
      ...
      function ActionBar(container, options) {
          ...
          var _this = _super.call(this) || this;
          _this._onDidBlur = _this._register(new event_js_1.Emitter());
          _this._onDidCancel = _this._register(new event_js_1.Emitter());
          _this._onDidRun = _this._register(new event_js_1.Emitter());
          _this._onDidBeforeRun = _this._register(new event_js_1.Emitter());
          _this.options = options;
          ...
          if (_this.options.actionRunner) {
              ...
              _this._actionRunner = new actions_js_1.ActionRunner();
      ...
      ActionBar.prototype.push = function (arg, options) {
          ...
          var actions = arrays_js_1.asArray(arg);
      ...
      ActionBar.prototype.clear = function () {
          this.items = lifecycle_js_1.dispose(this.items);
      ...
      ActionBar.prototype.dispose = function () {
          lifecycle_js_1.dispose(this.items);
          this.items = [];
