define('node_modules/monaco-editor/esm/vs/base/browser/ui/inputbox/inputBox', function(require, exports, module) {
  ...
  ''/*@require node_modules/monaco-editor/esm/vs/base/browser/ui/inputbox/inputBox.css*/;
  var nls = tslib_1.__importStar(require("node_modules/monaco-editor/esm/vs/nls"));
  var Bal = tslib_1.__importStar(require("node_modules/monaco-editor/esm/vs/base/browser/browser"));
  ...
  var history_js_1 = require("node_modules/monaco-editor/esm/vs/base/common/history");
  var $ = dom.$;
  var defaultOpts = {
      inputBackground: color_js_1.Color.fromHex('#3C3C3C'),
      inputForeground: color_js_1.Color.fromHex('#CCCCCC'),
      inputValidationInfoBorder: color_js_1.Color.fromHex('#55AAFF'),
      inputValidationInfoBackground: color_js_1.Color.fromHex('#063B49'),
      inputValidationWarningBorder: color_js_1.Color.fromHex('#B89500'),
      inputValidationWarningBackground: color_js_1.Color.fromHex('#352A05'),
      inputValidationErrorBorder: color_js_1.Color.fromHex('#BE1100'),
      inputValidationErrorBackground: color_js_1.Color.fromHex('#5A1D1D')
  };
  var InputBox = /** @class */ (function (_super) {
      ...
      function InputBox(container, contextViewProvider, options) {
          ...
          _this._onDidHeightChange = _this._register(new event_js_1.Emitter());
          ...
          if (_this.options.actions) {
              _this.actionbar = _this._register(new actionbar_js_1.ActionBar(_this.element));
          ...
          this.contextViewProvider.showContextView({
              ...
              render: function (container) {
                  ...
                  var spanElement = (_this.message.formatContent
                      ? htmlContentRenderer_js_1.renderFormattedText(_this.message.content, renderOptions)
                      : htmlContentRenderer_js_1.renderText(_this.message.content, renderOptions));
  ...
  var HistoryInputBox = /** @class */ (function (_super) {
      ...
      function HistoryInputBox(container, contextViewProvider, options) {
          ...
          _this.history = new history_js_1.HistoryNavigator(options.history, 100);
          return _this;
      }
