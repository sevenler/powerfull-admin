define('node_modules/monaco-editor/esm/vs/base/browser/ui/keybindingLabel/keybindingLabel', function(require, exports, module) {
   ...
   *--------------------------------------------------------------------------------------------*/
  ''/*@require node_modules/monaco-editor/esm/vs/base/browser/ui/keybindingLabel/keybindingLabel.css*/;
  ...
  var KeybindingLabel = /** @class */ (function () {
      ...
      KeybindingLabel.prototype.renderPart = function (parent, part, match) {
          var modifierLabels = keybindingLabels_js_1.UILabelProvider.modifierLabels[this.os];
          if (part.ctrlKey) {
      ...
      KeybindingLabel.prototype.renderUnbound = function (parent) {
          dom.append(parent, $('span.monaco-keybinding-key', undefined, nls_js_1.localize('unbound', "Unbound")));
      };
      KeybindingLabel.areSame = function (a, b) {
          if (a === b || (!a && !b)) {
              return true;
          }
          return !!a && !!b && objects_js_1.equals(a.firstPart, b.firstPart) && objects_js_1.equals(a.chordPart, b.chordPart);
      };
