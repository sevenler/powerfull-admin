define('node_modules/monaco-editor/esm/vs/base/browser/ui/tree/indexTreeModel', function(require, exports, module) {
  ...
  function treeNodeToElement(node) {
      ...
      var children = iterator_js_1.Iterator.map(iterator_js_1.Iterator.fromArray(node.children), treeNodeToElement);
  ...
  var IndexTreeModel = /** @class */ (function () {
      ...
      IndexTreeModel.prototype.splice = function (location, deleteCount, toInsert, onDidCreateNode, onDidDeleteNode) {
          ...
          var nodesToInsertIterator = iterator_js_1.Iterator.map(iterator_js_1.Iterator.from(toInsert), function (el) { return _this.createTreeNode(el, parentNode, parentNode.visible ? 1 /* Visible */ : 0 /* Hidden */, revealed, treeListElementsToInsert, onDidCreateNode); });
          ...
          iterator_js_1.Iterator.forEach(nodesToInsertIterator, function (child) {
          ...
          var result = iterator_js_1.Iterator.map(iterator_js_1.Iterator.fromArray(deletedNodes), treeNodeToElement);
      ...
      IndexTreeModel.prototype.createTreeNode = function (treeElement, parent, parentVisibility, revealed, treeListElements, onDidCreateNode) {
          ...
          var childElements = iterator_js_1.Iterator.from(treeElement.children);
          var childRevealed = revealed && visibility !== 0 /* Hidden */ && !node.collapsed;
          var childNodes = iterator_js_1.Iterator.map(childElements, function (el) { return _this.createTreeNode(el, node, visibility, childRevealed, treeListElements, onDidCreateNode); });
          var visibleChildrenCount = 0;
          var renderNodeCount = 1;
          iterator_js_1.Iterator.forEach(childNodes, function (child) {
      ...
      IndexTreeModel.prototype.getParentNodeLocation = function (location) {
          ...
          return arrays_js_1.tail2(location)[0];
      };
