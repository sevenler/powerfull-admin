define('node_modules/monaco-editor/esm/vs/base/browser/ui/list/listWidget', function(require, exports, module) {
  ...
  ''/*@require node_modules/monaco-editor/esm/vs/base/browser/ui/list/list.css*/;
  ...
  var list_js_1 = require("node_modules/monaco-editor/esm/vs/base/browser/ui/list/list");
  ...
  var splice_js_1 = require("node_modules/monaco-editor/esm/vs/base/browser/ui/list/splice");
  ...
  var TraitRenderer = /** @class */ (function () {
      ...
      TraitRenderer.prototype.renderElement = function (element, index, templateData) {
          var renderedElementIndex = arrays_js_1.firstIndex(this.renderedElements, function (el) { return el.templateData === templateData; });
      ...
      TraitRenderer.prototype.disposeTemplate = function (templateData) {
          var index = arrays_js_1.firstIndex(this.renderedElements, function (el) { return el.templateData === templateData; });
          if (index < 0) {
              return;
          }
  ...
  var Trait = /** @class */ (function () {
      function Trait(_trait) {
          ...
          this.indexes = [];
          this.sortedIndexes = [];
          this._onChange = new event_js_1.Emitter();
      }
      ...
      Trait.prototype.contains = function (index) {
          return arrays_js_1.binarySearch(this.sortedIndexes, index, numericSort) >= 0;
      };
      Trait.prototype.dispose = function () {
          this._onChange = lifecycle_js_1.dispose(this._onChange);
      };
      __decorate([
  ...
  var KeyboardController = /** @class */ (function () {
      function KeyboardController(list, view, options) {
          ...
          var onKeyDown = event_js_1.Event.chain(event_js_2.domEvent(view.domNode, 'keydown'))
      ...
      KeyboardController.prototype.onCtrlA = function (e) {
          e.preventDefault();
          e.stopPropagation();
          this.list.setSelection(arrays_js_1.range(this.list.length), e.browserEvent);
          this.view.domNode.focus();
      };
  ...
  var TypeLabelController = /** @class */ (function () {
      ...
      TypeLabelController.prototype.enable = function () {
          ...
          var onChar = event_js_1.Event.chain(event_js_2.domEvent(this.view.domNode, 'keydown'))
              .filter(function (e) { return !isInputElement(e.target); })
              .filter(function () { return _this.automaticKeyboardNavigation || _this.triggered; })
              .map(function (event) { return new keyboardEvent_js_1.StandardKeyboardEvent(event); })
              ...
              .event;
          var onClear = event_js_1.Event.debounce(onChar, function () { return null; }, 800);
          var onInput = event_js_1.Event.reduce(event_js_1.Event.any(onChar, onClear), function (r, i) { return i === null ? null : ((r || '') + i); });
      ...
      TypeLabelController.prototype.onInput = function (word) {
          ...
          for (var i = 0; i < this.list.length; i++) {
              ...
              if (typeof labelStr === 'undefined' || filters_js_1.matchesPrefix(word, labelStr)) {
  ...
  var MouseController = /** @class */ (function () {
      function MouseController(list) {
          ...
          if (this.mouseSupport) {
              ...
              touch_js_1.Gesture.addTarget(list.getHTMLElement());
          }
      ...
      MouseController.prototype.changeSelection = function (e, reference) {
          ...
          if (this.isSelectionRangeChangeEvent(e) && reference !== undefined) {
              ...
              var rangeSelection = arrays_js_1.range(min, max + 1);
              var selection = this.list.getSelection();
  ...
  var defaultStyles = {
      listFocusBackground: color_js_1.Color.fromHex('#073655'),
      listActiveSelectionBackground: color_js_1.Color.fromHex('#0E639C'),
      listActiveSelectionForeground: color_js_1.Color.fromHex('#FFFFFF'),
      listFocusAndSelectionBackground: color_js_1.Color.fromHex('#094771'),
      listFocusAndSelectionForeground: color_js_1.Color.fromHex('#FFFFFF'),
      listInactiveSelectionBackground: color_js_1.Color.fromHex('#3F3F46'),
      listHoverBackground: color_js_1.Color.fromHex('#2A2D2E'),
      listDropBackground: color_js_1.Color.fromHex('#383B3D')
  };
  var DefaultOptions = {
      ...
      ariaRootRole: list_js_1.ListAriaRootRole.TREE
  };
  ...
  var List = /** @class */ (function () {
      function List(container, virtualDelegate, renderers, _options) {
          ...
          this._onDidOpen = new event_js_1.Emitter();
          this.onDidOpen = this._onDidOpen.event;
          this._onPin = new event_js_1.Emitter();
          this.didJustPressContextMenuKey = false;
          this._onDidDispose = new event_js_1.Emitter();
          this.focus = new FocusTrait();
          this.selection = new Trait('selected');
          objects_js_1.mixin(_options, defaultStyles, false);
          ...
          this.view = new listView_js_1.ListView(container, virtualDelegate, renderers, viewOptions);
          if (typeof _options.ariaRole !== 'string') {
              this.view.domNode.setAttribute('role', list_js_1.ListAriaRootRole.TREE);
          }
          else {
          ...
          this.onDidFocus = event_js_1.Event.map(event_js_2.domEvent(this.view.domNode, 'focus', true), function () { return null; });
          this.onDidBlur = event_js_1.Event.map(event_js_2.domEvent(this.view.domNode, 'blur', true), function () { return null; });
          ...
          if (_options.ariaLabel) {
              this.view.domNode.setAttribute('aria-label', nls_js_1.localize('aria list', "{0}. Use the navigation keys to navigate.", _options.ariaLabel));
          }
          this.style(_options);
      }
      Object.defineProperty(List.prototype, "onFocusChange", {
          get: function () {
              var _this = this;
              return event_js_1.Event.map(this.eventBufferer.wrapEvent(this.focus.onChange), function (e) { return _this.toListEvent(e); });
          },
          enumerable: true,
          configurable: true
      });
      Object.defineProperty(List.prototype, "onSelectionChange", {
          get: function () {
              var _this = this;
              return event_js_1.Event.map(this.eventBufferer.wrapEvent(this.selection.onChange), function (e) { return _this.toListEvent(e); });
          },
          enumerable: true,
          configurable: true
      });
      ...
      Object.defineProperty(List.prototype, "onContextMenu", {
          get: function () {
              var _this = this;
              var fromKeydown = event_js_1.Event.chain(event_js_2.domEvent(this.view.domNode, 'keydown'))
                  .map(function (e) { return new keyboardEvent_js_1.StandardKeyboardEvent(e); })
                  ...
                  .event;
              var fromKeyup = event_js_1.Event.chain(event_js_2.domEvent(this.view.domNode, 'keyup'))
                  .filter(function () {
                  ...
                  .event;
              var fromMouse = event_js_1.Event.chain(this.view.onContextMenu)
                  ...
                  .event;
              return event_js_1.Event.any(fromKeydown, fromKeyup, fromMouse);
          },
          enumerable: true,
          configurable: true
      });
      Object.defineProperty(List.prototype, "onKeyDown", {
          get: function () { return event_js_2.domEvent(this.view.domNode, 'keydown'); },
          enumerable: true,
          configurable: true
      });
      ...
      List.prototype.reveal = function (index, relativeTop) {
          ...
          if (types_js_1.isNumber(relativeTop)) {
              // y = mx + b
              var m = elementHeight - this.view.renderHeight;
              this.view.setScrollTop(m * numbers_js_1.clamp(relativeTop, 0, 1) + elementTop);
          }
          else {
