define('node_modules/monaco-editor/esm/vs/base/browser/ui/findinput/findInput', function(require, exports, module) {
  ...
  ''/*@require node_modules/monaco-editor/esm/vs/base/browser/ui/findinput/findInput.css*/;
  ...
  var FindInput = /** @class */ (function (_super) {
      ...
      function FindInput(parent, contextViewProvider, _showOptionButtons, options) {
          ...
          _this._onDidOptionChange = _this._register(new event_js_1.Emitter());
          ...
          _this._onInput = _this._register(new event_js_1.Emitter());
          _this._onKeyUp = _this._register(new event_js_1.Emitter());
          _this._onCaseSensitiveKeyDown = _this._register(new event_js_1.Emitter());
          _this.onCaseSensitiveKeyDown = _this._onCaseSensitiveKeyDown.event;
          _this._onRegexKeyDown = _this._register(new event_js_1.Emitter());
      ...
      FindInput.prototype.buildDomNode = function (appendCaseSensitiveLabel, appendWholeWordsLabel, appendRegexLabel, history, flexibleHeight) {
          ...
          this.regex = this._register(new findInputCheckboxes_js_1.RegexCheckbox({
          ...
          this.wholeWords = this._register(new findInputCheckboxes_js_1.WholeWordsCheckbox({
          ...
          this.caseSensitive = this._register(new findInputCheckboxes_js_1.CaseSensitiveCheckbox({
