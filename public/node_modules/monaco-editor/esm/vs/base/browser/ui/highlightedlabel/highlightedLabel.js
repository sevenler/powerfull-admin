define('node_modules/monaco-editor/esm/vs/base/browser/ui/highlightedlabel/highlightedLabel', function(require, exports, module) {
  ...
  var octiconLabel_js_1 = require("node_modules/monaco-editor/esm/vs/base/browser/ui/octiconLabel/octiconLabel");
      ...
      HighlightedLabel.prototype.render = function () {
          ...
          for (var _i = 0, _a = this.highlights; _i < _a.length; _i++) {
              ...
              if (pos < highlight.start) {
                  ...
                  htmlContent += this.supportOcticons ? octiconLabel_js_1.renderOcticons(substring_1) : strings_js_1.escape(substring_1);
                  htmlContent += '</span>';
                  pos = highlight.end;
              }
              htmlContent += '<span class="highlight">';
              var substring = this.text.substring(highlight.start, highlight.end);
              htmlContent += this.supportOcticons ? octiconLabel_js_1.renderOcticons(substring) : strings_js_1.escape(substring);
              htmlContent += '</span>';
              pos = highlight.end;
          }
