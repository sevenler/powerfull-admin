define('node_modules/monaco-editor/esm/vs/base/browser/ui/list/listView', function(require, exports, module) {
  ...
  var rangeMap_js_1 = require("node_modules/monaco-editor/esm/vs/base/browser/ui/list/rangeMap");
  var rowCache_js_1 = require("node_modules/monaco-editor/esm/vs/base/browser/ui/list/rowCache");
  ...
  var decorators_js_1 = require("node_modules/monaco-editor/esm/vs/base/common/decorators");
  var range_js_1 = require("node_modules/monaco-editor/esm/vs/base/common/range");
  ...
  function equalsDragFeedback(f1, f2) {
      if (Array.isArray(f1) && Array.isArray(f2)) {
          return arrays_js_1.equals(f1, f2);
      }
      return f1 === f2;
  }
  var ListView = /** @class */ (function () {
      function ListView(container, virtualDelegate, renderers, options) {
          ...
          this._onDidChangeContentHeight = new event_js_1.Emitter();
          if (options.horizontalScrolling && options.supportDynamicHeights) {
              throw new Error('Horizontal scrolling and dynamic heights not supported simultaneously');
          }
          this.items = [];
          this.itemId = 0;
          this.rangeMap = new rangeMap_js_1.RangeMap();
          for (var _i = 0, renderers_1 = renderers; _i < renderers_1.length; _i++) {
              var renderer = renderers_1[_i];
              this.renderers.set(renderer.templateId, renderer);
          }
          this.cache = new rowCache_js_1.RowCache(this.renderers);
          ...
          this.horizontalScrolling = objects_js_1.getOrDefault(options, function (o) { return o.horizontalScrolling; }, DefaultOptions.horizontalScrolling);
          ...
          touch_js_1.Gesture.addTarget(this.rowsContainer);
          this.scrollableElement = new scrollableElement_js_1.ScrollableElement(this.rowsContainer, {
              alwaysConsumeMouseWheel: true,
              horizontal: this.horizontalScrolling ? 1 /* Auto */ : 2 /* Hidden */,
              vertical: objects_js_1.getOrDefault(options, function (o) { return o.verticalScrollMode; }, DefaultOptions.verticalScrollMode),
              useShadows: objects_js_1.getOrDefault(options, function (o) { return o.useShadows; }, DefaultOptions.useShadows)
          });
          this.domNode.appendChild(this.scrollableElement.getDomNode());
          container.appendChild(this.domNode);
          this.disposables = [this.rangeMap, this.gesture, this.scrollableElement, this.cache];
          this.scrollableElement.onScroll(this.onScroll, this, this.disposables);
          event_js_2.domEvent(this.rowsContainer, touch_js_1.EventType.Change)(this.onTouchChange, this, this.disposables);
          // Prevent the monaco-scrollable-element from scrolling
          // https://github.com/Microsoft/vscode/issues/44181
          event_js_2.domEvent(this.scrollableElement.getDomNode(), 'scroll')(function (e) { return e.target.scrollTop = 0; }, null, this.disposables);
          event_js_1.Event.map(event_js_2.domEvent(this.domNode, 'dragover'), function (e) { return _this.toDragEvent(e); })(this.onDragOver, this, this.disposables);
          event_js_1.Event.map(event_js_2.domEvent(this.domNode, 'drop'), function (e) { return _this.toDragEvent(e); })(this.onDrop, this, this.disposables);
          event_js_2.domEvent(this.domNode, 'dragleave')(this.onDragLeave, this, this.disposables);
          event_js_2.domEvent(window, 'dragend')(this.onDragEnd, this, this.disposables);
          this.setRowLineHeight = objects_js_1.getOrDefault(options, function (o) { return o.setRowLineHeight; }, DefaultOptions.setRowLineHeight);
          this.supportDynamicHeights = objects_js_1.getOrDefault(options, function (o) { return o.supportDynamicHeights; }, DefaultOptions.supportDynamicHeights);
          this.dnd = objects_js_1.getOrDefault(options, function (o) { return o.dnd; }, DefaultOptions.dnd);
          this.layout();
      }
      ...
      ListView.prototype._splice = function (start, deleteCount, elements) {
          ...
          var removeRange = range_js_1.Range.intersect(previousRenderRange, deleteRange);
          for (var i = removeRange.start; i < removeRange.end; i++) {
              this.removeItemFromDOM(i);
          }
          var previousRestRange = { start: start + deleteCount, end: this.items.length };
          var previousRenderedRestRange = range_js_1.Range.intersect(previousRestRange, previousRenderRange);
          var previousUnrenderedRestRanges = range_js_1.Range.relativeComplement(previousRestRange, previousRenderRange);
          ...
          var renderedRestRange = rangeMap_js_1.shift(previousRenderedRestRange, delta);
          var updateRange = range_js_1.Range.intersect(renderRange, renderedRestRange);
          for (var i = updateRange.start; i < updateRange.end; i++) {
              this.updateItemInDOM(this.items[i], i);
          }
          var removeRanges = range_js_1.Range.relativeComplement(renderedRestRange, renderRange);
          ...
          var unrenderedRestRanges = previousUnrenderedRestRanges.map(function (r) { return rangeMap_js_1.shift(r, delta); });
          var elementsRange = { start: start, end: start + elements.length };
          var insertRanges = [elementsRange].concat(unrenderedRestRanges).map(function (r) { return range_js_1.Range.intersect(renderRange, r); });
      ...
      ListView.prototype.render = function (renderTop, renderHeight, renderLeft, scrollWidth) {
          ...
          var rangesToInsert = range_js_1.Range.relativeComplement(renderRange, previousRenderRange);
          var rangesToRemove = range_js_1.Range.relativeComplement(previousRenderRange, renderRange);
          ...
          var canUseTranslate3d = !platform_js_1.isWindows && !browser.isFirefox && browser.getZoomLevel() === 0;
      ...
      ListView.prototype.insertItemInDOM = function (index, beforeElement) {
          ...
          if (uri) {
              var onDragStart = event_js_2.domEvent(item.row.domNode, 'dragstart');
      ...
      Object.defineProperty(ListView.prototype, "onMouseClick", {
          ...
          get: function () {
              var _this = this;
              return event_js_1.Event.map(event_js_2.domEvent(this.domNode, 'click'), function (e) { return _this.toMouseEvent(e); });
          },
          enumerable: true,
          configurable: true
      });
      Object.defineProperty(ListView.prototype, "onMouseDblClick", {
          get: function () {
              var _this = this;
              return event_js_1.Event.map(event_js_2.domEvent(this.domNode, 'dblclick'), function (e) { return _this.toMouseEvent(e); });
          },
          enumerable: true,
          configurable: true
      });
      Object.defineProperty(ListView.prototype, "onMouseMiddleClick", {
          get: function () {
              var _this = this;
              return event_js_1.Event.filter(event_js_1.Event.map(event_js_2.domEvent(this.domNode, 'auxclick'), function (e) { return _this.toMouseEvent(e); }), function (e) { return e.browserEvent.button === 1; });
          },
          enumerable: true,
          configurable: true
      });
      Object.defineProperty(ListView.prototype, "onMouseDown", {
          get: function () {
              var _this = this;
              return event_js_1.Event.map(event_js_2.domEvent(this.domNode, 'mousedown'), function (e) { return _this.toMouseEvent(e); });
          },
          enumerable: true,
          configurable: true
      });
      Object.defineProperty(ListView.prototype, "onContextMenu", {
          get: function () {
              var _this = this;
              return event_js_1.Event.map(event_js_2.domEvent(this.domNode, 'contextmenu'), function (e) { return _this.toMouseEvent(e); });
          },
          enumerable: true,
          configurable: true
      });
      Object.defineProperty(ListView.prototype, "onTouchStart", {
          get: function () {
              var _this = this;
              return event_js_1.Event.map(event_js_2.domEvent(this.domNode, 'touchstart'), function (e) { return _this.toTouchEvent(e); });
          },
          enumerable: true,
          configurable: true
      });
      Object.defineProperty(ListView.prototype, "onTap", {
          get: function () {
              var _this = this;
              return event_js_1.Event.map(event_js_2.domEvent(this.rowsContainer, touch_js_1.EventType.Tap), function (e) { return _this.toGestureEvent(e); });
          },
          enumerable: true,
          configurable: true
      });
      ...
      ListView.prototype.onDragStart = function (element, uri, event) {
          ...
          event.dataTransfer.setData(dnd_js_1.DataTransfers.RESOURCES, JSON.stringify([uri]));
          ...
          dnd_js_1.StaticDND.CurrentDragAndDropData = new ExternalElementsDragAndDropData(elements);
      ...
      ListView.prototype.onDragOver = function (event) {
          ...
          if (dnd_js_1.StaticDND.CurrentDragAndDropData && dnd_js_1.StaticDND.CurrentDragAndDropData.getData() === 'vscode-ui') {
              return false;
          }
          ...
          if (!this.currentDragData) {
              if (dnd_js_1.StaticDND.CurrentDragAndDropData) {
                  // Drag over from another list
                  this.currentDragData = dnd_js_1.StaticDND.CurrentDragAndDropData;
              }
              else {
          ...
          feedback = arrays_js_1.distinct(feedback).filter(function (i) { return i >= -1 && i < _this.length; }).sort();
          ...
          if (feedback[0] === -1) { // entire list feedback
              ...
              this.currentDragFeedbackDisposable = lifecycle_js_1.toDisposable(function () { return DOM.removeClass(_this.domNode, 'drop-target'); });
          }
          else {
              ...
              this.currentDragFeedbackDisposable = lifecycle_js_1.toDisposable(function () {
      ...
      ListView.prototype.onDragLeave = function () {
          var _this = this;
          this.onDragLeaveTimeout.dispose();
          this.onDragLeaveTimeout = async_js_1.disposableTimeout(function () { return _this.clearDragOverFeedback(); }, 100);
      };
      ListView.prototype.onDrop = function (event) {
          ...
          dnd_js_1.StaticDND.CurrentDragAndDropData = undefined;
      ...
      ListView.prototype.setupDragAndDropScrollTopAnimation = function (event) {
          ...
          this.dragOverAnimationStopDisposable = async_js_1.disposableTimeout(function () {
      ...
      ListView.prototype._rerender = function (renderTop, renderHeight) {
          ...
          while (true) {
              ...
              if (!didChange) {
                  ...
                  var unrenderRanges = range_js_1.Range.relativeComplement(previousRenderRange, renderRange);
                  ...
                  var renderRanges = range_js_1.Range.relativeComplement(renderRange, previousRenderRange);
