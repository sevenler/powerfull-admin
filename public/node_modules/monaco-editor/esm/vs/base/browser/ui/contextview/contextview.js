define('node_modules/monaco-editor/esm/vs/base/browser/ui/contextview/contextview', function(require, exports, module) {
  ...
  ''/*@require node_modules/monaco-editor/esm/vs/base/browser/ui/contextview/contextview.css*/;
  ...
  var ContextView = /** @class */ (function (_super) {
      ...
      function ContextView(container) {
          ...
          _this._register(lifecycle_js_1.toDisposable(function () { return _this.setContainer(null); }));
          return _this;
      }
      ContextView.prototype.setContainer = function (container) {
          var _this = this;
          if (this.container) {
              lifecycle_js_1.dispose(this.toDisposeOnSetContainer);
          ...
          if (container) {
              ...
              this.toDisposeOnSetContainer = lifecycle_js_1.combinedDisposable(toDisposeOnSetContainer_1);
          }
      };
