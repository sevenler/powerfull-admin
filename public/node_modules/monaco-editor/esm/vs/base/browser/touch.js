define('node_modules/monaco-editor/esm/vs/base/browser/touch', function(require, exports, module) {
  ...
  var DomUtils = tslib_1.__importStar(require("node_modules/monaco-editor/esm/vs/base/browser/dom"));
  ...
  var Gesture = /** @class */ (function (_super) {
      ...
      Gesture.prototype.onTouchStart = function (e) {
          ...
          for (var i = 0, len = e.targetTouches.length; i < len; i++) {
              ...
              var evt = this.newGestureEvent(exports.EventType.Start, touch.target);
      ...
      Gesture.prototype.onTouchEnd = function (e) {
          ...
          var _loop_1 = function (i, len) {
              ...
              if (holdTime < Gesture.HOLD_DELAY
                  ...
                  var evt = this_1.newGestureEvent(exports.EventType.Tap, data.initialTarget);
                  ...
                  && Math.abs(data.initialPageX - arrays.tail(data.rollingPageX)) < 30
                  && Math.abs(data.initialPageY - arrays.tail(data.rollingPageY)) < 30) {
                  var evt = this_1.newGestureEvent(exports.EventType.Contextmenu, data.initialTarget);
                  evt.pageX = arrays.tail(data.rollingPageX);
                  evt.pageY = arrays.tail(data.rollingPageY);
                  this_1.dispatchEvent(evt);
              }
              ...
              this_1.dispatchEvent(this_1.newGestureEvent(exports.EventType.End, data.initialTarget));
      ...
      Gesture.prototype.inertia = function (dispatchTo, t1, vX, dirX, x, vY, dirY, y) {
          ...
          this.handle = DomUtils.scheduleAtNextAnimationFrame(function () {
              ...
              var evt = _this.newGestureEvent(exports.EventType.Change);
      ...
      Gesture.prototype.onTouchMove = function (e) {
          ...
          for (var i = 0, len = e.changedTouches.length; i < len; i++) {
              ...
              var evt = this.newGestureEvent(exports.EventType.Change, data.initialTarget);
