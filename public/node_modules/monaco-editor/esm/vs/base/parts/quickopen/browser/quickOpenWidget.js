define('node_modules/monaco-editor/esm/vs/base/parts/quickopen/browser/quickOpenWidget', function(require, exports, module) {
  ...
  ''/*@require node_modules/monaco-editor/esm/vs/base/parts/quickopen/browser/quickopen.css*/;
  ...
  var quickOpenViewer_js_1 = require("node_modules/monaco-editor/esm/vs/base/parts/quickopen/browser/quickOpenViewer");
  var inputBox_js_1 = require("node_modules/monaco-editor/esm/vs/base/browser/ui/inputbox/inputBox");
  var treeImpl_js_1 = require("node_modules/monaco-editor/esm/vs/base/parts/tree/browser/treeImpl");
  var progressbar_js_1 = require("node_modules/monaco-editor/esm/vs/base/browser/ui/progressbar/progressbar");
  ...
  }(treeDefaults_js_1.DefaultController));
  exports.QuickOpenController = QuickOpenController;
  var defaultStyles = {
      background: color_js_1.Color.fromHex('#1E1E1E'),
      foreground: color_js_1.Color.fromHex('#CCCCCC'),
      pickerGroupForeground: color_js_1.Color.fromHex('#0097FB'),
      pickerGroupBorder: color_js_1.Color.fromHex('#3F3F46'),
      widgetShadow: color_js_1.Color.fromHex('#000000'),
  ...
  var QuickOpenWidget = /** @class */ (function (_super) {
      ...
      function QuickOpenWidget(container, callbacks, options) {
          ...
          objects_js_1.mixin(_this.styles, defaultStyles, false);
          _this.model = null;
          return _this;
      }
      ...
      QuickOpenWidget.prototype.create = function () {
          ...
          this._register(DOM.addDisposableListener(this.element, DOM.EventType.KEY_DOWN, function (e) {
              var keyboardEvent = new keyboardEvent_js_1.StandardKeyboardEvent(e);
          ...
          // Progress Bar
          this.progressBar = this._register(new progressbar_js_1.ProgressBar(this.element, { progressBarBackground: this.styles.progressBarBackground }));
          this.progressBar.hide();
          // Input Field
          this.inputContainer = document.createElement('div');
          DOM.addClass(this.inputContainer, 'quick-open-input');
          this.element.appendChild(this.inputContainer);
          this.inputBox = this._register(new inputBox_js_1.InputBox(this.inputContainer, undefined, {
          ...
          var createTree = this.options.treeCreator || (function (container, config, opts) { return new treeImpl_js_1.Tree(container, config, opts); });
          this.tree = this._register(createTree(this.treeContainer, {
              dataSource: new quickOpenViewer_js_1.DataSource(this),
              controller: new QuickOpenController({ clickBehavior: 1 /* ON_MOUSE_UP */, keyboardSupport: this.options.keyboardSupport }),
              renderer: (this.renderer = new quickOpenViewer_js_1.Renderer(this, this.styles)),
              filter: new quickOpenViewer_js_1.Filter(this),
              accessibilityProvider: new quickOpenViewer_js_1.AccessibilityProvider(this)
          }, {
              twistiePixels: 11,
              indentPixels: 0,
              alwaysFocused: true,
          ...
          this._register(this.tree.onDidChangeSelection(function (event) {
              if (event.selection && event.selection.length > 0) {
                  var mouseEvent = event.payload && event.payload.originalEvent instanceof mouseEvent_js_1.StandardMouseEvent ? event.payload.originalEvent : undefined;
      ...
      QuickOpenWidget.prototype.shouldOpenInBackground = function (e) {
          // Keyboard
          if (e instanceof keyboardEvent_js_1.StandardKeyboardEvent) {
