define('node_modules/monaco-editor/esm/vs/base/parts/quickopen/browser/quickOpenModel', function(require, exports, module) {
  ...
  var keybindingLabel_js_1 = require("node_modules/monaco-editor/esm/vs/base/browser/ui/keybindingLabel/keybindingLabel");
  ...
  var QuickOpenEntry = /** @class */ (function () {
      ...
      QuickOpenEntry.prototype.getAriaLabel = function () {
          return arrays_js_1.coalesce([this.getLabel(), this.getDescription(), this.getDetail()])
              .join(', ');
      };
      /**
  ...
  var Renderer = /** @class */ (function () {
      ...
      Renderer.prototype.renderTemplate = function (templateId, container, styles) {
          ...
          // Label
          var label = new iconLabel_js_1.IconLabel(row1, { supportHighlights: true, supportDescriptionHighlights: true });
          // Keybinding
          ...
          var keybinding = new keybindingLabel_js_1.KeybindingLabel(keybindingContainer, platform_js_1.OS);
          // Detail
          var detailContainer = document.createElement('div');
          row2.appendChild(detailContainer);
          DOM.addClass(detailContainer, 'quick-open-entry-meta');
          var detail = new highlightedLabel_js_1.HighlightedLabel(detailContainer, true);
          // Entry Group
          var group;
          ...
          var actionBar = new actionbar_js_1.ActionBar(actionBarContainer, {
