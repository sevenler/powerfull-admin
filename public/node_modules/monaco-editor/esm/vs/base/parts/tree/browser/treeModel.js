define('node_modules/monaco-editor/esm/vs/base/parts/tree/browser/treeModel', function(require, exports, module) {
      ...
      Lock.prototype.run = function (item, fn) {
          ...
          if (lock) {
              return new Promise(function (c, e) {
                  event_js_1.Event.once(lock.onDispose)(function () {
  ...
  var ItemRegistry = /** @class */ (function () {
      function ItemRegistry() {
          ...
          this._onDidRevealItem = new event_js_1.EventMultiplexer();
          this.onDidRevealItem = this._onDidRevealItem.event;
          this._onExpandItem = new event_js_1.EventMultiplexer();
          this.onExpandItem = this._onExpandItem.event;
          this._onDidExpandItem = new event_js_1.EventMultiplexer();
          this.onDidExpandItem = this._onDidExpandItem.event;
          this._onCollapseItem = new event_js_1.EventMultiplexer();
          this.onCollapseItem = this._onCollapseItem.event;
          this._onDidCollapseItem = new event_js_1.EventMultiplexer();
          this.onDidCollapseItem = this._onDidCollapseItem.event;
          this._onDidAddTraitItem = new event_js_1.EventMultiplexer();
          this.onDidAddTraitItem = this._onDidAddTraitItem.event;
          this._onDidRemoveTraitItem = new event_js_1.EventMultiplexer();
          this.onDidRemoveTraitItem = this._onDidRemoveTraitItem.event;
          this._onDidRefreshItem = new event_js_1.EventMultiplexer();
          this.onDidRefreshItem = this._onDidRefreshItem.event;
          this._onRefreshItemChildren = new event_js_1.EventMultiplexer();
          this.onRefreshItemChildren = this._onRefreshItemChildren.event;
          this._onDidRefreshItemChildren = new event_js_1.EventMultiplexer();
          this.onDidRefreshItemChildren = this._onDidRefreshItemChildren.event;
          this._onDidDisposeItem = new event_js_1.EventMultiplexer();
  ...
  var Item = /** @class */ (function () {
      function Item(id, registry, context, lock, element) {
          this._onDidCreate = new event_js_1.Emitter();
          this._onDidReveal = new event_js_1.Emitter();
          this.onDidReveal = this._onDidReveal.event;
          this._onExpand = new event_js_1.Emitter();
          this.onExpand = this._onExpand.event;
          this._onDidExpand = new event_js_1.Emitter();
          this.onDidExpand = this._onDidExpand.event;
          this._onCollapse = new event_js_1.Emitter();
          this.onCollapse = this._onCollapse.event;
          this._onDidCollapse = new event_js_1.Emitter();
          this.onDidCollapse = this._onDidCollapse.event;
          this._onDidAddTrait = new event_js_1.Emitter();
          this.onDidAddTrait = this._onDidAddTrait.event;
          this._onDidRemoveTrait = new event_js_1.Emitter();
          this.onDidRemoveTrait = this._onDidRemoveTrait.event;
          this._onDidRefresh = new event_js_1.Emitter();
          this.onDidRefresh = this._onDidRefresh.event;
          this._onRefreshChildren = new event_js_1.Emitter();
          this.onRefreshChildren = this._onRefreshChildren.event;
          this._onDidRefreshChildren = new event_js_1.Emitter();
  ...
  var TreeModel = /** @class */ (function () {
      function TreeModel(context) {
          this._onSetInput = new event_js_1.Emitter();
          this.onSetInput = this._onSetInput.event;
          this._onDidSetInput = new event_js_1.Emitter();
          this.onDidSetInput = this._onDidSetInput.event;
          this._onRefresh = new event_js_1.Emitter();
          this.onRefresh = this._onRefresh.event;
          this._onDidRefresh = new event_js_1.Emitter();
          this.onDidRefresh = this._onDidRefresh.event;
          this._onDidHighlight = new event_js_1.Emitter();
          this.onDidHighlight = this._onDidHighlight.event;
          this._onDidSelect = new event_js_1.Emitter();
          this.onDidSelect = this._onDidSelect.event;
          this._onDidFocus = new event_js_1.Emitter();
          this.onDidFocus = this._onDidFocus.event;
          this._onDidRevealItem = new event_js_1.Relay();
          this.onDidRevealItem = this._onDidRevealItem.event;
          this._onExpandItem = new event_js_1.Relay();
          this.onExpandItem = this._onExpandItem.event;
          this._onDidExpandItem = new event_js_1.Relay();
          this.onDidExpandItem = this._onDidExpandItem.event;
          this._onCollapseItem = new event_js_1.Relay();
          this.onCollapseItem = this._onCollapseItem.event;
          this._onDidCollapseItem = new event_js_1.Relay();
          this.onDidCollapseItem = this._onDidCollapseItem.event;
          this._onDidAddTraitItem = new event_js_1.Relay();
          this.onDidAddTraitItem = this._onDidAddTraitItem.event;
          this._onDidRemoveTraitItem = new event_js_1.Relay();
          this.onDidRemoveTraitItem = this._onDidRemoveTraitItem.event;
          this._onDidRefreshItem = new event_js_1.Relay();
          this.onDidRefreshItem = this._onDidRefreshItem.event;
          this._onRefreshItemChildren = new event_js_1.Relay();
          this.onRefreshItemChildren = this._onRefreshItemChildren.event;
          this._onDidRefreshItemChildren = new event_js_1.Relay();
          this.onDidRefreshItemChildren = this._onDidRefreshItemChildren.event;
          this._onDidDisposeItem = new event_js_1.Relay();
          this.context = context;
          this.input = null;
          this.traitsToItems = {};
      }
