define('node_modules/monaco-editor/esm/vs/base/parts/tree/browser/treeDefaults', function(require, exports, module) {

  "use strict";
  Object.defineProperty(exports, "__esModule", { value: true });
  var tslib_1 = require("node_modules/tslib/tslib");
  var platform = tslib_1.__importStar(require("node_modules/monaco-editor/esm/vs/base/common/platform"));
  var errors = tslib_1.__importStar(require("node_modules/monaco-editor/esm/vs/base/common/errors"));
  ...
  var KeybindingDispatcher = /** @class */ (function () {
      ...
      KeybindingDispatcher.prototype.set = function (keybinding, callback) {
          this._arr.push({
              keybinding: keyCodes_js_1.createKeybinding(keybinding, platform.OS),
              callback: callback
          });
      };
  ...
  var DefaultController = /** @class */ (function () {
      function DefaultController(options) {
          var _this = this;
          if (options === void 0) {
              options = { clickBehavior: 0 /* ON_MOUSE_DOWN */, keyboardSupport: true, openMode: 0 /* SINGLE_CLICK */ };
          }
