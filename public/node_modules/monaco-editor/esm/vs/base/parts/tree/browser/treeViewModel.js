define('node_modules/monaco-editor/esm/vs/base/parts/tree/browser/treeViewModel', function(require, exports, module) {
  ...
  var HeightMap = /** @class */ (function () {
      ...
      HeightMap.prototype.onRefreshItemSet = function (items) {
          ...
          this.onRefreshItems(new iterator_js_1.ArrayIterator(sortedItems));
      };
