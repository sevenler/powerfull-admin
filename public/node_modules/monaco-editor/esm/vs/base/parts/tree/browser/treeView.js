define('node_modules/monaco-editor/esm/vs/base/parts/tree/browser/treeView', function(require, exports, module) {
  ...
  var Lifecycle = tslib_1.__importStar(require("node_modules/monaco-editor/esm/vs/base/common/lifecycle"));
  var DOM = tslib_1.__importStar(require("node_modules/monaco-editor/esm/vs/base/browser/dom"));
  var Diff = tslib_1.__importStar(require("node_modules/monaco-editor/esm/vs/base/common/diff/diff"));
  var Touch = tslib_1.__importStar(require("node_modules/monaco-editor/esm/vs/base/browser/touch"));
  var strings = tslib_1.__importStar(require("node_modules/monaco-editor/esm/vs/base/common/strings"));
  var Mouse = tslib_1.__importStar(require("node_modules/monaco-editor/esm/vs/base/browser/mouseEvent"));
  var Keyboard = tslib_1.__importStar(require("node_modules/monaco-editor/esm/vs/base/browser/keyboardEvent"));
  var dnd = tslib_1.__importStar(require("node_modules/monaco-editor/esm/vs/base/parts/tree/browser/treeDnd"));
  ...
  var treeViewModel_js_1 = require("node_modules/monaco-editor/esm/vs/base/parts/tree/browser/treeViewModel");
  var _ = tslib_1.__importStar(require("node_modules/monaco-editor/esm/vs/base/parts/tree/browser/tree"));
  ...
  var treeDefaults_js_1 = require("node_modules/monaco-editor/esm/vs/base/parts/tree/browser/treeDefaults");
  ...
  var TreeView = /** @class */ (function (_super) {
      ...
      function TreeView(context, container) {
          ...
          _this.contentWidthUpdateDelayer = new async_js_1.Delayer(50);
          ...
          _this._onDOMFocus = new event_js_1.Emitter();
          _this._onDOMBlur = new event_js_1.Emitter();
          _this._onDidScroll = new event_js_1.Emitter();
          TreeView.counter++;
          ...
          _this.treeStyler = context.styler || new treeDefaults_js_1.DefaultTreestyler(_this.styleElement, "monaco-tree-instance-" + _this.instance);
          // ARIA
          ...
          _this.scrollableElement = new scrollableElement_js_1.ScrollableElement(_this.wrapper, {
      ...
      TreeView.prototype.onClearingInput = function (e) {
          var item = e.item;
          if (item) {
              this.onRemoveItems(new iterator_js_1.MappedIterator(item.getNavigator(), function (item) { return item && item.id; }));
              this.onRowsChanged();
          }
      };
              ...
              if (!skipDiff && !doToInsertItemsAlreadyExist && diff.length < 50) {
                  for (var _i = 0, diff_1 = diff; _i < diff_1.length; _i++) {
                      ...
                      if (diffChange.originalLength > 0) {
                          this.onRemoveItems(new iterator_js_1.ArrayIterator(previousChildrenIds_1, diffChange.originalStart, diffChange.originalStart + diffChange.originalLength));
                      }
                      if (diffChange.modifiedLength > 0) {
                          var beforeItem = afterModelItems_1[diffChange.modifiedStart - 1] || item;
                          beforeItem = beforeItem.getDepth() > 0 ? beforeItem : null;
                          this.onInsertItems(new iterator_js_1.ArrayIterator(afterModelItems_1, diffChange.modifiedStart, diffChange.modifiedStart + diffChange.modifiedLength), beforeItem ? beforeItem.id : null);
                      }
                  }
              }
              else if (skipDiff || diff.length) {
                  this.onRemoveItems(new iterator_js_1.ArrayIterator(previousChildrenIds_1));
                  this.onInsertItems(new iterator_js_1.ArrayIterator(afterModelItems_1), item.getDepth() > 0 ? item.id : null);
              }
      ...
      TreeView.prototype.onDragStart = function (item, e) {
          ...
          e.dataTransfer.setData(dnd_js_1.DataTransfers.RESOURCES, JSON.stringify([item.uri]));
          ...
          dnd_js_1.StaticDND.CurrentDragAndDropData = new dnd.ExternalElementsDragAndDropData(elements);
      ...
      TreeView.prototype.onDragOver = function (e) {
          ...
          if (!this.currentDragAndDropData) {
              ...
              if (dnd_js_1.StaticDND.CurrentDragAndDropData) {
                  this.currentDragAndDropData = dnd_js_1.StaticDND.CurrentDragAndDropData;
              }
              else {
          ...
          if (this.shouldInvalidateDropReaction || this.currentDropTarget !== currentDropTarget || !reactionEquals(this.currentDropElementReaction, reaction)) {
              ...
              if (canDrop) {
                  ...
                  if (reaction.autoExpand) {
                      var timeoutPromise_1 = async_js_1.timeout(500);
