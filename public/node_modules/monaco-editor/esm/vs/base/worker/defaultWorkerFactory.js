define('node_modules/monaco-editor/esm/vs/base/worker/defaultWorkerFactory', function(require, exports, module) {
  ...
  function getWorker(workerId, label) {
      ...
      if (platform_js_1.globals.MonacoEnvironment) {
          if (typeof platform_js_1.globals.MonacoEnvironment.getWorker === 'function') {
              return platform_js_1.globals.MonacoEnvironment.getWorker(workerId, label);
          }
          if (typeof platform_js_1.globals.MonacoEnvironment.getWorkerUrl === 'function') {
              return new Worker(platform_js_1.globals.MonacoEnvironment.getWorkerUrl(workerId, label));
          }
      }
      // ESM-comment-begin
