define('node_modules/monaco-editor/esm/vs/base/common/async', function(require, exports, module) {
  ...
  function createCancelablePromise(callback) {
      var source = new cancellation_js_1.CancellationTokenSource();
  ...
  function disposableTimeout(handler, timeout) {
      ...
      return lifecycle_js_1.toDisposable(function () { return clearTimeout(timer); });
  }
  exports.disposableTimeout = disposableTimeout;
  function first(promiseFactories, shouldStop, defaultValue) {
      if (shouldStop === void 0) {
          shouldStop = function (t) { return !!t; };
      }
