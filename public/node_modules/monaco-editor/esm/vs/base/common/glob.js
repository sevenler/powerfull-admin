define('node_modules/monaco-editor/esm/vs/base/common/glob', function(require, exports, module) {
  ...
  var CACHE = new map_js_1.LRUCache(10000); // bounded to 10000 elements
  var FALSE = function () {
      return false;
  };
  var NULL = function () {
      ...
      if (value) {
          ...
          if (typeof when_1 === 'string') {
              var result = function (path, basename, name, hasSibling) {
                  ...
                  return async_js_1.isThenable(matched) ?
