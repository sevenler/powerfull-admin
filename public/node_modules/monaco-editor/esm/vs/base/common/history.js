define('node_modules/monaco-editor/esm/vs/base/common/history', function(require, exports, module) {
  ...
  var HistoryNavigator = /** @class */ (function () {
      ...
      HistoryNavigator.prototype._onChange = function () {
          this._reduceToLimit();
          this._navigator = new iterator_js_1.ArrayNavigator(this._elements, 0, this._elements.length, this._elements.length);
      };
