define('node_modules/monaco-editor/esm/vs/editor/standalone/common/monarch/monarchLexer', function(require, exports, module) {
  ...
  var monarchCommon = tslib_1.__importStar(require("node_modules/monaco-editor/esm/vs/editor/standalone/common/monarch/monarchCommon"));
  ...
  var MonarchClassicTokensCollector = /** @class */ (function () {
      ...
      MonarchClassicTokensCollector.prototype.emit = function (startOffset, type) {
          ...
          this._tokens.push(new token_js_1.Token(startOffset, type, this._language));
      };
      ...
      MonarchClassicTokensCollector.prototype.finalize = function (endState) {
          return new token_js_1.TokenizationResult(this._tokens, endState);
      };
  ...
  var MonarchModernTokensCollector = /** @class */ (function () {
      ...
      MonarchModernTokensCollector.prototype.finalize = function (endState) {
          return new token_js_1.TokenizationResult2(MonarchModernTokensCollector._merge(this._prependTokens, this._tokens, null), endState);
      };
  ...
  var MonarchTokenizer = /** @class */ (function () {
      ...
      MonarchTokenizer.prototype._getNestedEmbeddedModeData = function (mimetypeOrModeId) {
          ...
          return new EmbeddedModeData(nestedModeId || nullMode_js_1.NULL_MODE_ID, nullMode_js_1.NULL_STATE);
      };
