define('node_modules/monaco-editor/esm/vs/editor/standalone/browser/quickOpen/gotoLine', function(require, exports, module) {
  ...
  ''/*@require node_modules/monaco-editor/esm/vs/editor/standalone/browser/quickOpen/gotoLine.css*/;
  ...
  var GotoLineEntry = /** @class */ (function (_super) {
      ...
      GotoLineEntry.prototype.parseInput = function (line) {
          ...
          var position;
          if (numbers.length === 0) {
              position = new position_js_1.Position(-1, -1);
          }
          else if (numbers.length === 1) {
              position = new position_js_1.Position(numbers[0], 1);
          }
          else {
              position = new position_js_1.Position(numbers[0], numbers[1]);
          }
          var model;
          if (editorBrowser_js_1.isCodeEditor(this.editor)) {
          ...
          if (isValid) {
              if (position.column && position.column > 1) {
                  label = strings.format(standaloneStrings_js_1.GoToLineNLS.gotoLineLabelValidLineAndColumn, position.lineNumber, position.column);
              }
              else {
                  label = strings.format(standaloneStrings_js_1.GoToLineNLS.gotoLineLabelValidLine, position.lineNumber);
              }
          }
          else if (position.lineNumber < 1 || position.lineNumber > (model ? model.getLineCount() : 0)) {
              label = strings.format(standaloneStrings_js_1.GoToLineNLS.gotoLineLabelEmptyWithLineLimit, model ? model.getLineCount() : 0);
          }
          else {
              label = strings.format(standaloneStrings_js_1.GoToLineNLS.gotoLineLabelEmptyWithLineAndColumnLimit, model ? model.getLineMaxColumn(position.lineNumber) : 0);
          }
          return {
              position: position,
              isValid: isValid,
      ...
      GotoLineEntry.prototype.getAriaLabel = function () {
          ...
          return strings.format(standaloneStrings_js_1.GoToLineNLS.gotoLineAriaLabel, currentLine, this.parseResult.label);
      };
      ...
      GotoLineEntry.prototype.toSelection = function () {
          return new range_js_1.Range(this.parseResult.position.lineNumber, this.parseResult.position.column, this.parseResult.position.lineNumber, this.parseResult.position.column);
      };
      return GotoLineEntry;
  }(quickOpenModel_js_1.QuickOpenEntry));
  ...
  var GotoLineAction = /** @class */ (function (_super) {
      ...
      function GotoLineAction() {
          return _super.call(this, standaloneStrings_js_1.GoToLineNLS.gotoLineActionInput, {
              id: 'editor.action.gotoLine',
              label: standaloneStrings_js_1.GoToLineNLS.gotoLineActionLabel,
              alias: 'Go to Line...',
              precondition: null,
              kbOpts: {
      ...
      GotoLineAction.prototype.run = function (accessor, editor) {
          ...
          this._show(this.getController(editor), {
              getModel: function (value) {
                  return new quickOpenModel_js_1.QuickOpenModel([new GotoLineEntry(value, editor, _this.getController(editor))]);
              },
  ...
  editorExtensions_js_1.registerEditorAction(GotoLineAction);
