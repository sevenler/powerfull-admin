define('node_modules/monaco-editor/esm/vs/editor/standalone/browser/standaloneThemeServiceImpl', function(require, exports, module) {
  ...
  var tokenization_js_1 = require("node_modules/monaco-editor/esm/vs/editor/common/modes/supports/tokenization");
  var themes_js_1 = require("node_modules/monaco-editor/esm/vs/editor/standalone/common/themes");
  ...
  var colorRegistry = platform_js_1.Registry.as(colorRegistry_js_1.Extensions.ColorContribution);
  var themingRegistry = platform_js_1.Registry.as(themeService_js_1.Extensions.ThemingContribution);
      ...
      StandaloneTheme.prototype.getColors = function () {
          if (!this.colors) {
              ...
              for (var id in this.themeData.colors) {
                  colors[id] = color_js_1.Color.fromHex(this.themeData.colors[id]);
              }
              if (this.themeData.inherit) {
                  var baseData = getBuiltinRules(this.themeData.base);
                  for (var id in baseData.colors) {
                      if (!colors[id]) {
                          colors[id] = color_js_1.Color.fromHex(baseData.colors[id]);
                      }
                  }
              }
              this.colors = colors;
  ...
  var StandaloneThemeServiceImpl = /** @class */ (function () {
      function StandaloneThemeServiceImpl() {
          ...
          this._onThemeChange = new event_js_1.Emitter();
          this._onIconThemeChange = new event_js_1.Emitter();
      ...
      StandaloneThemeServiceImpl.prototype.setTheme = function (themeName) {
          ...
          ruleCollector.addRule(tokenization_js_1.generateTokensCSSForColorMap(colorMap));
          this._styleElement.innerHTML = cssRules.join('\n');
          modes_js_1.TokenizationRegistry.setColorMap(colorMap);
