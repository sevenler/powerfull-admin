define('node_modules/monaco-editor/esm/vs/editor/standalone/browser/standaloneCodeServiceImpl', function(require, exports, module) {
  ...
  var codeEditorServiceImpl_js_1 = require("node_modules/monaco-editor/esm/vs/editor/browser/services/codeEditorServiceImpl");
          ...
          if (!model) {
              if (input.resource) {
                  ...
                  if (schema === network_js_1.Schemas.http || schema === network_js_1.Schemas.https) {
                      ...
                      dom_js_1.windowOpenNoOpener(input.resource.toString());
                      return editor;
                  }
              }
              return null;
  ...
  }(codeEditorServiceImpl_js_1.CodeEditorServiceImpl));
