define('node_modules/monaco-editor/esm/vs/editor/standalone/browser/quickOpen/quickOutline', function(require, exports, module) {
  ...
  ''/*@require node_modules/monaco-editor/esm/vs/editor/standalone/browser/quickOpen/quickOutline.css*/;
  ...
  var quickOpen_js_1 = require("node_modules/monaco-editor/esm/vs/editor/contrib/quickOpen/quickOpen");
  ...
  var SymbolEntry = /** @class */ (function (_super) {
      ...
      SymbolEntry.prototype.getAriaLabel = function () {
          return strings.format(standaloneStrings_js_1.QuickOutlineNLS.entryAriaLabel, this.name);
      };
      ...
      SymbolEntry.prototype.toSelection = function () {
          return new range_js_1.Range(this.range.startLineNumber, this.range.startColumn || 1, this.range.startLineNumber, this.range.startColumn || 1);
      };
      return SymbolEntry;
  ...
  var QuickOutlineAction = /** @class */ (function (_super) {
      ...
      function QuickOutlineAction() {
          return _super.call(this, standaloneStrings_js_1.QuickOutlineNLS.quickOutlineActionInput, {
              id: 'editor.action.quickOutline',
              label: standaloneStrings_js_1.QuickOutlineNLS.quickOutlineActionLabel,
              alias: 'Go to Symbol...',
              precondition: editorContextKeys_js_1.EditorContextKeys.hasDocumentSymbolProvider,
              kbOpts: {
      ...
      QuickOutlineAction.prototype.run = function (accessor, editor) {
          ...
          if (!modes_js_1.DocumentSymbolProviderRegistry.has(model)) {
              return undefined;
          }
          // Resolve outline
          return quickOpen_js_1.getDocumentSymbols(model, true, cancellation_js_1.CancellationToken.None).then(function (result) {
              if (result.length === 0) {
                  return;
              }
      ...
      QuickOutlineAction.prototype._run = function (editor, result) {
          ...
          this._show(this.getController(editor), {
              getModel: function (value) {
                  return new quickOpenModel_js_1.QuickOpenModel(_this.toQuickOpenEntries(editor, result, value));
              },
      ...
      QuickOutlineAction.prototype.symbolEntry = function (name, type, description, range, highlights, editor, decorator) {
          return new SymbolEntry(name, type, description, range_js_1.Range.lift(range), highlights, editor, decorator);
      };
      QuickOutlineAction.prototype.toQuickOpenEntries = function (editor, flattened, searchValue) {
          ...
          for (var _i = 0, flattened_1 = flattened; _i < flattened_1.length; _i++) {
              ...
              // Check for meatch
              var highlights = filters_js_1.matchesFuzzy(normalizedSearchValue, label);
              if (highlights) {
                  ...
                  // Add
                  results.push(this.symbolEntry(label, modes_js_1.symbolKindToCssClass(element.kind), description, element.range, highlights, editor, controller));
              }
          }
          ...
          // Mark first entry as outline
              ...
              results[0].setGroupLabel(strings.format(standaloneStrings_js_1.QuickOutlineNLS._symbols_, results.length));
          }
          return results;
      };
      QuickOutlineAction.prototype.typeToLabel = function (type, count) {
          switch (type) {
              case 'module': return strings.format(standaloneStrings_js_1.QuickOutlineNLS._modules_, count);
              case 'class': return strings.format(standaloneStrings_js_1.QuickOutlineNLS._class_, count);
              case 'interface': return strings.format(standaloneStrings_js_1.QuickOutlineNLS._interface_, count);
              case 'method': return strings.format(standaloneStrings_js_1.QuickOutlineNLS._method_, count);
              case 'function': return strings.format(standaloneStrings_js_1.QuickOutlineNLS._function_, count);
              case 'property': return strings.format(standaloneStrings_js_1.QuickOutlineNLS._property_, count);
              case 'variable': return strings.format(standaloneStrings_js_1.QuickOutlineNLS._variable_, count);
              case 'var': return strings.format(standaloneStrings_js_1.QuickOutlineNLS._variable2_, count);
              case 'constructor': return strings.format(standaloneStrings_js_1.QuickOutlineNLS._constructor_, count);
              case 'call': return strings.format(standaloneStrings_js_1.QuickOutlineNLS._call_, count);
          }
          return type;
      };
  ...
  editorExtensions_js_1.registerEditorAction(QuickOutlineAction);
