define('node_modules/monaco-editor/esm/vs/editor/browser/config/configuration', function(require, exports, module) {
  ...
  var charWidthReader_js_1 = require("node_modules/monaco-editor/esm/vs/editor/browser/config/charWidthReader");
  var elementSizeObserver_js_1 = require("node_modules/monaco-editor/esm/vs/editor/browser/config/elementSizeObserver");
  ...
  var CSSBasedConfiguration = /** @class */ (function (_super) {
      ...
      CSSBasedConfiguration.createRequest = function (chr, type, all, monospace) {
          var result = new charWidthReader_js_1.CharWidthRequest(chr, type);
          all.push(result);
          if (monospace) {
      ...
      CSSBasedConfiguration._actualReadConfiguration = function (bareFontInfo) {
          ...
          charWidthReader_js_1.readCharWidths(bareFontInfo, all);
  ...
  var Configuration = /** @class */ (function (_super) {
      ...
      function Configuration(isSimpleWidget, options, referenceDomElement, accessibilityService) {
          ...
          _this._elementSizeObserver = _this._register(new elementSizeObserver_js_1.ElementSizeObserver(referenceDomElement, function () { return _this._onReferenceDomElementSizeChanged(); }));
  ...
  }(commonEditorConfig_js_1.CommonEditorConfiguration));
