define('node_modules/monaco-editor/esm/vs/editor/browser/widget/diffEditorWidget', function(require, exports, module) {
  ...
  ''/*@require node_modules/monaco-editor/esm/vs/editor/browser/widget/media/diffEditor.css*/;
  ...
  var sash_js_1 = require("node_modules/monaco-editor/esm/vs/base/browser/ui/sash/sash");
  ...
  var diffReview_js_1 = require("node_modules/monaco-editor/esm/vs/editor/browser/widget/diffReview");
  ...
  var stringBuilder_js_1 = require("node_modules/monaco-editor/esm/vs/editor/common/core/stringBuilder");
  ...
  var overviewZoneManager_js_1 = require("node_modules/monaco-editor/esm/vs/editor/common/view/overviewZoneManager");
  var lineDecorations_js_1 = require("node_modules/monaco-editor/esm/vs/editor/common/viewLayout/lineDecorations");
  ...
  var VisualEditorState = /** @class */ (function () {
      ...
      VisualEditorState.prototype.apply = function (editor, overviewRuler, newDecorations, restoreScrollState) {
          var _this = this;
          var scrollState = restoreScrollState ? editorState_js_1.StableEditorScrollState.capture(editor) : null;
          // view zones
          editor.changeViewZones(function (viewChangeAccessor) {
  ...
  var DiffEditorWidget = /** @class */ (function (_super) {
      ...
      function DiffEditorWidget(domElement, options, editorWorkerService, contextKeyService, instantiationService, codeEditorService, themeService, notificationService) {
          ...
          _this._onDidUpdateDiff = _this._register(new event_js_1.Emitter());
          ...
          _this._updateDecorationsRunner = _this._register(new async_js_1.RunOnceScheduler(function () { return _this._updateDecorations(); }, 0));
          ...
          _this._overviewViewportDomElement = fastDomNode_js_1.createFastDomNode(document.createElement('div'));
          ...
          var leftServices = new serviceCollection_js_1.ServiceCollection();
          leftServices.set(contextkey_js_1.IContextKeyService, leftContextKeyService);
          ...
          var rightServices = new serviceCollection_js_1.ServiceCollection();
          rightServices.set(contextkey_js_1.IContextKeyService, rightContextKeyService);
          ...
          _this._reviewPane = new diffReview_js_1.DiffReview(_this);
      ...
      DiffEditorWidget._getClassName = function (theme, renderSideBySide) {
          ...
          result += themeService_js_1.getThemeTypeSelector(theme.type);
          return result;
      };
      ...
      DiffEditorWidget.prototype._createInnerEditor = function (instantiationService, container, options) {
          return instantiationService.createInstance(codeEditorWidget_js_1.CodeEditorWidget, container, options, {});
      };
      ...
      DiffEditorWidget = __decorate([
          __param(2, editorWorkerService_js_1.IEditorWorkerService),
          ...
          __param(7, notification_js_1.INotificationService)
      ], DiffEditorWidget);
  ...
  var DiffEditorWidgetStyle = /** @class */ (function (_super) {
      ...
      DiffEditorWidgetStyle.prototype.applyColors = function (theme) {
          var newInsertColor = (theme.getColor(colorRegistry_js_1.diffInserted) || colorRegistry_js_1.defaultInsertColor).transparent(2);
          var newRemoveColor = (theme.getColor(colorRegistry_js_1.diffRemoved) || colorRegistry_js_1.defaultRemoveColor).transparent(2);
  ...
  function createDecoration(startLineNumber, startColumn, endLineNumber, endColumn, options) {
      return {
          range: new range_js_1.Range(startLineNumber, startColumn, endLineNumber, endColumn),
          options: options
      };
  }
  var DECORATIONS = {
      charDelete: textModel_js_1.ModelDecorationOptions.register({
          className: 'char-delete'
      }),
      charDeleteWholeLine: textModel_js_1.ModelDecorationOptions.register({
          className: 'char-delete',
          isWholeLine: true
      }),
      charInsert: textModel_js_1.ModelDecorationOptions.register({
          className: 'char-insert'
      }),
      charInsertWholeLine: textModel_js_1.ModelDecorationOptions.register({
          className: 'char-insert',
          isWholeLine: true
      }),
      lineInsert: textModel_js_1.ModelDecorationOptions.register({
          className: 'line-insert',
          marginClassName: 'line-insert',
          isWholeLine: true
      }),
      lineInsertWithSign: textModel_js_1.ModelDecorationOptions.register({
          className: 'line-insert',
          linesDecorationsClassName: 'insert-sign',
          marginClassName: 'line-insert',
          isWholeLine: true
      }),
      lineDelete: textModel_js_1.ModelDecorationOptions.register({
          className: 'line-delete',
          marginClassName: 'line-delete',
          isWholeLine: true
      }),
      lineDeleteWithSign: textModel_js_1.ModelDecorationOptions.register({
          className: 'line-delete',
          linesDecorationsClassName: 'delete-sign',
          marginClassName: 'line-delete',
          isWholeLine: true
      }),
      lineDeleteMargin: textModel_js_1.ModelDecorationOptions.register({
          marginClassName: 'line-delete',
      })
  };
  var DiffEdtorWidgetSideBySide = /** @class */ (function (_super) {
      ...
      function DiffEdtorWidgetSideBySide(dataSource, enableSplitViewResizing) {
          ...
          _this._sash = _this._register(new sash_js_1.Sash(_this._dataSource.getContainerDomNode(), _this));
          ...
          for (var i = 0, length_5 = lineChanges.length; i < length_5; i++) {
              ...
              if (isChangeOrDelete(lineChange)) {
                  result.decorations.push({
                      range: new range_js_1.Range(lineChange.originalStartLineNumber, 1, lineChange.originalEndLineNumber, Number.MAX_VALUE),
                  ...
                  result.overviewZones.push(new overviewZoneManager_js_1.OverviewRulerZone(lineChange.originalStartLineNumber, lineChange.originalEndLineNumber, overviewZoneColor));
      ...
      DiffEdtorWidgetSideBySide.prototype._getModifiedEditorDecorations = function (lineChanges, ignoreTrimWhitespace, renderIndicators, originalEditor, modifiedEditor) {
          ...
          for (var i = 0, length_6 = lineChanges.length; i < length_6; i++) {
              ...
              if (isChangeOrInsert(lineChange)) {
                  result.decorations.push({
                      range: new range_js_1.Range(lineChange.modifiedStartLineNumber, 1, lineChange.modifiedEndLineNumber, Number.MAX_VALUE),
                  ...
                  result.overviewZones.push(new overviewZoneManager_js_1.OverviewRulerZone(lineChange.modifiedStartLineNumber, lineChange.modifiedEndLineNumber, overviewZoneColor));
                  if (lineChange.charChanges) {
                      for (var j = 0, lengthJ = lineChange.charChanges.length; j < lengthJ; j++) {
                          var charChange = lineChange.charChanges[j];
  ...
  var InlineViewZonesComputer = /** @class */ (function (_super) {
      ...
      InlineViewZonesComputer.prototype._produceModifiedFromDiff = function (lineChange, lineChangeOriginalLength, lineChangeModifiedLength) {
          ...
          if (lineChange.charChanges) {
              for (var j = 0, lengthJ = lineChange.charChanges.length; j < lengthJ; j++) {
                  var charChange = lineChange.charChanges[j];
                  if (isChangeOrDelete(charChange)) {
                      decorations.push(new viewModel_js_1.InlineDecoration(new range_js_1.Range(charChange.originalStartLineNumber, charChange.originalStartColumn, charChange.originalEndLineNumber, charChange.originalEndColumn), 'char-delete', 0 /* Regular */));
                  }
              }
          }
          var sb = stringBuilder_js_1.createStringBuilder(10000);
          var marginHTML = [];
          ...
          configuration_js_1.Configuration.applyFontInfoSlow(domNode, this.modifiedEditorConfiguration.fontInfo);
          var marginDomNode = document.createElement('div');
          marginDomNode.className = 'inline-deleted-margin-view-zone';
          marginDomNode.innerHTML = marginHTML.join('');
          configuration_js_1.Configuration.applyFontInfoSlow(marginDomNode, this.modifiedEditorConfiguration.fontInfo);
          return {
      ...
      InlineViewZonesComputer.prototype._renderOriginalLine = function (count, originalModel, config, tabSize, lineNumber, decorations, sb) {
          ...
          var actualDecorations = lineDecorations_js_1.LineDecoration.filter(decorations, lineNumber, 1, lineContent.length + 1);
          ...
          var isBasicASCII = viewModel_js_1.ViewLineRenderingData.isBasicASCII(lineContent, originalModel.mightContainNonBasicASCII());
          var containsRTL = viewModel_js_1.ViewLineRenderingData.containsRTL(lineContent, isBasicASCII, originalModel.mightContainRTL());
          var output = viewLineRenderer_js_1.renderViewLine(new viewLineRenderer_js_1.RenderLineInput((config.fontInfo.isMonospace && !config.viewInfo.disableMonospaceOptimizations), config.fontInfo.canUseHalfwidthRightwardsArrow, lineContent, false, isBasicASCII, containsRTL, 0, lineTokens, actualDecorations, tabSize, config.fontInfo.spaceWidth, config.viewInfo.stopRenderingLineAfter, config.viewInfo.renderWhitespace, config.viewInfo.renderControlCharacters, config.viewInfo.fontLigatures), sb);
  ...
  themeService_js_1.registerThemingParticipant(function (theme, collector) {
      var added = theme.getColor(colorRegistry_js_1.diffInserted);
      if (added) {
          collector.addRule(".monaco-editor .line-insert, .monaco-editor .char-insert { background-color: " + added + "; }");
          collector.addRule(".monaco-diff-editor .line-insert, .monaco-diff-editor .char-insert { background-color: " + added + "; }");
          collector.addRule(".monaco-editor .inline-added-margin-view-zone { background-color: " + added + "; }");
      }
      var removed = theme.getColor(colorRegistry_js_1.diffRemoved);
      if (removed) {
          collector.addRule(".monaco-editor .line-delete, .monaco-editor .char-delete { background-color: " + removed + "; }");
          collector.addRule(".monaco-diff-editor .line-delete, .monaco-diff-editor .char-delete { background-color: " + removed + "; }");
          collector.addRule(".monaco-editor .inline-deleted-margin-view-zone { background-color: " + removed + "; }");
      }
      var addedOutline = theme.getColor(colorRegistry_js_1.diffInsertedOutline);
      if (addedOutline) {
          collector.addRule(".monaco-editor .line-insert, .monaco-editor .char-insert { border: 1px " + (theme.type === 'hc' ? 'dashed' : 'solid') + " " + addedOutline + "; }");
      }
      var removedOutline = theme.getColor(colorRegistry_js_1.diffRemovedOutline);
      if (removedOutline) {
          collector.addRule(".monaco-editor .line-delete, .monaco-editor .char-delete { border: 1px " + (theme.type === 'hc' ? 'dashed' : 'solid') + " " + removedOutline + "; }");
      }
      var shadow = theme.getColor(colorRegistry_js_1.scrollbarShadow);
      if (shadow) {
          collector.addRule(".monaco-diff-editor.side-by-side .editor.modified { box-shadow: -6px 0 5px -5px " + shadow + "; }");
      }
      var border = theme.getColor(colorRegistry_js_1.diffBorder);
      if (border) {
