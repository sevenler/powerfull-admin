define('node_modules/monaco-editor/esm/vs/editor/browser/widget/diffReview', function(require, exports, module) {
  ...
  ''/*@require node_modules/monaco-editor/esm/vs/editor/browser/widget/media/diffReview.css*/;
  ...
  var DiffReview = /** @class */ (function (_super) {
      ...
      function DiffReview(diffEditor) {
          ...
          _this.shadow = fastDomNode_js_1.createFastDomNode(document.createElement('div'));
          _this.shadow.setClassName('diff-review-shadow');
          _this.actionBarContainer = fastDomNode_js_1.createFastDomNode(document.createElement('div'));
          _this.actionBarContainer.setClassName('diff-review-actions');
          _this._actionBar = _this._register(new actionbar_js_1.ActionBar(_this.actionBarContainer.domNode));
          _this._actionBar.push(new actions_js_1.Action('diffreview.close', nls.localize('label.close', "Close"), 'close-diff-review', true, function () {
              _this.hide();
          ...
          _this._content = fastDomNode_js_1.createFastDomNode(document.createElement('div'));
          _this._content.setClassName('diff-review-content');
          _this.scrollbar = _this._register(new scrollableElement_js_1.DomScrollableElement(_this._content.domNode, {}));
      ...
      DiffReview.prototype.prev = function () {
          ...
          this._diffEditor.setPosition(new position_js_1.Position(this._diffs[index].entries[0].modifiedLineStart, 1));
      ...
      DiffReview.prototype.accept = function () {
          ...
          if (jumpToLineNumber !== -1) {
              this._diffEditor.setPosition(new position_js_1.Position(jumpToLineNumber, 1));
              this._diffEditor.revealPosition(new position_js_1.Position(jumpToLineNumber, 1), 1 /* Immediate */);
          }
      };
      ...
      DiffReview.prototype._render = function () {
          ...
          configuration_js_1.Configuration.applyFontInfoSlow(container, modifiedOpts.fontInfo);
      ...
      DiffReview._renderLine = function (model, config, tabSize, lineNumber) {
          ...
          var lineTokens = new lineTokens_js_1.LineTokens(tokens, lineContent);
          var isBasicASCII = viewModel_js_1.ViewLineRenderingData.isBasicASCII(lineContent, model.mightContainNonBasicASCII());
          var containsRTL = viewModel_js_1.ViewLineRenderingData.containsRTL(lineContent, isBasicASCII, model.mightContainRTL());
          var r = viewLineRenderer_js_1.renderViewLine2(new viewLineRenderer_js_1.RenderLineInput((config.fontInfo.isMonospace && !config.viewInfo.disableMonospaceOptimizations), config.fontInfo.canUseHalfwidthRightwardsArrow, lineContent, false, isBasicASCII, containsRTL, 0, lineTokens, [], tabSize, config.fontInfo.spaceWidth, config.viewInfo.stopRenderingLineAfter, config.viewInfo.renderWhitespace, config.viewInfo.renderControlCharacters, config.viewInfo.fontLigatures));
          return r.html;
      };
      return DiffReview;
  ...
  themeService_js_1.registerThemingParticipant(function (theme, collector) {
      var lineNumbers = theme.getColor(editorColorRegistry_js_1.editorLineNumbers);
      if (lineNumbers) {
  ...
  editorExtensions_js_1.registerEditorAction(DiffReviewNext);
  editorExtensions_js_1.registerEditorAction(DiffReviewPrev);
