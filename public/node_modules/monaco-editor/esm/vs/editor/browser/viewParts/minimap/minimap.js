define('node_modules/monaco-editor/esm/vs/editor/browser/viewParts/minimap/minimap', function(require, exports, module) {
  ...
  ''/*@require node_modules/monaco-editor/esm/vs/editor/browser/viewParts/minimap/minimap.css*/;
  ...
  var globalMouseMoveMonitor_js_1 = require("node_modules/monaco-editor/esm/vs/base/browser/globalMouseMoveMonitor");
  ...
  var viewLayer_js_1 = require("node_modules/monaco-editor/esm/vs/editor/browser/view/viewLayer");
  ...
  var runtimeMinimapCharRenderer_js_1 = require("node_modules/monaco-editor/esm/vs/editor/common/view/runtimeMinimapCharRenderer");
  ...
  var RenderData = /** @class */ (function () {
      function RenderData(renderedLayout, imageData, lines) {
          ...
          this._renderedLines = new viewLayer_js_1.RenderedLinesCollection(function () { return MinimapLine.INVALID; });
  ...
  var Minimap = /** @class */ (function (_super) {
      ...
      function Minimap(context) {
          ...
          _this._buffers = null;
          _this._domNode = fastDomNode_js_1.createFastDomNode(document.createElement('div'));
          viewPart_js_1.PartFingerprints.write(_this._domNode, 8 /* Minimap */);
          _this._domNode.setClassName(_this._getMinimapDomNodeClassName());
          _this._domNode.setPosition('absolute');
          _this._domNode.setAttribute('role', 'presentation');
          _this._domNode.setAttribute('aria-hidden', 'true');
          _this._shadow = fastDomNode_js_1.createFastDomNode(document.createElement('div'));
          _this._shadow.setClassName('minimap-shadow-hidden');
          _this._domNode.appendChild(_this._shadow);
          _this._canvas = fastDomNode_js_1.createFastDomNode(document.createElement('canvas'));
          _this._canvas.setPosition('absolute');
          _this._canvas.setLeft(0);
          _this._domNode.appendChild(_this._canvas);
          _this._slider = fastDomNode_js_1.createFastDomNode(document.createElement('div'));
          ...
          _this._sliderHorizontal = fastDomNode_js_1.createFastDomNode(document.createElement('div'));
          ...
          _this._tokensColorTracker = minimapCharRenderer_js_1.MinimapTokensColorTracker.getInstance();
          _this._applyLayout();
          _this._mouseDownListener = dom.addStandardDisposableListener(_this._canvas.domNode, 'mousedown', function (e) {
              ...
              _this._context.privateViewEventBus.emit(new viewEvents.ViewRevealRangeRequestEvent(new range_js_1.Range(lineNumber, 1, lineNumber, 1), 1 /* Center */, false, 0 /* Smooth */));
          });
          _this._sliderMouseMoveMonitor = new globalMouseMoveMonitor_js_1.GlobalMouseMoveMonitor();
          _this._sliderMouseDownListener = dom.addStandardDisposableListener(_this._slider.domNode, 'mousedown', function (e) {
              ...
              if (e.leftButton && _this._lastRenderData) {
                  ...
                  _this._sliderMouseMoveMonitor.startMonitoring(globalMouseMoveMonitor_js_1.standardMouseMoveMerger, function (mouseMoveData) {
      ...
      Minimap.prototype.renderLines = function (layout) {
          ...
          for (var lineIndex = 0, lineCount = endLineNumber - startLineNumber + 1; lineIndex < lineCount; lineIndex++) {
              if (needed[lineIndex]) {
                  Minimap._renderLine(imageData, background, useLighterFont, renderMinimap, this._tokensColorTracker, runtimeMinimapCharRenderer_js_1.getOrCreateMinimapCharRenderer(), dy, tabSize, lineInfo.data[lineIndex]);
              }
  ...
  themeService_js_1.registerThemingParticipant(function (theme, collector) {
      var sliderBackground = theme.getColor(colorRegistry_js_1.scrollbarSliderBackground);
      if (sliderBackground) {
      ...
      var sliderHoverBackground = theme.getColor(colorRegistry_js_1.scrollbarSliderHoverBackground);
      ...
      var sliderActiveBackground = theme.getColor(colorRegistry_js_1.scrollbarSliderActiveBackground);
