define('node_modules/monaco-editor/esm/vs/editor/browser/viewParts/lines/viewLine', function(require, exports, module) {
  ...
  var rangeUtil_js_1 = require("node_modules/monaco-editor/esm/vs/editor/browser/viewParts/lines/rangeUtil");
  ...
  var ViewLine = /** @class */ (function () {
      ...
      ViewLine.prototype.setDomNode = function (domNode) {
          if (this._renderedViewLine) {
              this._renderedViewLine.domNode = fastDomNode_js_1.createFastDomNode(domNode);
          }
          else {
      ...
      ViewLine.prototype.onSelectionChanged = function () {
          if (alwaysRenderInlineSelection || this._options.themeType === themeService_js_1.HIGH_CONTRAST) {
              this._isMaybeInvalid = true;
              return true;
          }
          return false;
      ...
      ViewLine.prototype.renderLine = function (lineNumber, deltaTop, viewportData, sb) {
          ...
          var actualInlineDecorations = lineDecorations_js_1.LineDecoration.filter(lineData.inlineDecorations, lineNumber, lineData.minColumn, lineData.maxColumn);
          if (alwaysRenderInlineSelection || options.themeType === themeService_js_1.HIGH_CONTRAST) {
              ...
              for (var _i = 0, selections_1 = selections; _i < selections_1.length; _i++) {
                  ...
                  if (startColumn < endColumn) {
                      actualInlineDecorations.push(new lineDecorations_js_1.LineDecoration(startColumn, endColumn, 'inline-selected-text', 0 /* Regular */));
                  }
              }
          }
          var renderLineInput = new viewLineRenderer_js_1.RenderLineInput(options.useMonospaceOptimizations, options.canUseHalfwidthRightwardsArrow, lineData.content, lineData.continuesWithWrappedLine, lineData.isBasicASCII, lineData.containsRTL, lineData.minColumn - 1, lineData.tokens, actualInlineDecorations, lineData.tabSize, options.spaceWidth, options.stopRenderingLineAfter, options.renderWhitespace, options.renderControlCharacters, options.fontLigatures);
          ...
          var output = viewLineRenderer_js_1.renderViewLine(renderLineInput, sb);
  ...
  var FastRenderedViewLine = /** @class */ (function () {
      ...
      FastRenderedViewLine.prototype.getVisibleRangesForRange = function (startColumn, endColumn, context) {
          ...
          return [new renderingContext_js_1.HorizontalRange(startPosition, endPosition - startPosition)];
      };
  ...
  var RenderedViewLine = /** @class */ (function () {
      ...
      RenderedViewLine.prototype.getVisibleRangesForRange = function (startColumn, endColumn, context) {
          if (this._pixelOffsetCache !== null) {
              ...
              return [new renderingContext_js_1.HorizontalRange(startOffset, endOffset - startOffset)];
          }
      ...
      RenderedViewLine.prototype._readVisibleRangesForRange = function (startColumn, endColumn, context) {
          if (startColumn === endColumn) {
              ...
              if (pixelOffset === -1) {
                  ...
                  return [new renderingContext_js_1.HorizontalRange(pixelOffset, 0)];
              }
          }
          else {
      ...
      RenderedViewLine.prototype._actualReadPixelOffset = function (column, context) {
          if (this._characterMapping.length === 0) {
              // This line has no content
              var r_1 = rangeUtil_js_1.RangeUtil.readHorizontalRanges(this._getReadingTarget(), 0, 0, 0, 0, context.clientRectDeltaLeft, context.endNode);
              if (!r_1 || r_1.length === 0) {
                  return -1;
              }
              return r_1[0].left;
          ...
          var partIndex = viewLineRenderer_js_1.CharacterMapping.getPartIndex(partData);
          var charOffsetInPart = viewLineRenderer_js_1.CharacterMapping.getCharIndex(partData);
          var r = rangeUtil_js_1.RangeUtil.readHorizontalRanges(this._getReadingTarget(), partIndex, charOffsetInPart, partIndex, charOffsetInPart, context.clientRectDeltaLeft, context.endNode);
          if (!r || r.length === 0) {
              return -1;
          }
          return r[0].left;
      ...
      RenderedViewLine.prototype._readRawVisibleRangesForRange = function (startColumn, endColumn, context) {
          if (startColumn === 1 && endColumn === this._characterMapping.length) {
              ...
              return [new renderingContext_js_1.HorizontalRange(0, this.getWidth())];
          }
          var startPartData = this._characterMapping.charOffsetToPartData(startColumn - 1);
          var startPartIndex = viewLineRenderer_js_1.CharacterMapping.getPartIndex(startPartData);
          var startCharOffsetInPart = viewLineRenderer_js_1.CharacterMapping.getCharIndex(startPartData);
          var endPartData = this._characterMapping.charOffsetToPartData(endColumn - 1);
          var endPartIndex = viewLineRenderer_js_1.CharacterMapping.getPartIndex(endPartData);
          var endCharOffsetInPart = viewLineRenderer_js_1.CharacterMapping.getCharIndex(endPartData);
          return rangeUtil_js_1.RangeUtil.readHorizontalRanges(this._getReadingTarget(), startPartIndex, startCharOffsetInPart, endPartIndex, endCharOffsetInPart, context.clientRectDeltaLeft, context.endNode);
      };
      /**
