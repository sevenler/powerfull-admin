define('node_modules/monaco-editor/esm/vs/editor/browser/viewParts/selections/selections', function(require, exports, module) {
  ...
  ''/*@require node_modules/monaco-editor/esm/vs/editor/browser/viewParts/selections/selections.css*/;
  ...
  themeService_js_1.registerThemingParticipant(function (theme, collector) {
      var editorSelectionColor = theme.getColor(colorRegistry_js_1.editorSelectionBackground);
      if (editorSelectionColor) {
          collector.addRule(".monaco-editor .focused .selected-text { background-color: " + editorSelectionColor + "; }");
      }
      var editorInactiveSelectionColor = theme.getColor(colorRegistry_js_1.editorInactiveSelection);
      if (editorInactiveSelectionColor) {
          collector.addRule(".monaco-editor .selected-text { background-color: " + editorInactiveSelectionColor + "; }");
      }
      var editorSelectionForegroundColor = theme.getColor(colorRegistry_js_1.editorSelectionForeground);
