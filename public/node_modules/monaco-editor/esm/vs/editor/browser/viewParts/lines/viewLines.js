define('node_modules/monaco-editor/esm/vs/editor/browser/viewParts/lines/viewLines', function(require, exports, module) {
  ...
  ''/*@require node_modules/monaco-editor/esm/vs/editor/browser/viewParts/lines/viewLines.css*/;
  ...
  var viewLine_js_1 = require("node_modules/monaco-editor/esm/vs/editor/browser/viewParts/lines/viewLine");
  ...
  var ViewLines = /** @class */ (function (_super) {
      ...
      function ViewLines(context, linesContent) {
          ...
          _this._visibleLines = new viewLayer_js_1.VisibleLinesCollection(_this);
          ...
          _this._viewLineOptions = new viewLine_js_1.ViewLineOptions(conf, _this._context.theme.type);
          viewPart_js_1.PartFingerprints.write(_this.domNode, 7 /* ViewLines */);
          _this.domNode.setClassName('view-lines');
          configuration_js_1.Configuration.applyFontInfo(_this.domNode, conf.editor.fontInfo);
          // --- width & height
          _this._maxLineWidth = 0;
          _this._asyncUpdateLineWidths = new async_js_1.RunOnceScheduler(function () {
      ...
      ViewLines.prototype.createVisibleLine = function () {
          return new viewLine_js_1.ViewLine(this._viewLineOptions);
      };
      ...
      ViewLines.prototype.onConfigurationChanged = function (e) {
          ...
          if (e.fontInfo) {
              configuration_js_1.Configuration.applyFontInfo(this.domNode, conf.editor.fontInfo);
          }
      ...
      ViewLines.prototype._onOptionsMaybeChanged = function () {
          var conf = this._context.configuration;
          var newViewLineOptions = new viewLine_js_1.ViewLineOptions(conf, this._context.theme.type);
      ...
      ViewLines.prototype.linesVisibleRangesForRange = function (_range, includeNewLines) {
          ...
          var range = range_js_1.Range.intersectRanges(_range, this._lastRenderedData.getCurrentVisibleRange());
          if (!range) {
              return null;
          }
          var visibleRanges = [], visibleRangesLen = 0;
          var domReadingContext = new viewLine_js_1.DomReadingContext(this.domNode.domNode, this._textRangeRestingSpot);
          var nextLineModelLineNumber = 0;
          if (includeNewLines) {
              nextLineModelLineNumber = this._context.model.coordinatesConverter.convertViewPositionToModelPosition(new position_js_1.Position(range.startLineNumber, 1)).lineNumber;
          }
          var rendStartLineNumber = this._visibleLines.getStartLineNumber();
          var rendEndLineNumber = this._visibleLines.getEndLineNumber();
          for (var lineNumber = range.startLineNumber; lineNumber <= range.endLineNumber; lineNumber++) {
              ...
              if (includeNewLines && lineNumber < originalEndLineNumber) {
                  ...
                  nextLineModelLineNumber = this._context.model.coordinatesConverter.convertViewPositionToModelPosition(new position_js_1.Position(lineNumber + 1, 1)).lineNumber;
                  if (currentLineModelLineNumber !== nextLineModelLineNumber) {
                      visibleRangesForLine[visibleRangesForLine.length - 1].width += this._typicalHalfwidthCharacterWidth;
                  }
              }
              visibleRanges[visibleRangesLen++] = new renderingContext_js_1.LineVisibleRanges(lineNumber, visibleRangesForLine);
          }
      ...
      ViewLines.prototype.visibleRangeForPosition = function (position) {
          var visibleRanges = this.visibleRangesForRange2(new range_js_1.Range(position.lineNumber, position.column, position.lineNumber, position.column));
          if (!visibleRanges) {
              return null;
          }
      ...
      ViewLines.prototype._computeScrollLeftToRevealRange = function (lineNumber, startColumn, endColumn) {
          ...
          var visibleRanges = this.visibleRangesForRange2(new range_js_1.Range(lineNumber, startColumn, lineNumber, endColumn));
