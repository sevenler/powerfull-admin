define('node_modules/monaco-editor/esm/vs/editor/browser/viewParts/viewZones/viewZones', function(require, exports, module) {
  ...
  var ViewZones = /** @class */ (function (_super) {
      ...
      function ViewZones(context) {
          ...
          _this.marginDomNode = fastDomNode_js_1.createFastDomNode(document.createElement('div'));
      ...
      ViewZones.prototype._computeWhitespaceProps = function (zone) {
          ...
          if (typeof zone.afterColumn !== 'undefined') {
              ...
              zoneAfterModelPosition = new position_js_1.Position(validAfterLineNumber, this._context.model.getModelLineMaxColumn(validAfterLineNumber));
          }
      ...
      ViewZones.prototype.addZone = function (zone) {
          ...
          var myZone = {
              ...
              delegate: zone,
              isVisible: false,
              domNode: fastDomNode_js_1.createFastDomNode(zone.domNode),
              marginDomNode: zone.marginDomNode ? fastDomNode_js_1.createFastDomNode(zone.marginDomNode) : null
          };
