define('node_modules/monaco-editor/esm/vs/editor/browser/viewParts/overlayWidgets/overlayWidgets', function(require, exports, module) {
  ...
  ''/*@require node_modules/monaco-editor/esm/vs/editor/browser/viewParts/overlayWidgets/overlayWidgets.css*/;
  ...
  var ViewOverlayWidgets = /** @class */ (function (_super) {
      ...
      function ViewOverlayWidgets(context) {
          ...
          viewPart_js_1.PartFingerprints.write(_this._domNode, 4 /* OverlayWidgets */);
      ...
      ViewOverlayWidgets.prototype.addWidget = function (widget) {
          var domNode = fastDomNode_js_1.createFastDomNode(widget.getDomNode());
