define('node_modules/monaco-editor/esm/vs/editor/browser/viewParts/decorations/decorations', function(require, exports, module) {
  ...
  ''/*@require node_modules/monaco-editor/esm/vs/editor/browser/viewParts/decorations/decorations.css*/;
      ...
      DecorationsOverlay.prototype._renderNormalDecorations = function (ctx, decorations, output) {
          ...
          for (var i = 0, lenI = decorations.length; i < lenI; i++) {
              ...
              if (showIfCollapsed && range.endColumn === 1 && range.endLineNumber !== range.startLineNumber) {
                  range = new range_js_1.Range(range.startLineNumber, range.startColumn, range.endLineNumber - 1, this._context.model.getLineMaxColumn(range.endLineNumber - 1));
              }
          ...
          for (var j = 0, lenJ = linesVisibleRanges.length; j < lenJ; j++) {
              ...
              if (showIfCollapsed && lineVisibleRanges.ranges.length === 1) {
                  ...
                  if (singleVisibleRange.width === 0) {
                      ...
                      lineVisibleRanges.ranges[0] = new renderingContext_js_1.HorizontalRange(singleVisibleRange.left, this._typicalHalfwidthCharacterWidth);
                  }
              }
