define('node_modules/monaco-editor/esm/vs/editor/browser/viewParts/lines/rangeUtil', function(require, exports, module) {
  ...
  var RangeUtil = /** @class */ (function () {
      ...
      RangeUtil._mergeAdjacentRanges = function (ranges) {
          if (ranges.length === 1) {
              ...
              return [new renderingContext_js_1.HorizontalRange(ranges[0].left, ranges[0].width)];
          }
          ...
          for (var i = 1, len = ranges.length; i < len; i++) {
              ...
              if (prevLeft + prevWidth + 0.9 /* account for browser's rounding errors*/ >= myLeft) {
                  ...
                  result[resultLen++] = new renderingContext_js_1.HorizontalRange(prevLeft, prevWidth);
                  prevLeft = myLeft;
                  prevWidth = myWidth;
              }
          }
