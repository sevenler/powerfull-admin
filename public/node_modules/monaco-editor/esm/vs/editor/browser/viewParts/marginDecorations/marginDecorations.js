define('node_modules/monaco-editor/esm/vs/editor/browser/viewParts/marginDecorations/marginDecorations', function(require, exports, module) {
  ...
  ''/*@require node_modules/monaco-editor/esm/vs/editor/browser/viewParts/marginDecorations/marginDecorations.css*/;
  ...
  var MarginViewLineDecorationsOverlay = /** @class */ (function (_super) {
      ...
      MarginViewLineDecorationsOverlay.prototype._getDecorations = function (ctx) {
          ...
          for (var i = 0, len = decorations.length; i < len; i++) {
              ...
              if (marginClassName) {
                  r[rLen++] = new glyphMargin_js_1.DecorationToRender(d.range.startLineNumber, d.range.endLineNumber, marginClassName);
              }
          }
          return r;
      };
