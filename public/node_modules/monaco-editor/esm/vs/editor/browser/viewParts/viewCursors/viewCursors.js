define('node_modules/monaco-editor/esm/vs/editor/browser/viewParts/viewCursors/viewCursors', function(require, exports, module) {
  ...
  ''/*@require node_modules/monaco-editor/esm/vs/editor/browser/viewParts/viewCursors/viewCursors.css*/;
  ...
  var viewCursor_js_1 = require("node_modules/monaco-editor/esm/vs/editor/browser/viewParts/viewCursors/viewCursor");
  ...
  var ViewCursors = /** @class */ (function (_super) {
      ...
      function ViewCursors(context) {
          ...
          _this._primaryCursor = new viewCursor_js_1.ViewCursor(_this._context);
          ...
          _this._startCursorBlinkAnimation = new async_js_1.TimeoutTimer();
          _this._cursorFlatBlinkInterval = new async_js_1.IntervalTimer();
      ...
      ViewCursors.prototype._onCursorPositionChanged = function (position, secondaryPositions) {
          ...
          if (this._secondaryCursors.length < secondaryPositions.length) {
              ...
              for (var i = 0; i < addCnt; i++) {
                  var newCursor = new viewCursor_js_1.ViewCursor(this._context);
  ...
  themeService_js_1.registerThemingParticipant(function (theme, collector) {
      var caret = theme.getColor(editorColorRegistry_js_1.editorCursorForeground);
      if (caret) {
          var caretBackground = theme.getColor(editorColorRegistry_js_1.editorCursorBackground);
          if (!caretBackground) {
