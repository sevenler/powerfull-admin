define('node_modules/monaco-editor/esm/vs/editor/browser/viewParts/lineNumbers/lineNumbers', function(require, exports, module) {
  ...
  ''/*@require node_modules/monaco-editor/esm/vs/editor/browser/viewParts/lineNumbers/lineNumbers.css*/;
  ...
  var LineNumbersOverlay = /** @class */ (function (_super) {
      ...
      function LineNumbersOverlay(context) {
          ...
          _this._readConfig();
          _this._lastCursorModelPosition = new position_js_1.Position(1, 1);
      ...
      LineNumbersOverlay.prototype._getLineRenderLineNumber = function (viewLineNumber) {
          var modelPosition = this._context.model.coordinatesConverter.convertViewPositionToModelPosition(new position_js_1.Position(viewLineNumber, 1));
  ...
  themeService_js_1.registerThemingParticipant(function (theme, collector) {
      ...
      var activeLineNumber = theme.getColor(editorColorRegistry_js_1.editorActiveLineNumber);
      if (activeLineNumber) {
