define('node_modules/monaco-editor/esm/vs/editor/browser/viewParts/overviewRuler/decorationsOverviewRuler', function(require, exports, module) {
  ...
  var Settings = /** @class */ (function () {
      function Settings(config, theme) {
          ...
          var borderColor = theme.getColor(editorColorRegistry_js_1.editorOverviewRulerBorder);
          this.borderColor = borderColor ? borderColor.toString() : null;
          this.hideCursor = config.editor.viewInfo.hideCursorInOverviewRuler;
          var cursorColor = theme.getColor(editorColorRegistry_js_1.editorCursorForeground);
          ...
          var backgroundColor = (minimapEnabled ? modes_js_1.TokenizationRegistry.getDefaultBackground() : null);
          if (backgroundColor === null || minimapSide === 'left') {
              this.backgroundColor = null;
          }
          else {
              this.backgroundColor = color_js_1.Color.Format.CSS.formatHex(backgroundColor);
          }
  ...
  var DecorationsOverviewRuler = /** @class */ (function (_super) {
      ...
      function DecorationsOverviewRuler(context) {
          ...
          _this._domNode = fastDomNode_js_1.createFastDomNode(document.createElement('canvas'));
          ...
          _this._tokensColorTrackerListener = modes_js_1.TokenizationRegistry.onDidChange(function (e) {
      ...
      DecorationsOverviewRuler.prototype.onCursorStateChanged = function (e) {
          ...
          this._cursorPositions.sort(position_js_1.Position.compare);
          return true;
      };
