define('node_modules/monaco-editor/esm/vs/editor/browser/viewParts/contentWidgets/contentWidgets', function(require, exports, module) {
  ...
  var ViewContentWidgets = /** @class */ (function (_super) {
      ...
      function ViewContentWidgets(context, viewDomNode) {
          ...
          viewPart_js_1.PartFingerprints.write(_this.domNode, 1 /* ContentWidgets */);
          _this.domNode.setClassName('contentWidgets');
          _this.domNode.setPosition('absolute');
          _this.domNode.setTop(0);
          _this.overflowingContentWidgetsDomNode = fastDomNode_js_1.createFastDomNode(document.createElement('div'));
          viewPart_js_1.PartFingerprints.write(_this.overflowingContentWidgetsDomNode, 2 /* OverflowingContentWidgets */);
  ...
  var Widget = /** @class */ (function () {
      function Widget(context, viewDomNode, actual) {
          ...
          this._actual = actual;
          this.domNode = fastDomNode_js_1.createFastDomNode(this._actual.getDomNode());
      ...
      Widget.prototype._setPosition = function (position, range) {
          this._position = types_js_1.withUndefinedAsNull(position);
          this._range = types_js_1.withUndefinedAsNull(range);
      ...
      Widget.prototype.setPosition = function (position, range, preference) {
          ...
          this._preference = types_js_1.withUndefinedAsNull(preference);
          this._cachedDomNodeClientWidth = -1;
          this._cachedDomNodeClientHeight = -1;
      };
