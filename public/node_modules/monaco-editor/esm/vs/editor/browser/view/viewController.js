define('node_modules/monaco-editor/esm/vs/editor/browser/view/viewController', function(require, exports, module) {
  ...
  var ViewController = /** @class */ (function () {
      ...
      ViewController.prototype.setSelection = function (source, modelSelection) {
          this.commandDelegate.executeEditorCommand(coreCommands_js_1.CoreNavigationCommands.SetSelection, {
              source: source,
      ...
      ViewController.prototype.moveTo = function (viewPosition) {
          this._execMouseCommand(coreCommands_js_1.CoreNavigationCommands.MoveTo, this._usualArgs(viewPosition));
      };
      ViewController.prototype._moveToSelect = function (viewPosition) {
          this._execMouseCommand(coreCommands_js_1.CoreNavigationCommands.MoveToSelect, this._usualArgs(viewPosition));
      };
      ViewController.prototype._columnSelect = function (viewPosition, mouseColumn) {
          viewPosition = this._validateViewColumn(viewPosition);
          this._execMouseCommand(coreCommands_js_1.CoreNavigationCommands.ColumnSelect, {
              position: this._convertViewToModelPosition(viewPosition),
              viewPosition: viewPosition,
      ...
      ViewController.prototype._createCursor = function (viewPosition, wholeLine) {
          viewPosition = this._validateViewColumn(viewPosition);
          this._execMouseCommand(coreCommands_js_1.CoreNavigationCommands.CreateCursor, {
              position: this._convertViewToModelPosition(viewPosition),
              viewPosition: viewPosition,
              wholeLine: wholeLine
          });
      ...
      ViewController.prototype._lastCursorMoveToSelect = function (viewPosition) {
          this._execMouseCommand(coreCommands_js_1.CoreNavigationCommands.LastCursorMoveToSelect, this._usualArgs(viewPosition));
      };
      ViewController.prototype._wordSelect = function (viewPosition) {
          this._execMouseCommand(coreCommands_js_1.CoreNavigationCommands.WordSelect, this._usualArgs(viewPosition));
      };
      ViewController.prototype._wordSelectDrag = function (viewPosition) {
          this._execMouseCommand(coreCommands_js_1.CoreNavigationCommands.WordSelectDrag, this._usualArgs(viewPosition));
      };
      ViewController.prototype._lastCursorWordSelect = function (viewPosition) {
          this._execMouseCommand(coreCommands_js_1.CoreNavigationCommands.LastCursorWordSelect, this._usualArgs(viewPosition));
      };
      ViewController.prototype._lineSelect = function (viewPosition) {
          this._execMouseCommand(coreCommands_js_1.CoreNavigationCommands.LineSelect, this._usualArgs(viewPosition));
      };
      ViewController.prototype._lineSelectDrag = function (viewPosition) {
          this._execMouseCommand(coreCommands_js_1.CoreNavigationCommands.LineSelectDrag, this._usualArgs(viewPosition));
      };
      ViewController.prototype._lastCursorLineSelect = function (viewPosition) {
          this._execMouseCommand(coreCommands_js_1.CoreNavigationCommands.LastCursorLineSelect, this._usualArgs(viewPosition));
      };
      ViewController.prototype._lastCursorLineSelectDrag = function (viewPosition) {
          this._execMouseCommand(coreCommands_js_1.CoreNavigationCommands.LastCursorLineSelectDrag, this._usualArgs(viewPosition));
      };
      ViewController.prototype._selectAll = function () {
          this._execMouseCommand(coreCommands_js_1.CoreNavigationCommands.SelectAll, {});
      };
      // ----------------------
