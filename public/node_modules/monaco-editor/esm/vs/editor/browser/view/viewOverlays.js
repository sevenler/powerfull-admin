define('node_modules/monaco-editor/esm/vs/editor/browser/view/viewOverlays', function(require, exports, module) {
  ...
  var ViewOverlayLine = /** @class */ (function () {
      ...
      ViewOverlayLine.prototype.setDomNode = function (domNode) {
          this._domNode = fastDomNode_js_1.createFastDomNode(domNode);
      };
  ...
  var MarginViewOverlays = /** @class */ (function (_super) {
      ...
      function MarginViewOverlays(context) {
          ...
          configuration_js_1.Configuration.applyFontInfo(_this.domNode, _this._context.configuration.editor.fontInfo);
          return _this;
      }
      MarginViewOverlays.prototype.onConfigurationChanged = function (e) {
          var shouldRender = false;
          if (e.fontInfo) {
              configuration_js_1.Configuration.applyFontInfo(this.domNode, this._context.configuration.editor.fontInfo);
              shouldRender = true;
          }
          if (e.layoutInfo) {
