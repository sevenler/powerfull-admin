define('node_modules/monaco-editor/esm/vs/editor/browser/editorDom', function(require, exports, module) {
  ...
  }(mouseEvent_js_1.StandardMouseEvent));
  ...
  var GlobalEditorMouseMoveMonitor = /** @class */ (function (_super) {
      ...
      function GlobalEditorMouseMoveMonitor(editorViewDomNode) {
          ...
          _this._globalMouseMoveMonitor = _this._register(new globalMouseMoveMonitor_js_1.GlobalMouseMoveMonitor());
