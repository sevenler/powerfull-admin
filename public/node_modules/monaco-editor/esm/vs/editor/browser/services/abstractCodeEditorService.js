define('node_modules/monaco-editor/esm/vs/editor/browser/services/abstractCodeEditorService', function(require, exports, module) {
  ...
  var AbstractCodeEditorService = /** @class */ (function (_super) {
      ...
      function AbstractCodeEditorService() {
          ...
          _this._onCodeEditorAdd = _this._register(new event_js_1.Emitter());
          _this.onCodeEditorAdd = _this._onCodeEditorAdd.event;
          _this._onCodeEditorRemove = _this._register(new event_js_1.Emitter());
          _this._onDiffEditorAdd = _this._register(new event_js_1.Emitter());
          _this._onDiffEditorRemove = _this._register(new event_js_1.Emitter());
