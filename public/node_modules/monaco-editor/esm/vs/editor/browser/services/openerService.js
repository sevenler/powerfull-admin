define('node_modules/monaco-editor/esm/vs/editor/browser/services/openerService', function(require, exports, module) {
  ...
  var OpenerService = /** @class */ (function () {
      function OpenerService(_editorService, _commandService) {
          ...
          this._opener = new linkedList_js_1.LinkedList();
          //
      }
      ...
      OpenerService.prototype._doOpen = function (resource, options) {
          ...
          if (strings_js_1.equalsIgnoreCase(scheme, network_js_1.Schemas.http) || strings_js_1.equalsIgnoreCase(scheme, network_js_1.Schemas.https) || strings_js_1.equalsIgnoreCase(scheme, network_js_1.Schemas.mailto)) {
              // open http or default mail application
              dom.windowOpenNoOpener(encodeURI(resource.toString(true)));
              return Promise.resolve(true);
          }
          else if (strings_js_1.equalsIgnoreCase(scheme, network_js_1.Schemas.command)) {
              // run command or bail out if command isn't known
              if (!commands_js_1.CommandsRegistry.getCommand(path)) {
                  return Promise.reject("command '" + path + "' NOT known");
              }
              // execute as command
              var args = [];
              try {
                  args = marshalling_js_1.parse(query);
