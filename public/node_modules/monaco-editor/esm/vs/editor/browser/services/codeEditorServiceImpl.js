define('node_modules/monaco-editor/esm/vs/editor/browser/services/codeEditorServiceImpl', function(require, exports, module) {
  ...
  var abstractCodeEditorService_js_1 = require("node_modules/monaco-editor/esm/vs/editor/browser/services/abstractCodeEditorService");
  ...
  }(abstractCodeEditorService_js_1.AbstractCodeEditorService));
  ...
  var DecorationCSSRules = /** @class */ (function () {
      ...
      DecorationCSSRules.prototype.getCSSTextForModelDecorationContentClassName = function (opts) {
          ...
          if (typeof opts !== 'undefined') {
              ...
              if (typeof opts.contentIconPath !== 'undefined') {
                  cssTextArr.push(strings.format(_CSS_MAP.contentIconPath, uri_js_1.URI.revive(opts.contentIconPath).toString(true).replace(/'/g, '%27')));
              }
      ...
      DecorationCSSRules.prototype.getCSSTextForModelDecorationGlyphMarginClassName = function (opts) {
          ...
          if (typeof opts.gutterIconPath !== 'undefined') {
              cssTextArr.push(strings.format(_CSS_MAP.gutterIconPath, uri_js_1.URI.revive(opts.gutterIconPath).toString(true).replace(/'/g, '%27')));
      ...
      DecorationCSSRules.prototype.resolveValue = function (value) {
          if (editorCommon_js_1.isThemeColor(value)) {
