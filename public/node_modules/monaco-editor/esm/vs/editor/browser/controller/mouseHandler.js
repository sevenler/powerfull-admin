define('node_modules/monaco-editor/esm/vs/editor/browser/controller/mouseHandler', function(require, exports, module) {
  ...
  var mouseTarget_js_1 = require("node_modules/monaco-editor/esm/vs/editor/browser/controller/mouseTarget");
  var editorDom_js_1 = require("node_modules/monaco-editor/esm/vs/editor/browser/editorDom");
  ...
  var MouseHandler = /** @class */ (function (_super) {
      ...
      function MouseHandler(context, viewController, viewHelper) {
          ...
          _this.mouseTargetFactory = new mouseTarget_js_1.MouseTargetFactory(_this._context, viewHelper);
          ...
          _this._asyncFocus = _this._register(new async_js_1.RunOnceScheduler(function () { return _this.viewHelper.focusTextArea(); }, 0));
          _this.lastMouseLeaveTime = -1;
          var mouseEvents = new editorDom_js_1.EditorMouseEventFactory(_this.viewHelper.viewDomNode);
          ...
          var onMouseWheel = function (browserEvent) {
              ...
              var e = new mouseEvent_js_1.StandardWheelEvent(browserEvent);
              if (e.browserEvent.ctrlKey || e.browserEvent.metaKey) {
                  var zoomLevel = editorZoom_js_1.EditorZoom.getZoomLevel();
      ...
      MouseHandler.prototype.getTargetAtClientPoint = function (clientX, clientY) {
          var clientPos = new editorDom_js_1.ClientCoordinates(clientX, clientY);
          var pos = clientPos.toPageCoordinates();
          var editorPos = editorDom_js_1.createEditorPagePosition(this.viewHelper.viewDomNode);
  ...
  var MouseDownOperation = /** @class */ (function (_super) {
      ...
      function MouseDownOperation(context, viewController, viewHelper, createMouseTarget, getMouseColumn) {
          ...
          _this._mouseMoveMonitor = _this._register(new editorDom_js_1.GlobalEditorMouseMoveMonitor(_this._viewHelper.viewDomNode));
          _this._onScrollTimeout = _this._register(new async_js_1.TimeoutTimer());
          _this._mouseState = new MouseDownState();
          _this._currentSelection = new selection_js_1.Selection(1, 1, 1, 1);
      ...
      MouseDownOperation.prototype._getPositionOutsideEditor = function (e) {
          ...
          if (e.posy < editorContent.y) {
              ...
              var viewZoneData = mouseTarget_js_1.HitTestContext.getZoneAtCoord(this._context, verticalOffset);
              if (viewZoneData) {
                  var newPosition = this._helpPositionJumpOverViewZone(viewZoneData);
                  if (newPosition) {
                      return new mouseTarget_js_1.MouseTarget(null, 13 /* OUTSIDE_EDITOR */, mouseColumn, newPosition);
                  }
              }
              var aboveLineNumber = viewLayout.getLineNumberAtVerticalOffset(verticalOffset);
              return new mouseTarget_js_1.MouseTarget(null, 13 /* OUTSIDE_EDITOR */, mouseColumn, new position_js_1.Position(aboveLineNumber, 1));
          }
          if (e.posy > editorContent.y + editorContent.height) {
              ...
              return new mouseTarget_js_1.MouseTarget(null, 13 /* OUTSIDE_EDITOR */, mouseColumn, new position_js_1.Position(belowLineNumber, model.getLineMaxColumn(belowLineNumber)));
          }
          ...
          if (e.posx < editorContent.x) {
              return new mouseTarget_js_1.MouseTarget(null, 13 /* OUTSIDE_EDITOR */, mouseColumn, new position_js_1.Position(possibleLineNumber, 1));
          }
          if (e.posx > editorContent.x + editorContent.width) {
              return new mouseTarget_js_1.MouseTarget(null, 13 /* OUTSIDE_EDITOR */, mouseColumn, new position_js_1.Position(possibleLineNumber, model.getLineMaxColumn(possibleLineNumber)));
          }
          return null;
      };
      MouseDownOperation.prototype._findMousePosition = function (e, testEventTarget) {
          ...
          if (t.type === 8 /* CONTENT_VIEW_ZONE */ || t.type === 5 /* GUTTER_VIEW_ZONE */) {
              ...
              if (newPosition) {
                  return new mouseTarget_js_1.MouseTarget(t.element, t.type, t.mouseColumn, newPosition, null, t.detail);
              }
          }
          return t;
      };
      MouseDownOperation.prototype._helpPositionJumpOverViewZone = function (viewZoneData) {
          ...
          var selectionStart = new position_js_1.Position(this._currentSelection.selectionStartLineNumber, this._currentSelection.selectionStartColumn);
