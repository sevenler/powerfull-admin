define('node_modules/monaco-editor/esm/vs/editor/browser/controller/mouseTarget', function(require, exports, module) {
  ...
  var HitTestContext = /** @class */ (function () {
      ...
      HitTestContext.getZoneAtCoord = function (context, mouseVerticalOffset) {
          ...
          if (viewZoneWhitespace) {
              ...
              if (viewZoneWhitespace.afterLineNumber > 0) {
                  ...
                  positionBefore = new position_js_1.Position(viewZoneWhitespace.afterLineNumber, context.model.getLineMaxColumn(viewZoneWhitespace.afterLineNumber));
              }
      ...
      HitTestContext.prototype.getFullLineRangeAtCoord = function (mouseVerticalOffset) {
          if (this._context.viewLayout.isAfterLines(mouseVerticalOffset)) {
              ...
              return {
                  range: new range_js_1.Range(lineNumber_1, maxLineColumn_1, lineNumber_1, maxLineColumn_1),
                  isAfterLines: true
              };
          }
  ...
  var HitTestRequest = /** @class */ (function (_super) {
      ...
      function HitTestRequest(ctx, editorPos, pos, target) {
          ...
          if (target) {
              _this.target = target;
              _this.targetPath = viewPart_js_1.PartFingerprints.collect(target, ctx.viewDomNode);
          }
          else {
              _this.target = null;
  ...
  var MouseTargetFactory = /** @class */ (function () {
      ...
      MouseTargetFactory.prototype.mouseTargetIsWidget = function (e) {
          var t = e.target;
          var path = viewPart_js_1.PartFingerprints.collect(t, this._viewHelper.viewDomNode);
      ...
      MouseTargetFactory._hitTestViewLines = function (ctx, request, domHitTestExecuted) {
          ...
          if (ctx.isAfterLines(request.mouseVerticalOffset)) {
              ...
              return request.fulfill(7 /* CONTENT_EMPTY */, new position_js_1.Position(lineCount, maxLineColumn), undefined, EMPTY_CONTENT_AFTER_LINES);
          }
          if (domHitTestExecuted) {
              ...
              if (ElementPath.isStrictChildOfViewLines(request.targetPath)) {
                  ...
                  if (ctx.model.getLineLength(lineNumber) === 0) {
                      ...
                      return request.fulfill(7 /* CONTENT_EMPTY */, new position_js_1.Position(lineNumber, 1), undefined, detail);
                  }
              }
      ...
      MouseTargetFactory._hitTestMinimap = function (ctx, request) {
          if (ElementPath.isChildOfMinimap(request.targetPath)) {
              ...
              return request.fulfill(11 /* SCROLLBAR */, new position_js_1.Position(possibleLineNumber, maxColumn));
          }
          return null;
      };
      ...
      MouseTargetFactory.createMouseTargetFromHitTestPosition = function (ctx, request, lineNumber, column) {
          var pos = new position_js_1.Position(lineNumber, column);
          var lineWidth = ctx.getLineWidth(lineNumber);
          if (request.mouseContentHorizontalOffset > lineWidth) {
              if (browser.isEdge && pos.column === 1) {
                  ...
                  return request.fulfill(7 /* CONTENT_EMPTY */, new position_js_1.Position(lineNumber, ctx.model.getLineMaxColumn(lineNumber)), undefined, detail_1);
              }
              var detail = createEmptyContentDataInLines(request.mouseContentHorizontalOffset - lineWidth);
          ...
          for (var i = 1; i < points.length; i++) {
              ...
              if (prev.offset <= request.mouseContentHorizontalOffset && request.mouseContentHorizontalOffset <= curr.offset) {
                  var rng = new range_js_1.Range(lineNumber, prev.column, lineNumber, curr.column);
      ...
      MouseTargetFactory._doHitTestWithCaretRangeFromPoint = function (ctx, request) {
          ...
          var adjustedPage = new editorDom_js_1.PageCoordinates(request.pos.x, adjustedPageY);
