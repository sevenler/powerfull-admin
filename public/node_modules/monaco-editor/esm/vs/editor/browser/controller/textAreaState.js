define('node_modules/monaco-editor/esm/vs/editor/browser/controller/textAreaState', function(require, exports, module) {
  ...
  var PagedScreenReaderStrategy = /** @class */ (function () {
      ...
      PagedScreenReaderStrategy.fromEditorSelection = function (previousState, model, selection, trimLongText) {
          ...
          var pretextRange = selectionStartPageRange.intersectRanges(new range_js_1.Range(1, 1, selection.startLineNumber, selection.startColumn));
          var pretext = model.getValueInRange(pretextRange, 1 /* LF */);
          var lastLine = model.getLineCount();
          var lastLineMaxColumn = model.getLineMaxColumn(lastLine);
          var posttextRange = selectionEndPageRange.intersectRanges(new range_js_1.Range(selection.endLineNumber, selection.endColumn, lastLine, lastLineMaxColumn));
          ...
          return new TextAreaState(pretext + text + posttext, pretext.length, pretext.length + text.length, new position_js_1.Position(selection.startLineNumber, selection.startColumn), new position_js_1.Position(selection.endLineNumber, selection.endColumn));
      };
