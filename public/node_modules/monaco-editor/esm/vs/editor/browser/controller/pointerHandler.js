define('node_modules/monaco-editor/esm/vs/editor/browser/controller/pointerHandler', function(require, exports, module) {
  ...
  var mouseHandler_js_1 = require("node_modules/monaco-editor/esm/vs/editor/browser/controller/mouseHandler");
  ...
  var MsPointerHandler = /** @class */ (function (_super) {
      ...
      MsPointerHandler.prototype._onCaptureGestureTap = function (rawEvent) {
          var _this = this;
          var e = new editorDom_js_1.EditorMouseEvent(rawEvent, this.viewHelper.viewDomNode);
  ...
  }(mouseHandler_js_1.MouseHandler));
  /**
  ...
  var TouchHandler = /** @class */ (function (_super) {
      ...
      function TouchHandler(context, viewController, viewHelper) {
          var _this = _super.call(this, context, viewController, viewHelper) || this;
          touch_js_1.Gesture.addTarget(_this.viewHelper.linesContentDomNode);
          _this._register(dom.addDisposableListener(_this.viewHelper.linesContentDomNode, touch_js_1.EventType.Tap, function (e) { return _this.onTap(e); }));
          _this._register(dom.addDisposableListener(_this.viewHelper.linesContentDomNode, touch_js_1.EventType.Change, function (e) { return _this.onChange(e); }));
          _this._register(dom.addDisposableListener(_this.viewHelper.linesContentDomNode, touch_js_1.EventType.Contextmenu, function (e) { return _this._onContextMenu(new editorDom_js_1.EditorMouseEvent(e, _this.viewHelper.viewDomNode), false); }));
          return _this;
      }
      ...
      TouchHandler.prototype.onTap = function (event) {
          ...
          this.viewHelper.focusTextArea();
          var target = this._createMouseTarget(new editorDom_js_1.EditorMouseEvent(event, this.viewHelper.viewDomNode), false);
          if (target.position) {
  ...
  var PointerHandler = /** @class */ (function () {
      function PointerHandler(context, viewController, viewHelper) {
          if (window.navigator.msPointerEnabled) {
              ...
              this.handler = new mouseHandler_js_1.MouseHandler(context, viewController, viewHelper);
          }
      }
