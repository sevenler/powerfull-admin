define('node_modules/monaco-editor/esm/vs/editor/browser/controller/textAreaInput', function(require, exports, module) {
  ...
  var TextAreaInput = /** @class */ (function (_super) {
      ...
      function TextAreaInput(host, textArea) {
          ...
          _this._onFocus = _this._register(new event_js_1.Emitter());
          _this.onFocus = _this._onFocus.event;
          _this._onBlur = _this._register(new event_js_1.Emitter());
          ...
          _this._onCut = _this._register(new event_js_1.Emitter());
          _this.onCut = _this._onCut.event;
          _this._onPaste = _this._register(new event_js_1.Emitter());
          _this.onPaste = _this._onPaste.event;
          _this._onType = _this._register(new event_js_1.Emitter());
          ...
          _this._onCompositionUpdate = _this._register(new event_js_1.Emitter());
          ...
          _this._onSelectionChangeRequest = _this._register(new event_js_1.Emitter());
          ...
          _this._asyncTriggerCut = _this._register(new async_js_1.RunOnceScheduler(function () { return _this._onCut.fire(); }, 0));
          _this._textAreaState = textAreaState_js_1.TextAreaState.EMPTY;
          ...
          _this._register(dom.addDisposableListener(textArea.domNode, 'compositionstart', function (e) {
              ...
              if (!browser.isEdgeOrIE) {
                  _this._setAndWriteTextAreaState('compositionstart', textAreaState_js_1.TextAreaState.EMPTY);
              }
          ...
          var deduceInputFromTextAreaValue = function (couldBeEmojiInput, couldBeTypingAtOffset0) {
              ...
              var newState = textAreaState_js_1.TextAreaState.readFromTextArea(_this._textArea);
              return [newState, textAreaState_js_1.TextAreaState.deduceInput(oldState, newState, couldBeEmojiInput, couldBeTypingAtOffset0)];
          };
          /**
          ...
          var deduceComposition = function (text) {
              var oldState = _this._textAreaState;
              var newState = textAreaState_js_1.TextAreaState.selectedText(text);
              var typeInput = {
                  text: newState.value,
          ...
          _this._register(dom.addDisposableListener(textArea.domNode, 'compositionend', function (e) {
              ...
              if (browser.isEdgeOrIE || browser.isChrome) {
                  _this._textAreaState = textAreaState_js_1.TextAreaState.readFromTextArea(_this._textArea);
              }
              if (!_this._isDoingComposition) {
                  return;
              }
          ...
          _this._register(dom.addDisposableListener(textArea.domNode, 'paste', function (e) {
              ...
              if (ClipboardEventUtils.canUseTextData(e)) {
                  ...
                  if (_this._textArea.getSelectionStart() !== _this._textArea.getSelectionEnd()) {
                      ...
                      _this._setAndWriteTextAreaState('paste', textAreaState_js_1.TextAreaState.EMPTY);
                  }
      ...
      TextAreaInput.prototype._installSelectionChangeListener = function () {
          ...
          return dom.addDisposableListener(document, 'selectionchange', function (e) {
              ...
              var newSelection = new selection_js_1.Selection(newSelectionStartPosition.lineNumber, newSelectionStartPosition.column, newSelectionEndPosition.lineNumber, newSelectionEndPosition.column);
      ...
      TextAreaInput.prototype._setHasFocus = function (newHasFocus) {
          ...
          if (this._hasFocus) {
              if (browser.isEdge) {
                  ...
                  this._setAndWriteTextAreaState('focusgain', textAreaState_js_1.TextAreaState.EMPTY);
              }
              else {
      ...
      TextAreaInput.prototype._ensureClipboardGetsEditorSelection = function (e) {
          ...
          if (!ClipboardEventUtils.canUseTextData(e)) {
              ...
              this._setAndWriteTextAreaState('copy or cut', textAreaState_js_1.TextAreaState.selectedText(copyPlainText));
              return;
          }
          var copyHTML = null;
