define('node_modules/monaco-editor/esm/vs/editor/browser/controller/textAreaHandler', function(require, exports, module) {
  ...
  ''/*@require node_modules/monaco-editor/esm/vs/editor/browser/controller/textAreaHandler.css*/;
  ...
  var textAreaInput_js_1 = require("node_modules/monaco-editor/esm/vs/editor/browser/controller/textAreaInput");
  var textAreaState_js_1 = require("node_modules/monaco-editor/esm/vs/editor/browser/controller/textAreaState");
  ...
  var TextAreaHandler = /** @class */ (function (_super) {
      ...
      function TextAreaHandler(context, viewController, viewHelper) {
          ...
          _this._selections = [new selection_js_1.Selection(1, 1, 1, 1)];
          // Text Area (The focus will always be in the textarea when the cursor is blinking)
          _this.textArea = fastDomNode_js_1.createFastDomNode(document.createElement('textarea'));
          viewPart_js_1.PartFingerprints.write(_this.textArea, 6 /* TextArea */);
          ...
          _this.textAreaCover = fastDomNode_js_1.createFastDomNode(document.createElement('div'));
          ...
          var textAreaInputHost = {
              ...
              getHTMLToCopy: function () {
                  if (!_this._copyWithSyntaxHighlighting && !textAreaInput_js_1.CopyOptions.forceCopyWithSyntaxHighlighting) {
                      return null;
                  }
              ...
              getScreenReaderContent: function (currentState) {
                  if (browser.isIPad) {
                      ...
                      return textAreaState_js_1.TextAreaState.EMPTY;
                  }
                  if (_this._accessibilitySupport === 1 /* Disabled */) {
                      ...
                      if (platform.isMacintosh) {
                          ...
                          if (selection.isEmpty()) {
                              ...
                              if (textBefore.length > 0) {
                                  return new textAreaState_js_1.TextAreaState(textBefore, textBefore.length, textBefore.length, position, position);
                              }
                          }
                      }
                      return textAreaState_js_1.TextAreaState.EMPTY;
                  }
                  return textAreaState_js_1.PagedScreenReaderStrategy.fromEditorSelection(currentState, simpleModel, _this._selections[0], _this._accessibilitySupport === 0 /* Unknown */);
              },
          ...
          _this._textAreaInput = _this._register(new textAreaInput_js_1.TextAreaInput(textAreaInputHost, _this.textArea));
          ...
          _this._register(_this._textAreaInput.onCompositionStart(function () {
              ...
              _this._context.privateViewEventBus.emit(new viewEvents.ViewRevealRangeRequestEvent(new range_js_1.Range(lineNumber, column, lineNumber, column), 0 /* Simple */, true, 1 /* Immediate */));
      ...
      TextAreaHandler.prototype._getWordBeforePosition = function (position) {
          ...
          var wordSeparators = wordCharacterClassifier_js_1.getMapForWordSeparators(this._context.configuration.editor.wordSeparators);
      ...
      TextAreaHandler.prototype.prepareRender = function (ctx) {
          if (this._accessibilitySupport === 2 /* Enabled */) {
              ...
              var primaryCursorPosition = new position_js_1.Position(this._selections[0].positionLineNumber, this._selections[0].positionColumn);
      ...
      TextAreaHandler.prototype._renderInsideEditor = function (top, left, width, height, useEditorFont) {
          ...
          if (useEditorFont) {
              configuration_js_1.Configuration.applyFontInfo(ta, this._fontInfo);
          }
          else {
              ta.setFontSize(1);
