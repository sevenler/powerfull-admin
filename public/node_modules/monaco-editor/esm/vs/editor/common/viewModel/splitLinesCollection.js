define('node_modules/monaco-editor/esm/vs/editor/common/viewModel/splitLinesCollection', function(require, exports, module) {
  ...
  var SplitLinesCollection = /** @class */ (function () {
      ...
      SplitLinesCollection.prototype._constructLines = function (resetHiddenAreas) {
          ...
          var hiddenAreas = this.hiddenAreasIds.map(function (areaId) { return _this.model.getDecorationRange(areaId); }).sort(range_js_1.Range.compareRangesUsingStarts);
          ...
          this.prefixSumComputer = new prefixSumComputer_js_1.PrefixSumComputerWithCache(values);
      };
      ...
      SplitLinesCollection.prototype._reduceRanges = function (_ranges) {
          ...
          var ranges = _ranges.map(function (r) { return _this.model.validateRange(r); }).sort(range_js_1.Range.compareRangesUsingStarts);
          var result = [];
      ...
      SplitLinesCollection.prototype.setHiddenAreas = function (_ranges) {
          ...
          var oldRanges = this.hiddenAreasIds.map(function (areaId) { return _this.model.getDecorationRange(areaId); }).sort(range_js_1.Range.compareRangesUsingStarts);
      ...
      SplitLinesCollection.prototype.onModelLinesInserted = function (versionId, fromLineNumber, _toLineNumber, text) {
          ...
          var testPosition = new position_js_1.Position(fromLineNumber, 1);
      ...
      SplitLinesCollection.prototype.validateViewPosition = function (viewLineNumber, viewColumn, expectedModelPosition) {
          ...
          var computedModelPosition = this.model.validatePosition(new position_js_1.Position(lineIndex + 1, computedModelColumn));
      ...
      SplitLinesCollection.prototype.convertViewPositionToModelPosition = function (viewLineNumber, viewColumn) {
          ...
          return this.model.validatePosition(new position_js_1.Position(lineIndex + 1, inputColumn));
      };
      SplitLinesCollection.prototype.convertModelPositionToViewPosition = function (_modelLineNumber, _modelColumn) {
          this._ensureValidState();
          var validPosition = this.model.validatePosition(new position_js_1.Position(_modelLineNumber, _modelColumn));
      ...
      SplitLinesCollection.prototype.getDecorationsInRange = function (range, ownerId, filterOutValidation) {
          ...
          if (modelEnd.lineNumber - modelStart.lineNumber <= range.endLineNumber - range.startLineNumber) {
              ...
              return this.model.getDecorationsInRange(new range_js_1.Range(modelStart.lineNumber, 1, modelEnd.lineNumber, modelEnd.column), ownerId, filterOutValidation);
          }
          var result = [];
          var modelStartLineIndex = modelStart.lineNumber - 1;
          var modelEndLineIndex = modelEnd.lineNumber - 1;
          ...
          for (var modelLineIndex = modelStartLineIndex; modelLineIndex <= modelEndLineIndex; modelLineIndex++) {
              ...
              if (line.isVisible()) {
                  ...
                  if (reqStart !== null) {
                      ...
                      result = result.concat(this.model.getDecorationsInRange(new range_js_1.Range(reqStart.lineNumber, reqStart.column, modelLineIndex, maxLineColumn), ownerId, filterOutValidation));
                      reqStart = null;
                  }
              }
          }
          if (reqStart !== null) {
              result = result.concat(this.model.getDecorationsInRange(new range_js_1.Range(reqStart.lineNumber, reqStart.column, modelEnd.lineNumber, modelEnd.column), ownerId, filterOutValidation));
              reqStart = null;
          }
          result.sort(function (a, b) {
              var res = range_js_1.Range.compareRangesUsingStarts(a.range, b.range);
              if (res === 0) {
                  if (a.id < b.id) {
                      return -1;
                  }
  ...
  var VisibleIdentitySplitLine = /** @class */ (function () {
      ...
      VisibleIdentitySplitLine.prototype.getViewLineData = function (model, modelLineNumber, _outputLineIndex) {
          ...
          return new viewModel_js_1.ViewLineData(lineContent, false, 1, lineContent.length + 1, lineTokens.inflate());
      };
  ...
  var SplitLine = /** @class */ (function () {
      ...
      SplitLine.prototype.getViewLineData = function (model, modelLineNumber, outputLineIndex) {
          ...
          var lineTokens = model.getLineTokens(modelLineNumber);
          return new viewModel_js_1.ViewLineData(lineContent, continuesWithWrappedLine, minColumn, maxColumn, lineTokens.sliceAndInflate(startOffset, endOffset, deltaStartIndex));
      };
      ...
      SplitLine.prototype.getViewPositionOfModelPosition = function (deltaLineNumber, inputColumn) {
          ...
          return new position_js_1.Position(deltaLineNumber + outputLineIndex, outputColumn);
      };
