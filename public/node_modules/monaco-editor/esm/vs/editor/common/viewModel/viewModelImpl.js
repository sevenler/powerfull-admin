define('node_modules/monaco-editor/esm/vs/editor/common/viewModel/viewModelImpl', function(require, exports, module) {
  ...
  var minimapCharRenderer_js_1 = require("node_modules/monaco-editor/esm/vs/editor/common/view/minimapCharRenderer");
  var viewEvents = tslib_1.__importStar(require("node_modules/monaco-editor/esm/vs/editor/common/view/viewEvents"));
  var viewLayout_js_1 = require("node_modules/monaco-editor/esm/vs/editor/common/viewLayout/viewLayout");
  var characterHardWrappingLineMapper_js_1 = require("node_modules/monaco-editor/esm/vs/editor/common/viewModel/characterHardWrappingLineMapper");
  var splitLinesCollection_js_1 = require("node_modules/monaco-editor/esm/vs/editor/common/viewModel/splitLinesCollection");
  var viewModel_js_1 = require("node_modules/monaco-editor/esm/vs/editor/common/viewModel/viewModel");
  var viewModelDecorations_js_1 = require("node_modules/monaco-editor/esm/vs/editor/common/viewModel/viewModelDecorations");
  ...
  var ViewModel = /** @class */ (function (_super) {
      ...
      function ViewModel(editorId, configuration, model, scheduleAtNextAnimationFrame) {
          ...
          _this.model = model;
          _this._tokenizeViewportSoon = _this._register(new async_js_1.RunOnceScheduler(function () { return _this.tokenizeViewport(); }, 50));
          ...
          if (USE_IDENTITY_LINES_COLLECTION && _this.model.isTooLargeForTokenization()) {
              _this.lines = new splitLinesCollection_js_1.IdentityLinesCollection(_this.model);
          }
          else {
              var conf = _this.configuration.editor;
              var hardWrappingLineMapperFactory = new characterHardWrappingLineMapper_js_1.CharacterHardWrappingLineMapperFactory(conf.wrappingInfo.wordWrapBreakBeforeCharacters, conf.wrappingInfo.wordWrapBreakAfterCharacters, conf.wrappingInfo.wordWrapBreakObtrusiveCharacters);
              _this.lines = new splitLinesCollection_js_1.SplitLinesCollection(_this.model, hardWrappingLineMapperFactory, _this.model.getOptions().tabSize, conf.wrappingInfo.wrappingColumn, conf.fontInfo.typicalFullwidthCharacterWidth / conf.fontInfo.typicalHalfwidthCharacterWidth, conf.wrappingInfo.wrappingIndent);
          }
          _this.coordinatesConverter = _this.lines.createCoordinatesConverter();
          _this.viewLayout = _this._register(new viewLayout_js_1.ViewLayout(_this.configuration, _this.getLineCount(), scheduleAtNextAnimationFrame));
          ...
          _this.decorations = new viewModelDecorations_js_1.ViewModelDecorations(_this.editorId, _this.model, _this.configuration, _this.lines, _this.coordinatesConverter);
          ...
          _this._register(minimapCharRenderer_js_1.MinimapTokensColorTracker.getInstance().onDidChange(function () {
              try {
                  var eventsCollector = _this._beginEmit();
      ...
      ViewModel.prototype.tokenizeViewport = function () {
          ...
          var startPosition = this.coordinatesConverter.convertViewPositionToModelPosition(new position_js_1.Position(linesViewportData.startLineNumber, 1));
          var endPosition = this.coordinatesConverter.convertViewPositionToModelPosition(new position_js_1.Position(linesViewportData.endLineNumber, 1));
      ...
      ViewModel.prototype._onConfigurationChanged = function (eventsCollector, e) {
          ...
          if (this.viewportStartLine !== -1) {
              var previousViewportStartViewPosition = new position_js_1.Position(this.viewportStartLine, this.getLineMinColumn(this.viewportStartLine));
      ...
      ViewModel.prototype._registerModelEvents = function () {
          ...
          this._register(this.model.onDidChangeTokens(function (e) {
              ...
              for (var j = 0, lenJ = e.ranges.length; j < lenJ; j++) {
                  ...
                  var viewStartLineNumber = _this.coordinatesConverter.convertModelPositionToViewPosition(new position_js_1.Position(modelRange.fromLineNumber, 1)).lineNumber;
                  var viewEndLineNumber = _this.coordinatesConverter.convertModelPositionToViewPosition(new position_js_1.Position(modelRange.toLineNumber, _this.model.getLineMaxColumn(modelRange.toLineNumber))).lineNumber;
                  viewRanges[j] = {
      ...
      ViewModel.prototype.saveState = function () {
          ...
          var firstPosition = this.coordinatesConverter.convertViewPositionToModelPosition(new position_js_1.Position(firstViewLineNumber, this.getLineMinColumn(firstViewLineNumber)));
      ...
      ViewModel.prototype.setViewport = function (startLineNumber, endLineNumber, centeredLineNumber) {
          ...
          var position = this.coordinatesConverter.convertViewPositionToModelPosition(new position_js_1.Position(startLineNumber, this.getLineMinColumn(startLineNumber)));
          this.viewportStartLineTrackedRange = this.model._setTrackedRange(this.viewportStartLineTrackedRange, new range_js_1.Range(position.lineNumber, position.column, position.lineNumber, position.column), 1 /* NeverGrowsWhenTypingAtEdges */);
      ...
      ViewModel.prototype.getViewLineRenderingData = function (visibleRange, lineNumber) {
          ...
          return new viewModel_js_1.ViewLineRenderingData(lineData.minColumn, lineData.maxColumn, lineData.content, lineData.continuesWithWrappedLine, mightContainRTL, mightContainNonBasicASCII, lineData.tokens, inlineDecorations, tabSize);
      };
      ...
      ViewModel.prototype.getPlainTextToCopy = function (ranges, emptySelectionClipboard, forceCRLF) {
          ...
          if (nonEmptyRanges.length === 0) {
              ...
              var modelLineNumbers = ranges.map(function (r) {
                  var viewLineStart = new position_js_1.Position(r.startLineNumber, 1);
      ...
      ViewModel.prototype._getHTMLToCopy = function (modelRange, colorMap) {
          ...
          for (var lineNumber = startLineNumber; lineNumber <= endLineNumber; lineNumber++) {
              ...
              if (lineContent === '') {
                  ...
                  result += textToHtmlTokenizer_js_1.tokenizeLineToHTML(lineContent, lineTokens.inflate(), colorMap, startOffset, endOffset, tabSize);
              }
          }
          return result;
      };
