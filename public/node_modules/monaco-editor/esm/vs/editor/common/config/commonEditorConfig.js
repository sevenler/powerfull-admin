define('node_modules/monaco-editor/esm/vs/editor/common/config/commonEditorConfig', function(require, exports, module) {
  ...
  var CommonEditorConfiguration = /** @class */ (function (_super) {
      ...
      function CommonEditorConfiguration(isSimpleWidget, options) {
          ...
          _this._register(editorZoom_js_1.EditorZoom.onDidChangeZoomLevel(function (_) { return _this._recomputeOptions(); }));
      ...
      CommonEditorConfiguration.prototype._computeInternalOptions = function () {
          ...
          var bareFontInfo = fontInfo_js_1.BareFontInfo.createFromRawSettings(this._rawOptions, partialEnv.zoomLevel, this.isSimpleWidget);
          var env = {
