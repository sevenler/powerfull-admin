define('node_modules/monaco-editor/esm/vs/editor/common/config/editorOptions', function(require, exports, module) {
  ...
  function cursorStyleToString(cursorStyle) {
      if (cursorStyle === exports.TextEditorCursorStyle.Line) {
          return 'line';
      }
      else if (cursorStyle === exports.TextEditorCursorStyle.Block) {
          return 'block';
      }
      else if (cursorStyle === exports.TextEditorCursorStyle.Underline) {
          return 'underline';
      }
      else if (cursorStyle === exports.TextEditorCursorStyle.LineThin) {
          return 'line-thin';
      }
      else if (cursorStyle === exports.TextEditorCursorStyle.BlockOutline) {
          return 'block-outline';
      }
      else if (cursorStyle === exports.TextEditorCursorStyle.UnderlineThin) {
  ...
  function _cursorStyleFromString(cursorStyle, defaultValue) {
      ...
      if (cursorStyle === 'line') {
          return exports.TextEditorCursorStyle.Line;
      }
      else if (cursorStyle === 'block') {
          return exports.TextEditorCursorStyle.Block;
      }
      else if (cursorStyle === 'underline') {
          return exports.TextEditorCursorStyle.Underline;
      }
      else if (cursorStyle === 'line-thin') {
          return exports.TextEditorCursorStyle.LineThin;
      }
      else if (cursorStyle === 'block-outline') {
          return exports.TextEditorCursorStyle.BlockOutline;
      }
      else if (cursorStyle === 'underline-thin') {
          return exports.TextEditorCursorStyle.UnderlineThin;
      }
      return exports.TextEditorCursorStyle.Line;
  }
  /**
  ...
  var EditorOptionsValidator = /** @class */ (function () {
      ...
      EditorOptionsValidator._sanitizeSuggestOpts = function (opts, defaults) {
          ...
          return {
              ...
              filteredTypes: types_js_1.isObject(suggestOpts.filteredTypes) ? suggestOpts.filteredTypes : Object.create(null)
          };
      };
  ...
  exports.EDITOR_DEFAULTS = {
      inDiffEditor: false,
      wordSeparators: wordHelper_js_1.USUAL_WORD_SEPARATORS,
      ...
      viewInfo: {
          ...
          cursorStyle: exports.TextEditorCursorStyle.Line,
          cursorWidth: 0,
