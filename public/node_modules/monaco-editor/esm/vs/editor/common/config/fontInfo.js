define('node_modules/monaco-editor/esm/vs/editor/common/config/fontInfo', function(require, exports, module) {
  ...
  var BareFontInfo = /** @class */ (function () {
      ...
      BareFontInfo.createFromRawSettings = function (opts, zoomLevel, ignoreEditorZoom) {
          ...
          var fontFamily = _string(opts.fontFamily, editorOptions_js_1.EDITOR_FONT_DEFAULTS.fontFamily);
          var fontWeight = _string(opts.fontWeight, editorOptions_js_1.EDITOR_FONT_DEFAULTS.fontWeight);
          var fontSize = safeParseFloat(opts.fontSize, editorOptions_js_1.EDITOR_FONT_DEFAULTS.fontSize);
          fontSize = clamp(fontSize, 0, MAXIMUM_FONT_SIZE);
          if (fontSize === 0) {
              fontSize = editorOptions_js_1.EDITOR_FONT_DEFAULTS.fontSize;
          }
          ...
          var editorZoomLevelMultiplier = 1 + (ignoreEditorZoom ? 0 : editorZoom_js_1.EditorZoom.getZoomLevel() * 0.1);
