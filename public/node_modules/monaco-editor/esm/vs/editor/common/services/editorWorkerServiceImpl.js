define('node_modules/monaco-editor/esm/vs/editor/common/services/editorWorkerServiceImpl', function(require, exports, module) {
  ...
  var defaultWorkerFactory_js_1 = require("node_modules/monaco-editor/esm/vs/base/worker/defaultWorkerFactory");
  ...
  var EditorWorkerServiceImpl = /** @class */ (function (_super) {
      ...
      EditorWorkerServiceImpl.prototype.computeMoreMinimalEdits = function (resource, edits) {
          var _this = this;
          if (arrays_js_1.isNonEmptyArray(edits)) {
              if (!canSyncModel(this._modelService, resource)) {
                  return Promise.resolve(edits); // File too large
              }
              var sw_1 = stopwatch_js_1.StopWatch.create(true);
      ...
      EditorWorkerServiceImpl = __decorate([
          ...
          __param(1, resourceConfiguration_js_1.ITextResourceConfigurationService),
  ...
  var WorkerManager = /** @class */ (function (_super) {
      ...
      function WorkerManager(modelService) {
          ...
          var stopWorkerInterval = _this._register(new async_js_1.IntervalTimer());
  ...
  var EditorModelManager = /** @class */ (function (_super) {
      ...
      function EditorModelManager(proxy, modelService, keepIdleModels) {
          ...
          _this._modelService = modelService;
          if (!keepIdleModels) {
              var timer = new async_js_1.IntervalTimer();
      ...
      EditorModelManager.prototype.dispose = function () {
          for (var modelUrl in this._syncedModels) {
              lifecycle_js_1.dispose(this._syncedModels[modelUrl]);
          }
      ...
      EditorModelManager.prototype._stopModelSync = function (modelUrl) {
          ...
          lifecycle_js_1.dispose(toDispose);
      };
  ...
  var EditorWorkerClient = /** @class */ (function (_super) {
      ...
      function EditorWorkerClient(modelService, label) {
          var _this = _super.call(this) || this;
          _this._modelService = modelService;
          _this._workerFactory = new defaultWorkerFactory_js_1.DefaultWorkerFactory(label);
          _this._worker = null;
      ...
      EditorWorkerClient.prototype._getOrCreateWorker = function () {
          if (!this._worker) {
              try {
                  this._worker = this._register(new simpleWorker_js_1.SimpleWorkerClient(this._workerFactory, 'vs/editor/common/services/editorSimpleWorker'));
              }
              catch (err) {
                  simpleWorker_js_1.logOnceWebWorkerWarning(err);
                  this._worker = new SynchronousWorkerClient(new editorSimpleWorker_js_1.EditorSimpleWorkerImpl(null));
              }
          }
          return this._worker;
      };
      EditorWorkerClient.prototype._getProxy = function () {
          ...
          return this._getOrCreateWorker().getProxyObject().then(undefined, function (err) {
              simpleWorker_js_1.logOnceWebWorkerWarning(err);
              _this._worker = new SynchronousWorkerClient(new editorSimpleWorker_js_1.EditorSimpleWorkerImpl(null));
      ...
      EditorWorkerClient.prototype.textualSuggest = function (resource, position) {
          ...
          return this._withSyncedResources([resource]).then(function (proxy) {
              ...
              var wordDefRegExp = languageConfigurationRegistry_js_1.LanguageConfigurationRegistry.getWordDefinition(model.getLanguageIdentifier().id);
              var wordDef = wordDefRegExp.source;
              var wordDefFlags = strings_js_1.regExpFlags(wordDefRegExp);
