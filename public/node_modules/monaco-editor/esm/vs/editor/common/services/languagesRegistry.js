define('node_modules/monaco-editor/esm/vs/editor/common/services/languagesRegistry', function(require, exports, module) {
  ...
  var mime = tslib_1.__importStar(require("node_modules/monaco-editor/esm/vs/base/common/mime"));
  ...
  var LanguagesRegistry = /** @class */ (function (_super) {
      ...
      function LanguagesRegistry(useModesRegistry, warnOnOverwrite) {
          ...
          if (useModesRegistry) {
              ...
              _this._register(modesRegistry_js_1.ModesRegistry.onDidChangeLanguages(function (m) { return _this._initializeFromRegistry(); }));
          }
          return _this;
      }
      LanguagesRegistry.prototype._initializeFromRegistry = function () {
          ...
          var desc = modesRegistry_js_1.ModesRegistry.getLanguages();
      ...
      LanguagesRegistry.prototype._registerLanguages = function (desc) {
          ...
          platform_js_1.Registry.as(configurationRegistry_js_1.Extensions.Configuration).registerOverrideIdentifiers(modesRegistry_js_1.ModesRegistry.getLanguages().map(function (language) { return language.id; }));
      ...
      LanguagesRegistry.prototype._registerLanguage = function (lang) {
          ...
          if (hasOwnProperty.call(this._languages, langId)) {
              ...
              resolvedLanguage = {
                  identifier: new modes_js_1.LanguageIdentifier(langId, languageId),
                  name: null,
                  mimetypes: [],
                  aliases: [],
                  extensions: [],
      ...
      LanguagesRegistry.prototype.getLanguageIdentifier = function (_modeId) {
          if (_modeId === nullMode_js_1.NULL_MODE_ID || _modeId === 0 /* Null */) {
              return nullMode_js_1.NULL_LANGUAGE_IDENTIFIER;
          }
          var modeId;
