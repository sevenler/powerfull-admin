define('node_modules/monaco-editor/esm/vs/editor/common/core/lineTokens', function(require, exports, module) {
  ...
  var LineTokens = /** @class */ (function () {
      ...
      LineTokens.prototype.getLanguageId = function (tokenIndex) {
          ...
          return modes_js_1.TokenMetadata.getLanguageId(metadata);
      };
      LineTokens.prototype.getStandardTokenType = function (tokenIndex) {
          var metadata = this._tokens[(tokenIndex << 1) + 1];
          return modes_js_1.TokenMetadata.getTokenType(metadata);
      };
      LineTokens.prototype.getForeground = function (tokenIndex) {
          var metadata = this._tokens[(tokenIndex << 1) + 1];
          return modes_js_1.TokenMetadata.getForeground(metadata);
      };
      LineTokens.prototype.getClassName = function (tokenIndex) {
          var metadata = this._tokens[(tokenIndex << 1) + 1];
          return modes_js_1.TokenMetadata.getClassNameFromMetadata(metadata);
      };
      LineTokens.prototype.getInlineStyle = function (tokenIndex, colorMap) {
          var metadata = this._tokens[(tokenIndex << 1) + 1];
          return modes_js_1.TokenMetadata.getInlineStyleFromMetadata(metadata, colorMap);
      };
