define('node_modules/monaco-editor/esm/vs/editor/common/modes', function(require, exports, module) {
  ...
  var languageFeatureRegistry_js_1 = require("node_modules/monaco-editor/esm/vs/editor/common/modes/languageFeatureRegistry");
  var tokenizationRegistry_js_1 = require("node_modules/monaco-editor/esm/vs/editor/common/modes/tokenizationRegistry");
  /**
   * @internal
   */
  ...
  function isResourceTextEdit(thing) {
      return types_js_1.isObject(thing) && thing.resource && Array.isArray(thing.edits);
  }
   ...
   * @internal
   */
  exports.ReferenceProviderRegistry = new languageFeatureRegistry_js_1.LanguageFeatureRegistry();
  /**
   * @internal
   */
  exports.RenameProviderRegistry = new languageFeatureRegistry_js_1.LanguageFeatureRegistry();
  /**
   * @internal
   */
  exports.CompletionProviderRegistry = new languageFeatureRegistry_js_1.LanguageFeatureRegistry();
  /**
   * @internal
   */
  exports.SignatureHelpProviderRegistry = new languageFeatureRegistry_js_1.LanguageFeatureRegistry();
  /**
   * @internal
   */
  exports.HoverProviderRegistry = new languageFeatureRegistry_js_1.LanguageFeatureRegistry();
  /**
   * @internal
   */
  exports.DocumentSymbolProviderRegistry = new languageFeatureRegistry_js_1.LanguageFeatureRegistry();
  /**
   * @internal
   */
  exports.DocumentHighlightProviderRegistry = new languageFeatureRegistry_js_1.LanguageFeatureRegistry();
  /**
   * @internal
   */
  exports.DefinitionProviderRegistry = new languageFeatureRegistry_js_1.LanguageFeatureRegistry();
  /**
   * @internal
   */
  exports.DeclarationProviderRegistry = new languageFeatureRegistry_js_1.LanguageFeatureRegistry();
  /**
   * @internal
   */
  exports.ImplementationProviderRegistry = new languageFeatureRegistry_js_1.LanguageFeatureRegistry();
  /**
   * @internal
   */
  exports.TypeDefinitionProviderRegistry = new languageFeatureRegistry_js_1.LanguageFeatureRegistry();
  /**
   * @internal
   */
  exports.CodeLensProviderRegistry = new languageFeatureRegistry_js_1.LanguageFeatureRegistry();
  /**
   * @internal
   */
  exports.CodeActionProviderRegistry = new languageFeatureRegistry_js_1.LanguageFeatureRegistry();
  /**
   * @internal
   */
  exports.DocumentFormattingEditProviderRegistry = new languageFeatureRegistry_js_1.LanguageFeatureRegistry();
  /**
   * @internal
   */
  exports.DocumentRangeFormattingEditProviderRegistry = new languageFeatureRegistry_js_1.LanguageFeatureRegistry();
  /**
   * @internal
   */
  exports.OnTypeFormattingEditProviderRegistry = new languageFeatureRegistry_js_1.LanguageFeatureRegistry();
  /**
   * @internal
   */
  exports.LinkProviderRegistry = new languageFeatureRegistry_js_1.LanguageFeatureRegistry();
  /**
   * @internal
   */
  exports.ColorProviderRegistry = new languageFeatureRegistry_js_1.LanguageFeatureRegistry();
  /**
   * @internal
   */
  exports.SelectionRangeRegistry = new languageFeatureRegistry_js_1.LanguageFeatureRegistry();
  /**
   * @internal
   */
  exports.FoldingRangeProviderRegistry = new languageFeatureRegistry_js_1.LanguageFeatureRegistry();
  /**
   * @internal
   */
  exports.TokenizationRegistry = new tokenizationRegistry_js_1.TokenizationRegistryImpl();
