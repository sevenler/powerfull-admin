define('node_modules/monaco-editor/esm/vs/editor/common/model/textModelTokens', function(require, exports, module) {
  ...
  var ModelLineTokens = /** @class */ (function () {
      ...
      ModelLineTokens.prototype.delete = function (fromChIndex, toChIndex) {
          ...
          var fromTokenIndex = lineTokens_js_1.LineTokens.findIndexInTokensArray(tokens, fromChIndex);
      ...
      ModelLineTokens.prototype.insert = function (chIndex, textLength) {
          ...
          var tokens = new Uint32Array(this._lineTokens);
          var tokensCount = (tokens.length >>> 1);
          var fromTokenIndex = lineTokens_js_1.LineTokens.findIndexInTokensArray(tokens, chIndex);
          if (fromTokenIndex > 0) {
  ...
  var ModelLinesTokens = /** @class */ (function () {
      ...
      ModelLinesTokens.prototype.getTokens = function (topLevelLanguageId, lineIndex, lineText) {
          ...
          if (rawLineTokens !== null && rawLineTokens !== EMPTY_LINE_TOKENS) {
              return new lineTokens_js_1.LineTokens(new Uint32Array(rawLineTokens), lineText);
          }
          var lineTokens = new Uint32Array(2);
          lineTokens[0] = lineText.length;
          lineTokens[1] = getDefaultMetadata(topLevelLanguageId);
          return new lineTokens_js_1.LineTokens(lineTokens, lineText);
      };
      ...
      ModelLinesTokens.prototype._setTokens = function (topLevelLanguageId, lineIndex, lineTextLength, tokens) {
          ...
          if (lineTextLength === 0) {
              ...
              if (tokens && tokens.length > 1) {
                  hasDifferentLanguageId = (modes_js_1.TokenMetadata.getLanguageId(tokens[1]) !== topLevelLanguageId);
              }
          ...
          lineTokens_js_1.LineTokens.convertToEndOffset(tokens, lineTextLength);
      ...
      ModelLinesTokens.prototype._tokenizeText = function (buffer, text, state) {
          ...
          if (!r) {
              r = nullMode_js_1.nullTokenize2(this.languageIdentifier.id, text, state, 0);
          }
          return r;
      };
      ModelLinesTokens.prototype._updateTokensUntilLine = function (buffer, eventBuilder, lineNumber) {
          ...
          for (var lineIndex = this._invalidLineStartIndex; lineIndex <= endLineIndex; lineIndex++) {
              ...
              if (!r) {
                  r = nullMode_js_1.nullTokenize2(this.languageIdentifier.id, text, lineStartState, 0);
              }
