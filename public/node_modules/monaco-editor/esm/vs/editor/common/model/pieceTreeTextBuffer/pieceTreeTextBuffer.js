define('node_modules/monaco-editor/esm/vs/editor/common/model/pieceTreeTextBuffer/pieceTreeTextBuffer', function(require, exports, module) {
  ...
  var PieceTreeTextBuffer = /** @class */ (function () {
      ...
      PieceTreeTextBuffer.prototype._doApplyEdits = function (operations) {
          ...
          for (var i = 0; i < operations.length; i++) {
              ...
              var contentChangeRange = new range_js_1.Range(startLineNumber, startColumn, endLineNumber, endColumn);
              contentChanges.push({
      ...
      PieceTreeTextBuffer._getInverseEditRanges = function (operations) {
          ...
          for (var i = 0, len = operations.length; i < len; i++) {
              ...
              if (op.lines && op.lines.length > 0) {
                  ...
                  if (lineCount === 1) {
                      // single line insert
                      resultRange = new range_js_1.Range(startLineNumber, startColumn, startLineNumber, startColumn + firstLine.length);
                  }
                  else {
                      // multi line insert
                      resultRange = new range_js_1.Range(startLineNumber, startColumn, startLineNumber + lineCount - 1, lastLine.length + 1);
                  }
              }
              else {
      ...
      PieceTreeTextBuffer._sortOpsAscending = function (a, b) {
          var r = range_js_1.Range.compareRangesUsingEnds(a.range, b.range);
          if (r === 0) {
