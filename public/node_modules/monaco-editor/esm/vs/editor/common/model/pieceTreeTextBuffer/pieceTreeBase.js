define('node_modules/monaco-editor/esm/vs/editor/common/model/pieceTreeTextBuffer/pieceTreeBase', function(require, exports, module) {
  ...
  var rbTreeBase_js_1 = require("node_modules/monaco-editor/esm/vs/editor/common/model/pieceTreeTextBuffer/rbTreeBase");
  ...
  var PieceTreeBase = /** @class */ (function () {
      ...
      PieceTreeBase.prototype.findMatchesInNode = function (node, searcher, startLineNumber, startColumn, startCursor, endCursor, searchData, captureMatches, limitResultCount, resultLen, result) {
          ...
          do {
              ...
              if (m) {
                  ...
                  result[resultLen++] = textModelSearch_js_1.createFindMatch(new range_js_1.Range(startLineNumber + lineFeedCnt, retStartColumn, startLineNumber + lineFeedCnt, retEndColumn), m, captureMatches);
      ...
      PieceTreeBase.prototype.findMatchesLineByLine = function (searchRange, searchData, captureMatches, limitResultCount) {
          var result = [];
          var resultLen = 0;
          var searcher = new textModelSearch_js_1.Searcher(searchData.wordSeparators, searchData.regex);
      ...
      PieceTreeBase.prototype._findMatchesInLine = function (searchData, searcher, text, lineNumber, deltaOffset, resultLen, result, captureMatches, limitResultCount) {
          ...
          if (!captureMatches && searchData.simpleSearch) {
              ...
              while ((lastMatchIndex = text.indexOf(searchString, lastMatchIndex + searchStringLen)) !== -1) {
                  if (!wordSeparators || textModelSearch_js_1.isValidMatch(wordSeparators, text, textLength, lastMatchIndex, searchStringLen)) {
          ...
          do {
              ...
              if (m) {
                  result[resultLen++] = textModelSearch_js_1.createFindMatch(new range_js_1.Range(lineNumber, m.index + 1 + deltaOffset, lineNumber, m.index + 1 + m[0].length + deltaOffset), m, captureMatches);
                  if (resultLen >= limitResultCount) {
                      return resultLen;
                  }
              }
      ...
      PieceTreeBase.prototype.delete = function (offset, cnt) {
          ...
          if (startNode === endNode) {
              ...
              if (startPosition.nodeStartOffset === offset) {
                  if (cnt === startNode.piece.length) { // delete node
                      ...
                      rbTreeBase_js_1.rbDelete(this, startNode);
          ...
          for (var node = secondNode; node !== rbTreeBase_js_1.SENTINEL && node !== endNode; node = node.next()) {
              nodesToDel.push(node);
          }
      ...
      PieceTreeBase.prototype.insertContentToNodeLeft = function (value, node) {
          ...
          if (this.shouldCheckCRLF() && this.endWithCR(value) && this.startWithLF(node)) {
              ...
              node.piece = nPiece;
              value += '\n';
              rbTreeBase_js_1.updateTreeMetadata(this, node, -1, -1);
              if (node.piece.length === 0) {
                  nodesToDel.push(node);
              }
          }
      ...
      PieceTreeBase.prototype.deleteNodes = function (nodes) {
          for (var i = 0; i < nodes.length; i++) {
              rbTreeBase_js_1.rbDelete(this, nodes[i]);
          }
      };
      ...
      PieceTreeBase.prototype.deleteNodeTail = function (node, pos) {
          ...
          rbTreeBase_js_1.updateTreeMetadata(this, node, size_delta, lf_delta);
      };
      ...
      PieceTreeBase.prototype.shrinkNode = function (node, start, end) {
          ...
          node.piece = new Piece(piece.bufferIndex, piece.start, newEnd, newLineFeedCnt, newLength);
          rbTreeBase_js_1.updateTreeMetadata(this, node, newLength - oldLength, newLineFeedCnt - oldLFCnt);
      ...
      PieceTreeBase.prototype.appendToNode = function (node, value) {
          ...
          rbTreeBase_js_1.updateTreeMetadata(this, node, value.length, lf_delta);
      };
      ...
      PieceTreeBase.prototype.fixCRLF = function (prev, next) {
          ...
          rbTreeBase_js_1.updateTreeMetadata(this, prev, -1, -1);
          ...
          rbTreeBase_js_1.updateTreeMetadata(this, next, -1, -1);
          ...
          for (var i = 0; i < nodesToDel.length; i++) {
              rbTreeBase_js_1.rbDelete(this, nodesToDel[i]);
          }
      };
          ...
          if (this.shouldCheckCRLF() && this.endWithCR(value)) {
              ...
              if (this.startWithLF(nextNode)) {
                  ...
                  if (nextNode.piece.length === 1) {
                      rbTreeBase_js_1.rbDelete(this, nextNode);
                  }
                  else {
                      ...
                      rbTreeBase_js_1.updateTreeMetadata(this, nextNode, -1, -1);
                  }
                  return true;
              }
          }
      ...
      PieceTreeBase.prototype.rbInsertRight = function (node, p) {
          var z = new rbTreeBase_js_1.TreeNode(p, 1 /* Red */);
          ...
          if (x === rbTreeBase_js_1.SENTINEL) {
              ...
              var nextNode = rbTreeBase_js_1.leftest(node.right);
              nextNode.left = z;
              z.parent = nextNode;
          }
          rbTreeBase_js_1.fixInsert(this, z);
          return z;
      };
      /**
       *      node              node
      ...
      PieceTreeBase.prototype.rbInsertLeft = function (node, p) {
          ...
          if (this.root === rbTreeBase_js_1.SENTINEL) {
              ...
              var prevNode = rbTreeBase_js_1.righttest(node.left); // a
              prevNode.right = z;
              z.parent = prevNode;
          }
          rbTreeBase_js_1.fixInsert(this, z);
