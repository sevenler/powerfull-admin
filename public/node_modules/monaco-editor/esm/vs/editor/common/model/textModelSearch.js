define('node_modules/monaco-editor/esm/vs/editor/common/model/textModelSearch', function(require, exports, module) {
  ...
  var SearchParams = /** @class */ (function () {
      ...
      SearchParams.prototype.parseSearchRequest = function () {
          ...
          return new SearchData(regex, this.wordSeparators ? wordCharacterClassifier_js_1.getMapForWordSeparators(this.wordSeparators) : null, canUseSimpleSearch ? this.searchString : null);
      };
      return SearchParams;
  }());
  ...
  var TextModelSearch = /** @class */ (function () {
      ...
      TextModelSearch._doFindNextMatchMultiline = function (model, searchStart, searcher, captureMatches) {
          var searchTextStart = new position_js_1.Position(searchStart.lineNumber, 1);
          var deltaOffset = model.getOffsetAt(searchTextStart);
          var lineCount = model.getLineCount();
          // We always execute multiline search over the lines joined with \n
          // This makes it that \n will match the EOL for both CRLF and LF models
          // We compensate for offset errors in `_getMultilineMatchRange`
          var text = model.getValueInRange(new range_js_1.Range(searchTextStart.lineNumber, searchTextStart.column, lineCount, model.getLineMaxColumn(lineCount)), 1 /* LF */);
          var lfCounter = (model.getEOL() === '\r\n' ? new LineFeedCounter(text) : null);
      ...
      TextModelSearch._doFindPreviousMatchMultiline = function (model, searchStart, searcher, captureMatches) {
          var matches = this._doFindMatchesMultiline(model, new range_js_1.Range(1, 1, searchStart.lineNumber, searchStart.column), searcher, captureMatches, 10 * LIMIT_FIND_COUNT);
          if (matches.length > 0) {
