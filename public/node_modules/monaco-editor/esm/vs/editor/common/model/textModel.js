define('node_modules/monaco-editor/esm/vs/editor/common/model/textModel', function(require, exports, module) {
  ...
  var model = tslib_1.__importStar(require("node_modules/monaco-editor/esm/vs/editor/common/model"));
  var editStack_js_1 = require("node_modules/monaco-editor/esm/vs/editor/common/model/editStack");
  var indentationGuesser_js_1 = require("node_modules/monaco-editor/esm/vs/editor/common/model/indentationGuesser");
  var intervalTree_js_1 = require("node_modules/monaco-editor/esm/vs/editor/common/model/intervalTree");
  var pieceTreeTextBufferBuilder_js_1 = require("node_modules/monaco-editor/esm/vs/editor/common/model/pieceTreeTextBuffer/pieceTreeTextBufferBuilder");
  var textModelEvents_js_1 = require("node_modules/monaco-editor/esm/vs/editor/common/model/textModelEvents");
  var textModelSearch_js_1 = require("node_modules/monaco-editor/esm/vs/editor/common/model/textModelSearch");
  var textModelTokens_js_1 = require("node_modules/monaco-editor/esm/vs/editor/common/model/textModelTokens");
  ...
  var supports_js_1 = require("node_modules/monaco-editor/esm/vs/editor/common/modes/supports");
  var richEditBrackets_js_1 = require("node_modules/monaco-editor/esm/vs/editor/common/modes/supports/richEditBrackets");
  var types_js_1 = require("node_modules/monaco-editor/esm/vs/base/common/types");
  var CHEAP_TOKENIZATION_LENGTH_LIMIT = 2048;
  function createTextBufferBuilder() {
      return new pieceTreeTextBufferBuilder_js_1.PieceTreeTextBufferBuilder();
  }
  ...
  var TextModel = /** @class */ (function (_super) {
      ...
      function TextModel(source, creationOptions, languageIdentifier, associatedResource) {
          ...
          //#region Events
          _this._onWillDispose = _this._register(new event_js_1.Emitter());
          ...
          _this._onDidChangeLanguage = _this._register(new event_js_1.Emitter());
          _this.onDidChangeLanguage = _this._onDidChangeLanguage.event;
          _this._onDidChangeLanguageConfiguration = _this._register(new event_js_1.Emitter());
          _this.onDidChangeLanguageConfiguration = _this._onDidChangeLanguageConfiguration.event;
          _this._onDidChangeTokens = _this._register(new event_js_1.Emitter());
          _this.onDidChangeTokens = _this._onDidChangeTokens.event;
          _this._onDidChangeOptions = _this._register(new event_js_1.Emitter());
          ...
          if (typeof associatedResource === 'undefined' || associatedResource === null) {
              _this._associatedResource = uri_js_1.URI.parse('inmemory://model/' + MODEL_ID);
          }
          else {
          ...
          var bufferTextLength = _this._buffer.getValueLengthInRange(new range_js_1.Range(1, 1, bufferLineCount, _this._buffer.getLineLength(bufferLineCount) + 1), 0 /* TextDefined */);
          ...
          _this._languageIdentifier = languageIdentifier || nullMode_js_1.NULL_LANGUAGE_IDENTIFIER;
          _this._tokenizationListener = modes_js_1.TokenizationRegistry.onDidChange(function (e) {
          ...
          _this._languageRegistryListener = languageConfigurationRegistry_js_1.LanguageConfigurationRegistry.onDidChange(function (e) {
          ...
          _this._commandManager = new editStack_js_1.EditStack(_this);
      ...
      TextModel.resolveOptions = function (textBuffer, options) {
          if (options.detectIndentation) {
              var guessedIndentation = indentationGuesser_js_1.guessIndentation(textBuffer, options.tabSize, options.insertSpaces);
      ...
      TextModel.prototype.setValueFromTextBuffer = function (textBuffer) {
          ...
          this._commandManager = new editStack_js_1.EditStack(this);
          ...
          ], this._versionId, false, false), this._createContentChanged2(new range_js_1.Range(1, 1, endLineNumber, endColumn), 0, oldModelValueLength, this.getValue(), false, false, true));
      };
      TextModel.prototype.setEOL = function (eol) {
          ...
          ], this._versionId, false, false), this._createContentChanged2(new range_js_1.Range(1, 1, endLineNumber, endColumn), 0, oldModelValueLength, this.getValue(), false, false, false));
      };
      ...
      TextModel.prototype._onAfterEOLChange = function () {
          ...
          for (var i = 0, len = allDecorations.length; i < len; i++) {
              ...
              intervalTree_js_1.recomputeMaxEnd(node);
          }
      };
      TextModel.prototype._resetTokenizationState = function () {
          ...
          var tokenizationSupport = (this._isTooLargeForTokenization
              ? null
              : modes_js_1.TokenizationRegistry.get(this._languageIdentifier.language));
          this._tokens = new textModelTokens_js_1.ModelLinesTokens(this._languageIdentifier, tokenizationSupport);
      ...
      TextModel.prototype.detectIndentation = function (defaultInsertSpaces, defaultTabSize) {
          this._assertNotDisposed();
          var guessedIndentation = indentationGuesser_js_1.guessIndentation(this._buffer, defaultTabSize, defaultInsertSpaces);
          this.updateOptions({
              insertSpaces: guessedIndentation.insertSpaces,
              tabSize: guessedIndentation.tabSize,
              indentSize: guessedIndentation.tabSize,
      ...
      TextModel.prototype.findMatches = function (searchString, rawSearchScope, isRegex, matchCase, wordSeparators, captureMatches, limitResultCount) {
          ...
          this._assertNotDisposed();
          var searchRange;
          if (range_js_1.Range.isIRange(rawSearchScope)) {
          ...
          if (!isRegex && searchString.indexOf('\n') < 0) {
              ...
              var searchParams = new textModelSearch_js_1.SearchParams(searchString, isRegex, matchCase, wordSeparators);
          ...
          return textModelSearch_js_1.TextModelSearch.findMatches(this, new textModelSearch_js_1.SearchParams(searchString, isRegex, matchCase, wordSeparators), searchRange, captureMatches, limitResultCount);
      };
      TextModel.prototype.findNextMatch = function (searchString, rawSearchStart, isRegex, matchCase, wordSeparators, captureMatches) {
          ...
          if (!isRegex && searchString.indexOf('\n') < 0) {
              ...
              var lineCount = this.getLineCount();
              var searchRange = new range_js_1.Range(searchStart.lineNumber, searchStart.column, lineCount, this.getLineMaxColumn(lineCount));
          ...
          if (this._options.trimAutoWhitespace && this._trimAutoWhitespaceLines) {
              ...
              if (editsAreNearCursors) {
                  for (var i = 0, len = this._trimAutoWhitespaceLines.length; i < len; i++) {
                      ...
                      if (allowTrimLine) {
                          editOperations.push({
                              range: new range_js_1.Range(trimLineNumber, 1, trimLineNumber, maxLineColumn),
                              text: null
                          });
                      }
                  }
          ...
          if (contentChanges.length !== 0) {
              ...
              for (var i = 0, len = contentChanges.length; i < len; i++) {
                  ...
                  try {
                      ...
                      this._tokens = new textModelTokens_js_1.ModelLinesTokens(this._tokens.languageIdentifier, this._tokens.tokenizationSupport);
                  }
                  ...
                  for (var j = editingLinesCnt; j >= 0; j--) {
                      ...
                      rawContentChanges.push(new textModelEvents_js_1.ModelRawLineChanged(editLineNumber, this.getLineContent(currentEditLineNumber)));
                  }
                  ...
                  if (editingLinesCnt < insertingLinesCnt) {
                      ...
                      rawContentChanges.push(new textModelEvents_js_1.ModelRawLinesInserted(spliceLineNumber + 1, startLineNumber + insertingLinesCnt, newLines));
                  }
      ...
      TextModel.prototype.getLinesDecorations = function (_startLineNumber, _endLineNumber, ownerId, filterOutValidation) {
          ...
          var endColumn = this.getLineMaxColumn(endLineNumber);
          return this._getDecorationsInRange(new range_js_1.Range(startLineNumber, 1, endLineNumber, endColumn), ownerId, filterOutValidation);
      };
      ...
      TextModel.prototype.tokenizeViewport = function (startLineNumber, endLineNumber) {
          ...
          var eventBuilder = new textModelTokens_js_1.ModelTokensChangedEventBuilder();
      ...
      TextModel.prototype._revalidateTokensNow = function (toLineNumber) {
          ...
          var eventBuilder = new textModelTokens_js_1.ModelTokensChangedEventBuilder();
          var sw = stopwatch_js_1.StopWatch.create(false);
      ...
      TextModel.prototype.getWordAtPosition = function (_position) {
          ...
          var rightBiasedWord = wordHelper_js_1.getWordAtText(position.column, languageConfigurationRegistry_js_1.LanguageConfigurationRegistry.getWordDefinition(lineTokens.getLanguageId(tokenIndex)), lineContent.substring(rbStartOffset, rbEndOffset), rbStartOffset);
          ...
          if (tokenIndex > 0 && rbStartOffset === position.column - 1) {
              ...
              var leftBiasedWord = wordHelper_js_1.getWordAtText(position.column, languageConfigurationRegistry_js_1.LanguageConfigurationRegistry.getWordDefinition(lineTokens.getLanguageId(tokenIndex - 1)), lineContent.substring(lbStartOffset, lbEndOffset), lbStartOffset);
              // Make sure the result touches the original passed in position
      ...
      TextModel.prototype.findMatchingBracketUp = function (_bracket, _position) {
          ...
          var bracketsSupport = languageConfigurationRegistry_js_1.LanguageConfigurationRegistry.getBracketsSupport(languageId);
          if (!bracketsSupport) {
              return null;
          }
      ...
      TextModel.prototype._matchBracket = function (position) {
          ...
          var currentModeBrackets = languageConfigurationRegistry_js_1.LanguageConfigurationRegistry.getBracketsSupport(lineTokens.getLanguageId(tokenIndex));
          // check that the token is not to be ignored
          if (currentModeBrackets && !supports_js_1.ignoreBracketsInToken(lineTokens.getStandardTokenType(tokenIndex))) {
              ...
              var bestResult = null;
              while (true) {
                  var foundBracket = richEditBrackets_js_1.BracketsUtils.findNextBracketInToken(currentModeBrackets.forwardRegex, lineNumber, lineText, searchStartOffset, searchEndOffset);
                  if (!foundBracket) {
          ...
          if (tokenIndex > 0 && lineTokens.getStartOffset(tokenIndex) === position.column - 1) {
              ...
              tokenIndex--;
              var prevModeBrackets = languageConfigurationRegistry_js_1.LanguageConfigurationRegistry.getBracketsSupport(lineTokens.getLanguageId(tokenIndex));
              // check that previous token is not to be ignored
              if (prevModeBrackets && !supports_js_1.ignoreBracketsInToken(lineTokens.getStandardTokenType(tokenIndex))) {
                  ...
                  var foundBracket = richEditBrackets_js_1.BracketsUtils.findPrevBracketInToken(prevModeBrackets.reversedRegex, lineNumber, lineText, searchStartOffset, searchEndOffset);
                  // check that we didn't hit a bracket too far away from position
      ...
      TextModel.prototype._findMatchingBracketUp = function (bracket, position) {
          ...
          for (var lineNumber = position.lineNumber; lineNumber >= 1; lineNumber--) {
              ...
              for (; tokenIndex >= 0; tokenIndex--) {
                  ...
                  if (tokenLanguageId === languageId && !supports_js_1.ignoreBracketsInToken(tokenType)) {
                      while (true) {
                          var r = richEditBrackets_js_1.BracketsUtils.findPrevBracketInToken(reversedBracketRegex, lineNumber, lineText, tokenStartOffset, searchStopOffset);
                          if (!r) {
                              break;
                          }
      ...
      TextModel.prototype._findMatchingBracketDown = function (bracket, position) {
          ...
          for (var lineNumber = position.lineNumber, lineCount = this.getLineCount(); lineNumber <= lineCount; lineNumber++) {
              ...
              for (; tokenIndex < tokenCount; tokenIndex++) {
                  ...
                  if (tokenLanguageId === languageId && !supports_js_1.ignoreBracketsInToken(tokenType)) {
                      while (true) {
                          var r = richEditBrackets_js_1.BracketsUtils.findNextBracketInToken(bracketRegex, lineNumber, lineText, searchStartOffset, tokenEndOffset);
                          if (!r) {
                              break;
                          }
                          var hitText = lineText.substring(r.startColumn - 1, r.endColumn - 1);
          ...
          for (var lineNumber = position.lineNumber; lineNumber >= 1; lineNumber--) {
              ...
              for (; tokenIndex >= 0; tokenIndex--) {
                  ...
                  if (languageId !== tokenLanguageId) {
                      ...
                      modeBrackets = languageConfigurationRegistry_js_1.LanguageConfigurationRegistry.getBracketsSupport(languageId);
                  }
                  if (modeBrackets && !supports_js_1.ignoreBracketsInToken(tokenType)) {
                      var r = richEditBrackets_js_1.BracketsUtils.findPrevBracketInToken(modeBrackets.reversedRegex, lineNumber, lineText, tokenStartOffset, searchStopOffset);
                      if (r) {
      ...
      TextModel.prototype.findNextBracket = function (_position) {
          ...
          for (var lineNumber = position.lineNumber, lineCount = this.getLineCount(); lineNumber <= lineCount; lineNumber++) {
              ...
              for (; tokenIndex < tokenCount; tokenIndex++) {
                  ...
                  if (modeBrackets && !supports_js_1.ignoreBracketsInToken(tokenType)) {
                      var r = richEditBrackets_js_1.BracketsUtils.findNextBracketInToken(modeBrackets.forwardRegex, lineNumber, lineText, searchStartOffset, tokenEndOffset);
                      if (r) {
                          return this._toFoundBracket(modeBrackets, r);
                      }
                  }
      ...
      TextModel.prototype.getActiveIndentGuide = function (lineNumber, minLineNumber, maxLineNumber) {
          ...
          var foldingRules = languageConfigurationRegistry_js_1.LanguageConfigurationRegistry.getFoldingRules(this._languageIdentifier.id);
      ...
      TextModel.DEFAULT_CREATION_OPTIONS = {
          ...
          tabSize: editorOptions_js_1.EDITOR_MODEL_DEFAULTS.tabSize,
          indentSize: editorOptions_js_1.EDITOR_MODEL_DEFAULTS.indentSize,
          insertSpaces: editorOptions_js_1.EDITOR_MODEL_DEFAULTS.insertSpaces,
          detectIndentation: false,
          defaultEOL: 1 /* LF */,
          trimAutoWhitespace: editorOptions_js_1.EDITOR_MODEL_DEFAULTS.trimAutoWhitespace,
          largeFileOptimizations: editorOptions_js_1.EDITOR_MODEL_DEFAULTS.largeFileOptimizations,
      };
      return TextModel;
  ...
  var DecorationsTrees = /** @class */ (function () {
      ...
      DecorationsTrees.prototype.insert = function (node) {
          if (intervalTree_js_1.getNodeIsInOverviewRuler(node)) {
  ...
  var ModelDecorationOptions = /** @class */ (function () {
      function ModelDecorationOptions(options) {
          ...
          this.hoverMessage = types_js_1.withUndefinedAsNull(options.hoverMessage);
          this.glyphMarginHoverMessage = types_js_1.withUndefinedAsNull(options.glyphMarginHoverMessage);
  ...
  var DidChangeDecorationsEmitter = /** @class */ (function (_super) {
      ...
      function DidChangeDecorationsEmitter() {
          var _this = _super.call(this) || this;
          _this._actual = _this._register(new event_js_1.Emitter());
  ...
  var DidChangeContentEmitter = /** @class */ (function (_super) {
      ...
      function DidChangeContentEmitter() {
           ...
           */
          _this._fastEmitter = _this._register(new event_js_1.Emitter());
          _this.fastEvent = _this._fastEmitter.event;
          _this._slowEmitter = _this._register(new event_js_1.Emitter());
