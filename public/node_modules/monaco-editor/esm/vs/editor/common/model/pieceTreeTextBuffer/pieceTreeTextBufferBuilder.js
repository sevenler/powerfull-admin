define('node_modules/monaco-editor/esm/vs/editor/common/model/pieceTreeTextBuffer/pieceTreeTextBufferBuilder', function(require, exports, module) {
  ...
  var pieceTreeBase_js_1 = require("node_modules/monaco-editor/esm/vs/editor/common/model/pieceTreeTextBuffer/pieceTreeBase");
  var pieceTreeTextBuffer_js_1 = require("node_modules/monaco-editor/esm/vs/editor/common/model/pieceTreeTextBuffer/pieceTreeTextBuffer");
      ...
      PieceTreeTextBufferFactory.prototype.create = function (defaultEOL) {
          ...
          if (this._normalizeEOL &&
              ...
              for (var i = 0, len = chunks.length; i < len; i++) {
                  ...
                  var newLineStart = pieceTreeBase_js_1.createLineStartsFast(str);
                  chunks[i] = new pieceTreeBase_js_1.StringBuffer(str, newLineStart);
              }
          }
          return new pieceTreeTextBuffer_js_1.PieceTreeTextBuffer(chunks, this._bom, eol, this._containsRTL, this._isBasicASCII, this._normalizeEOL);
      };
  ...
  var PieceTreeTextBufferBuilder = /** @class */ (function () {
      ...
      PieceTreeTextBufferBuilder.prototype._acceptChunk2 = function (chunk) {
          var lineStarts = pieceTreeBase_js_1.createLineStarts(this._tmpLineStarts, chunk);
      ...
      PieceTreeTextBufferBuilder.prototype._finish = function () {
          ...
          if (this._hasPreviousChar) {
              ...
              var newLineStarts = pieceTreeBase_js_1.createLineStartsFast(lastChunk.buffer);
