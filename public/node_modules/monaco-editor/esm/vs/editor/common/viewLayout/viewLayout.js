define('node_modules/monaco-editor/esm/vs/editor/common/viewLayout/viewLayout', function(require, exports, module) {
  ...
  var linesLayout_js_1 = require("node_modules/monaco-editor/esm/vs/editor/common/viewLayout/linesLayout");
  ...
  var ViewLayout = /** @class */ (function (_super) {
      ...
      function ViewLayout(configuration, lineCount, scheduleAtNextAnimationFrame) {
          ...
          _this._linesLayout = new linesLayout_js_1.LinesLayout(lineCount, _this._configuration.editor.lineHeight);
          _this.scrollable = _this._register(new scrollable_js_1.Scrollable(0, scheduleAtNextAnimationFrame));
