define('node_modules/monaco-editor/esm/vs/editor/common/controller/cursorWordOperations', function(require, exports, module) {
  ...
  var WordOperations = /** @class */ (function () {
      ...
      WordOperations.moveWordLeft = function (wordSeparators, model, position, wordNavigationType) {
          ...
          var prevWordOnLine = WordOperations._findPreviousWordOnLine(wordSeparators, model, new position_js_1.Position(lineNumber, column));
          if (wordNavigationType === 0 /* WordStart */) {
              if (prevWordOnLine && !movedToPreviousLine) {
                  ...
                  if (lastWhitespaceColumn < column) {
                      return new position_js_1.Position(lineNumber, prevWordOnLine.end + 1);
                  }
              }
      ...
      WordOperations.moveWordRight = function (wordSeparators, model, position, wordNavigationType) {
          ...
          var nextWordOnLine = WordOperations._findNextWordOnLine(wordSeparators, model, new position_js_1.Position(lineNumber, column));
      ...
      WordOperations.deleteWordLeft = function (wordSeparators, model, selection, whitespaceHeuristics, wordNavigationType) {
          ...
          var position = new position_js_1.Position(selection.positionLineNumber, selection.positionColumn);
          var lineNumber = position.lineNumber;
          var column = position.column;
      ...
      WordOperations.word = function (config, model, cursor, inSelectionMode, position) {
          ...
          if (!inSelectionMode) {
              ...
              return new cursorCommon_js_1.SingleCursorState(new range_js_1.Range(position.lineNumber, startColumn_1, position.lineNumber, endColumn_1), 0, new position_js_1.Position(position.lineNumber, endColumn_1), 0);
          }
          var startColumn;
          var endColumn;
          if (prevWord && prevWord.wordType === 1 /* Regular */ && prevWord.start < position.column - 1 && position.column - 1 < prevWord.end) {
          ...
          if (cursor.selectionStart.containsPosition(position)) {
              ...
              column = startColumn;
              var possiblePosition = new position_js_1.Position(lineNumber, column);
