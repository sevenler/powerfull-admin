define('node_modules/monaco-editor/esm/vs/editor/common/controller/cursorCommon', function(require, exports, module) {
  ...
  var CursorConfiguration = /** @class */ (function () {
      ...
      CursorConfiguration.prototype.normalizeIndentation = function (str) {
          return textModel_js_1.TextModel.normalizeIndentation(str, this.indentSize, this.insertSpaces);
      };
      CursorConfiguration._getElectricCharacters = function (languageIdentifier) {
          try {
              return languageConfigurationRegistry_js_1.LanguageConfigurationRegistry.getElectricCharacters(languageIdentifier.id);
          }
          catch (e) {
      ...
      CursorConfiguration._getAutoClosingPairs = function (languageIdentifier) {
          try {
              return languageConfigurationRegistry_js_1.LanguageConfigurationRegistry.getAutoClosingPairs(languageIdentifier.id);
          }
          catch (e) {
              errors_js_1.onUnexpectedError(e);
              return null;
      ...
      CursorConfiguration._getLanguageDefinedShouldAutoClose = function (languageIdentifier) {
          try {
              var autoCloseBeforeSet_1 = languageConfigurationRegistry_js_1.LanguageConfigurationRegistry.getAutoCloseBeforeSet(languageIdentifier.id);
      ...
      CursorConfiguration._getSurroundingPairs = function (languageIdentifier) {
          try {
              return languageConfigurationRegistry_js_1.LanguageConfigurationRegistry.getSurroundingPairs(languageIdentifier.id);
          }
          catch (e) {
              errors_js_1.onUnexpectedError(e);
              return null;
  ...
  var SingleCursorState = /** @class */ (function () {
      ...
      SingleCursorState.prototype.move = function (inSelectionMode, lineNumber, column, leftoverVisibleColumns) {
          if (inSelectionMode) {
              // move just position
              return new SingleCursorState(this.selectionStart, this.selectionStartLeftoverVisibleColumns, new position_js_1.Position(lineNumber, column), leftoverVisibleColumns);
          }
          else {
              // move everything
              return new SingleCursorState(new range_js_1.Range(lineNumber, column, lineNumber, column), leftoverVisibleColumns, new position_js_1.Position(lineNumber, column), leftoverVisibleColumns);
          }
      };
      SingleCursorState._computeSelection = function (selectionStart, position) {
          ...
          return new selection_js_1.Selection(startLineNumber, startColumn, endLineNumber, endColumn);
      };
  ...
  var CursorContext = /** @class */ (function () {
      ...
      CursorContext.prototype.convertViewPositionToModelPosition = function (lineNumber, column) {
          return this.viewModel.coordinatesConverter.convertViewPositionToModelPosition(new position_js_1.Position(lineNumber, column));
      };
  ...
  var CursorState = /** @class */ (function () {
      ...
      CursorState.fromModelSelection = function (modelSelection) {
          ...
          var modelState = new SingleCursorState(new range_js_1.Range(selectionStartLineNumber, selectionStartColumn, selectionStartLineNumber, selectionStartColumn), 0, new position_js_1.Position(positionLineNumber, positionColumn), 0);
