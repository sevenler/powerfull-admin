define('node_modules/monaco-editor/esm/vs/editor/common/controller/cursorColumnSelection', function(require, exports, module) {
  ...
  var ColumnSelection = /** @class */ (function () {
      ...
      ColumnSelection._columnSelect = function (config, model, fromLineNumber, fromVisibleColumn, toLineNumber, toVisibleColumn) {
          ...
          for (var i = 0; i < lineCount; i++) {
              ...
              var startColumn = cursorCommon_js_1.CursorColumns.columnFromVisibleColumn2(config, model, lineNumber, fromVisibleColumn);
              var endColumn = cursorCommon_js_1.CursorColumns.columnFromVisibleColumn2(config, model, lineNumber, toVisibleColumn);
              var visibleStartColumn = cursorCommon_js_1.CursorColumns.visibleColumnFromColumn2(config, model, new position_js_1.Position(lineNumber, startColumn));
              var visibleEndColumn = cursorCommon_js_1.CursorColumns.visibleColumnFromColumn2(config, model, new position_js_1.Position(lineNumber, endColumn));
              ...
              result.push(new cursorCommon_js_1.SingleCursorState(new range_js_1.Range(lineNumber, startColumn, lineNumber, startColumn), 0, new position_js_1.Position(lineNumber, endColumn), 0));
          }
          return {
              viewStates: result,
              reversed: reversed,
      ...
      ColumnSelection.columnSelect = function (config, model, fromViewSelection, toViewLineNumber, toViewVisualColumn) {
          var fromViewPosition = new position_js_1.Position(fromViewSelection.selectionStartLineNumber, fromViewSelection.selectionStartColumn);
          var fromViewVisibleColumn = cursorCommon_js_1.CursorColumns.visibleColumnFromColumn2(config, model, fromViewPosition);
      ...
      ColumnSelection.columnSelectRight = function (config, model, cursor, toViewLineNumber, toViewVisualColumn) {
          ...
          for (var lineNumber = minViewLineNumber; lineNumber <= maxViewLineNumber; lineNumber++) {
              ...
              var lineMaxVisualViewColumn = cursorCommon_js_1.CursorColumns.visibleColumnFromColumn2(config, model, new position_js_1.Position(lineNumber, lineMaxViewColumn));
