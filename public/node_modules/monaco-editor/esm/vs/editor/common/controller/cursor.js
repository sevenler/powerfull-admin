define('node_modules/monaco-editor/esm/vs/editor/common/controller/cursor', function(require, exports, module) {
  ...
  var cursorCollection_js_1 = require("node_modules/monaco-editor/esm/vs/editor/common/controller/cursorCollection");
  ...
  var Cursor = /** @class */ (function (_super) {
      ...
      function Cursor(configuration, model, viewModel) {
          ...
          _this._onDidReachMaxCursorCount = _this._register(new event_js_1.Emitter());
          ...
          _this.context = new cursorCommon_js_1.CursorContext(_this._configuration, _this._model, _this._viewModel);
          _this._cursors = new cursorCollection_js_1.CursorCollection(_this.context);
      ...
      Cursor.prototype.restoreState = function (states) {
          ...
          this.setStates('restoreState', 0 /* NotSet */, cursorCommon_js_1.CursorState.fromModelSelections(desiredSelections));
      ...
      Cursor.prototype._onModelContentChanged = function (hadFlushEvent) {
          ...
          if (hadFlushEvent) {
              ...
              this.setStates('modelChange', 2 /* RecoverFromMarkers */, cursorCommon_js_1.CursorState.fromModelSelections(selectionsFromMarkers));
          }
      };
      ...
      Cursor.prototype.getColumnSelectData = function () {
          ...
          return {
              ...
              toViewVisualColumn: cursorCommon_js_1.CursorColumns.visibleColumnFromColumn2(this.context.config, this.context.viewModel, primaryPos)
          };
      };
      ...
      Cursor.prototype.setSelections = function (source, selections) {
          this.setStates(source, 0 /* NotSet */, cursorCommon_js_1.CursorState.fromModelSelections(selections));
      };
      ...
      Cursor.prototype._revealRange = function (revealTarget, verticalType, revealHorizontal, scrollType) {
          ...
          var viewRange = new range_js_1.Range(viewPosition.lineNumber, viewPosition.column, viewPosition.lineNumber, viewPosition.column);
          this.emitCursorRevealRange(viewRange, verticalType, revealHorizontal, scrollType);
      };
      ...
      Cursor.prototype._interpretCompositionEnd = function (source) {
          if (!this._isDoingComposition && source === 'keyboard') {
              ...
              this._executeEditOperation(cursorTypeOperations_js_1.TypeOperations.compositionEndWithInterceptors(this._prevEditOperationType, this.context.config, this.context.model, this.getSelections()));
          }
      };
      Cursor.prototype._type = function (source, text) {
          if (!this._isDoingComposition && source === 'keyboard') {
              ...
              for (var i = 0, len = text.length; i < len; i++) {
                  ...
                  this._executeEditOperation(cursorTypeOperations_js_1.TypeOperations.typeWithInterceptors(this._prevEditOperationType, this.context.config, this.context.model, this.getSelections(), chr));
              }
          }
          else {
              this._executeEditOperation(cursorTypeOperations_js_1.TypeOperations.typeWithoutInterceptors(this._prevEditOperationType, this.context.config, this.context.model, this.getSelections(), text));
          }
      };
      Cursor.prototype._replacePreviousChar = function (text, replaceCharCnt) {
          this._executeEditOperation(cursorTypeOperations_js_1.TypeOperations.replacePreviousChar(this._prevEditOperationType, this.context.config, this.context.model, this.getSelections(), text, replaceCharCnt));
      };
      Cursor.prototype._paste = function (text, pasteOnNewLine, multicursorText) {
          this._executeEditOperation(cursorTypeOperations_js_1.TypeOperations.paste(this.context.config, this.context.model, this.getSelections(), text, pasteOnNewLine, multicursorText));
      };
      Cursor.prototype._cut = function () {
          this._executeEditOperation(cursorDeleteOperations_js_1.DeleteOperations.cut(this.context.config, this.context.model, this.getSelections()));
      };
      Cursor.prototype._externalExecuteCommand = function (command) {
          this._cursors.killSecondaryCursors();
          this._executeEditOperation(new cursorCommon_js_1.EditOperationResult(0 /* Other */, [command], {
              shouldPushStackElementBefore: false,
              shouldPushStackElementAfter: false
          }));
      };
      Cursor.prototype._externalExecuteCommands = function (commands) {
          this._executeEditOperation(new cursorCommon_js_1.EditOperationResult(0 /* Other */, commands, {
              shouldPushStackElementBefore: false,
              shouldPushStackElementAfter: false
          }));
      };
