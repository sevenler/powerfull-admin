define('node_modules/monaco-editor/esm/vs/editor/common/controller/cursorMoveCommands', function(require, exports, module) {
  ...
  var cursorMoveOperations_js_1 = require("node_modules/monaco-editor/esm/vs/editor/common/controller/cursorMoveOperations");
  ...
  var CursorMoveCommands = /** @class */ (function () {
      ...
      CursorMoveCommands.addCursorDown = function (context, cursors, useLogicalLine) {
          ...
          for (var i = 0, len = cursors.length; i < len; i++) {
              ...
              if (useLogicalLine) {
                  result[resultLen++] = cursorCommon_js_1.CursorState.fromModelState(cursorMoveOperations_js_1.MoveOperations.translateDown(context.config, context.model, cursor.modelState));
              }
              else {
                  result[resultLen++] = cursorCommon_js_1.CursorState.fromViewState(cursorMoveOperations_js_1.MoveOperations.translateDown(context.config, context.viewModel, cursor.viewState));
              }
          }
          return result;
      };
      CursorMoveCommands.addCursorUp = function (context, cursors, useLogicalLine) {
          ...
          for (var i = 0, len = cursors.length; i < len; i++) {
              ...
              result[resultLen++] = new cursorCommon_js_1.CursorState(cursor.modelState, cursor.viewState);
              if (useLogicalLine) {
                  result[resultLen++] = cursorCommon_js_1.CursorState.fromModelState(cursorMoveOperations_js_1.MoveOperations.translateUp(context.config, context.model, cursor.modelState));
              }
              else {
                  result[resultLen++] = cursorCommon_js_1.CursorState.fromViewState(cursorMoveOperations_js_1.MoveOperations.translateUp(context.config, context.viewModel, cursor.viewState));
              }
          }
          return result;
      };
      ...
      CursorMoveCommands._moveToLineStartByView = function (context, cursor, inSelectionMode) {
          return cursorCommon_js_1.CursorState.fromViewState(cursorMoveOperations_js_1.MoveOperations.moveToBeginningOfLine(context.config, context.viewModel, cursor.viewState, inSelectionMode));
      };
      CursorMoveCommands._moveToLineStartByModel = function (context, cursor, inSelectionMode) {
          return cursorCommon_js_1.CursorState.fromModelState(cursorMoveOperations_js_1.MoveOperations.moveToBeginningOfLine(context.config, context.model, cursor.modelState, inSelectionMode));
      };
      ...
      CursorMoveCommands._moveToLineEndByView = function (context, cursor, inSelectionMode) {
          return cursorCommon_js_1.CursorState.fromViewState(cursorMoveOperations_js_1.MoveOperations.moveToEndOfLine(context.config, context.viewModel, cursor.viewState, inSelectionMode));
      };
      CursorMoveCommands._moveToLineEndByModel = function (context, cursor, inSelectionMode) {
          return cursorCommon_js_1.CursorState.fromModelState(cursorMoveOperations_js_1.MoveOperations.moveToEndOfLine(context.config, context.model, cursor.modelState, inSelectionMode));
      };
      CursorMoveCommands.expandLineSelection = function (context, cursors) {
          ...
          for (var i = 0, len = cursors.length; i < len; i++) {
              ...
              result[i] = cursorCommon_js_1.CursorState.fromViewState(new cursorCommon_js_1.SingleCursorState(new range_js_1.Range(startLineNumber, 1, startLineNumber, 1), 0, new position_js_1.Position(endLineNumber, endColumn), 0));
          }
          return result;
      };
      CursorMoveCommands.moveToBeginningOfBuffer = function (context, cursors, inSelectionMode) {
          ...
          for (var i = 0, len = cursors.length; i < len; i++) {
              var cursor = cursors[i];
              result[i] = cursorCommon_js_1.CursorState.fromModelState(cursorMoveOperations_js_1.MoveOperations.moveToBeginningOfBuffer(context.config, context.model, cursor.modelState, inSelectionMode));
          }
          return result;
      };
      CursorMoveCommands.moveToEndOfBuffer = function (context, cursors, inSelectionMode) {
          ...
          for (var i = 0, len = cursors.length; i < len; i++) {
              var cursor = cursors[i];
              result[i] = cursorCommon_js_1.CursorState.fromModelState(cursorMoveOperations_js_1.MoveOperations.moveToEndOfBuffer(context.config, context.model, cursor.modelState, inSelectionMode));
          }
          return result;
      };
      CursorMoveCommands.selectAll = function (context, cursor) {
          ...
          return cursorCommon_js_1.CursorState.fromModelState(new cursorCommon_js_1.SingleCursorState(new range_js_1.Range(1, 1, 1, 1), 0, new position_js_1.Position(lineCount, maxColumn), 0));
      };
      CursorMoveCommands.line = function (context, cursor, inSelectionMode, _position, _viewPosition) {
          ...
          var viewPosition = (_viewPosition
              ? context.validateViewPosition(new position_js_1.Position(_viewPosition.lineNumber, _viewPosition.column), position)
          ...
          if (!inSelectionMode || !cursor.modelState.hasSelection()) {
              ...
              return cursorCommon_js_1.CursorState.fromModelState(new cursorCommon_js_1.SingleCursorState(new range_js_1.Range(position.lineNumber, 1, selectToLineNumber, selectToColumn), 0, new position_js_1.Position(selectToLineNumber, selectToColumn), 0));
          }
          // Continuing line selection
          var enteringLineNumber = cursor.modelState.selectionStart.getStartPosition().lineNumber;
          if (position.lineNumber < enteringLineNumber) {
              return cursorCommon_js_1.CursorState.fromViewState(cursor.viewState.move(cursor.modelState.hasSelection(), viewPosition.lineNumber, 1, 0));
          }
              ...
              return cursorCommon_js_1.CursorState.fromViewState(cursor.viewState.move(cursor.modelState.hasSelection(), selectToViewLineNumber, selectToViewColumn, 0));
          }
          else {
              var endPositionOfSelectionStart = cursor.modelState.selectionStart.getEndPosition();
              return cursorCommon_js_1.CursorState.fromModelState(cursor.modelState.move(cursor.modelState.hasSelection(), endPositionOfSelectionStart.lineNumber, endPositionOfSelectionStart.column, 0));
          }
      };
      CursorMoveCommands.word = function (context, cursor, inSelectionMode, _position) {
          var position = context.model.validatePosition(_position);
          return cursorCommon_js_1.CursorState.fromModelState(cursorWordOperations_js_1.WordOperations.word(context.config, context.model, cursor.modelState, inSelectionMode, position));
      };
      CursorMoveCommands.cancelSelection = function (context, cursor) {
          ...
          return cursorCommon_js_1.CursorState.fromViewState(new cursorCommon_js_1.SingleCursorState(new range_js_1.Range(lineNumber, column, lineNumber, column), 0, new position_js_1.Position(lineNumber, column), 0));
      };
      ...
      CursorMoveCommands._moveLeft = function (context, cursors, inSelectionMode, noOfColumns) {
          ...
          for (var i = 0, len = cursors.length; i < len; i++) {
              var cursor = cursors[i];
              var newViewState = cursorMoveOperations_js_1.MoveOperations.moveLeft(context.config, context.viewModel, cursor.viewState, inSelectionMode, noOfColumns);
              if (noOfColumns === 1 && newViewState.position.lineNumber !== cursor.viewState.position.lineNumber) {
                  ...
                  if (newViewModelPosition.lineNumber === cursor.modelState.position.lineNumber) {
                      ...
                      newViewState = cursorMoveOperations_js_1.MoveOperations.moveLeft(context.config, context.viewModel, newViewState, inSelectionMode, 1);
                  }
              }
              result[i] = cursorCommon_js_1.CursorState.fromViewState(newViewState);
          }
          return result;
      };
      CursorMoveCommands._moveHalfLineLeft = function (context, cursors, inSelectionMode) {
          ...
          for (var i = 0, len = cursors.length; i < len; i++) {
              ...
              result[i] = cursorCommon_js_1.CursorState.fromViewState(cursorMoveOperations_js_1.MoveOperations.moveLeft(context.config, context.viewModel, cursor.viewState, inSelectionMode, halfLine));
          }
          return result;
      };
      CursorMoveCommands._moveRight = function (context, cursors, inSelectionMode, noOfColumns) {
          ...
          for (var i = 0, len = cursors.length; i < len; i++) {
              var cursor = cursors[i];
              var newViewState = cursorMoveOperations_js_1.MoveOperations.moveRight(context.config, context.viewModel, cursor.viewState, inSelectionMode, noOfColumns);
              if (noOfColumns === 1 && newViewState.position.lineNumber !== cursor.viewState.position.lineNumber) {
                  // moved over to the next view line
                  var newViewModelPosition = context.viewModel.coordinatesConverter.convertViewPositionToModelPosition(newViewState.position);
                  if (newViewModelPosition.lineNumber === cursor.modelState.position.lineNumber) {
                      // stayed on the same model line => pass wrapping point where 2 view positions map to a single model position
                      newViewState = cursorMoveOperations_js_1.MoveOperations.moveRight(context.config, context.viewModel, newViewState, inSelectionMode, 1);
                  }
              }
              result[i] = cursorCommon_js_1.CursorState.fromViewState(newViewState);
          }
      ...
      CursorMoveCommands._moveHalfLineRight = function (context, cursors, inSelectionMode) {
          ...
          for (var i = 0, len = cursors.length; i < len; i++) {
              ...
              var viewLineNumber = cursor.viewState.position.lineNumber;
              var halfLine = Math.round(context.viewModel.getLineContent(viewLineNumber).length / 2);
              result[i] = cursorCommon_js_1.CursorState.fromViewState(cursorMoveOperations_js_1.MoveOperations.moveRight(context.config, context.viewModel, cursor.viewState, inSelectionMode, halfLine));
          }
          return result;
      };
      CursorMoveCommands._moveDownByViewLines = function (context, cursors, inSelectionMode, linesCount) {
          ...
          for (var i = 0, len = cursors.length; i < len; i++) {
              var cursor = cursors[i];
              result[i] = cursorCommon_js_1.CursorState.fromViewState(cursorMoveOperations_js_1.MoveOperations.moveDown(context.config, context.viewModel, cursor.viewState, inSelectionMode, linesCount));
          }
          return result;
      };
      CursorMoveCommands._moveDownByModelLines = function (context, cursors, inSelectionMode, linesCount) {
          ...
          for (var i = 0, len = cursors.length; i < len; i++) {
              var cursor = cursors[i];
              result[i] = cursorCommon_js_1.CursorState.fromModelState(cursorMoveOperations_js_1.MoveOperations.moveDown(context.config, context.model, cursor.modelState, inSelectionMode, linesCount));
          }
          return result;
      };
      CursorMoveCommands._moveUpByViewLines = function (context, cursors, inSelectionMode, linesCount) {
          ...
          for (var i = 0, len = cursors.length; i < len; i++) {
              var cursor = cursors[i];
              result[i] = cursorCommon_js_1.CursorState.fromViewState(cursorMoveOperations_js_1.MoveOperations.moveUp(context.config, context.viewModel, cursor.viewState, inSelectionMode, linesCount));
          }
          return result;
      };
      CursorMoveCommands._moveUpByModelLines = function (context, cursors, inSelectionMode, linesCount) {
          ...
          for (var i = 0, len = cursors.length; i < len; i++) {
              var cursor = cursors[i];
              result[i] = cursorCommon_js_1.CursorState.fromModelState(cursorMoveOperations_js_1.MoveOperations.moveUp(context.config, context.model, cursor.modelState, inSelectionMode, linesCount));
          }
          return result;
      };
  ...
  })(exports.CursorMove || (exports.CursorMove = {}));
