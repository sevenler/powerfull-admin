define('node_modules/monaco-editor/esm/vs/editor/common/controller/cursorCollection', function(require, exports, module) {
  ...
  var oneCursor_js_1 = require("node_modules/monaco-editor/esm/vs/editor/common/controller/oneCursor");
  ...
  var CursorCollection = /** @class */ (function () {
      function CursorCollection(context) {
          ...
          this.primaryCursor = new oneCursor_js_1.OneCursor(context);
      ...
      CursorCollection.prototype._addSecondaryCursor = function () {
          this.secondaryCursors.push(new oneCursor_js_1.OneCursor(this.context));
          ...
          for (var sortedCursorIndex = 0; sortedCursorIndex < sortedCursors.length - 1; sortedCursorIndex++) {
              ...
              if (shouldMergeCursors) {
                  ...
                  if (!looserSelection.equalsSelection(winnerSelection)) {
                      ...
                      var resultingState = cursorCommon_js_1.CursorState.fromModelSelection(resultingSelection);
