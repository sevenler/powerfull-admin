define('node_modules/monaco-editor/esm/vs/editor/common/controller/cursorMoveOperations', function(require, exports, module) {
  ...
  var MoveOperations = /** @class */ (function () {
      ...
      MoveOperations.left = function (config, model, lineNumber, column) {
          if (column > model.getLineMinColumn(lineNumber)) {
              if (cursorCommon_js_1.CursorColumns.isLowSurrogate(model, lineNumber, column - 2)) {
      ...
      MoveOperations.right = function (config, model, lineNumber, column) {
          if (column < model.getLineMaxColumn(lineNumber)) {
              if (cursorCommon_js_1.CursorColumns.isHighSurrogate(model, lineNumber, column - 1)) {
      ...
      MoveOperations.down = function (config, model, lineNumber, column, leftoverVisibleColumns, count, allowMoveOnLastLine) {
          var currentVisibleColumn = cursorCommon_js_1.CursorColumns.visibleColumnFromColumn(model.getLineContent(lineNumber), column, config.tabSize) + leftoverVisibleColumns;
          ...
          if (lineNumber > lineCount) {
              ...
              if (allowMoveOnLastLine) {
                  ...
                  if (cursorCommon_js_1.CursorColumns.isInsideSurrogatePair(model, lineNumber, column)) {
                      column = column - 1;
                  }
              }
          }
          else {
              column = cursorCommon_js_1.CursorColumns.columnFromVisibleColumn2(config, model, lineNumber, currentVisibleColumn);
              if (cursorCommon_js_1.CursorColumns.isInsideSurrogatePair(model, lineNumber, column)) {
                  column = column - 1;
              }
          }
          leftoverVisibleColumns = currentVisibleColumn - cursorCommon_js_1.CursorColumns.visibleColumnFromColumn(model.getLineContent(lineNumber), column, config.tabSize);
      ...
      MoveOperations.translateDown = function (config, model, cursor) {
          ...
          return new cursorCommon_js_1.SingleCursorState(new range_js_1.Range(selectionStart.lineNumber, selectionStart.column, selectionStart.lineNumber, selectionStart.column), selectionStart.leftoverVisibleColumns, new position_js_1.Position(position.lineNumber, position.column), position.leftoverVisibleColumns);
      };
