define('node_modules/monaco-editor/esm/vs/editor/common/view/minimapCharRenderer', function(require, exports, module) {
  ...
  var rgba_js_1 = require("node_modules/monaco-editor/esm/vs/editor/common/core/rgba");
  ...
  var MinimapTokensColorTracker = /** @class */ (function () {
      function MinimapTokensColorTracker() {
          ...
          modes_js_1.TokenizationRegistry.onDidChange(function (e) {
      ...
      MinimapTokensColorTracker.prototype._updateColorMap = function () {
          ...
          if (!colorMap) {
              this._colors = [rgba_js_1.RGBA8.Empty];
          ...
          for (var colorId = 1; colorId < colorMap.length; colorId++) {
              ...
              this._colors[colorId] = new rgba_js_1.RGBA8(source.r, source.g, source.b, Math.round(source.a * 255));
          }
