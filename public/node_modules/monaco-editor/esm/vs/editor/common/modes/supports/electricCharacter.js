define('node_modules/monaco-editor/esm/vs/editor/common/modes/supports/electricCharacter', function(require, exports, module) {
  ...
  var BracketElectricCharacterSupport = /** @class */ (function () {
      function BracketElectricCharacterSupport(richEditBrackets, autoClosePairs, contribution) {
          ...
          this._complexAutoClosePairs = autoClosePairs.filter(function (pair) { return pair.open.length > 1 && !!pair.close; }).map(function (el) { return new languageConfiguration_js_1.StandardAutoClosingPairConditional(el); });
          if (contribution.docComment) {
              // IDocComment is legacy, only partially supported
              this._complexAutoClosePairs.push(new languageConfiguration_js_1.StandardAutoClosingPairConditional({ open: contribution.docComment.open, close: contribution.docComment.close || '' }));
          }
      }
      ...
      BracketElectricCharacterSupport.prototype._onElectricAutoIndent = function (character, context, column) {
          ...
          if (supports_js_1.ignoreBracketsInToken(context.getStandardTokenType(tokenIndex))) {
              return null;
          }
          ...
          var r = richEditBrackets_js_1.BracketsUtils.findPrevBracketInToken(reversedBracketRegex, 1, text, 0, text.length);
          if (!r) {
              return null;
          }
