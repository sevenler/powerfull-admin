define('node_modules/monaco-editor/esm/vs/editor/common/modes/supports/characterPair', function(require, exports, module) {
  ...
  var CharacterPairSupport = /** @class */ (function () {
      function CharacterPairSupport(config) {
          if (config.autoClosingPairs) {
              this._autoClosingPairs = config.autoClosingPairs.map(function (el) { return new languageConfiguration_js_1.StandardAutoClosingPairConditional(el); });
          }
          else if (config.brackets) {
              this._autoClosingPairs = config.brackets.map(function (b) { return new languageConfiguration_js_1.StandardAutoClosingPairConditional({ open: b[0], close: b[1] }); });
          }
          else {
