define('node_modules/monaco-editor/esm/vs/editor/common/modes/languageFeatureRegistry', function(require, exports, module) {
  ...
  var languageSelector_js_1 = require("node_modules/monaco-editor/esm/vs/editor/common/modes/languageSelector");
  ...
  var LanguageFeatureRegistry = /** @class */ (function () {
      ...
      LanguageFeatureRegistry.prototype._updateScores = function (model) {
          ...
          for (var _i = 0, _a = this._entries; _i < _a.length; _i++) {
              var entry = _a[_i];
              entry._score = languageSelector_js_1.score(entry.selector, model.uri, model.getLanguageIdentifier().language, modelService_js_1.shouldSynchronizeModel(model));
