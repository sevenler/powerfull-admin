define('node_modules/monaco-editor/esm/vs/editor/common/modes/languageSelector', function(require, exports, module) {
  ...
  function score(selector, candidateUri, candidateLanguage, candidateIsSynchronized) {
      if (Array.isArray(selector)) {
          ...
          if (pattern) {
              if (pattern === candidateUri.fsPath || glob_js_1.match(pattern, candidateUri.fsPath)) {
                  ret = 10;
              }
              else {
                  return 0;
