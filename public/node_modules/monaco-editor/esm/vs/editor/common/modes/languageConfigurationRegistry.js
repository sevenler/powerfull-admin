define('node_modules/monaco-editor/esm/vs/editor/common/modes/languageConfigurationRegistry', function(require, exports, module) {
  ...
  var characterPair_js_1 = require("node_modules/monaco-editor/esm/vs/editor/common/modes/supports/characterPair");
  var electricCharacter_js_1 = require("node_modules/monaco-editor/esm/vs/editor/common/modes/supports/electricCharacter");
  var indentRules_js_1 = require("node_modules/monaco-editor/esm/vs/editor/common/modes/supports/indentRules");
  var onEnter_js_1 = require("node_modules/monaco-editor/esm/vs/editor/common/modes/supports/onEnter");
  ...
  var RichEditSupport = /** @class */ (function () {
      function RichEditSupport(languageIdentifier, previous, rawConf) {
          ...
          this.characterPair = new characterPair_js_1.CharacterPairSupport(this._conf);
          this.wordDefinition = this._conf.wordPattern || wordHelper_js_1.DEFAULT_WORD_REGEXP;
          this.indentationRules = this._conf.indentationRules;
          if (this._conf.indentationRules) {
              this.indentRulesSupport = new indentRules_js_1.IndentRulesSupport(this._conf.indentationRules);
          }
      ...
      Object.defineProperty(RichEditSupport.prototype, "brackets", {
          get: function () {
              if (!this._brackets && this._conf.brackets) {
                  this._brackets = new richEditBrackets_js_1.RichEditBrackets(this._languageIdentifier, this._conf.brackets);
              }
      ...
      Object.defineProperty(RichEditSupport.prototype, "electricCharacter", {
          get: function () {
              if (!this._electricCharacter) {
                  ...
                  this._electricCharacter = new electricCharacter_js_1.BracketElectricCharacterSupport(this.brackets, autoClosingPairs, this._conf.__electricCharacterSupport);
              }
      ...
      RichEditSupport._handleOnEnter = function (conf) {
          ...
          if (!empty) {
              return new onEnter_js_1.OnEnterSupport(onEnter);
          }
          return null;
      };
  ...
  var LanguageConfigurationRegistryImpl = /** @class */ (function () {
      ...
      LanguageConfigurationRegistryImpl.prototype.onElectricCharacter = function (character, context, column) {
          var scopedLineTokens = supports_js_1.createScopedLineTokens(context, column - 1);
      ...
      LanguageConfigurationRegistryImpl.prototype.getAutoCloseBeforeSet = function (languageId) {
          var characterPairSupport = this._getCharacterPairSupport(languageId);
          if (!characterPairSupport) {
              return characterPair_js_1.CharacterPairSupport.DEFAULT_AUTOCLOSE_BEFORE_LANGUAGE_DEFINED;
          }
      ...
      LanguageConfigurationRegistryImpl.prototype.getWordDefinition = function (languageId) {
          var value = this._getRichEditSupport(languageId);
          if (!value) {
              return wordHelper_js_1.ensureValidWordDefinition(null);
          }
          return wordHelper_js_1.ensureValidWordDefinition(value.wordDefinition || null);
      };
      ...
      LanguageConfigurationRegistryImpl.prototype.getIndentForEnter = function (model, range, indentConverter, autoIndent) {
          ...
          var beforeEnterText;
          var afterEnterText;
          var scopedLineTokens = supports_js_1.createScopedLineTokens(lineTokens, range.startColumn - 1);
          ...
          if (!autoIndent && !embeddedLanguage) {
              ...
              if (indentRulesSupport.shouldDecrease(beforeEnterText)) {
                  if (beforeEnterIndentAction) {
                      ...
                      if (beforeEnterIndentAction.action !== languageConfiguration_js_1.IndentAction.Indent) {
      ...
      LanguageConfigurationRegistryImpl.prototype.getRawEnterActionAtPosition = function (model, lineNumber, column) {
          var r = this.getEnterAction(model, new range_js_1.Range(lineNumber, column, lineNumber, column));
      ...
      LanguageConfigurationRegistryImpl.prototype.getScopedLineTokens = function (model, lineNumber, columnNumber) {
          ...
          var scopedLineTokens = supports_js_1.createScopedLineTokens(lineTokens, column);
