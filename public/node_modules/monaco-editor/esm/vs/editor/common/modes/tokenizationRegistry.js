define('node_modules/monaco-editor/esm/vs/editor/common/modes/tokenizationRegistry', function(require, exports, module) {
  ...
  var TokenizationRegistryImpl = /** @class */ (function () {
      ...
      TokenizationRegistryImpl.prototype.get = function (language) {
          return types_js_1.withUndefinedAsNull(this._map.get(language));
      };
      TokenizationRegistryImpl.prototype.setColorMap = function (colorMap) {
          this._colorMap = colorMap;
          this._onDidChange.fire({
              changedLanguages: map_js_1.keys(this._map),
