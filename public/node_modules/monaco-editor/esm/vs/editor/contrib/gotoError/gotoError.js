define('node_modules/monaco-editor/esm/vs/editor/contrib/gotoError/gotoError', function(require, exports, module) {
  ...
  var gotoErrorWidget_js_1 = require("node_modules/monaco-editor/esm/vs/editor/contrib/gotoError/gotoErrorWidget");
  ...
  var actions_js_2 = require("node_modules/monaco-editor/esm/vs/base/common/actions");
  ...
  var MarkerModel = /** @class */ (function () {
      function MarkerModel(editor, markers) {
          ...
          this._onCurrentMarkerChanged = new event_js_1.Emitter();
          this._onMarkerSetChanged = new event_js_1.Emitter();
          ...
          this._toUnbind.push(this._editor.onDidChangeCursorPosition(function () {
              ...
              if (_this.currentMarker && _this._editor.getPosition() && range_js_1.Range.containsPosition(_this.currentMarker, _this._editor.getPosition())) {
                  return;
              }
              _this._nextIdx = -1;
          }));
      ...
      MarkerModel.prototype.setMarkers = function (markers) {
          ...
          if (!oldMarker) {
              ...
              this._nextIdx = Math.max(-1, arrays_js_1.binarySearch(this._markers, oldMarker, MarkerNavigationAction.compareMarker));
          }
      ...
      MarkerModel.prototype._initIdx = function (fwd) {
          ...
          for (var i = 0; i < this._markers.length; i++) {
              var range = range_js_1.Range.lift(this._markers[i]);
              if (range.isEmpty() && this._editor.getModel()) {
                  var word = this._editor.getModel().getWordAtPosition(range.getStartPosition());
                  if (word) {
                      range = new range_js_1.Range(range.startLineNumber, word.startColumn, range.startLineNumber, word.endColumn);
                  }
              }
      ...
      MarkerModel.prototype.findMarkerAtPosition = function (pos) {
          for (var _i = 0, _a = this._markers; _i < _a.length; _i++) {
              var marker = _a[_i];
              if (range_js_1.Range.containsPosition(marker, pos)) {
                  return marker;
              }
          }
          return undefined;
      ...
      MarkerModel.prototype.dispose = function () {
          this._toUnbind = lifecycle_js_1.dispose(this._toUnbind);
      };
      return MarkerModel;
  }());
  var MarkerController = /** @class */ (function () {
      ...
      MarkerController.prototype._cleanUp = function () {
          ...
          this._disposeOnClose = lifecycle_js_1.dispose(this._disposeOnClose);
          this._widget = null;
          this._model = null;
      };
      MarkerController.prototype.getOrCreateModel = function () {
          ...
          var actions = [
              new actions_js_2.Action(PrevMarkerAction.ID, PrevMarkerAction.LABEL + (prevMarkerKeybinding ? " (" + prevMarkerKeybinding.getLabel() + ")" : ''), 'show-previous-problem chevron-up', this._model.canNavigate(), function () {
              ...
              new actions_js_2.Action(NextMarkerAction.ID, NextMarkerAction.LABEL + (nextMarkerKeybinding ? " (" + nextMarkerKeybinding.getLabel() + ")" : ''), 'show-next-problem chevron-down', this._model.canNavigate(), function () {
                  return __awaiter(_this, void 0, void 0, function () {
                      return __generator(this, function (_a) {
                          if (this._model) {
          ...
          this._widget = new gotoErrorWidget_js_1.MarkerNavigationWidget(this._editor, actions, this._themeService);
          ...
          this._disposeOnClose.push(this._widget.onDidSelectRelatedInformation(function (related) {
              _this._editorService.openCodeEditor({
                  ...
                  options: { pinned: true, revealIfOpened: true, selection: range_js_1.Range.lift(related).collapseToStart() }
              }, _this._editor).then(undefined, errors_js_1.onUnexpectedError);
      ...
      MarkerController.prototype._getMarkers = function () {
          ...
          return this._markerService.read({
              resource: model.uri,
              severities: markers_js_1.MarkerSeverity.Error | markers_js_1.MarkerSeverity.Warning | markers_js_1.MarkerSeverity.Info
          });
      };
  ...
  var MarkerNavigationAction = /** @class */ (function (_super) {
      ...
      MarkerNavigationAction.prototype.run = function (accessor, editor) {
          var _this = this;
          var markerService = accessor.get(markers_js_1.IMarkerService);
          ...
          var markers = markerService.read({ severities: markers_js_1.MarkerSeverity.Error | markers_js_1.MarkerSeverity.Warning | markers_js_1.MarkerSeverity.Info }).sort(MarkerNavigationAction.compareMarker);
          if (markers.length === 0) {
              return Promise.resolve(undefined);
          }
          ...
          var oldMarker = model.currentMarker || { resource: editorModel.uri, severity: markers_js_1.MarkerSeverity.Error, startLineNumber: 1, startColumn: 1, endLineNumber: 1, endColumn: 1 };
          var idx = arrays_js_1.binarySearch(markers, oldMarker, MarkerNavigationAction.compareMarker);
          if (idx < 0) {
              // find best match...
              idx = ~idx;
              idx %= markers.length;
      ...
      MarkerNavigationAction.compareMarker = function (a, b) {
          var res = strings_js_1.compare(a.resource.toString(), b.resource.toString());
          if (res === 0) {
              res = markers_js_1.MarkerSeverity.compare(a.severity, b.severity);
          }
          if (res === 0) {
              res = range_js_1.Range.compareRangesUsingStarts(a, b);
          }
          return res;
      };
  ...
  var NextMarkerAction = /** @class */ (function (_super) {
      ...
      function NextMarkerAction() {
          return _super.call(this, true, false, {
              ...
              kbOpts: { kbExpr: editorContextKeys_js_1.EditorContextKeys.editorTextFocus, primary: 512 /* Alt */ | 66 /* F8 */, weight: 100 /* EditorContrib */ }
          }) || this;
      }
  ...
  var PrevMarkerAction = /** @class */ (function (_super) {
      ...
      function PrevMarkerAction() {
          return _super.call(this, false, false, {
              ...
              precondition: editorContextKeys_js_1.EditorContextKeys.writable,
              kbOpts: { kbExpr: editorContextKeys_js_1.EditorContextKeys.editorTextFocus, primary: 1024 /* Shift */ | 512 /* Alt */ | 66 /* F8 */, weight: 100 /* EditorContrib */ }
          }) || this;
      }
  ...
  editorExtensions_js_1.registerEditorContribution(MarkerController);
  editorExtensions_js_1.registerEditorAction(NextMarkerAction);
  editorExtensions_js_1.registerEditorAction(PrevMarkerAction);
  editorExtensions_js_1.registerEditorAction(NextMarkerInFilesAction);
  editorExtensions_js_1.registerEditorAction(PrevMarkerInFilesAction);
  var CONTEXT_MARKERS_NAVIGATION_VISIBLE = new contextkey_js_1.RawContextKey('markersNavigationVisible', false);
  var MarkerCommand = editorExtensions_js_1.EditorCommand.bindToContribution(MarkerController.get);
  editorExtensions_js_1.registerEditorCommand(new MarkerCommand({
