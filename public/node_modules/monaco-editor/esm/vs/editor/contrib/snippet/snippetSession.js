define('node_modules/monaco-editor/esm/vs/editor/contrib/snippet/snippetSession', function(require, exports, module) {
  ...
  ''/*@require node_modules/monaco-editor/esm/vs/editor/contrib/snippet/snippetSession.css*/;
  ...
  var clipboardService_js_1 = require("node_modules/monaco-editor/esm/vs/platform/clipboard/common/clipboardService");
  ...
  var snippetVariables_js_1 = require("node_modules/monaco-editor/esm/vs/editor/contrib/snippet/snippetVariables");
  var themeService_js_1 = require("node_modules/monaco-editor/esm/vs/platform/theme/common/themeService");
  var colors = tslib_1.__importStar(require("node_modules/monaco-editor/esm/vs/platform/theme/common/colorRegistry"));
  ...
  var OneSnippet = /** @class */ (function () {
      function OneSnippet(editor, snippet, offset) {
          ...
          this._offset = offset;
          this._placeholderGroups = arrays_js_1.groupBy(snippet.placeholders, snippetParser_js_1.Placeholder.compareByIndex);
      ...
      OneSnippet.prototype._initDecorations = function () {
          ...
          this._editor.changeDecorations(function (accessor) {
              ...
              for (var _i = 0, _a = _this._snippet.placeholders; _i < _a.length; _i++) {
                  ...
                  var range = range_js_1.Range.fromPositions(model.getPositionAt(_this._offset + placeholderOffset), model.getPositionAt(_this._offset + placeholderOffset + placeholderLen));
          ...
          if (this._placeholderGroupsIdx >= 0) {
              ...
              for (var _i = 0, _a = this._placeholderGroups[this._placeholderGroupsIdx]; _i < _a.length; _i++) {
                  ...
                  if (placeholder.transform) {
                      ...
                      operations.push(editOperation_js_1.EditOperation.replaceMove(range, placeholder.transform.resolve(currentValue)));
                  }
              }
          ...
          this._editor.changeDecorations(function (accessor) {
              ...
              for (var _i = 0, _a = _this._placeholderGroups[_this._placeholderGroupsIdx]; _i < _a.length; _i++) {
                  ...
                  for (var _d = 0, _e = nested._snippet.placeholders; _d < _e.length; _d++) {
                      ...
                      var range = range_js_1.Range.fromPositions(model.getPositionAt(nested._offset + placeholderOffset), model.getPositionAt(nested._offset + placeholderOffset + placeholderLen));
              ...
              _this._placeholderGroups = arrays_js_1.groupBy(_this._snippet.placeholders, snippetParser_js_1.Placeholder.compareByIndex);
          });
      };
      OneSnippet._decor = {
          active: textModel_js_1.ModelDecorationOptions.register({ stickiness: 0 /* AlwaysGrowsWhenTypingAtEdges */, className: 'snippet-placeholder' }),
          inactive: textModel_js_1.ModelDecorationOptions.register({ stickiness: 1 /* NeverGrowsWhenTypingAtEdges */, className: 'snippet-placeholder' }),
          activeFinal: textModel_js_1.ModelDecorationOptions.register({ stickiness: 1 /* NeverGrowsWhenTypingAtEdges */, className: 'finish-snippet-placeholder' }),
          inactiveFinal: textModel_js_1.ModelDecorationOptions.register({ stickiness: 1 /* NeverGrowsWhenTypingAtEdges */, className: 'finish-snippet-placeholder' }),
      };
      return OneSnippet;
  }());
  ...
  var SnippetSession = /** @class */ (function () {
      ...
      SnippetSession.adjustWhitespace = function (model, position, snippet) {
          ...
          var lineLeadingWhitespace = strings_js_1.getLeadingWhitespace(line, 0, position.column - 1);
          snippet.walk(function (marker) {
              if (marker instanceof snippetParser_js_1.Text && !(marker.parent instanceof snippetParser_js_1.Choice)) {
                  ...
                  for (var i = 1; i < lines.length; i++) {
                      var templateLeadingWhitespace = strings_js_1.getLeadingWhitespace(lines[i]);
      ...
      SnippetSession.createEditsAndSnippets = function (editor, template, overwriteBefore, overwriteAfter, enforceFinalTabstop, adjustWhitespace) {
          ...
          var modelBasedVariableResolver = new snippetVariables_js_1.ModelBasedVariableResolver(model);
          var clipboardService = editor.invokeWithinContext(function (accessor) { return accessor.get(clipboardService_js_1.IClipboardService, instantiation_js_1.optional); });
          var workspaceService = editor.invokeWithinContext(function (accessor) { return accessor.get(workspace_js_1.IWorkspaceContextService, instantiation_js_1.optional); });
          var delta = 0;
          ...
          var indexedSelections = editor.getSelections()
              ...
              .sort(function (a, b) { return range_js_1.Range.compareRangesUsingStarts(a.selection, b.selection); });
          for (var _i = 0, indexedSelections_1 = indexedSelections; _i < indexedSelections_1.length; _i++) {
              ...
              var snippet = new snippetParser_js_1.SnippetParser().parse(template, true, enforceFinalTabstop);
              ...
              snippet.resolveVariables(new snippetVariables_js_1.CompositeSnippetVariableResolver([
                  ...
                  new snippetVariables_js_1.ClipboardBasedVariableResolver(clipboardService, idx, indexedSelections.length),
                  new snippetVariables_js_1.SelectionBasedVariableResolver(model, selection),
                  new snippetVariables_js_1.CommentBasedVariableResolver(model),
      ...
      SnippetSession.prototype.dispose = function () {
          lifecycle_js_1.dispose(this._snippets);
      };
      ...
      SnippetSession.prototype.insert = function () {
          ...
          var selections = model.pushEditOperations(this._editor.getSelections(), edits, function (undoEdits) {
              if (_this._snippets[0].hasPlaceholder) {
                  ...
                  return undoEdits.map(function (edit) { return selection_js_1.Selection.fromPositions(edit.range.getEndPosition()); });
              }
          });
