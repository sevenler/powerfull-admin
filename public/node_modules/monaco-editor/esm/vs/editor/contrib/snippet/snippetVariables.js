define('node_modules/monaco-editor/esm/vs/editor/contrib/snippet/snippetVariables', function(require, exports, module) {
  ...
  var workspaces_js_1 = require("node_modules/monaco-editor/esm/vs/platform/workspaces/common/workspaces");
      ...
      SelectionBasedVariableResolver.prototype.resolve = function (variable) {
          ...
          if (name === 'SELECTION' || name === 'TM_SELECTED_TEXT') {
              ...
              if (value && this._selection.startLineNumber !== this._selection.endLineNumber && variable.snippet) {
                  ...
                  var lineLeadingWhitespace = strings_js_1.getLeadingWhitespace(line, 0, this._selection.startColumn - 1);
                  ...
                  variable.snippet.walk(function (marker) {
                      ...
                      if (marker instanceof snippetParser_js_1.Text) {
                          varLeadingWhitespace_1 = strings_js_1.getLeadingWhitespace(marker.value.split(/\r\n|\r|\n/).pop());
                      }
                      return true;
                  });
                  var whitespaceCommonLength_1 = strings_js_1.commonPrefixLength(varLeadingWhitespace_1, lineLeadingWhitespace);
  ...
  var ModelBasedVariableResolver = /** @class */ (function () {
      ...
      ModelBasedVariableResolver.prototype.resolve = function (variable) {
          var name = variable.name;
          if (name === 'TM_FILENAME') {
              return path_js_1.basename(this._model.uri.fsPath);
          }
          else if (name === 'TM_FILENAME_BASE') {
              var name_1 = path_js_1.basename(this._model.uri.fsPath);
              ...
              var dir = path_js_1.dirname(this._model.uri.fsPath);
              return dir !== '.' ? dir : '';
          }
  ...
  var ClipboardBasedVariableResolver = /** @class */ (function () {
      ...
      ClipboardBasedVariableResolver.prototype.resolve = function (variable) {
          ...
          var lines = text.split(/\r\n|\n|\r/).filter(function (s) { return !strings_js_1.isFalsyOrWhitespace(s); });
  ...
  var CommentBasedVariableResolver = /** @class */ (function () {
      ...
      CommentBasedVariableResolver.prototype.resolve = function (variable) {
          ...
          var config = languageConfigurationRegistry_js_1.LanguageConfigurationRegistry.getComments(language.id);
          if (!config) {
              return undefined;
          }
  ...
  var TimeBasedVariableResolver = /** @class */ (function () {
      ...
      TimeBasedVariableResolver.prototype.resolve = function (variable) {
          ...
          if (name === 'CURRENT_YEAR') {
              ...
              return strings_js_1.pad((new Date().getMonth().valueOf() + 1), 2);
          }
          else if (name === 'CURRENT_DATE') {
              return strings_js_1.pad(new Date().getDate().valueOf(), 2);
          }
          else if (name === 'CURRENT_HOUR') {
              return strings_js_1.pad(new Date().getHours().valueOf(), 2);
          }
          else if (name === 'CURRENT_MINUTE') {
              return strings_js_1.pad(new Date().getMinutes().valueOf(), 2);
          }
          else if (name === 'CURRENT_SECOND') {
              return strings_js_1.pad(new Date().getSeconds().valueOf(), 2);
          }
  ...
  var WorkspaceBasedVariableResolver = /** @class */ (function () {
      ...
      WorkspaceBasedVariableResolver.prototype.resolve = function (variable) {
          ...
          var workspaceIdentifier = workspaces_js_1.toWorkspaceIdentifier(this._workspaceService.getWorkspace());
          if (!workspaceIdentifier) {
              return undefined;
          }
          if (workspaces_js_1.isSingleFolderWorkspaceIdentifier(workspaceIdentifier)) {
              return path_js_1.basename(workspaceIdentifier.path);
          }
          var filename = path_js_1.basename(workspaceIdentifier.configPath.path);
          if (strings_js_1.endsWith(filename, workspaces_js_1.WORKSPACE_EXTENSION)) {
              filename = filename.substr(0, filename.length - workspaces_js_1.WORKSPACE_EXTENSION.length - 1);
          }
          return filename;
      };
