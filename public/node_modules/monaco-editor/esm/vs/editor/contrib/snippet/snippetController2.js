define('node_modules/monaco-editor/esm/vs/editor/contrib/snippet/snippetController2', function(require, exports, module) {
  ...
  var snippetSession_js_1 = require("node_modules/monaco-editor/esm/vs/editor/contrib/snippet/snippetSession");
  var SnippetController2 = /** @class */ (function () {
      ...
      SnippetController2.prototype.dispose = function () {
          ...
          lifecycle_js_1.dispose(this._session);
      };
      ...
      SnippetController2.prototype._doInsert = function (template, overwriteBefore, overwriteAfter, undoStopBefore, undoStopAfter, adjustWhitespace) {
          ...
          this._snippetListener = lifecycle_js_1.dispose(this._snippetListener);
          if (undoStopBefore) {
              this._editor.getModel().pushStackElement();
          }
          if (!this._session) {
              this._modelVersionId = this._editor.getModel().getAlternativeVersionId();
              this._session = new snippetSession_js_1.SnippetSession(this._editor, template, overwriteBefore, overwriteAfter, adjustWhitespace);
      ...
      SnippetController2.prototype._handleChoice = function () {
          ...
          if (this._currentChoice !== choice) {
              ...
              this._editor.setSelections(this._editor.getSelections()
                  .map(function (s) { return selection_js_1.Selection.fromPositions(s.getStartPosition()); }));
              var first_1 = choice.options[0];
              suggest_js_1.showSimpleSuggestions(this._editor, choice.options.map(function (option, i) {
                  ...
                  return {
                      ...
                      sortText: strings_js_1.repeat('a', i + 1),
                      range: range_js_1.Range.fromPositions(_this._editor.getPosition(), _this._editor.getPosition().delta(0, first_1.value.length))
                  };
              }));
          }
      };
      ...
      SnippetController2.prototype.cancel = function (resetSelection) {
          ...
          this._hasPrevTabstop.reset();
          this._hasNextTabstop.reset();
          lifecycle_js_1.dispose(this._snippetListener);
          lifecycle_js_1.dispose(this._session);
      ...
      SnippetController2.InSnippetMode = new contextkey_js_1.RawContextKey('inSnippetMode', false);
      SnippetController2.HasNextTabstop = new contextkey_js_1.RawContextKey('hasNextTabstop', false);
      SnippetController2.HasPrevTabstop = new contextkey_js_1.RawContextKey('hasPrevTabstop', false);
  ...
  editorExtensions_js_1.registerEditorContribution(SnippetController2);
  var CommandCtor = editorExtensions_js_1.EditorCommand.bindToContribution(SnippetController2.get);
  editorExtensions_js_1.registerEditorCommand(new CommandCtor({
