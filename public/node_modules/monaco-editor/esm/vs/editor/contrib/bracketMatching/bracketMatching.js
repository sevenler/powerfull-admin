define('node_modules/monaco-editor/esm/vs/editor/contrib/bracketMatching/bracketMatching', function(require, exports, module) {
  ...
  ''/*@require node_modules/monaco-editor/esm/vs/editor/contrib/bracketMatching/bracketMatching.css*/;
  ...
  var overviewRulerBracketMatchForeground = colorRegistry_js_1.registerColor('editorOverviewRuler.bracketMatchForeground', { dark: '#A0A0A0', light: '#A0A0A0', hc: '#A0A0A0' }, nls.localize('overviewRulerBracketMatchForeground', 'Overview ruler marker color for matching brackets.'));
  ...
  var BracketMatchingController = /** @class */ (function (_super) {
      ...
      function BracketMatchingController(editor) {
          ...
          _this._decorations = [];
          _this._updateBracketsSoon = _this._register(new async_js_1.RunOnceScheduler(function () { return _this._updateBrackets(); }, 50));
      ...
      BracketMatchingController.prototype.jumpToBracket = function () {
          ...
          var newSelections = this._editor.getSelections().map(function (selection) {
              ...
              return new selection_js_1.Selection(position.lineNumber, position.column, position.lineNumber, position.column);
          });
      ...
      BracketMatchingController.prototype.selectToBracket = function () {
          ...
          this._editor.getSelections().forEach(function (selection) {
              ...
              if (openBracket && closeBracket) {
                  newSelections.push(new selection_js_1.Selection(openBracket.lineNumber, openBracket.column, closeBracket.lineNumber, closeBracket.column));
              }
          });
      ...
      BracketMatchingController.prototype._recomputeBrackets = function () {
          ...
          if (positions.length > 1) {
              positions.sort(position_js_1.Position.compare);
          }
      ...
      BracketMatchingController._DECORATION_OPTIONS = textModel_js_1.ModelDecorationOptions.register({
          stickiness: 1 /* NeverGrowsWhenTypingAtEdges */,
          className: 'bracket-match',
          overviewRuler: {
              color: themeService_js_1.themeColorFromId(overviewRulerBracketMatchForeground),
  ...
  editorExtensions_js_1.registerEditorContribution(BracketMatchingController);
  editorExtensions_js_1.registerEditorAction(SelectToBracketAction);
  editorExtensions_js_1.registerEditorAction(JumpToBracketAction);
  themeService_js_1.registerThemingParticipant(function (theme, collector) {
      var bracketMatchBackground = theme.getColor(editorColorRegistry_js_1.editorBracketMatchBackground);
      if (bracketMatchBackground) {
          collector.addRule(".monaco-editor .bracket-match { background-color: " + bracketMatchBackground + "; }");
      }
      var bracketMatchBorder = theme.getColor(editorColorRegistry_js_1.editorBracketMatchBorder);
