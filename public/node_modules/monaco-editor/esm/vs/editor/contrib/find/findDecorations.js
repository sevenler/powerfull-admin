define('node_modules/monaco-editor/esm/vs/editor/contrib/find/findDecorations', function(require, exports, module) {
  ...
  var FindDecorations = /** @class */ (function () {
      ...
      FindDecorations._CURRENT_FIND_MATCH_DECORATION = textModel_js_1.ModelDecorationOptions.register({
          stickiness: 1 /* NeverGrowsWhenTypingAtEdges */,
          zIndex: 13,
          className: 'currentFindMatch',
          showIfCollapsed: true,
          overviewRuler: {
              color: themeService_js_1.themeColorFromId(colorRegistry_js_1.overviewRulerFindMatchForeground),
              position: model_js_1.OverviewRulerLane.Center
          }
      });
      FindDecorations._FIND_MATCH_DECORATION = textModel_js_1.ModelDecorationOptions.register({
          stickiness: 1 /* NeverGrowsWhenTypingAtEdges */,
          className: 'findMatch',
          showIfCollapsed: true,
          overviewRuler: {
      ...
      FindDecorations._FIND_MATCH_NO_OVERVIEW_DECORATION = textModel_js_1.ModelDecorationOptions.register({
          stickiness: 1 /* NeverGrowsWhenTypingAtEdges */,
          className: 'findMatch',
          showIfCollapsed: true
      });
      FindDecorations._FIND_MATCH_ONLY_OVERVIEW_DECORATION = textModel_js_1.ModelDecorationOptions.register({
          stickiness: 1 /* NeverGrowsWhenTypingAtEdges */,
          overviewRuler: {
              color: themeService_js_1.themeColorFromId(colorRegistry_js_1.overviewRulerFindMatchForeground),
              position: model_js_1.OverviewRulerLane.Center
      ...
      FindDecorations._RANGE_HIGHLIGHT_DECORATION = textModel_js_1.ModelDecorationOptions.register({
          stickiness: 1 /* NeverGrowsWhenTypingAtEdges */,
          className: 'rangeHighlight',
          isWholeLine: true
      });
      FindDecorations._FIND_SCOPE_DECORATION = textModel_js_1.ModelDecorationOptions.register({
          className: 'findScope',
          isWholeLine: true
      });
