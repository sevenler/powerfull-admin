define('node_modules/monaco-editor/esm/vs/editor/contrib/find/findWidget', function(require, exports, module) {
  ...
  ''/*@require node_modules/monaco-editor/esm/vs/editor/contrib/find/findWidget.css*/;
  ...
  var contextScopedHistoryWidget_js_1 = require("node_modules/monaco-editor/esm/vs/platform/browser/contextScopedHistoryWidget");
  ...
  var NLS_MATCHES_COUNT_LIMIT_TITLE = nls.localize('title.matchesCountLimit', "Only the first {0} results are highlighted, but all find operations work on the entire text.", findModel_js_1.MATCHES_LIMIT);
  ...
  var FindWidget = /** @class */ (function (_super) {
      ...
      function FindWidget(codeEditor, controller, state, contextViewProvider, keybindingService, contextKeyService, themeService) {
          ...
          _this._updateHistoryDelayer = new async_js_1.Delayer(500);
          _this._register(lifecycle_js_1.toDisposable(function () { return _this._updateHistoryDelayer.cancel(); }));
          ...
          _this._findInputFocused = findModel_js_1.CONTEXT_FIND_INPUT_FOCUSED.bindTo(contextKeyService);
          ...
          _this._replaceInputFocused = findModel_js_1.CONTEXT_REPLACE_INPUT_FOCUSED.bindTo(contextKeyService);
      ...
      FindWidget.prototype._applyTheme = function (theme) {
          var inputStyles = {
              inputActiveOptionBorder: theme.getColor(colorRegistry_js_1.inputActiveOptionBorder),
              inputBackground: theme.getColor(colorRegistry_js_1.inputBackground),
              inputForeground: theme.getColor(colorRegistry_js_1.inputForeground),
              inputBorder: theme.getColor(colorRegistry_js_1.inputBorder),
              inputValidationInfoBackground: theme.getColor(colorRegistry_js_1.inputValidationInfoBackground),
              inputValidationInfoForeground: theme.getColor(colorRegistry_js_1.inputValidationInfoForeground),
              inputValidationInfoBorder: theme.getColor(colorRegistry_js_1.inputValidationInfoBorder),
              inputValidationWarningBackground: theme.getColor(colorRegistry_js_1.inputValidationWarningBackground),
              inputValidationWarningForeground: theme.getColor(colorRegistry_js_1.inputValidationWarningForeground),
              inputValidationWarningBorder: theme.getColor(colorRegistry_js_1.inputValidationWarningBorder),
              inputValidationErrorBackground: theme.getColor(colorRegistry_js_1.inputValidationErrorBackground),
              inputValidationErrorForeground: theme.getColor(colorRegistry_js_1.inputValidationErrorForeground),
              inputValidationErrorBorder: theme.getColor(colorRegistry_js_1.inputValidationErrorBorder),
          };
      ...
      FindWidget.prototype._onFindInputKeyDown = function (e) {
          if (e.equals(3 /* Enter */)) {
              this._codeEditor.getAction(findModel_js_1.FIND_IDS.NextMatchFindAction).run().then(undefined, errors_js_1.onUnexpectedError);
              e.preventDefault();
              return;
          }
          if (e.equals(1024 /* Shift */ | 3 /* Enter */)) {
              this._codeEditor.getAction(findModel_js_1.FIND_IDS.PreviousMatchFindAction).run().then(undefined, errors_js_1.onUnexpectedError);
              e.preventDefault();
              return;
          }
          if (e.equals(2 /* Tab */)) {
      ...
      FindWidget.prototype._buildFindPart = function () {
          ...
          this._prevBtn = this._register(new SimpleButton({
              ...
              className: 'previous',
              onTrigger: function () {
                  _this._codeEditor.getAction(findModel_js_1.FIND_IDS.PreviousMatchFindAction).run().then(undefined, errors_js_1.onUnexpectedError);
              }
          }));
          // Next button
          this._nextBtn = this._register(new SimpleButton({
              ...
              className: 'next',
              onTrigger: function () {
                  _this._codeEditor.getAction(findModel_js_1.FIND_IDS.NextMatchFindAction).run().then(undefined, errors_js_1.onUnexpectedError);
              }
          }));
      ...
      FindWidget.prototype._buildReplacePart = function () {
          ...
          this._replaceInputBox = this._register(new contextScopedHistoryWidget_js_1.ContextScopedHistoryInputBox(replaceInput, undefined, {
      ...
      FindWidget.prototype._buildSash = function () {
          var _this = this;
          this._resizeSash = new sash_js_1.Sash(this._domNode, this, { orientation: 0 /* VERTICAL */ });
          this._resized = false;
  ...
  themeService_js_1.registerThemingParticipant(function (theme, collector) {
      ...
      addBackgroundColorRule('.findMatch', theme.getColor(colorRegistry_js_1.editorFindMatchHighlight));
      addBackgroundColorRule('.currentFindMatch', theme.getColor(colorRegistry_js_1.editorFindMatch));
      addBackgroundColorRule('.findScope', theme.getColor(colorRegistry_js_1.editorFindRangeHighlight));
      ...
      var findMatchHighlightBorder = theme.getColor(colorRegistry_js_1.editorFindMatchHighlightBorder);
      ...
      var findMatchBorder = theme.getColor(colorRegistry_js_1.editorFindMatchBorder);
      if (findMatchBorder) {
          collector.addRule(".monaco-editor .currentFindMatch { border: 2px solid " + findMatchBorder + "; padding: 1px; box-sizing: border-box; }");
      }
      var findRangeHighlightBorder = theme.getColor(colorRegistry_js_1.editorFindRangeHighlightBorder);
      ...
      var error = theme.getColor(colorRegistry_js_1.errorForeground);
      if (error) {
          collector.addRule(".monaco-editor .find-widget.no-results .matchesCount { color: " + error + "; }");
      }
      var resizeBorderBackground = theme.getColor(colorRegistry_js_1.editorWidgetResizeBorder);
      if (resizeBorderBackground) {
          ...
          var border = theme.getColor(colorRegistry_js_1.editorWidgetBorder);
          if (border) {
              collector.addRule(".monaco-editor .find-widget .monaco-sash { background-color: " + border + "; width: 3px !important; margin-left: -4px;}");
          }
      }
      var inputActiveBorder = theme.getColor(colorRegistry_js_1.inputActiveOptionBorder);
