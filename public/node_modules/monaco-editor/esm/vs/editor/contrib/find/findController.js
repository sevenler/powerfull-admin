define('node_modules/monaco-editor/esm/vs/editor/contrib/find/findController', function(require, exports, module) {
  ...
  var findOptionsWidget_js_1 = require("node_modules/monaco-editor/esm/vs/editor/contrib/find/findOptionsWidget");
  var findState_js_1 = require("node_modules/monaco-editor/esm/vs/editor/contrib/find/findState");
  var findWidget_js_1 = require("node_modules/monaco-editor/esm/vs/editor/contrib/find/findWidget");
  ...
  var CommonFindController = /** @class */ (function (_super) {
      ...
      function CommonFindController(editor, contextKeyService, storageService, clipboardService) {
          ...
          _this._findWidgetVisible = findModel_js_1.CONTEXT_FIND_WIDGET_VISIBLE.bindTo(contextKeyService);
          ...
          _this._state = _this._register(new findState_js_1.FindReplaceState());
  ...
  var FindController = /** @class */ (function (_super) {
      ...
      FindController.prototype._createFindWidget = function () {
          this._widget = this._register(new findWidget_js_1.FindWidget(this._editor, this, this._state, this._contextViewService, this._keybindingService, this._contextKeyService, this._themeService));
          this._findOptionsWidget = this._register(new findOptionsWidget_js_1.FindOptionsWidget(this._editor, this._state, this._keybindingService, this._themeService));
      };
      FindController = __decorate([
          ...
          __param(5, storage_js_1.IStorageService),
          __param(6, instantiation_js_1.optional(clipboardService_js_1.IClipboardService))
      ], FindController);
  ...
  editorExtensions_js_1.registerEditorContribution(FindController);
  editorExtensions_js_1.registerEditorAction(StartFindAction);
  editorExtensions_js_1.registerEditorAction(StartFindWithSelectionAction);
  editorExtensions_js_1.registerEditorAction(NextMatchFindAction);
  editorExtensions_js_1.registerEditorAction(PreviousMatchFindAction);
  editorExtensions_js_1.registerEditorAction(NextSelectionMatchFindAction);
  editorExtensions_js_1.registerEditorAction(PreviousSelectionMatchFindAction);
  editorExtensions_js_1.registerEditorAction(StartFindReplaceAction);
  var FindCommand = editorExtensions_js_1.EditorCommand.bindToContribution(CommonFindController.get);
  editorExtensions_js_1.registerEditorCommand(new FindCommand({
