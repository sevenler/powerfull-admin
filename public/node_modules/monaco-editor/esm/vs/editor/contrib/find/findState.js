define('node_modules/monaco-editor/esm/vs/editor/contrib/find/findState', function(require, exports, module) {
  ...
  var FindReplaceState = /** @class */ (function () {
      function FindReplaceState() {
          ...
          this._onFindReplaceStateChange = new event_js_1.Emitter();
      }
      ...
      FindReplaceState.prototype.change = function (newState, moveCursor, updateHistory) {
          ...
          if (typeof newState.searchScope !== 'undefined') {
              if (!range_js_1.Range.equalsRange(this._searchScope, newState.searchScope)) {
