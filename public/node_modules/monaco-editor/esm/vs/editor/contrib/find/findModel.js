define('node_modules/monaco-editor/esm/vs/editor/contrib/find/findModel', function(require, exports, module) {
  ...
  var findDecorations_js_1 = require("node_modules/monaco-editor/esm/vs/editor/contrib/find/findDecorations");
  var replaceAllCommand_js_1 = require("node_modules/monaco-editor/esm/vs/editor/contrib/find/replaceAllCommand");
  var replacePattern_js_1 = require("node_modules/monaco-editor/esm/vs/editor/contrib/find/replacePattern");
  ...
  var FindModelBoundToEditorModel = /** @class */ (function () {
      function FindModelBoundToEditorModel(editor, state) {
          ...
          this._updateDecorationsScheduler = new async_js_1.RunOnceScheduler(function () { return _this.research(false); }, 100);
      ...
      FindModelBoundToEditorModel.prototype.dispose = function () {
          ...
          lifecycle_js_1.dispose(this._startSearchingTimer);
          ...
          if (findScope !== null) {
              if (findScope.startLineNumber !== findScope.endLineNumber) {
                  if (findScope.endColumn === 1) {
                      findScope = new range_js_1.Range(findScope.startLineNumber, 1, findScope.endLineNumber - 1, this._editor.getModel().getLineMaxColumn(findScope.endLineNumber - 1));
                  }
                  else {
                      // multiline find scope => expand to line starts / ends
                      findScope = new range_js_1.Range(findScope.startLineNumber, 1, findScope.endLineNumber, this._editor.getModel().getLineMaxColumn(findScope.endLineNumber));
                  }
              }
          }
      ...
      FindModelBoundToEditorModel.prototype._moveToPrevMatch = function (before, isRecursed) {
          ...
          var lineNumber = before.lineNumber, column = before.column;
          var model = this._editor.getModel();
          var position = new position_js_1.Position(lineNumber, column);
      ...
      FindModelBoundToEditorModel.prototype._getReplacePattern = function () {
          if (this._state.isRegex) {
              return replacePattern_js_1.parseReplaceString(this._state.replaceString);
          }
      ...
      FindModelBoundToEditorModel.prototype.replace = function () {
          ...
          if (nextMatch) {
              if (selection.equalsRange(nextMatch.range)) {
                  ...
                  var command = new replaceCommand_js_1.ReplaceCommand(selection, replaceString);
      ...
      FindModelBoundToEditorModel.prototype._largeReplaceAll = function () {
          var searchParams = new textModelSearch_js_1.SearchParams(this._state.searchString, this._state.isRegex, this._state.matchCase, this._state.wholeWord ? this._editor.getConfiguration().wordSeparators : null);
          ...
          var command = new replaceCommand_js_1.ReplaceCommandThatPreservesSelection(fullModelRange, resultText, this._editor.getSelection());
      ...
      FindModelBoundToEditorModel.prototype._regularReplaceAll = function (findScope) {
          ...
          var command = new replaceAllCommand_js_1.ReplaceAllCommand(this._editor.getSelection(), matches.map(function (m) { return m.range; }), replaceStrings);
          this._executeEditorCommand('replaceAll', command);
      };
      FindModelBoundToEditorModel.prototype.selectAllMatches = function () {
          ...
          var selections = matches.map(function (m) { return new selection_js_1.Selection(m.range.startLineNumber, m.range.startColumn, m.range.endLineNumber, m.range.endColumn); });
