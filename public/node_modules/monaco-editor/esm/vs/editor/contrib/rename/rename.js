define('node_modules/monaco-editor/esm/vs/editor/contrib/rename/rename', function(require, exports, module) {
  ...
  var renameInputField_js_1 = require("node_modules/monaco-editor/esm/vs/editor/contrib/rename/renameInputField");
  ...
  var RenameSkeleton = /** @class */ (function () {
      function RenameSkeleton(model, position) {
          ...
          this._providers = modes_js_1.RenameProviderRegistry.ordered(model);
      }
                  ...
                  switch (_a.label) {
                      ...
                      case 2:
                          if (!res) {
                              ...
                              if (word) {
                                  return [2 /*return*/, {
                                          range: new range_js_1.Range(this.position.lineNumber, word.startColumn, this.position.lineNumber, word.endColumn),
                                          text: word.word
                                      }];
                              }
                          }
  ...
  function rename(model, position, newName) {
      return __awaiter(this, void 0, void 0, function () {
          return __generator(this, function (_a) {
              return [2 /*return*/, new RenameSkeleton(model, position).provideRenameEdits(newName, 0, [], cancellation_js_1.CancellationToken.None)];
          });
      });
  }
      ...
      Object.defineProperty(RenameController.prototype, "renameInputField", {
          get: function () {
              if (!this._renameInputField) {
                  this._renameInputField = this._register(new renameInputField_js_1.RenameInputField(this.editor, this._themeService, this._contextKeyService));
              }
      ...
      RenameController.prototype.run = function () {
          return __awaiter(this, void 0, void 0, function () {
              ...
              return __generator(this, function (_a) {
                  ...
                  this._activeRename = {
                      id: id,
                      operation: async_js_1.createCancelablePromise(function (token) { return _this.doRename(token, id); })
                  };
          ...
          return __awaiter(this, void 0, void 0, function () {
              ...
              return __generator(this, function (_a) {
                  switch (_a.label) {
                      ...
                      case 3:
                          e_1 = _a.sent();
                          messageController_js_1.MessageController.get(this.editor).showMessage(e_1 || nls.localize('resolveRenameLocationFailed', "An unknown error occurred while resolving rename location"), position);
                          return [2 /*return*/, undefined];
                      case 4:
                          if (!loc) {
                              return [2 /*return*/, undefined];
                          ...
                          if (loc.rejectReason) {
                              messageController_js_1.MessageController.get(this.editor).showMessage(loc.rejectReason, position);
                              return [2 /*return*/, undefined];
                          }
                          ...
                          if (!range_js_1.Range.isEmpty(selection) && !range_js_1.Range.spansMultipleLines(selection) && range_js_1.Range.containsRange(loc.range, selection)) {
                          ...
                          return [2 /*return*/, this.renameInputField.getInput(loc.range, loc.text, selectionStart, selectionEnd).then(function (newNameOrFocusFlag) {
                                  ...
                                  _this.editor.focus();
                                  var state = new editorState_js_1.EditorState(_this.editor, 4 /* Position */ | 1 /* Value */ | 2 /* Selection */ | 8 /* Scroll */);
                                  var renameOperation = Promise.resolve(skeleton.provideRenameEdits(newNameOrFocusFlag, 0, [], token).then(function (result) {
                                      ...
                                      if (result.rejectReason) {
                                          if (state.validate(_this.editor)) {
                                              messageController_js_1.MessageController.get(_this.editor).showMessage(result.rejectReason, _this.editor.getPosition());
                                          }
                                          else {
                                      ...
                                      return _this._bulkEditService.apply(result, { editor: _this.editor }).then(function (result) {
                                          ...
                                          if (result.ariaSummary) {
                                              aria_js_1.alert(nls.localize('aria', "Successfully renamed '{0}' to '{1}'. Summary: {2}", loc.text, newNameOrFocusFlag, result.ariaSummary));
                                          }
                                      });
                                  }, function (err) {
  ...
  var RenameAction = /** @class */ (function (_super) {
      ...
      function RenameAction() {
          return _super.call(this, {
              ...
              alias: 'Rename Symbol',
              precondition: contextkey_js_1.ContextKeyExpr.and(editorContextKeys_js_1.EditorContextKeys.writable, editorContextKeys_js_1.EditorContextKeys.hasRenameProvider),
              kbOpts: {
      ...
      RenameAction.prototype.runCommand = function (accessor, args) {
          ...
          if (uri_js_1.URI.isUri(uri) && position_js_1.Position.isIPosition(pos)) {
  ...
  editorExtensions_js_1.registerEditorContribution(RenameController);
  editorExtensions_js_1.registerEditorAction(RenameAction);
  var RenameCommand = editorExtensions_js_1.EditorCommand.bindToContribution(RenameController.get);
  editorExtensions_js_1.registerEditorCommand(new RenameCommand({
      id: 'acceptRenameInput',
      precondition: renameInputField_js_1.CONTEXT_RENAME_INPUT_VISIBLE,
  ...
  // ---- api bridge command
  editorExtensions_js_1.registerDefaultLanguageCommand('_executeDocumentRenameProvider', function (model, position, args) {
      var newName = args.newName;
      if (typeof newName !== 'string') {
          throw errors_js_1.illegalArgument('newName');
      }
