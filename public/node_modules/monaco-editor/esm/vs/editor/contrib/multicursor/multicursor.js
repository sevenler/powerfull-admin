define('node_modules/monaco-editor/esm/vs/editor/contrib/multicursor/multicursor', function(require, exports, module) {
  ...
  var findController_js_1 = require("node_modules/monaco-editor/esm/vs/editor/contrib/find/findController");
  ...
  var InsertCursorAbove = /** @class */ (function (_super) {
      ...
      InsertCursorAbove.prototype.run = function (accessor, editor, args) {
          ...
          cursors.setStates(args.source, 3 /* Explicit */, cursorMoveCommands_js_1.CursorMoveCommands.addCursorUp(context, cursors.getAll(), useLogicalLine));
  ...
  var InsertCursorBelow = /** @class */ (function (_super) {
      ...
      InsertCursorBelow.prototype.run = function (accessor, editor, args) {
          ...
          context.model.pushStackElement();
          cursors.setStates(args.source, 3 /* Explicit */, cursorMoveCommands_js_1.CursorMoveCommands.addCursorDown(context, cursors.getAll(), useLogicalLine));
  ...
  var MultiCursorSelectionController = /** @class */ (function (_super) {
      ...
      MultiCursorSelectionController.prototype._endSession = function () {
          this._sessionDispose = lifecycle_js_1.dispose(this._sessionDispose);
      ...
      MultiCursorSelectionController.prototype.selectAll = function (findController) {
          ...
          if (matches.length > 0) {
              ...
              this._setSelections(matches.map(function (m) { return new selection_js_1.Selection(m.range.startLineNumber, m.range.startColumn, m.range.endLineNumber, m.range.endColumn); }));
          }
      };
  ...
  var MultiCursorSelectionControllerAction = /** @class */ (function (_super) {
      ...
      MultiCursorSelectionControllerAction.prototype.run = function (accessor, editor) {
          ...
          var findController = findController_js_1.CommonFindController.get(editor);
          if (!findController) {
              return;
          }
  ...
  var MoveSelectionToNextFindMatchAction = /** @class */ (function (_super) {
      ...
      function MoveSelectionToNextFindMatchAction() {
          return _super.call(this, {
              ...
              kbOpts: {
                  kbExpr: editorContextKeys_js_1.EditorContextKeys.focus,
                  primary: keyCodes_js_1.KeyChord(2048 /* CtrlCmd */ | 41 /* KEY_K */, 2048 /* CtrlCmd */ | 34 /* KEY_D */),
                  weight: 100 /* EditorContrib */
              }
          }) || this;
      }
  ...
  var SelectionHighlighter = /** @class */ (function (_super) {
      ...
      function SelectionHighlighter(editor) {
          ...
          _this.decorations = [];
          _this.updateSoon = _this._register(new async_js_1.RunOnceScheduler(function () { return _this._update(); }, 300));
          _this.state = null;
          ...
          _this._register(findController_js_1.CommonFindController.get(editor).getState().onFindReplaceStateChange(function (e) {
              _this._update();
          }));
          return _this;
      }
      ...
      SelectionHighlighter.prototype._setState = function (state) {
          ...
          var hasFindOccurrences = modes_js_1.DocumentHighlightProviderRegistry.has(model);
          ...
          allMatches.sort(range_js_1.Range.compareRangesUsingStarts);
          ...
          for (var i = 0, j = 0, len = allMatches.length, lenJ = selections.length; i < len;) {
              ...
              if (j >= lenJ) {
                  ...
                  var cmp = range_js_1.Range.compareRangesUsingStarts(match, selections[j]);
                  if (cmp < 0) {
                      // match is before sel
      ...
      SelectionHighlighter._SELECTION_HIGHLIGHT_OVERVIEW = textModel_js_1.ModelDecorationOptions.register({
      ...
      SelectionHighlighter._SELECTION_HIGHLIGHT = textModel_js_1.ModelDecorationOptions.register({
          stickiness: 1 /* NeverGrowsWhenTypingAtEdges */,
          className: 'selectionHighlight',
      });
  ...
  editorExtensions_js_1.registerEditorContribution(MultiCursorSelectionController);
  editorExtensions_js_1.registerEditorContribution(SelectionHighlighter);
  editorExtensions_js_1.registerEditorAction(InsertCursorAbove);
  editorExtensions_js_1.registerEditorAction(InsertCursorBelow);
  editorExtensions_js_1.registerEditorAction(InsertCursorAtEndOfEachLineSelected);
  editorExtensions_js_1.registerEditorAction(AddSelectionToNextFindMatchAction);
  editorExtensions_js_1.registerEditorAction(AddSelectionToPreviousFindMatchAction);
  editorExtensions_js_1.registerEditorAction(MoveSelectionToNextFindMatchAction);
  editorExtensions_js_1.registerEditorAction(MoveSelectionToPreviousFindMatchAction);
  editorExtensions_js_1.registerEditorAction(SelectHighlightsAction);
  editorExtensions_js_1.registerEditorAction(CompatChangeAll);
  editorExtensions_js_1.registerEditorAction(InsertCursorAtEndOfLineSelected);
  editorExtensions_js_1.registerEditorAction(InsertCursorAtTopOfLineSelected);
