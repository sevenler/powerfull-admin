define('node_modules/monaco-editor/esm/vs/editor/contrib/parameterHints/parameterHintsModel', function(require, exports, module) {
  ...
  var ParameterHintsModel = /** @class */ (function (_super) {
      ...
      function ParameterHintsModel(editor, delay) {
          ...
          _this._onChangedHints = _this._register(new event_js_1.Emitter());
          _this.onChangedHints = _this._onChangedHints.event;
          _this._state = ParameterHintState.Default;
          _this.triggerChars = new characterClassifier_js_1.CharacterSet();
          _this.retriggerChars = new characterClassifier_js_1.CharacterSet();
          _this.triggerId = 0;
          _this.editor = editor;
          _this.enabled = false;
          _this.throttledDelayer = new async_js_1.Delayer(delay);
      ...
      ParameterHintsModel.prototype.trigger = function (context, delay) {
          ...
          }, delay).then(undefined, errors_js_1.onUnexpectedError);
      };
      ...
      ParameterHintsModel.prototype.doTrigger = function (triggerContext, triggerId) {
          ...
          this.state = new ParameterHintState.Pending(async_js_1.createCancelablePromise(function (token) {
              return provideSignatureHelp_js_1.provideSignatureHelp(model, position, triggerContext, token);
          }));
