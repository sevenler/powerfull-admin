define('node_modules/monaco-editor/esm/vs/editor/contrib/parameterHints/parameterHints', function(require, exports, module) {
  ...
  var parameterHintsWidget_js_1 = require("node_modules/monaco-editor/esm/vs/editor/contrib/parameterHints/parameterHintsWidget");
  ...
  var ParameterHintsController = /** @class */ (function () {
      function ParameterHintsController(editor, instantiationService) {
          this.editor = editor;
          this.widget = instantiationService.createInstance(parameterHintsWidget_js_1.ParameterHintsWidget, this.editor);
      }
      ...
      ParameterHintsController.prototype.dispose = function () {
          lifecycle_js_1.dispose(this.widget);
      };
  ...
  var TriggerParameterHintsAction = /** @class */ (function (_super) {
      ...
      function TriggerParameterHintsAction() {
          return _super.call(this, {
              ...
              precondition: editorContextKeys_js_1.EditorContextKeys.hasSignatureHelpProvider,
              kbOpts: {
  ...
  editorExtensions_js_1.registerEditorContribution(ParameterHintsController);
  editorExtensions_js_1.registerEditorAction(TriggerParameterHintsAction);
  var weight = 100 /* EditorContrib */ + 75;
  var ParameterHintsCommand = editorExtensions_js_1.EditorCommand.bindToContribution(ParameterHintsController.get);
  editorExtensions_js_1.registerEditorCommand(new ParameterHintsCommand({
      id: 'closeParameterHints',
      precondition: provideSignatureHelp_js_1.Context.Visible,
  ...
  editorExtensions_js_1.registerEditorCommand(new ParameterHintsCommand({
      ...
      precondition: contextkey_js_1.ContextKeyExpr.and(provideSignatureHelp_js_1.Context.Visible, provideSignatureHelp_js_1.Context.MultipleSignatures),
