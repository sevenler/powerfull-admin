define('node_modules/monaco-editor/esm/vs/editor/contrib/wordHighlighter/wordHighlighter', function(require, exports, module) {
  ...
  var arrays = tslib_1.__importStar(require("node_modules/monaco-editor/esm/vs/base/common/arrays"));
  ...
  exports.editorWordHighlight = colorRegistry_js_1.registerColor('editor.wordHighlightBackground', { dark: '#575757B8', light: '#57575740', hc: null }, nls.localize('wordHighlight', 'Background color of a symbol during read-access, like reading a variable. The color must not be opaque so as not to hide underlying decorations.'), true);
  exports.editorWordHighlightStrong = colorRegistry_js_1.registerColor('editor.wordHighlightStrongBackground', { dark: '#004972B8', light: '#0e639c40', hc: null }, nls.localize('wordHighlightStrong', 'Background color of a symbol during write-access, like writing to a variable. The color must not be opaque so as not to hide underlying decorations.'), true);
  exports.editorWordHighlightBorder = colorRegistry_js_1.registerColor('editor.wordHighlightBorder', { light: null, dark: null, hc: colorRegistry_js_1.activeContrastBorder }, nls.localize('wordHighlightBorder', 'Border color of a symbol during read-access, like reading a variable.'));
  exports.editorWordHighlightStrongBorder = colorRegistry_js_1.registerColor('editor.wordHighlightStrongBorder', { light: null, dark: null, hc: colorRegistry_js_1.activeContrastBorder }, nls.localize('wordHighlightStrongBorder', 'Border color of a symbol during write-access, like writing to a variable.'));
  exports.overviewRulerWordHighlightForeground = colorRegistry_js_1.registerColor('editorOverviewRuler.wordHighlightForeground', { dark: '#A0A0A0CC', light: '#A0A0A0CC', hc: '#A0A0A0CC' }, nls.localize('overviewRulerWordHighlightForeground', 'Overview ruler marker color for symbol highlights. The color must not be opaque so as not to hide underlying decorations.'), true);
  exports.overviewRulerWordHighlightStrongForeground = colorRegistry_js_1.registerColor('editorOverviewRuler.wordHighlightStrongForeground', { dark: '#C0A0C0CC', light: '#C0A0C0CC', hc: '#C0A0C0CC' }, nls.localize('overviewRulerWordHighlightStrongForeground', 'Overview ruler marker color for write-access symbol highlights. The color must not be opaque so as not to hide underlying decorations.'), true);
  exports.ctxHasWordHighlights = new contextkey_js_1.RawContextKey('hasWordHighlights', false);
  function getOccurrencesAtPosition(model, position, token) {
      var orderedByScore = modes_js_1.DocumentHighlightProviderRegistry.ordered(model);
      // in order of score ask the occurrences provider
      // until someone response with a good result
      // (good = none empty array)
      return async_js_1.first(orderedByScore.map(function (provider) {
          return function () {
  ...
  var OccurenceAtPositionRequest = /** @class */ (function () {
      function OccurenceAtPositionRequest(model, selection, wordSeparators) {
          ...
          this.result = async_js_1.createCancelablePromise(function (token) { return _this._compute(model, selection, wordSeparators, token); });
      }
  ...
  var TextualOccurenceAtPositionRequest = /** @class */ (function (_super) {
      ...
      TextualOccurenceAtPositionRequest.prototype._compute = function (model, selection, wordSeparators, token) {
          return async_js_1.timeout(250, token).then(function () {
              ...
              return matches.map(function (m) {
                  return {
                      range: m.range,
                      kind: modes_js_1.DocumentHighlightKind.Text
                  };
              });
          });
      };
  ...
  function computeOccurencesAtPosition(model, selection, wordSeparators) {
      if (modes_js_1.DocumentHighlightProviderRegistry.has(model)) {
          return new SemanticOccurenceAtPositionRequest(model, selection, wordSeparators);
      }
      return new TextualOccurenceAtPositionRequest(model, selection, wordSeparators);
  }
  editorExtensions_js_1.registerDefaultLanguageCommand('_executeDocumentHighlights', function (model, position) { return getOccurrencesAtPosition(model, position, cancellation_js_1.CancellationToken.None); });
  var WordHighlighter = /** @class */ (function () {
      ...
      WordHighlighter._getDecorationOptions = function (kind) {
          if (kind === modes_js_1.DocumentHighlightKind.Write) {
              return this._WRITE_OPTIONS;
          }
          else if (kind === modes_js_1.DocumentHighlightKind.Text) {
      ...
      WordHighlighter._WRITE_OPTIONS = textModel_js_1.ModelDecorationOptions.register({
          stickiness: 1 /* NeverGrowsWhenTypingAtEdges */,
          className: 'wordHighlightStrong',
          overviewRuler: {
              color: themeService_js_1.themeColorFromId(exports.overviewRulerWordHighlightStrongForeground),
              position: model_js_1.OverviewRulerLane.Center
          }
      });
      WordHighlighter._TEXT_OPTIONS = textModel_js_1.ModelDecorationOptions.register({
          stickiness: 1 /* NeverGrowsWhenTypingAtEdges */,
          className: 'selectionHighlight',
          overviewRuler: {
              color: themeService_js_1.themeColorFromId(colorRegistry_js_1.overviewRulerSelectionHighlightForeground),
              position: model_js_1.OverviewRulerLane.Center
          }
      });
      WordHighlighter._REGULAR_OPTIONS = textModel_js_1.ModelDecorationOptions.register({
          stickiness: 1 /* NeverGrowsWhenTypingAtEdges */,
          className: 'wordHighlight',
          overviewRuler: {
              color: themeService_js_1.themeColorFromId(exports.overviewRulerWordHighlightForeground),
              position: model_js_1.OverviewRulerLane.Center
          }
      });
  ...
  editorExtensions_js_1.registerEditorContribution(WordHighlighterContribution);
  editorExtensions_js_1.registerEditorAction(NextWordHighlightAction);
  editorExtensions_js_1.registerEditorAction(PrevWordHighlightAction);
  editorExtensions_js_1.registerEditorAction(TriggerWordHighlightAction);
  themeService_js_1.registerThemingParticipant(function (theme, collector) {
      var selectionHighlight = theme.getColor(colorRegistry_js_1.editorSelectionHighlight);
      ...
      var selectionHighlightBorder = theme.getColor(colorRegistry_js_1.editorSelectionHighlightBorder);
