define('node_modules/monaco-editor/esm/vs/editor/contrib/suggest/completionModel', function(require, exports, module) {
  ...
  var CompletionModel = /** @class */ (function () {
      function CompletionModel(items, column, lineContext, wordDistance, options) {
          if (options === void 0) {
              options = editorOptions_js_1.EDITOR_DEFAULTS.contribInfo.suggest;
          }
      ...
      CompletionModel.prototype.dispose = function () {
          ...
          for (var _i = 0, _a = this._items; _i < _a.length; _i++) {
              ...
              if (!seen.has(container)) {
                  seen.add(container);
                  if (lifecycle_js_1.isDisposable(container)) {
                      container.dispose();
                  }
              }
          }
      ...
      CompletionModel.prototype._createCachedState = function () {
          ...
          // user-configuration
          var scoreFn = (!this._options.filterGraceful || source.length > 2000) ? filters_js_1.fuzzyScore : filters_js_1.fuzzyScoreGracefulAggressive;
          for (var i = 0; i < source.length; i++) {
              ...
              if (wordLen === 0) {
                  ...
                  if (wordPos >= wordLen) {
                      ...
                      item.score = filters_js_1.anyScore(word, wordLow, 0, item.completion.label, item.labelLow, 0);
