define('node_modules/monaco-editor/esm/vs/editor/contrib/suggest/wordContextKey', function(require, exports, module) {
  ...
  var WordContextKey = /** @class */ (function () {
      ...
      WordContextKey.prototype.dispose = function () {
          lifecycle_js_1.dispose(this._confListener, this._selectionListener);
          this._ckAtEnd.reset();
      };
      ...
      WordContextKey.AtEnd = new contextkey_js_1.RawContextKey('atEndOfWord', false);
