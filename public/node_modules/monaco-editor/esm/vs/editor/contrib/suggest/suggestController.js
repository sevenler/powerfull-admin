define('node_modules/monaco-editor/esm/vs/editor/contrib/suggest/suggestController', function(require, exports, module) {
  ...
  var snippetParser_js_1 = require("node_modules/monaco-editor/esm/vs/editor/contrib/snippet/snippetParser");
  ...
  var suggestAlternatives_js_1 = require("node_modules/monaco-editor/esm/vs/editor/contrib/suggest/suggestAlternatives");
  var suggestModel_js_1 = require("node_modules/monaco-editor/esm/vs/editor/contrib/suggest/suggestModel");
  var suggestWidget_js_1 = require("node_modules/monaco-editor/esm/vs/editor/contrib/suggest/suggestWidget");
  var wordContextKey_js_1 = require("node_modules/monaco-editor/esm/vs/editor/contrib/suggest/wordContextKey");
  ...
  var AcceptOnCharacterOracle = /** @class */ (function () {
      ...
      AcceptOnCharacterOracle.prototype._onItem = function (selected) {
          if (!selected || !arrays_js_1.isNonEmptyArray(selected.item.completion.commitCharacters)) {
              this.reset();
              return;
          }
          var acceptCharacters = new characterClassifier_js_1.CharacterSet();
  ...
  var SuggestController = /** @class */ (function () {
      function SuggestController(_editor, editorWorker, _memoryService, _commandService, _contextKeyService, _instantiationService) {
          ...
          this._model = new suggestModel_js_1.SuggestModel(this._editor, editorWorker);
          this._widget = new async_js_1.IdleValue(function () {
              var widget = _this._instantiationService.createInstance(suggestWidget_js_1.SuggestWidget, _this._editor);
              ...
              var makesTextEdit = suggest_js_1.Context.MakesTextEdit.bindTo(_this._contextKeyService);
          ...
          this._alternatives = new async_js_1.IdleValue(function () {
              var res = new suggestAlternatives_js_1.SuggestAlternatives(_this._editor, _this._contextKeyService);
              _this._toDispose.push(res);
              return res;
          });
          this._toDispose.push(_instantiationService.createInstance(wordContextKey_js_1.WordContextKey, _editor));
          ...
          var acceptSuggestionsOnEnter = suggest_js_1.Context.AcceptSuggestionsOnEnter.bindTo(_contextKeyService);
      ...
      SuggestController.prototype._onDidSelectItem = function (event, keepAlternativeSuggestions, undoStops) {
          ...
          if (Array.isArray(suggestion.additionalTextEdits)) {
              this._editor.executeEdits('suggestController.additionalTextEdits', suggestion.additionalTextEdits.map(function (edit) { return editOperation_js_1.EditOperation.replace(range_js_1.Range.lift(edit.range), edit.text); }));
          }
          // keep item in memory
          ...
          if (!(suggestion.insertTextRules & 4 /* InsertAsSnippet */)) {
              insertText = snippetParser_js_1.SnippetParser.escape(insertText);
          }
          ...
          snippetController2_js_1.SnippetController2.get(this._editor).insert(insertText, overwriteBefore + columnDelta, overwriteAfter, false, false, !(suggestion.insertTextRules & 1 /* KeepWhitespace */));
          if (undoStops) {
              this._editor.pushUndoStop();
          }
          if (!suggestion.command) {
              ...
              // exec command, done
              (_a = this._commandService).executeCommand.apply(_a, [suggestion.command.id].concat((suggestion.command.arguments ? suggestion.command.arguments.slice() : []))).catch(errors_js_1.onUnexpectedError);
              this._model.cancel();
          }
      ...
      SuggestController.prototype._alertCompletionItem = function (_a) {
          ...
          if (arrays_js_1.isNonEmptyArray(suggestion.additionalTextEdits)) {
      ...
      SuggestController.prototype.triggerSuggestAndAcceptBest = function (arg) {
          ...
          event_js_1.Event.once(this._model.onDidTrigger)(function (_) {
              // wait for trigger because only then the cancel-event is trustworthy
              var listener = [];
              event_js_1.Event.any(_this._model.onDidTrigger, _this._model.onDidCancel)(function () {
                  // retrigger or cancel -> try to type default text
                  lifecycle_js_1.dispose(listener);
                  fallback();
              }, undefined, listener);
      ...
      SuggestController = __decorate([
          ...
          __param(2, suggestMemory_js_1.ISuggestMemoryService),
  ...
  var TriggerSuggestAction = /** @class */ (function (_super) {
      ...
      function TriggerSuggestAction() {
          return _super.call(this, {
              ...
              precondition: contextkey_js_1.ContextKeyExpr.and(editorContextKeys_js_1.EditorContextKeys.writable, editorContextKeys_js_1.EditorContextKeys.hasCompletionItemProvider),
              kbOpts: {
  ...
  editorExtensions_js_1.registerEditorContribution(SuggestController);
  editorExtensions_js_1.registerEditorAction(TriggerSuggestAction);
  var weight = 100 /* EditorContrib */ + 90;
  var SuggestCommand = editorExtensions_js_1.EditorCommand.bindToContribution(SuggestController.get);
  editorExtensions_js_1.registerEditorCommand(new SuggestCommand({
      id: 'acceptSelectedSuggestion',
      precondition: suggest_js_1.Context.Visible,
  ...
  editorExtensions_js_1.registerEditorCommand(new SuggestCommand({
      ...
      kbOpts: {
          weight: weight,
          kbExpr: contextkey_js_1.ContextKeyExpr.and(editorContextKeys_js_1.EditorContextKeys.textInputFocus, suggest_js_1.Context.AcceptSuggestionsOnEnter, suggest_js_1.Context.MakesTextEdit),
          primary: 3 /* Enter */
      }
  }));
  editorExtensions_js_1.registerEditorCommand(new SuggestCommand({
  ...
  editorExtensions_js_1.registerEditorCommand(new SuggestCommand({
      ...
      precondition: contextkey_js_1.ContextKeyExpr.and(suggest_js_1.Context.Visible, suggest_js_1.Context.MultipleSuggestions),
  ...
  editorExtensions_js_1.registerEditorCommand(new SuggestCommand({
      ...
      precondition: contextkey_js_1.ContextKeyExpr.and(contextkey_js_1.ContextKeyExpr.equals('config.editor.tabCompletion', 'on'), wordContextKey_js_1.WordContextKey.AtEnd, suggest_js_1.Context.Visible.toNegated(), suggestAlternatives_js_1.SuggestAlternatives.OtherSuggestions.toNegated(), snippetController2_js_1.SnippetController2.InSnippetMode.toNegated()),
      handler: function (x, arg) {
          x.triggerSuggestAndAcceptBest(types_js_1.isObject(arg) ? __assign({ fallback: 'tab' }, arg) : { fallback: 'tab' });
      },
      kbOpts: {
          weight: weight,
          primary: 2 /* Tab */
  ...
  editorExtensions_js_1.registerEditorCommand(new SuggestCommand({
      ...
      precondition: contextkey_js_1.ContextKeyExpr.and(contextkey_js_1.ContextKeyExpr.equals('config.editor.tabCompletion', 'on'), suggestAlternatives_js_1.SuggestAlternatives.OtherSuggestions, suggest_js_1.Context.Visible.toNegated(), snippetController2_js_1.SnippetController2.InSnippetMode.toNegated()),
