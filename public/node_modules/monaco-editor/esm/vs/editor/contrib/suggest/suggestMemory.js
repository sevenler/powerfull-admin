define('node_modules/monaco-editor/esm/vs/editor/contrib/suggest/suggestMemory', function(require, exports, module) {
  ...
  var LRUMemory = /** @class */ (function (_super) {
      ...
      function LRUMemory() {
          ...
          _this._cache = new map_js_1.LRUCache(300, 0.66);
          _this._seq = 0;
          return _this;
      }
      ...
      LRUMemory.prototype.fromJSON = function (data) {
          ...
          for (var _i = 0, data_1 = data; _i < data_1.length; _i++) {
              ...
              value.touch = seq;
              value.type = typeof value.type === 'number' ? value.type : modes_js_1.completionKindFromString(value.type);
  ...
  var PrefixMemory = /** @class */ (function (_super) {
      ...
      function PrefixMemory() {
          var _this = _super !== null && _super.apply(this, arguments) || this;
          _this._trie = map_js_1.TernarySearchTree.forStrings();
          _this._seq = 0;
          return _this;
      }
  ...
  var SuggestMemoryService = /** @class */ (function (_super) {
      ...
      function SuggestMemoryService(_storageService, _configService) {
          ...
          _this._persistSoon = _this._register(new async_js_1.RunOnceScheduler(function () { return _this._saveState(); }, 500));
  ...
  exports.ISuggestMemoryService = instantiation_js_1.createDecorator('ISuggestMemories');
  extensions_js_1.registerSingleton(exports.ISuggestMemoryService, SuggestMemoryService, true);
