define('node_modules/monaco-editor/esm/vs/editor/contrib/suggest/wordDistance', function(require, exports, module) {
  ...
  var WordDistance = /** @class */ (function () {
      ...
      WordDistance.create = function (service, editor) {
          ...
          return new bracketSelections_js_1.BracketSelectionRangeProvider().provideSelectionRanges(model, [position]).then(function (ranges) {
              ...
              return service.computeWordRanges(model.uri, ranges[0][0].range).then(function (wordRanges) {
                  return new /** @class */ (function (_super) {
                      ...
                      class_1.prototype.distance = function (anchor, suggestion) {
                          ...
                          if (arrays_js_1.isFalsyOrEmpty(wordLines)) {
                              return 2 << 20;
                          }
                          var idx = arrays_js_1.binarySearch(wordLines, range_js_1.Range.fromPositions(anchor), range_js_1.Range.compareRangesUsingStarts);
                          ...
                          for (var _i = 0, _a = ranges[0]; _i < _a.length; _i++) {
                              var range = _a[_i];
                              if (!range_js_1.Range.containsRange(range.range, bestWordRange)) {
                                  break;
                              }
                              blockDistance -= 1;
                          }
