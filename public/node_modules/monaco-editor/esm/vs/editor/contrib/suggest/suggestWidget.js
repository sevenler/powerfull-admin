define('node_modules/monaco-editor/esm/vs/editor/contrib/suggest/suggestWidget', function(require, exports, module) {
  ...
  ''/*@require node_modules/monaco-editor/esm/vs/editor/contrib/suggest/media/suggest.css*/;
  ...
  var getIconClasses_js_1 = require("node_modules/monaco-editor/esm/vs/editor/common/services/getIconClasses");
   ...
   */
  exports.editorSuggestWidgetBackground = colorRegistry_js_1.registerColor('editorSuggestWidget.background', { dark: colorRegistry_js_1.editorWidgetBackground, light: colorRegistry_js_1.editorWidgetBackground, hc: colorRegistry_js_1.editorWidgetBackground }, nls.localize('editorSuggestWidgetBackground', 'Background color of the suggest widget.'));
  exports.editorSuggestWidgetBorder = colorRegistry_js_1.registerColor('editorSuggestWidget.border', { dark: colorRegistry_js_1.editorWidgetBorder, light: colorRegistry_js_1.editorWidgetBorder, hc: colorRegistry_js_1.editorWidgetBorder }, nls.localize('editorSuggestWidgetBorder', 'Border color of the suggest widget.'));
  exports.editorSuggestWidgetForeground = colorRegistry_js_1.registerColor('editorSuggestWidget.foreground', { dark: colorRegistry_js_1.editorForeground, light: colorRegistry_js_1.editorForeground, hc: colorRegistry_js_1.editorForeground }, nls.localize('editorSuggestWidgetForeground', 'Foreground color of the suggest widget.'));
  exports.editorSuggestWidgetSelectedBackground = colorRegistry_js_1.registerColor('editorSuggestWidget.selectedBackground', { dark: colorRegistry_js_1.listFocusBackground, light: colorRegistry_js_1.listFocusBackground, hc: colorRegistry_js_1.listFocusBackground }, nls.localize('editorSuggestWidgetSelectedBackground', 'Background color of the selected entry in the suggest widget.'));
  exports.editorSuggestWidgetHighlightForeground = colorRegistry_js_1.registerColor('editorSuggestWidget.highlightForeground', { dark: colorRegistry_js_1.listHighlightForeground, light: colorRegistry_js_1.listHighlightForeground, hc: colorRegistry_js_1.listHighlightForeground }, nls.localize('editorSuggestWidgetHighlightForeground', 'Color of the match highlights in the suggest widget.'));
  ...
  var Renderer = /** @class */ (function () {
      ...
      Renderer.prototype.renderTemplate = function (container) {
          ...
          data.disposables = [];
          data.root = container;
          dom_js_1.addClass(data.root, 'show-file-icons');
          data.icon = dom_js_1.append(container, dom_js_1.$('.icon'));
          data.colorspan = dom_js_1.append(data.icon, dom_js_1.$('span.colorspan'));
          var text = dom_js_1.append(container, dom_js_1.$('.contents'));
          var main = dom_js_1.append(text, dom_js_1.$('.main'));
          data.iconLabel = new iconLabel_js_1.IconLabel(main, { supportHighlights: true });
          data.disposables.push(data.iconLabel);
          data.typeLabel = dom_js_1.append(main, dom_js_1.$('span.type-label'));
          data.readMore = dom_js_1.append(main, dom_js_1.$('span.readMore'));
          ...
          configureFont();
          event_js_1.Event.chain(this.editor.onDidChangeConfiguration.bind(this.editor))
      ...
      Renderer.prototype.renderElement = function (element, _index, templateData) {
          ...
          data.icon.className = 'icon ' + modes_js_1.completionKindToCssClass(suggestion.kind);
          data.colorspan.style.backgroundColor = '';
          var labelOptions = {
              labelEscapeNewLines: true,
              matches: filters_js_1.createMatches(element.score)
          };
          var color = [];
          if (suggestion.kind === 19 /* Color */ && extractColor(element, color)) {
              ...
              labelOptions.extraClasses = [].concat(getIconClasses_js_1.getIconClasses(this._modelService, this._modeService, uri_js_1.URI.from({ scheme: 'fake', path: suggestion.label }), files_js_1.FileKind.FILE), getIconClasses_js_1.getIconClasses(this._modelService, this._modeService, uri_js_1.URI.from({ scheme: 'fake', path: suggestion.detail }), files_js_1.FileKind.FILE));
          }
          else if (suggestion.kind === 23 /* Folder */ && this._themeService.getIconTheme().hasFolderIcons) {
              // special logic for 'folder' completion items
              data.icon.className = 'icon hide';
              labelOptions.extraClasses = [].concat(getIconClasses_js_1.getIconClasses(this._modelService, this._modeService, uri_js_1.URI.from({ scheme: 'fake', path: suggestion.label }), files_js_1.FileKind.FOLDER), getIconClasses_js_1.getIconClasses(this._modelService, this._modeService, uri_js_1.URI.from({ scheme: 'fake', path: suggestion.detail }), files_js_1.FileKind.FOLDER));
          }
          else {
              // normal icon
              data.icon.className = 'icon hide';
              labelOptions.extraClasses = [
                  "suggest-icon " + modes_js_1.completionKindToCssClass(suggestion.kind)
              ];
          }
          data.iconLabel.setLabel(suggestion.label, undefined, labelOptions);
          data.typeLabel.textContent = (suggestion.detail || '').replace(/\n.*$/m, '');
          if (canExpandCompletionItem(element)) {
              dom_js_1.show(data.readMore);
              ...
              dom_js_1.hide(data.readMore);
              data.readMore.onmousedown = null;
              data.readMore.onclick = null;
          }
      };
      Renderer.prototype.disposeTemplate = function (templateData) {
          templateData.disposables = lifecycle_js_1.dispose(templateData.disposables);
      };
      Renderer = __decorate([
          __param(3, modelService_js_1.IModelService),
          __param(4, modeService_js_1.IModeService),
  ...
  var SuggestionDetails = /** @class */ (function () {
      function SuggestionDetails(container, widget, editor, markdownRenderer, triggerKeybindingLabel) {
          ...
          this.borderWidth = 1;
          this.disposables = [];
          this.el = dom_js_1.append(container, dom_js_1.$('.details'));
          this.disposables.push(lifecycle_js_1.toDisposable(function () { return container.removeChild(_this.el); }));
          this.body = dom_js_1.$('.body');
          this.scrollbar = new scrollableElement_js_1.DomScrollableElement(this.body, {});
          dom_js_1.append(this.el, this.scrollbar.getDomNode());
          this.disposables.push(this.scrollbar);
          this.header = dom_js_1.append(this.body, dom_js_1.$('.header'));
          this.close = dom_js_1.append(this.header, dom_js_1.$('span.close'));
          this.close.title = nls.localize('readLess', "Read less...{0}", this.triggerKeybindingLabel);
          this.type = dom_js_1.append(this.header, dom_js_1.$('p.type'));
          this.docs = dom_js_1.append(this.body, dom_js_1.$('p.docs'));
          this.ariaLabel = null;
          this.configureFont();
          event_js_1.Event.chain(this.editor.onDidChangeConfiguration.bind(this.editor))
      ...
      SuggestionDetails.prototype.render = function (item) {
          var _this = this;
          this.renderDisposeable = lifecycle_js_1.dispose(this.renderDisposeable);
          if (!item || !canExpandCompletionItem(item)) {
              this.type.textContent = '';
              this.docs.textContent = '';
              dom_js_1.addClass(this.el, 'no-docs');
              this.ariaLabel = null;
              return;
          }
          dom_js_1.removeClass(this.el, 'no-docs');
          if (typeof item.completion.documentation === 'string') {
              dom_js_1.removeClass(this.docs, 'markdown-docs');
              this.docs.textContent = item.completion.documentation;
          }
          else {
              dom_js_1.addClass(this.docs, 'markdown-docs');
              this.docs.innerHTML = '';
          ...
          if (item.completion.detail) {
              ...
              dom_js_1.show(this.type);
          }
          else {
              this.type.innerText = '';
              dom_js_1.hide(this.type);
          }
  ...
  var SuggestWidget = /** @class */ (function () {
      function SuggestWidget(editor, telemetryService, contextKeyService, themeService, storageService, keybindingService, modeService, openerService, instantiationService) {
          ...
          this.editorBlurTimeout = new async_js_1.TimeoutTimer();
          this.showTimeout = new async_js_1.TimeoutTimer();
          this.onDidSelectEmitter = new event_js_1.Emitter();
          this.onDidFocusEmitter = new event_js_1.Emitter();
          this.onDidHideEmitter = new event_js_1.Emitter();
          this.onDidShowEmitter = new event_js_1.Emitter();
          ...
          var markdownRenderer = new markdownRenderer_js_1.MarkdownRenderer(editor, modeService, openerService);
          this.isAuto = false;
          this.focusedItem = null;
          this.storageService = storageService;
          this.element = dom_js_1.$('.editor-widget.suggest-widget');
          this.messageElement = dom_js_1.append(this.element, dom_js_1.$('.message'));
          this.listElement = dom_js_1.append(this.element, dom_js_1.$('.tree'));
          this.details = new SuggestionDetails(this.element, this, this.editor, markdownRenderer, triggerKeybindingLabel);
          var applyIconStyle = function () { return dom_js_1.toggleClass(_this.element, 'no-icons', !_this.editor.getConfiguration().contribInfo.suggest.showIcons); };
          applyIconStyle();
          var renderer = instantiationService.createInstance(Renderer, this, this.editor, triggerKeybindingLabel);
          this.list = new listWidget_js_1.List(this.listElement, this, [renderer], {
              useShadows: false,
              openController: { shouldOpen: function () { return false; } },
              mouseSupport: false
          });
          this.toDispose = [
              styler_js_1.attachListStyler(this.list, themeService, {
                  listInactiveFocusBackground: exports.editorSuggestWidgetSelectedBackground,
                  listInactiveFocusOutline: colorRegistry_js_1.activeContrastBorder
              }),
          ...
          this.suggestWidgetVisible = suggest_js_1.Context.Visible.bindTo(contextKeyService);
          this.suggestWidgetMultipleSuggestions = suggest_js_1.Context.MultipleSuggestions.bindTo(contextKeyService);
      ...
      SuggestWidget.prototype.select = function (item, index) {
          ...
          item.resolve(cancellation_js_1.CancellationToken.None).then(function () {
      ...
      SuggestWidget.prototype._ariaAlert = function (newAriaAlertLabel) {
          ...
          if (this._lastAriaAlertLabel) {
              aria_js_1.alert(this._lastAriaAlertLabel, true);
          }
      };
      SuggestWidget.prototype.onThemeChange = function (theme) {
          ...
          var focusBorderColor = theme.getColor(colorRegistry_js_1.focusBorder);
          if (focusBorderColor) {
      ...
      SuggestWidget.prototype.onListFocus = function (e) {
          ...
          if (item !== this.focusedItem) {
              ...
              this.currentSuggestionDetails = async_js_1.createCancelablePromise(function (token) { return item.resolve(token); });
              this.currentSuggestionDetails.then(function () {
                  ...
                  if (_this.expandDocsSettingFromStorage()) {
                      ...
                      dom_js_1.removeClass(_this.element, 'docs-side');
                  }
                  _this._ariaAlert(_this._getSuggestionAriaAlertLabel(item));
              }).catch(errors_js_1.onUnexpectedError).then(function () {
      ...
      SuggestWidget.prototype.setState = function (state) {
          ...
          this.state = state;
          dom_js_1.toggleClass(this.element, 'frozen', state === 4 /* Frozen */);
          switch (state) {
              case 0 /* Hidden */:
                  dom_js_1.hide(this.messageElement, this.details.element, this.listElement);
                  this.hide();
                  this.listHeight = 0;
                  if (stateChanged) {
              ...
              case 1 /* Loading */:
                  ...
                  dom_js_1.hide(this.listElement, this.details.element);
                  dom_js_1.show(this.messageElement);
                  dom_js_1.removeClass(this.element, 'docs-side');
                  this.show();
                  this.focusedItem = null;
                  break;
              case 2 /* Empty */:
                  ...
                  break;
              case 3 /* Open */:
                  dom_js_1.hide(this.messageElement);
                  dom_js_1.show(this.listElement);
                  this.show();
                  break;
              case 4 /* Frozen */:
                  dom_js_1.hide(this.messageElement);
              ...
              case 5 /* Details */:
                  dom_js_1.hide(this.messageElement);
                  dom_js_1.show(this.details.element, this.listElement);
                  this.show();
      ...
      SuggestWidget.prototype.toggleDetails = function () {
          ...
          if (this.expandDocsSettingFromStorage()) {
              ...
              dom_js_1.hide(this.details.element);
              dom_js_1.removeClass(this.element, 'docs-side');
              dom_js_1.removeClass(this.element, 'docs-below');
              this.editor.layoutContentWidget(this);
              /* __GDPR__
      ...
      SuggestWidget.prototype.showDetails = function () {
          this.expandSideOrBelow();
          dom_js_1.show(this.details.element);
      ...
      SuggestWidget.prototype.show = function () {
          ...
          this.showTimeout.cancelAndSet(function () {
              dom_js_1.addClass(_this.element, 'visible');
      ...
      SuggestWidget.prototype.hide = function () {
          ...
          dom_js_1.removeClass(this.element, 'visible');
      };
      ...
      SuggestWidget.prototype.adjustDocsPosition = function () {
          ...
          var editorCoords = dom_js_1.getDomNodePagePosition(this.editor.getDomNode());
          var cursorX = editorCoords.left + cursorCoords.left;
          var cursorY = editorCoords.top + cursorCoords.top + cursorCoords.height;
          var widgetCoords = dom_js_1.getDomNodePagePosition(this.element);
          ...
          if (widgetX < cursorX - this.listWidth) {
              ...
              dom_js_1.addClass(this.element, 'list-right');
          }
          else {
              dom_js_1.removeClass(this.element, 'list-right');
          }
          ...
          if (dom_js_1.hasClass(this.element, 'docs-side')
      ...
      SuggestWidget.prototype.expandSideOrBelow = function () {
          ...
          if (!matches || Number(matches[1]) < this.maxWidgetWidth) {
              dom_js_1.addClass(this.element, 'docs-below');
              dom_js_1.removeClass(this.element, 'docs-side');
          }
          else if (canExpandCompletionItem(this.focusedItem)) {
              dom_js_1.addClass(this.element, 'docs-side');
              dom_js_1.removeClass(this.element, 'docs-below');
          }
      };
      ...
      SuggestWidget = __decorate([
          __param(1, telemetry_js_1.ITelemetryService),
          __param(2, contextkey_js_1.IContextKeyService),
          __param(3, themeService_js_1.IThemeService),
          __param(4, storage_js_1.IStorageService),
          __param(5, keybinding_js_1.IKeybindingService),
          __param(6, modeService_js_1.IModeService),
          __param(7, opener_js_1.IOpenerService),
