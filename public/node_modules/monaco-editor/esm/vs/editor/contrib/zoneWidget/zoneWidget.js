define('node_modules/monaco-editor/esm/vs/editor/contrib/zoneWidget/zoneWidget', function(require, exports, module) {
   ...
   *--------------------------------------------------------------------------------------------*/
  ''/*@require node_modules/monaco-editor/esm/vs/editor/contrib/zoneWidget/zoneWidget.css*/;
  ...
  var defaultColor = new color_js_1.Color(new color_js_1.RGBA(0, 122, 204));
  var defaultOptions = {
      showArrow: true,
      showFrame: true,
      className: '',
  ...
  var Arrow = /** @class */ (function () {
      ...
      Arrow.prototype.show = function (where) {
          this._decorations = this._editor.deltaDecorations(this._decorations, [{ range: range_js_1.Range.fromPositions(where), options: { className: this._ruleName, stickiness: 1 /* NeverGrowsWhenTypingAtEdges */ } }]);
      };
      Arrow.prototype.hide = function () {
          this._editor.deltaDecorations(this._decorations, []);
      };
      Arrow._IdGenerator = new idGenerator_js_1.IdGenerator('.arrow-decoration-');
      return Arrow;
  }());
  var ZoneWidget = /** @class */ (function () {
      ...
      ZoneWidget.prototype.show = function (rangeOrPos, heightInLines) {
          var range = range_js_1.Range.isIRange(rangeOrPos)
              ? rangeOrPos
              : new range_js_1.Range(rangeOrPos.lineNumber, rangeOrPos.column, rangeOrPos.lineNumber, rangeOrPos.column);
          this._isShowing = true;
          this._showImpl(range, heightInLines);
          this._isShowing = false;
          this._positionMarkerId = this.editor.deltaDecorations(this._positionMarkerId, [{ range: range, options: textModel_js_1.ModelDecorationOptions.EMPTY }]);
      };
      ...
      ZoneWidget.prototype._initSash = function () {
          var _this = this;
          this._resizeSash = new sash_js_1.Sash(this.domNode, this, { orientation: 1 /* HORIZONTAL */ });
