define('node_modules/monaco-editor/esm/vs/editor/contrib/contextmenu/contextmenu', function(require, exports, module) {
  ...
  var ContextMenuController = /** @class */ (function () {
      ...
      ContextMenuController.prototype._getMenuActions = function (model) {
          ...
          for (var _i = 0, groups_1 = groups; _i < groups_1.length; _i++) {
              ...
              result.push(new actionbar_js_1.Separator());
          }
      ...
      ContextMenuController.prototype._doShowContextMenu = function (actions, anchor) {
          ...
          this._contextMenuService.showContextMenu({
              ...
              getActionItem: function (action) {
                  ...
                  if (keybinding) {
                      return new actionbar_js_1.ActionItem(action, action, { label: true, keybinding: keybinding.getLabel(), isMenu: true });
                  }
                  var customActionItem = action;
                  if (typeof customActionItem.getActionItem === 'function') {
                      return customActionItem.getActionItem();
                  }
                  return new actionbar_js_1.ActionItem(action, action, { icon: true, label: true, isMenu: true });
              },
      ...
      ContextMenuController = __decorate([
          ...
          __param(5, actions_js_1.IMenuService)
  ...
  editorExtensions_js_1.registerEditorContribution(ContextMenuController);
  editorExtensions_js_1.registerEditorAction(ShowContextMenu);
