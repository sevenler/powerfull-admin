define('node_modules/monaco-editor/esm/vs/editor/contrib/comment/blockCommentCommand', function(require, exports, module) {
  ...
  var BlockCommentCommand = /** @class */ (function () {
      ...
      BlockCommentCommand._createAddBlockCommentOperations = function (r, startToken, endToken) {
          ...
          if (!range_js_1.Range.isEmpty(r)) {
              ...
              res.push(editOperation_js_1.EditOperation.insert(new position_js_1.Position(r.startLineNumber, r.startColumn), startToken + ' '));
              // Insert block comment end
              res.push(editOperation_js_1.EditOperation.insert(new position_js_1.Position(r.endLineNumber, r.endColumn), ' ' + endToken));
          }
          else {
