define('node_modules/monaco-editor/esm/vs/editor/contrib/comment/lineCommentCommand', function(require, exports, module) {
  ...
  var blockCommentCommand_js_1 = require("node_modules/monaco-editor/esm/vs/editor/contrib/comment/blockCommentCommand");
  var LineCommentCommand = /** @class */ (function () {
      ...
      LineCommentCommand._gatherPreflightCommentStrings = function (model, startLineNumber, endLineNumber) {
          ...
          var config = languageConfigurationRegistry_js_1.LanguageConfigurationRegistry.getComments(languageId);
      ...
      LineCommentCommand.prototype._executeLineComments = function (model, builder, data, s) {
          ...
          var cursorPosition = new position_js_1.Position(s.positionLineNumber, s.positionColumn);
      ...
      LineCommentCommand.prototype._executeBlockComment = function (model, builder, s) {
          ...
          if (!ops) {
              if (s.isEmpty()) {
                  ...
                  ops = blockCommentCommand_js_1.BlockCommentCommand._createAddBlockCommentOperations(new range_js_1.Range(s.startLineNumber, firstNonWhitespaceIndex + 1, s.startLineNumber, lineContent.length + 1), startToken, endToken);
              }
              else {
                  ops = blockCommentCommand_js_1.BlockCommentCommand._createAddBlockCommentOperations(new range_js_1.Range(s.startLineNumber, model.getLineFirstNonWhitespaceColumn(s.startLineNumber), s.endLineNumber, model.getLineMaxColumn(s.endLineNumber)), startToken, endToken);
              }
              if (ops.length === 1) {
      ...
      LineCommentCommand._createAddLineCommentsOperations = function (lines, startLineNumber) {
          ...
          for (var i = 0, len = lines.length; i < len; i++) {
              ...
              res.push(editOperation_js_1.EditOperation.insert(new position_js_1.Position(startLineNumber + i, lineData.commentStrOffset + 1), lineData.commentStr + ' '));
          }
          return res;
      };
