define('node_modules/monaco-editor/esm/vs/editor/contrib/smartSelect/smartSelect', function(require, exports, module) {
  ...
  var wordSelections_js_1 = require("node_modules/monaco-editor/esm/vs/editor/contrib/smartSelect/wordSelections");
  var bracketSelections_js_1 = require("node_modules/monaco-editor/esm/vs/editor/contrib/smartSelect/bracketSelections");
  ...
  var SmartSelectController = /** @class */ (function () {
      ...
      SmartSelectController.prototype.dispose = function () {
          lifecycle_js_1.dispose(this._selectionListener);
      };
      ...
      SmartSelectController.prototype.run = function (forward) {
          ...
          if (!this._state) {
              promise = provideSelectionRanges(model, selections.map(function (s) { return s.getPosition(); }), cancellation_js_1.CancellationToken.None).then(function (ranges) {
                  ...
                  lifecycle_js_1.dispose(_this._selectionListener);
          ...
          return promise.then(function () {
              ...
              var selections = _this._state.map(function (state) { return selection_js_1.Selection.fromPositions(state.ranges[state.index].getStartPosition(), state.ranges[state.index].getEndPosition()); });
  ...
  editorExtensions_js_1.registerEditorContribution(SmartSelectController);
  editorExtensions_js_1.registerEditorAction(GrowSelectionAction);
  editorExtensions_js_1.registerEditorAction(ShrinkSelectionAction);
  // word selection
  modes.SelectionRangeRegistry.register('*', new wordSelections_js_1.WordSelectionRangeProvider());
          ...
          return allRawRanges.map(function (oneRawRanges) {
              ...
              for (var i = 1; i < oneRanges.length; i++) {
                  ...
                  if (cur.startLineNumber !== prev.startLineNumber || cur.endLineNumber !== prev.endLineNumber) {
                      ...
                      var rangeNoWhitespace = new range_js_1.Range(prev.startLineNumber, model.getLineFirstNonWhitespaceColumn(prev.startLineNumber), prev.endLineNumber, model.getLineLastNonWhitespaceColumn(prev.endLineNumber));
                      if (rangeNoWhitespace.containsRange(prev) && !rangeNoWhitespace.equalsRange(prev)) {
                          oneRangesWithTrivia.push(rangeNoWhitespace);
                      }
                      // add line/block range
                      var rangeFull = new range_js_1.Range(prev.startLineNumber, 1, prev.endLineNumber, model.getLineMaxColumn(prev.endLineNumber));
  ...
  editorExtensions_js_1.registerDefaultLanguageCommand('_executeSelectionRangeProvider', function (model, _position, args) {
      return provideSelectionRanges(model, args.positions, cancellation_js_1.CancellationToken.None);
  });
