define('node_modules/monaco-editor/esm/vs/editor/contrib/smartSelect/bracketSelections', function(require, exports, module) {
  ...
  var BracketSelectionRangeProvider = /** @class */ (function () {
              ...
              if (!bracket.isOpen) {
                  ...
                  if (val < 0) {
                      ...
                      if (list) {
                          ...
                          var innerBracket = range_js_1.Range.fromPositions(bracket.range.getEndPosition(), closing.getStartPosition());
                          var outerBracket = range_js_1.Range.fromPositions(bracket.range.getStartPosition(), closing.getEndPosition());
      ...
      BracketSelectionRangeProvider._addBracketLeading = function (model, bracket, bucket) {
          ...
          if (column !== 0 && column !== bracket.startColumn) {
              bucket.push({ range: range_js_1.Range.fromPositions(new position_js_1.Position(startLine, column), bracket.getEndPosition()), kind: 'statement.brackets.leading' });
              bucket.push({ range: range_js_1.Range.fromPositions(new position_js_1.Position(startLine, 1), bracket.getEndPosition()), kind: 'statement.brackets.leading.full' });
          }
          // xxxxxxxx
          // {
          //
          ...
          if (aboveLine > 0) {
              ...
              if (column_1 === bracket.startColumn && column_1 !== model.getLineLastNonWhitespaceColumn(aboveLine)) {
                  bucket.push({ range: range_js_1.Range.fromPositions(new position_js_1.Position(aboveLine, column_1), bracket.getEndPosition()), kind: 'statement.brackets.leading' });
                  bucket.push({ range: range_js_1.Range.fromPositions(new position_js_1.Position(aboveLine, 1), bracket.getEndPosition()), kind: 'statement.brackets.leading.full' });
              }
          }
      };
