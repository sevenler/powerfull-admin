define('node_modules/monaco-editor/esm/vs/editor/contrib/linesOperations/linesOperations', function(require, exports, module) {
  ...
  var coreCommands_js_1 = require("node_modules/monaco-editor/esm/vs/editor/browser/controller/coreCommands");
  ...
  var trimTrailingWhitespaceCommand_js_1 = require("node_modules/monaco-editor/esm/vs/editor/common/commands/trimTrailingWhitespaceCommand");
  ...
  var copyLinesCommand_js_1 = require("node_modules/monaco-editor/esm/vs/editor/contrib/linesOperations/copyLinesCommand");
  var moveLinesCommand_js_1 = require("node_modules/monaco-editor/esm/vs/editor/contrib/linesOperations/moveLinesCommand");
  var sortLinesCommand_js_1 = require("node_modules/monaco-editor/esm/vs/editor/contrib/linesOperations/sortLinesCommand");
  // copy lines
  var AbstractCopyLinesAction = /** @class */ (function (_super) {
      ...
      AbstractCopyLinesAction.prototype.run = function (_accessor, editor) {
          ...
          for (var _i = 0, selections_1 = selections; _i < selections_1.length; _i++) {
              ...
              commands.push(new copyLinesCommand_js_1.CopyLinesCommand(selection, this.down));
          }
          editor.pushUndoStop();
  ...
  var AbstractMoveLinesAction = /** @class */ (function (_super) {
      ...
      AbstractMoveLinesAction.prototype.run = function (_accessor, editor) {
          ...
          for (var _i = 0, selections_2 = selections; _i < selections_2.length; _i++) {
              ...
              commands.push(new moveLinesCommand_js_1.MoveLinesCommand(selection, this.down, autoIndent));
          }
          editor.pushUndoStop();
          editor.executeCommands(this.id, commands);
          editor.pushUndoStop();
  ...
  var AbstractSortLinesAction = /** @class */ (function (_super) {
      ...
      AbstractSortLinesAction.prototype.run = function (_accessor, editor) {
          ...
          for (var _i = 0, selections_3 = selections; _i < selections_3.length; _i++) {
              ...
              if (!sortLinesCommand_js_1.SortLinesCommand.canRun(editor.getModel(), selection, this.descending)) {
                  return;
              }
          }
          var commands = [];
          for (var i = 0, len = selections.length; i < len; i++) {
              commands[i] = new sortLinesCommand_js_1.SortLinesCommand(selections[i], this.descending);
          }
          editor.pushUndoStop();
          editor.executeCommands(this.id, commands);
          editor.pushUndoStop();
  ...
  var TrimTrailingWhitespaceAction = /** @class */ (function (_super) {
      ...
      function TrimTrailingWhitespaceAction() {
          return _super.call(this, {
              ...
              kbOpts: {
                  kbExpr: editorContextKeys_js_1.EditorContextKeys.editorTextFocus,
                  primary: keyCodes_js_1.KeyChord(2048 /* CtrlCmd */ | 41 /* KEY_K */, 2048 /* CtrlCmd */ | 54 /* KEY_X */),
                  weight: 100 /* EditorContrib */
              }
          }) || this;
      }
      TrimTrailingWhitespaceAction.prototype.run = function (_accessor, editor, args) {
          ...
          if (args.reason === 'auto-save') {
              ...
              cursors = (editor.getSelections() || []).map(function (s) { return new position_js_1.Position(s.positionLineNumber, s.positionColumn); });
          }
          var selection = editor.getSelection();
          if (selection === null) {
              return;
          }
          var command = new trimTrailingWhitespaceCommand_js_1.TrimTrailingWhitespaceCommand(selection, cursors);
          editor.pushUndoStop();
  ...
  var DeleteLinesAction = /** @class */ (function (_super) {
      ...
      DeleteLinesAction.prototype.run = function (_accessor, editor) {
          ...
          for (var i = 0, len = ops.length; i < len; i++) {
              ...
              edits.push(editOperation_js_1.EditOperation.replace(new selection_js_1.Selection(startLineNumber, startColumn, endLineNumber, endColumn), ''));
              cursorState.push(new selection_js_1.Selection(startLineNumber - linesDeleted, op.positionColumn, startLineNumber - linesDeleted, op.positionColumn));
  ...
  var IndentLinesAction = /** @class */ (function (_super) {
      ...
      IndentLinesAction.prototype.run = function (_accessor, editor) {
          ...
          editor.pushUndoStop();
          editor.executeCommands(this.id, cursorTypeOperations_js_1.TypeOperations.indent(cursors.context.config, editor.getModel(), editor.getSelections()));
          editor.pushUndoStop();
      };
  ...
  var OutdentLinesAction = /** @class */ (function (_super) {
      ...
      OutdentLinesAction.prototype.run = function (_accessor, editor) {
          coreCommands_js_1.CoreEditingCommands.Outdent.runEditorCommand(_accessor, editor, null);
      };
  ...
  var InsertLineBeforeAction = /** @class */ (function (_super) {
      ...
      InsertLineBeforeAction.prototype.run = function (_accessor, editor) {
          ...
          editor.pushUndoStop();
          editor.executeCommands(this.id, cursorTypeOperations_js_1.TypeOperations.lineInsertBefore(cursors.context.config, editor.getModel(), editor.getSelections()));
      };
  ...
  var InsertLineAfterAction = /** @class */ (function (_super) {
      ...
      InsertLineAfterAction.prototype.run = function (_accessor, editor) {
          ...
          editor.pushUndoStop();
          editor.executeCommands(this.id, cursorTypeOperations_js_1.TypeOperations.lineInsertAfter(cursors.context.config, editor.getModel(), editor.getSelections()));
      };
  ...
  var AbstractDeleteAllToBoundaryAction = /** @class */ (function (_super) {
      ...
      AbstractDeleteAllToBoundaryAction.prototype.run = function (_accessor, editor) {
          ...
          for (var i = 0, count = rangesToDelete.length - 1; i < count; i++) {
              ...
              if (range_js_1.Range.intersectRanges(range, nextRange) === null) {
                  effectiveRanges.push(range);
              }
              else {
                  rangesToDelete[i + 1] = range_js_1.Range.plusRange(range, nextRange);
              }
          }
          ...
          var edits = effectiveRanges.map(function (range) {
              return editOperation_js_1.EditOperation.replace(range, '');
          });
          editor.pushUndoStop();
  ...
  var DeleteAllLeftAction = /** @class */ (function (_super) {
      ...
      DeleteAllLeftAction.prototype._getEndCursorState = function (primaryCursor, rangesToDelete) {
          ...
          rangesToDelete.forEach(function (range) {
              ...
              if (range.endColumn === 1 && deletedLines > 0) {
                  ...
                  endCursor = new selection_js_1.Selection(newStartLine, range.startColumn, newStartLine, range.startColumn);
              }
              else {
                  endCursor = new selection_js_1.Selection(range.startLineNumber, range.startColumn, range.startLineNumber, range.startColumn);
              }
      ...
      DeleteAllLeftAction.prototype._getRangesToDelete = function (editor) {
          ...
          rangesToDelete.sort(range_js_1.Range.compareRangesUsingStarts);
          rangesToDelete = rangesToDelete.map(function (selection) {
              if (selection.isEmpty()) {
                  if (selection.startColumn === 1) {
                      ...
                      return new range_js_1.Range(deleteFromLine, deleteFromColumn, selection.startLineNumber, 1);
                  }
                  else {
                      return new range_js_1.Range(selection.startLineNumber, 1, selection.startLineNumber, selection.startColumn);
                  }
              }
              else {
                  return selection;
  ...
  var DeleteAllRightAction = /** @class */ (function (_super) {
      ...
      DeleteAllRightAction.prototype._getEndCursorState = function (primaryCursor, rangesToDelete) {
          ...
          for (var i = 0, len = rangesToDelete.length, offset = 0; i < len; i++) {
              var range = rangesToDelete[i];
              var endCursor = new selection_js_1.Selection(range.startLineNumber - offset, range.startColumn, range.startLineNumber - offset, range.startColumn);
              if (range.intersectRanges(primaryCursor)) {
                  endPrimaryCursor = endCursor;
              }
              else {
          ...
          var rangesToDelete = selections.map(function (sel) {
              if (sel.isEmpty()) {
                  ...
                  if (sel.startColumn === maxColumn) {
                      return new range_js_1.Range(sel.startLineNumber, sel.startColumn, sel.startLineNumber + 1, 1);
                  }
                  else {
                      return new range_js_1.Range(sel.startLineNumber, sel.startColumn, sel.startLineNumber, maxColumn);
                  }
              }
              return sel;
          });
  ...
  var JoinLinesAction = /** @class */ (function (_super) {
      ...
      JoinLinesAction.prototype.run = function (_accessor, editor) {
          ...
          var lastSelection = selections.reduce(function (previousValue, currentValue) {
              if (previousValue.isEmpty()) {
                  ...
                  if (currentValue.startLineNumber > previousValue.endLineNumber + 1) {
                      ...
                      return new selection_js_1.Selection(previousValue.startLineNumber, previousValue.startColumn, currentValue.endLineNumber, currentValue.endColumn);
                  }
              }
              else {
          ...
          for (var i = 0, len = reducedSelections.length; i < len; i++) {
              ...
              var deleteSelection = new range_js_1.Range(startLineNumber, startColumn, endLineNumber, endColumn);
              if (!deleteSelection.isEmpty()) {
                  var resultSelection = void 0;
                  if (selection.isEmpty()) {
                      edits.push(editOperation_js_1.EditOperation.replace(deleteSelection, trimmedLinesContent));
                      resultSelection = new selection_js_1.Selection(deleteSelection.startLineNumber - lineOffset, trimmedLinesContent.length - columnDeltaOffset + 1, startLineNumber - lineOffset, trimmedLinesContent.length - columnDeltaOffset + 1);
                  }
                  else {
                      if (selection.startLineNumber === selection.endLineNumber) {
                          edits.push(editOperation_js_1.EditOperation.replace(deleteSelection, trimmedLinesContent));
                          resultSelection = new selection_js_1.Selection(selection.startLineNumber - lineOffset, selection.startColumn, selection.endLineNumber - lineOffset, selection.endColumn);
                      }
                      else {
                          edits.push(editOperation_js_1.EditOperation.replace(deleteSelection, trimmedLinesContent));
                          resultSelection = new selection_js_1.Selection(selection.startLineNumber - lineOffset, selection.startColumn, selection.startLineNumber - lineOffset, trimmedLinesContent.length - selectionEndPositionOffset);
                      }
                  }
                  if (range_js_1.Range.intersectRanges(deleteSelection, primaryCursor) !== null) {
      ...
      TransposeAction.prototype.run = function (_accessor, editor) {
          ...
          for (var i = 0, len = selections.length; i < len; i++) {
              ...
              if (cursor.column >= maxColumn) {
                  ...
                  var deleteSelection = new range_js_1.Range(cursor.lineNumber, Math.max(1, cursor.column - 1), cursor.lineNumber + 1, 1);
                  var chars = model.getValueInRange(deleteSelection).split('').reverse().join('');
                  commands.push(new replaceCommand_js_1.ReplaceCommand(new selection_js_1.Selection(cursor.lineNumber, Math.max(1, cursor.column - 1), cursor.lineNumber + 1, 1), chars));
              }
              else {
                  var deleteSelection = new range_js_1.Range(cursor.lineNumber, Math.max(1, cursor.column - 1), cursor.lineNumber, cursor.column + 1);
                  var chars = model.getValueInRange(deleteSelection).split('').reverse().join('');
                  commands.push(new replaceCommand_js_1.ReplaceCommandThatPreservesSelection(deleteSelection, chars, new selection_js_1.Selection(cursor.lineNumber, cursor.column + 1, cursor.lineNumber, cursor.column + 1)));
              }
          }
          editor.pushUndoStop();
          editor.executeCommands(this.id, commands);
      ...
      AbstractCaseAction.prototype.run = function (_accessor, editor) {
          ...
          for (var i = 0, len = selections.length; i < len; i++) {
              ...
              if (selection.isEmpty()) {
                  ...
                  var wordRange = new range_js_1.Range(cursor.lineNumber, word.startColumn, cursor.lineNumber, word.endColumn);
                  var text = model.getValueInRange(wordRange);
                  commands.push(new replaceCommand_js_1.ReplaceCommandThatPreservesSelection(wordRange, this._modifyText(text, wordSeparators), new selection_js_1.Selection(cursor.lineNumber, cursor.column, cursor.lineNumber, cursor.column)));
              }
              else {
                  var text = model.getValueInRange(selection);
                  commands.push(new replaceCommand_js_1.ReplaceCommandThatPreservesSelection(selection, this._modifyText(text, wordSeparators), selection));
              }
          }
          editor.pushUndoStop();
          editor.executeCommands(this.id, commands);
  ...
  editorExtensions_js_1.registerEditorAction(CopyLinesUpAction);
  editorExtensions_js_1.registerEditorAction(CopyLinesDownAction);
  editorExtensions_js_1.registerEditorAction(MoveLinesUpAction);
  editorExtensions_js_1.registerEditorAction(MoveLinesDownAction);
  editorExtensions_js_1.registerEditorAction(SortLinesAscendingAction);
  editorExtensions_js_1.registerEditorAction(SortLinesDescendingAction);
  editorExtensions_js_1.registerEditorAction(TrimTrailingWhitespaceAction);
  editorExtensions_js_1.registerEditorAction(DeleteLinesAction);
  editorExtensions_js_1.registerEditorAction(IndentLinesAction);
  editorExtensions_js_1.registerEditorAction(OutdentLinesAction);
  editorExtensions_js_1.registerEditorAction(InsertLineBeforeAction);
  editorExtensions_js_1.registerEditorAction(InsertLineAfterAction);
  editorExtensions_js_1.registerEditorAction(DeleteAllLeftAction);
  editorExtensions_js_1.registerEditorAction(DeleteAllRightAction);
  editorExtensions_js_1.registerEditorAction(JoinLinesAction);
  editorExtensions_js_1.registerEditorAction(TransposeAction);
  editorExtensions_js_1.registerEditorAction(UpperCaseAction);
  editorExtensions_js_1.registerEditorAction(LowerCaseAction);
  editorExtensions_js_1.registerEditorAction(TitleCaseAction);
