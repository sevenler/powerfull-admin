define('node_modules/monaco-editor/esm/vs/editor/contrib/linesOperations/moveLinesCommand', function(require, exports, module) {
  ...
  var indentUtils = tslib_1.__importStar(require("node_modules/monaco-editor/esm/vs/editor/contrib/indentation/indentUtils"));
  var MoveLinesCommand = /** @class */ (function () {
      ...
      MoveLinesCommand.prototype.getEditOperations = function (model, builder) {
          ...
          if (s.startLineNumber === s.endLineNumber && model.getLineMaxColumn(s.startLineNumber) === 1) {
              ...
              if (this._isMovingDown) {
                  ...
                  builder.addEditOperation(new range_js_1.Range(movingLineNumber_1 - 1, model.getLineMaxColumn(movingLineNumber_1 - 1), movingLineNumber_1, model.getLineMaxColumn(movingLineNumber_1)), null);
                  ...
                  if (this.shouldAutoIndent(model, s)) {
                      ...
                      if (movingLineMatchResult !== null) {
                          ...
                          var indentOfMovingLine = languageConfigurationRegistry_js_1.LanguageConfigurationRegistry.getGoodIndentForLine(virtualModel, model.getLanguageIdAtPosition(movingLineNumber_1, 1), s.startLineNumber, indentConverter);
                      ...
                      builder.addEditOperation(new range_js_1.Range(s.startLineNumber, 1, s.startLineNumber, 1), insertingText_1 + '\n');
                      ...
                      if (ret !== null) {
                          ...
                          var newIndentatOfMovingBlock = languageConfigurationRegistry_js_1.LanguageConfigurationRegistry.getGoodIndentForLine(virtualModel, model.getLanguageIdAtPosition(movingLineNumber_1, 1), s.startLineNumber + 1, indentConverter);
                  ...
                  movingLineText = model.getLineContent(movingLineNumber_1);
                  // Delete line that needs to be moved
                  builder.addEditOperation(new range_js_1.Range(movingLineNumber_1, 1, movingLineNumber_1 + 1, 1), null);
                  ...
                  if (this.shouldAutoIndent(model, s)) {
                      ...
                      if (ret !== null) {
                          ...
                          var indentOfFirstLine = languageConfigurationRegistry_js_1.LanguageConfigurationRegistry.getGoodIndentForLine(virtualModel, model.getLanguageIdAtPosition(s.startLineNumber, 1), movingLineNumber_1, indentConverter);
      ...
      MoveLinesCommand.prototype.matchEnterRule = function (model, indentConverter, tabSize, line, oneLineAbove, oneLineAboveText) {
          ...
          var enter = languageConfigurationRegistry_js_1.LanguageConfigurationRegistry.getEnterAction(model, new range_js_1.Range(validPrecedingLine, maxColumn, validPrecedingLine, maxColumn));
          if (enter) {
              ...
              if (this.trimLeft(movingLineText).indexOf(this.trimLeft(enterPrefix)) >= 0) {
                  ...
                  var indentMetadataOfMovelingLine = languageConfigurationRegistry_js_1.LanguageConfigurationRegistry.getIndentMetadata(model, line);
      ...
      MoveLinesCommand.prototype.shouldAutoIndent = function (model, selection) {
          ...
          if (languageConfigurationRegistry_js_1.LanguageConfigurationRegistry.getIndentRulesSupport(languageAtSelectionStart) === null) {
              return false;
          }
          return true;
      };
