define('node_modules/monaco-editor/esm/vs/editor/contrib/codeAction/codeActionTrigger', function(require, exports, module) {
  ...
  var CodeActionKind = /** @class */ (function () {
      ...
      CodeActionKind.prototype.contains = function (other) {
          return this.value === other.value || strings_js_1.startsWith(other.value, this.value + CodeActionKind.sep);
      };
