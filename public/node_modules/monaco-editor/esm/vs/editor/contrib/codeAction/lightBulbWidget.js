define('node_modules/monaco-editor/esm/vs/editor/contrib/codeAction/lightBulbWidget', function(require, exports, module) {
  ...
  ''/*@require node_modules/monaco-editor/esm/vs/editor/contrib/codeAction/lightBulbWidget.css*/;
  ...
  var LightBulbWidget = /** @class */ (function (_super) {
      ...
      function LightBulbWidget(editor) {
          ...
          _this._onClick = _this._register(new event_js_1.Emitter());
          _this.onClick = _this._onClick.event;
          _this._state = codeActionModel_js_1.CodeActionsState.Empty;
          _this._futureFixes = new cancellation_js_1.CancellationTokenSource();
          ...
          _this._register(dom.addDisposableListener(_this._domNode, 'mouseenter', function (e) {
              ...
              _this.hide();
              var monitor = new globalMouseMoveMonitor_js_1.GlobalMouseMoveMonitor();
              monitor.startMonitoring(globalMouseMoveMonitor_js_1.standardMouseMoveMerger, function () { }, function () {
                  monitor.dispose();
              });
          }));
      ...
      LightBulbWidget.prototype.tryShow = function (newState) {
          ...
          this._futureFixes = new cancellation_js_1.CancellationTokenSource();
          var token = this._futureFixes.token;
          this._state = newState;
          if (this._state.type === codeActionModel_js_1.CodeActionsState.Empty.type) {
              return;
          }
      ...
      LightBulbWidget.prototype._show = function (codeActions) {
          ...
          var indent = textModel_js_1.TextModel.computeIndentLevel(lineContent, tabSize);
      ...
      LightBulbWidget.prototype.hide = function () {
          this._position = null;
          this._state = codeActionModel_js_1.CodeActionsState.Empty;
          this._futureFixes.cancel();
          this._editor.layoutContentWidget(this);
      };
