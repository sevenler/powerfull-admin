define('node_modules/monaco-editor/esm/vs/editor/contrib/codeAction/codeActionModel', function(require, exports, module) {
  ...
  exports.SUPPORTED_CODE_ACTIONS = new contextkey_js_1.RawContextKey('supportedCodeAction', '');
  var CodeActionOracle = /** @class */ (function () {
      function CodeActionOracle(_editor, _markerService, _signalChange, _delay, _progressService) {
          ...
          this._disposables = [];
          this._autoTriggerTimer = new async_js_1.TimeoutTimer();
      ...
      CodeActionOracle.prototype._getRangeOfMarker = function (selection) {
          ...
          for (var _i = 0, _a = this._markerService.read({ resource: model.uri }); _i < _a.length; _i++) {
              var marker = _a[_i];
              if (range_js_1.Range.intersectRanges(marker, selection)) {
                  return range_js_1.Range.lift(marker);
              }
          }
          return undefined;
      };
      ...
      CodeActionOracle.prototype._createEventAndSignalChange = function (trigger, selection) {
          if (!selection) {
              // cancel
              this._signalChange(exports.CodeActionsState.Empty);
              ...
              var actions = async_js_1.createCancelablePromise(function (token) { return codeAction_js_1.getCodeActions(model_1, selection, trigger, token); });
              if (this._progressService && trigger.type === 'manual') {
                  this._progressService.showWhile(actions, 250);
              }
              this._signalChange(new exports.CodeActionsState.Triggered(trigger, selection, position, actions));
              return actions;
          }
      };
  ...
  })(exports.CodeActionsState || (exports.CodeActionsState = {}));
  var CodeActionModel = /** @class */ (function () {
      function CodeActionModel(_editor, _markerService, contextKeyService, _progressService) {
          ...
          this._markerService = _markerService;
          this._progressService = _progressService;
          this._state = exports.CodeActionsState.Empty;
          this._onDidChangeState = new event_js_1.Emitter();
          this._disposables = [];
          ...
          this._disposables.push(modes_js_1.CodeActionProviderRegistry.onDidChange(function () { return _this._update(); }));
          this._update();
      }
      CodeActionModel.prototype.dispose = function () {
          this._disposables = lifecycle_js_1.dispose(this._disposables);
          lifecycle_js_1.dispose(this._codeActionOracle);
      };
      ...
      CodeActionModel.prototype._update = function () {
          ...
          this.setState(exports.CodeActionsState.Empty);
          var model = this._editor.getModel();
          if (model
              && modes_js_1.CodeActionProviderRegistry.has(model)
              && !this._editor.getConfiguration().readOnly) {
              var supportedActions = [];
              for (var _i = 0, _a = modes_js_1.CodeActionProviderRegistry.all(model); _i < _a.length; _i++) {
                  var provider = _a[_i];
