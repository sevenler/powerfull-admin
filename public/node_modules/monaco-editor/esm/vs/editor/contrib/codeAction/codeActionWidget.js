define('node_modules/monaco-editor/esm/vs/editor/contrib/codeAction/codeActionWidget', function(require, exports, module) {
  ...
  var CodeActionContextMenu = /** @class */ (function () {
      function CodeActionContextMenu(_editor, _contextMenuService, _onApplyCodeAction) {
          ...
          this._onDidExecuteCodeAction = new event_js_1.Emitter();
      ...
      CodeActionContextMenu.prototype.codeActionToAction = function (action) {
          ...
          return new actions_js_1.Action(id, title, undefined, true, function () {
      ...
      CodeActionContextMenu.prototype._toCoords = function (position) {
          ...
          var editorCoords = dom_js_1.getDomNodePagePosition(this._editor.getDomNode());
