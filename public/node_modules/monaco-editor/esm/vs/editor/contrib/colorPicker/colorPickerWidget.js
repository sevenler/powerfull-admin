define('node_modules/monaco-editor/esm/vs/editor/contrib/colorPicker/colorPickerWidget', function(require, exports, module) {
  ...
  ''/*@require node_modules/monaco-editor/esm/vs/editor/contrib/colorPicker/colorPicker.css*/;
  ...
  var ColorPickerHeader = /** @class */ (function (_super) {
      ...
      function ColorPickerHeader(container, model, themeService) {
          ...
          colorBox.style.backgroundColor = color_js_1.Color.Format.CSS.format(_this.model.originalColor);
          _this.backgroundColor = themeService.getTheme().getColor(colorRegistry_js_1.editorHoverBackground) || color_js_1.Color.white;
          _this._register(themeService_js_1.registerThemingParticipant(function (theme, collector) {
              _this.backgroundColor = theme.getColor(colorRegistry_js_1.editorHoverBackground) || color_js_1.Color.white;
          }));
          ...
          _this.pickedColorNode.style.backgroundColor = color_js_1.Color.Format.CSS.format(model.color);
      ...
      ColorPickerHeader.prototype.onDidChangeColor = function (color) {
          this.pickedColorNode.style.backgroundColor = color_js_1.Color.Format.CSS.format(color);
  ...
  var SaturationBox = /** @class */ (function (_super) {
      ...
      function SaturationBox(container, model, pixelRatio) {
          ...
          _this.model = model;
          _this.pixelRatio = pixelRatio;
          _this._onDidChange = new event_js_1.Emitter();
          _this.onDidChange = _this._onDidChange.event;
          _this._onColorFlushed = new event_js_1.Emitter();
      ...
      SaturationBox.prototype.onMouseDown = function (e) {
          var _this = this;
          this.monitor = this._register(new globalMouseMoveMonitor_js_1.GlobalMouseMoveMonitor());
          var origin = dom.getDomNodePagePosition(this.domNode);
          if (e.target !== this.selection) {
              this.onDidChangePosition(e.offsetX, e.offsetY);
          }
          this.monitor.startMonitoring(globalMouseMoveMonitor_js_1.standardMouseMoveMerger, function (event) { return _this.onDidChangePosition(event.posx - origin.left, event.posy - origin.top); }, function () { return null; });
      ...
      SaturationBox.prototype.paint = function () {
          var hsva = this.model.color.hsva;
          var saturatedColor = new color_js_1.Color(new color_js_1.HSVA(hsva.h, 1, 1, 1));
  ...
  var Strip = /** @class */ (function (_super) {
      ...
      Strip.prototype.onMouseDown = function (e) {
          var _this = this;
          var monitor = this._register(new globalMouseMoveMonitor_js_1.GlobalMouseMoveMonitor());
          var origin = dom.getDomNodePagePosition(this.domNode);
          dom.addClass(this.domNode, 'grabbing');
          if (e.target !== this.slider) {
              this.onDidChangeTop(e.offsetY);
          }
          monitor.startMonitoring(globalMouseMoveMonitor_js_1.standardMouseMoveMerger, function (event) { return _this.onDidChangeTop(event.posy - origin.top); }, function () { return null; });
          var mouseUpListener = dom.addDisposableListener(document, dom.EventType.MOUSE_UP, function () {
              _this._onColorFlushed.fire();
              mouseUpListener.dispose();
  ...
  var OpacityStrip = /** @class */ (function (_super) {
      ...
      OpacityStrip.prototype.onDidChangeColor = function (color) {
          ...
          var opaque = new color_js_1.Color(new color_js_1.RGBA(r, g, b, 1));
          var transparent = new color_js_1.Color(new color_js_1.RGBA(r, g, b, 0));
  ...
  var ColorPickerWidget = /** @class */ (function (_super) {
      ...
      function ColorPickerWidget(container, model, pixelRatio, themeService) {
          ...
          _this.model = model;
          _this.pixelRatio = pixelRatio;
          _this._register(browser_js_1.onDidChangeZoomLevel(function () { return _this.layout(); }));
