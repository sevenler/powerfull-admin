define('node_modules/monaco-editor/esm/vs/editor/contrib/colorPicker/colorDetector', function(require, exports, module) {
  ...
  var hash_js_1 = require("node_modules/monaco-editor/esm/vs/base/common/hash");
  ...
  var ColorDetector = /** @class */ (function () {
      function ColorDetector(_editor, _codeEditorService, _configurationService) {
          ...
          this._globalToDispose.push(modes_js_1.ColorProviderRegistry.onDidChange(function (e) { return _this.onModelChanged(); }));
      ...
      ColorDetector.prototype.onModelChanged = function () {
          ...
          var model = this._editor.getModel();
          if (!model || !modes_js_1.ColorProviderRegistry.has(model)) {
              return;
          }
          this._localToDispose.push(this._editor.onDidChangeModelContent(function (e) {
              if (!_this._timeoutTimer) {
                  _this._timeoutTimer = new async_js_1.TimeoutTimer();
      ...
      ColorDetector.prototype.beginCompute = function () {
          var _this = this;
          this._computePromise = async_js_1.createCancelablePromise(function (token) {
              var model = _this._editor.getModel();
              if (!model) {
                  return Promise.resolve([]);
              }
              return color_js_2.getColors(model, token);
          });
      ...
      ColorDetector.prototype.updateColorDecorators = function (colorData) {
          ...
          for (var i = 0; i < colorData.length && decorations.length < MAX_DECORATORS; i++) {
              ...
              var rgba = new color_js_1.RGBA(Math.round(red * 255), Math.round(green * 255), Math.round(blue * 255), alpha);
              var subKey = hash_js_1.hash(rgba).toString(16);
      ...
      ColorDetector.prototype.getColorData = function (position) {
          ...
          var decorations = model
              .getDecorationsInRange(range_js_1.Range.fromPositions(position, position))
  ...
  editorExtensions_js_1.registerEditorContribution(ColorDetector);
