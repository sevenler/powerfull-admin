define('node_modules/monaco-editor/esm/vs/editor/contrib/format/formattingEdit', function(require, exports, module) {
  ...
  var FormattingEdit = /** @class */ (function () {
      ...
      FormattingEdit.execute = function (editor, _edits) {
          ...
          if (edits.length === 1 && FormattingEdit._isFullModelReplaceEdit(editor, edits[0])) {
              ...
              editor.executeEdits('formatEditsCommand', edits.map(function (edit) { return editOperation_js_1.EditOperation.replace(range_js_1.Range.lift(edit.range), edit.text); }));
          }
          else {
              editor.executeEdits('formatEditsCommand', edits.map(function (edit) { return editOperation_js_1.EditOperation.replaceMove(range_js_1.Range.lift(edit.range), edit.text); }));
          }
          editor.pushUndoStop();
      };
