define('node_modules/monaco-editor/esm/vs/editor/contrib/folding/indentRangeProvider', function(require, exports, module) {
   ...
   *--------------------------------------------------------------------------------------------*/
  var foldingRanges_js_1 = require("node_modules/monaco-editor/esm/vs/editor/contrib/folding/foldingRanges");
  ...
  var IndentRangeProvider = /** @class */ (function () {
      ...
      IndentRangeProvider.prototype.compute = function (cancelationToken) {
          var foldingRules = languageConfigurationRegistry_js_1.LanguageConfigurationRegistry.getFoldingRules(this.editorModel.getLanguageIdentifier().id);
