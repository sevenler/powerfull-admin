define('node_modules/monaco-editor/esm/vs/editor/contrib/folding/folding', function(require, exports, module) {
  ...
  ''/*@require node_modules/monaco-editor/esm/vs/editor/contrib/folding/folding.css*/;
  ...
  var foldingModel_js_1 = require("node_modules/monaco-editor/esm/vs/editor/contrib/folding/foldingModel");
  var foldingDecorations_js_1 = require("node_modules/monaco-editor/esm/vs/editor/contrib/folding/foldingDecorations");
  var editorContextKeys_js_1 = require("node_modules/monaco-editor/esm/vs/editor/common/editorContextKeys");
  var hiddenRangeModel_js_1 = require("node_modules/monaco-editor/esm/vs/editor/contrib/folding/hiddenRangeModel");
  ...
  var indentRangeProvider_js_1 = require("node_modules/monaco-editor/esm/vs/editor/contrib/folding/indentRangeProvider");
  ...
  var intializingRangeProvider_js_1 = require("node_modules/monaco-editor/esm/vs/editor/contrib/folding/intializingRangeProvider");
  ...
  var FoldingController = /** @class */ (function () {
      function FoldingController(editor) {
          ...
          this.localToDispose = [];
          this.foldingDecorationProvider = new foldingDecorations_js_1.FoldingDecorationProvider(editor);
          ...
          this.globalToDispose.push({ dispose: function () { return lifecycle_js_1.dispose(_this.localToDispose); } });
          this.onModelChanged();
      }
      ...
      FoldingController.prototype.dispose = function () {
          this.globalToDispose = lifecycle_js_1.dispose(this.globalToDispose);
      };
      /**
       * Store view state.
       */
      ...
      FoldingController.prototype.restoreViewState = function (state) {
          ...
          if (state.provider === syntaxRangeProvider_js_1.ID_SYNTAX_PROVIDER || state.provider === intializingRangeProvider_js_1.ID_INIT_PROVIDER) {
      ...
      FoldingController.prototype.onModelChanged = function () {
          var _this = this;
          this.localToDispose = lifecycle_js_1.dispose(this.localToDispose);
          var model = this.editor.getModel();
          if (!this._isEnabled || !model || model.isTooLargeForTokenization()) {
              // huge files get no view model, so they cannot support hidden areas
              return;
          }
          this.foldingModel = new foldingModel_js_1.FoldingModel(model, this.foldingDecorationProvider);
          this.localToDispose.push(this.foldingModel);
          this.hiddenRangeModel = new hiddenRangeModel_js_1.HiddenRangeModel(this.foldingModel);
          ...
          this.updateScheduler = new async_js_1.Delayer(200);
          this.cursorChangedScheduler = new async_js_1.RunOnceScheduler(function () { return _this.revealCursor(); }, 200);
          this.localToDispose.push(this.cursorChangedScheduler);
          this.localToDispose.push(modes_js_1.FoldingRangeProviderRegistry.onDidChange(function () { return _this.onFoldingStrategyChanged(); }));
      ...
      FoldingController.prototype.getRangeProvider = function (editorModel) {
          ...
          this.rangeProvider = new indentRangeProvider_js_1.IndentRangeProvider(editorModel); // fallback
          if (this._useFoldingProviders && this.foldingModel) {
              var foldingProviders = modes_js_1.FoldingRangeProviderRegistry.ordered(this.foldingModel.textModel);
              if (foldingProviders.length === 0 && this.foldingStateMemento && this.foldingStateMemento.collapsedRegions) {
                  var rangeProvider = this.rangeProvider = new intializingRangeProvider_js_1.InitializingRangeProvider(editorModel, this.foldingStateMemento.collapsedRegions, function () {
                  ...
                  this.rangeProvider = new syntaxRangeProvider_js_1.SyntaxRangeProvider(editorModel, foldingProviders);
              }
          }
      ...
      FoldingController.prototype.onModelContentChanged = function () {
          ...
          if (this.updateScheduler) {
              ...
              this.foldingModelPromise = this.updateScheduler.trigger(function () {
                  ...
                  var foldingRegionPromise = _this.foldingRegionPromise = async_js_1.createCancelablePromise(function (token) { return _this.getRangeProvider(foldingModel.textModel).compute(token); });
  ...
  var UnfoldAction = /** @class */ (function (_super) {
      ...
      UnfoldAction.prototype.invoke = function (_foldingController, foldingModel, editor, args) {
          ...
          if (args && args.direction === 'up') {
              foldingModel_js_1.setCollapseStateLevelsUp(foldingModel, false, levels, lineNumbers);
          }
          else {
              foldingModel_js_1.setCollapseStateLevelsDown(foldingModel, false, levels, lineNumbers);
          }
      };
      return UnfoldAction;
  }(FoldingAction));
  var UnFoldRecursivelyAction = /** @class */ (function (_super) {
      ...
      function UnFoldRecursivelyAction() {
          return _super.call(this, {
              ...
              kbOpts: {
                  kbExpr: editorContextKeys_js_1.EditorContextKeys.editorTextFocus,
                  primary: keyCodes_js_1.KeyChord(2048 /* CtrlCmd */ | 41 /* KEY_K */, 2048 /* CtrlCmd */ | 89 /* US_CLOSE_SQUARE_BRACKET */),
                  weight: 100 /* EditorContrib */
              }
          }) || this;
      }
      UnFoldRecursivelyAction.prototype.invoke = function (_foldingController, foldingModel, editor, _args) {
          foldingModel_js_1.setCollapseStateLevelsDown(foldingModel, false, Number.MAX_VALUE, this.getSelectedLines(editor));
      };
  ...
  var FoldAction = /** @class */ (function (_super) {
      ...
      FoldAction.prototype.invoke = function (_foldingController, foldingModel, editor, args) {
          ...
          var lineNumbers = this.getLineNumbers(args, editor);
          if (args && args.direction === 'up') {
              foldingModel_js_1.setCollapseStateLevelsUp(foldingModel, true, levels, lineNumbers);
          }
          else {
              foldingModel_js_1.setCollapseStateLevelsDown(foldingModel, true, levels, lineNumbers);
          }
      };
      return FoldAction;
  }(FoldingAction));
  var FoldRecursivelyAction = /** @class */ (function (_super) {
      ...
      function FoldRecursivelyAction() {
          return _super.call(this, {
              ...
              kbOpts: {
                  kbExpr: editorContextKeys_js_1.EditorContextKeys.editorTextFocus,
                  primary: keyCodes_js_1.KeyChord(2048 /* CtrlCmd */ | 41 /* KEY_K */, 2048 /* CtrlCmd */ | 87 /* US_OPEN_SQUARE_BRACKET */),
                  weight: 100 /* EditorContrib */
              }
          }) || this;
      }
      FoldRecursivelyAction.prototype.invoke = function (_foldingController, foldingModel, editor) {
          ...
          foldingModel_js_1.setCollapseStateLevelsDown(foldingModel, true, Number.MAX_VALUE, selectedLines);
      };
  ...
  var FoldAllBlockCommentsAction = /** @class */ (function (_super) {
      ...
      function FoldAllBlockCommentsAction() {
          return _super.call(this, {
              ...
              kbOpts: {
                  kbExpr: editorContextKeys_js_1.EditorContextKeys.editorTextFocus,
                  primary: keyCodes_js_1.KeyChord(2048 /* CtrlCmd */ | 41 /* KEY_K */, 2048 /* CtrlCmd */ | 85 /* US_SLASH */),
                  weight: 100 /* EditorContrib */
              }
          }) || this;
      }
      FoldAllBlockCommentsAction.prototype.invoke = function (_foldingController, foldingModel, editor) {
          if (foldingModel.regions.hasTypes()) {
              foldingModel_js_1.setCollapseStateForType(foldingModel, modes_js_1.FoldingRangeKind.Comment.value, true);
          }
          else {
              ...
              var comments = languageConfigurationRegistry_js_1.LanguageConfigurationRegistry.getComments(editorModel.getLanguageIdentifier().id);
              if (comments && comments.blockCommentStartToken) {
                  var regExp = new RegExp('^\\s*' + strings_js_1.escapeRegExpCharacters(comments.blockCommentStartToken));
                  foldingModel_js_1.setCollapseStateForMatchingLines(foldingModel, regExp, true);
              }
          }
      };
  ...
  var FoldAllRegionsAction = /** @class */ (function (_super) {
      ...
      function FoldAllRegionsAction() {
          return _super.call(this, {
              ...
              kbOpts: {
                  kbExpr: editorContextKeys_js_1.EditorContextKeys.editorTextFocus,
                  primary: keyCodes_js_1.KeyChord(2048 /* CtrlCmd */ | 41 /* KEY_K */, 2048 /* CtrlCmd */ | 29 /* KEY_8 */),
                  weight: 100 /* EditorContrib */
              }
          }) || this;
      }
      FoldAllRegionsAction.prototype.invoke = function (_foldingController, foldingModel, editor) {
          if (foldingModel.regions.hasTypes()) {
              foldingModel_js_1.setCollapseStateForType(foldingModel, modes_js_1.FoldingRangeKind.Region.value, true);
          }
          else {
              var editorModel = editor.getModel();
              if (!editorModel) {
              ...
              var foldingRules = languageConfigurationRegistry_js_1.LanguageConfigurationRegistry.getFoldingRules(editorModel.getLanguageIdentifier().id);
  ...
  var UnfoldAllRegionsAction = /** @class */ (function (_super) {
      ...
      function UnfoldAllRegionsAction() {
          return _super.call(this, {
              ...
              kbOpts: {
                  kbExpr: editorContextKeys_js_1.EditorContextKeys.editorTextFocus,
                  primary: keyCodes_js_1.KeyChord(2048 /* CtrlCmd */ | 41 /* KEY_K */, 2048 /* CtrlCmd */ | 30 /* KEY_9 */),
                  weight: 100 /* EditorContrib */
              }
          }) || this;
      }
      UnfoldAllRegionsAction.prototype.invoke = function (_foldingController, foldingModel, editor) {
          if (foldingModel.regions.hasTypes()) {
              foldingModel_js_1.setCollapseStateForType(foldingModel, modes_js_1.FoldingRangeKind.Region.value, false);
          }
          else {
              var editorModel = editor.getModel();
              if (!editorModel) {
              ...
              if (foldingRules && foldingRules.markers && foldingRules.markers.start) {
                  var regExp = new RegExp(foldingRules.markers.start);
                  foldingModel_js_1.setCollapseStateForMatchingLines(foldingModel, regExp, false);
              }
          }
      };
  ...
  var FoldAllAction = /** @class */ (function (_super) {
      ...
      function FoldAllAction() {
          return _super.call(this, {
              ...
              kbOpts: {
                  kbExpr: editorContextKeys_js_1.EditorContextKeys.editorTextFocus,
                  primary: keyCodes_js_1.KeyChord(2048 /* CtrlCmd */ | 41 /* KEY_K */, 2048 /* CtrlCmd */ | 21 /* KEY_0 */),
                  weight: 100 /* EditorContrib */
              }
          }) || this;
      }
      FoldAllAction.prototype.invoke = function (_foldingController, foldingModel, _editor) {
          foldingModel_js_1.setCollapseStateLevelsDown(foldingModel, true);
      };
  ...
  var UnfoldAllAction = /** @class */ (function (_super) {
      ...
      function UnfoldAllAction() {
          return _super.call(this, {
              ...
              kbOpts: {
                  kbExpr: editorContextKeys_js_1.EditorContextKeys.editorTextFocus,
                  primary: keyCodes_js_1.KeyChord(2048 /* CtrlCmd */ | 41 /* KEY_K */, 2048 /* CtrlCmd */ | 40 /* KEY_J */),
                  weight: 100 /* EditorContrib */
              }
          }) || this;
      }
      UnfoldAllAction.prototype.invoke = function (_foldingController, foldingModel, _editor) {
          foldingModel_js_1.setCollapseStateLevelsDown(foldingModel, false);
      };
  ...
  var FoldLevelAction = /** @class */ (function (_super) {
      ...
      FoldLevelAction.prototype.invoke = function (_foldingController, foldingModel, editor) {
          foldingModel_js_1.setCollapseStateAtLevel(foldingModel, this.getFoldingLevel(), true, this.getSelectedLines(editor));
      };
      FoldLevelAction.ID_PREFIX = 'editor.foldLevel';
      FoldLevelAction.ID = function (level) { return FoldLevelAction.ID_PREFIX + level; };
      return FoldLevelAction;
  }(FoldingAction));
  editorExtensions_js_1.registerEditorContribution(FoldingController);
  editorExtensions_js_1.registerEditorAction(UnfoldAction);
  editorExtensions_js_1.registerEditorAction(UnFoldRecursivelyAction);
  editorExtensions_js_1.registerEditorAction(FoldAction);
  editorExtensions_js_1.registerEditorAction(FoldRecursivelyAction);
  editorExtensions_js_1.registerEditorAction(FoldAllAction);
  editorExtensions_js_1.registerEditorAction(UnfoldAllAction);
  editorExtensions_js_1.registerEditorAction(FoldAllBlockCommentsAction);
  editorExtensions_js_1.registerEditorAction(FoldAllRegionsAction);
  editorExtensions_js_1.registerEditorAction(UnfoldAllRegionsAction);
  for (var i = 1; i <= 7; i++) {
      editorExtensions_js_1.registerInstantiatedEditorAction(new FoldLevelAction({
          ...
          kbOpts: {
              kbExpr: editorContextKeys_js_1.EditorContextKeys.editorTextFocus,
              primary: keyCodes_js_1.KeyChord(2048 /* CtrlCmd */ | 41 /* KEY_K */, 2048 /* CtrlCmd */ | (21 /* KEY_0 */ + i)),
              weight: 100 /* EditorContrib */
          }
      }));
  }
