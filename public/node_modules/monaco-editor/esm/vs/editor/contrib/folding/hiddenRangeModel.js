define('node_modules/monaco-editor/esm/vs/editor/contrib/folding/hiddenRangeModel', function(require, exports, module) {
  ...
  var HiddenRangeModel = /** @class */ (function () {
      ...
      HiddenRangeModel.prototype.applyMemento = function (state) {
          ...
          for (var _i = 0, state_1 = state; _i < state_1.length; _i++) {
              ...
              hiddenRanges.push(new range_js_1.Range(r.startLineNumber + 1, 1, r.endLineNumber, 1));
          }
  ...
  function findRange(ranges, line) {
      var i = arrays_js_1.findFirstInSorted(ranges, function (r) { return line < r.startLineNumber; }) - 1;
