define('node_modules/monaco-editor/esm/vs/editor/contrib/toggleTabFocusMode/toggleTabFocusMode', function(require, exports, module) {
  ...
  var ToggleTabFocusModeAction = /** @class */ (function (_super) {
      ...
      ToggleTabFocusModeAction.prototype.run = function (accessor, editor) {
          var oldValue = commonEditorConfig_js_1.TabFocus.getTabFocusMode();
          var newValue = !oldValue;
          commonEditorConfig_js_1.TabFocus.setTabFocusMode(newValue);
          if (newValue) {
              aria_js_1.alert(nls.localize('toggle.tabMovesFocus.on', "Pressing Tab will now move focus to the next focusable element"));
          }
          else {
              aria_js_1.alert(nls.localize('toggle.tabMovesFocus.off', "Pressing Tab will now insert the tab character"));
          }
      };
  ...
  editorExtensions_js_1.registerEditorAction(ToggleTabFocusModeAction);
