define('node_modules/monaco-editor/esm/vs/editor/contrib/links/getLinks', function(require, exports, module) {
          ...
          if (this._link.url) {
              try {
                  if (typeof this._link.url === 'string') {
                      return Promise.resolve(uri_js_1.URI.parse(this._link.url));
                  }
                  else {
  ...
  var LinksList = /** @class */ (function (_super) {
      ...
      function LinksList(tuples) {
          ...
          var _loop_1 = function (list, provider) {
              ...
              if (lifecycle_js_1.isDisposable(provider)) {
      ...
      LinksList._union = function (oldLinks, newLinks) {
          ...
          for (oldIndex = 0, newIndex = 0, oldLen = oldLinks.length, newLen = newLinks.length; oldIndex < oldLen && newIndex < newLen;) {
              ...
              if (range_js_1.Range.areIntersectingOrTouching(oldLink.range, newLink.range)) {
                  // Remove the oldLink
                  oldIndex++;
                  continue;
              }
              var comparisonResult = range_js_1.Range.compareRangesUsingStarts(oldLink.range, newLink.range);
  ...
  function getLinks(model, token) {
      ...
      var promises = modes_js_1.LinkProviderRegistry.ordered(model).reverse().map(function (provider, i) {
      ...
      return Promise.all(promises).then(function () { return new LinksList(arrays_js_1.coalesce(lists)); });
  }
  exports.getLinks = getLinks;
  commands_js_1.CommandsRegistry.registerCommand('_executeLinkProvider', function (accessor) {
      var args = [];
      ...
      return __awaiter(_this, void 0, void 0, function () {
          ...
          return __generator(this, function (_a) {
              switch (_a.label) {
                  case 0:
                      uri = args[0];
                      if (!(uri instanceof uri_js_1.URI)) {
                          return [2 /*return*/, []];
                      }
                      model = accessor.get(modelService_js_1.IModelService).getModel(uri);
                      if (!model) {
                          return [2 /*return*/, []];
                      }
                      return [4 /*yield*/, getLinks(model, cancellation_js_1.CancellationToken.None)];
                  case 1:
                      list = _a.sent();
                      if (!list) {
                          return [2 /*return*/, []];
