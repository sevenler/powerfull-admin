define('node_modules/monaco-editor/esm/vs/editor/contrib/goToDefinition/clickLinkGesture', function(require, exports, module) {
  ...
  var ClickLinkGesture = /** @class */ (function (_super) {
      ...
      function ClickLinkGesture(editor) {
          ...
          _this._onMouseMoveOrRelevantKeyDown = _this._register(new event_js_1.Emitter());
          _this.onMouseMoveOrRelevantKeyDown = _this._onMouseMoveOrRelevantKeyDown.event;
          _this._onExecute = _this._register(new event_js_1.Emitter());
          _this.onExecute = _this._onExecute.event;
          _this._onCancel = _this._register(new event_js_1.Emitter());
