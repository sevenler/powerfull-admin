define('node_modules/monaco-editor/esm/vs/editor/contrib/codelens/codelensWidget', function(require, exports, module) {
   ...
   *--------------------------------------------------------------------------------------------*/
  ''/*@require node_modules/monaco-editor/esm/vs/editor/contrib/codelens/codelensWidget.css*/;
  ...
  var CodeLensContentWidget = /** @class */ (function () {
      ...
      CodeLensContentWidget.prototype.withCommands = function (inSymbols, animate) {
          ...
          var symbols = arrays_js_1.coalesce(inSymbols);
          if (arrays_js_1.isFalsyOrEmpty(symbols)) {
          ...
          for (var i = 0; i < symbols.length; i++) {
              ...
              if (command) {
                  var title = strings_js_1.escape(command.title);
                  var part = void 0;
                  if (command.id) {
                      part = "<a id=" + i + ">" + title + "</a>";
  ...
  themeService_js_1.registerThemingParticipant(function (theme, collector) {
      var codeLensForeground = theme.getColor(editorColorRegistry_js_1.editorCodeLensForeground);
