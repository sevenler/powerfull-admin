define('node_modules/monaco-editor/esm/vs/editor/contrib/caretOperations/moveCaretCommand', function(require, exports, module) {
  ...
  var MoveCaretCommand = /** @class */ (function () {
      ...
      MoveCaretCommand.prototype.getEditOperations = function (model, builder) {
          ...
          builder.addEditOperation(new range_js_1.Range(lineNumber, 1, lineNumber, model.getLineMaxColumn(lineNumber)), null);
          builder.addEditOperation(new range_js_1.Range(lineNumber, 1, lineNumber, 1), newLineContent);
