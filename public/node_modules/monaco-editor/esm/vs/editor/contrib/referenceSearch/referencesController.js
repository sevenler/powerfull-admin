define('node_modules/monaco-editor/esm/vs/editor/contrib/referenceSearch/referencesController', function(require, exports, module) {
  ...
  exports.ctxReferenceSearchVisible = new contextkey_js_1.RawContextKey('referenceSearchVisible', false);
  var ReferencesController = /** @class */ (function () {
      ...
      ReferencesController.prototype.dispose = function () {
          ...
          if (this._widget) {
              lifecycle_js_1.dispose(this._widget);
              this._widget = null;
          }
          if (this._model) {
              lifecycle_js_1.dispose(this._model);
              this._model = null;
          }
      };
      ReferencesController.prototype.toggleWidget = function (range, modelPromise, options) {
          ...
          var data = referencesWidget_js_1.LayoutData.fromJSON(this._storageService.get(storageKey, 0 /* GLOBAL */, '{}'));
          this._widget = this._instantiationService.createInstance(referencesWidget_js_1.ReferenceWidget, this._editor, this._defaultTreeKeyboardSupport, data);
          ...
          modelPromise.then(function (model) {
              ...
              return _this._widget.setModel(_this._model).then(function () {
                  if (_this._widget && _this._model && _this._editor.hasModel()) { // might have been closed
                      ...
                      var pos = new position_js_1.Position(range.startLineNumber, range.startColumn);
      ...
      ReferencesController.prototype._gotoReference = function (ref) {
          ...
          var range = range_js_1.Range.lift(ref.range).collapseToStart();
