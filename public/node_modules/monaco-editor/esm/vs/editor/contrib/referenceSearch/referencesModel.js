define('node_modules/monaco-editor/esm/vs/editor/contrib/referenceSearch/referencesModel', function(require, exports, module) {
  ...
  var idGenerator_js_1 = require("node_modules/monaco-editor/esm/vs/base/common/idGenerator");
  ...
  var OneReference = /** @class */ (function () {
      function OneReference(parent, _range, isProviderFirst) {
          ...
          this._onRefChanged = new event_js_1.Emitter();
          this.onRefChanged = this._onRefChanged.event;
          this.id = idGenerator_js_1.defaultGenerator.nextId();
      }
      ...
      OneReference.prototype.getAriaMessage = function () {
          return nls_js_1.localize('aria.oneReference', "symbol in {0} on line {1} at column {2}", resources_js_1.basename(this.uri), this.range.startLineNumber, this.range.startColumn);
      };
      return OneReference;
  }());
  ...
  var FilePreview = /** @class */ (function () {
      ...
      FilePreview.prototype.dispose = function () {
          lifecycle_js_1.dispose(this._modelReference);
      };
      FilePreview.prototype.preview = function (range, n) {
          ...
          var beforeRange = new range_js_1.Range(startLineNumber, word.startColumn, startLineNumber, startColumn);
          var afterRange = new range_js_1.Range(endLineNumber, endColumn, endLineNumber, Number.MAX_VALUE);
          var ret = {
  ...
  var FileReferences = /** @class */ (function () {
      ...
      FileReferences.prototype.getAriaMessage = function () {
          ...
          if (len === 1) {
              return nls_js_1.localize('aria.fileReferences.1', "1 symbol in {0}, full path {1}", resources_js_1.basename(this.uri), this.uri.fsPath);
          }
          else {
              return nls_js_1.localize('aria.fileReferences.N', "{0} symbols in {1}, full path {2}", len, resources_js_1.basename(this.uri), this.uri.fsPath);
          }
      };
  ...
  var ReferencesModel = /** @class */ (function () {
      function ReferencesModel(references) {
          ...
          this.groups = [];
          this.references = [];
          this._onDidChangeReferenceRange = new event_js_1.Emitter();
          ...
          for (var _i = 0, references_1 = references; _i < references_1.length; _i++) {
              ...
              if (current.children.length === 0
                  || !range_js_1.Range.equalsRange(ref.range, current.children[current.children.length - 1].range)) {
      ...
      ReferencesModel.prototype.getAriaMessage = function () {
          if (this.empty) {
              return nls_js_1.localize('aria.result.0', "No results found");
          }
          else if (this.references.length === 1) {
              return nls_js_1.localize('aria.result.1', "Found 1 symbol in {0}", this.references[0].uri.fsPath);
          }
          else if (this.groups.length === 1) {
              return nls_js_1.localize('aria.result.n1', "Found {0} symbols in {1}", this.references.length, this.groups[0].uri.fsPath);
          }
          else {
              return nls_js_1.localize('aria.result.nm', "Found {0} symbols in {1} files", this.references.length, this.groups.length);
          }
      };
      ...
      ReferencesModel.prototype.dispose = function () {
          lifecycle_js_1.dispose(this.groups);
