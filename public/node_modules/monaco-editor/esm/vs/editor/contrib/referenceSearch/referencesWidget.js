define('node_modules/monaco-editor/esm/vs/editor/contrib/referenceSearch/referencesWidget', function(require, exports, module) {
  ...
  ''/*@require node_modules/monaco-editor/esm/vs/editor/contrib/referenceSearch/media/referencesWidget.css*/;
  ...
  var referencesTree_js_1 = require("node_modules/monaco-editor/esm/vs/editor/contrib/referenceSearch/referencesTree");
  ...
  var splitview_js_1 = require("node_modules/monaco-editor/esm/vs/base/browser/ui/splitview/splitview");
  var DecorationsManager = /** @class */ (function () {
      ...
      DecorationsManager.prototype.dispose = function () {
          this._callOnModelChange = lifecycle_js_1.dispose(this._callOnModelChange);
      ...
      DecorationsManager.prototype._onDecorationChanged = function () {
          ...
          this._decorations.forEach(function (reference, decorationId) {
              ...
              else if (range_js_1.Range.spansMultipleLines(newRange)) {
                  ignore = true;
              }
              else {
      ...
      DecorationsManager.DecorationOptions = textModel_js_1.ModelDecorationOptions.register({
  ...
  exports.ctxReferenceWidgetSearchTreeFocused = new contextkey_js_1.RawContextKey('referenceSearchTreeFocused', true);
  /**
  ...
  var ReferenceWidget = /** @class */ (function (_super) {
      ...
      function ReferenceWidget(editor, _defaultTreeKeyboardSupport, layoutData, themeService, _textModelResolverService, _instantiationService, _peekViewService, _uriLabel) {
          ...
          _this._onDidSelectReference = new event_js_1.Emitter();
      ...
      ReferenceWidget.prototype.dispose = function () {
          ...
          this._callOnDispose = lifecycle_js_1.dispose(this._callOnDispose);
          lifecycle_js_1.dispose(this._preview, this._previewNotAvailableMessage, this._tree, this._previewModelReference);
          this._splitView.dispose();
          _super.prototype.dispose.call(this);
      };
      ReferenceWidget.prototype._applyTheme = function (theme) {
          var borderColor = theme.getColor(exports.peekViewBorder) || color_js_1.Color.transparent;
          this.style({
              arrowColor: borderColor,
              frameColor: borderColor,
              headerBackgroundColor: theme.getColor(exports.peekViewTitleBackground) || color_js_1.Color.transparent,
      ...
      ReferenceWidget.prototype._fillBody = function (containerElement) {
          ...
          this._splitView = new splitview_js_1.SplitView(containerElement, { orientation: 1 /* HORIZONTAL */ });
          // editor
          ...
          this._previewNotAvailableMessage = textModel_js_1.TextModel.createFromString(nls.localize('missingPreviewMessage', "no preview available"));
          // tree
          this._treeContainer = dom.append(containerElement, dom.$('div.ref-tree.inline'));
          var treeOptions = {
              ariaLabel: nls.localize('treeAriaLabel', "References"),
              keyboardSupport: this._defaultTreeKeyboardSupport,
              accessibilityProvider: new referencesTree_js_1.AriaProvider(),
          ...
          this._tree = this._instantiationService.createInstance(listService_js_1.WorkbenchAsyncDataTree, this._treeContainer, new referencesTree_js_1.Delegate(), [
      ...
      ReferenceWidget.prototype.setModel = function (newModel) {
          // clean up
          this._disposeOnNewModel = lifecycle_js_1.dispose(this._disposeOnNewModel);
                  ...
                  switch (_a.label) {
                      case 0:
                          ...
                          if (reference.uri.scheme !== network_js_1.Schemas.inMemory) {
                              this.setTitle(resources_js_1.basenameOrAuthority(reference.uri), this._uriLabel.getUriLabel(resources_js_1.dirname(reference.uri)));
                          }
                          else {
                      ...
                      case 4:
                          ...
                          lifecycle_js_1.dispose(this._previewModelReference);
                          model = ref.object;
                          if (model) {
                              scrollType = this._preview.getModel() === model.textEditorModel ? 0 /* Smooth */ : 1 /* Immediate */;
                              sel = range_js_1.Range.lift(reference.range).collapseToStart();
      ...
      ReferenceWidget = __decorate([
          ...
          __param(6, peekViewWidget_js_1.IPeekViewService),
  ...
  // theming
  exports.peekViewTitleBackground = colorRegistry_js_1.registerColor('peekViewTitle.background', { dark: '#1E1E1E', light: '#FFFFFF', hc: '#0C141F' }, nls.localize('peekViewTitleBackground', 'Background color of the peek view title area.'));
  exports.peekViewTitleForeground = colorRegistry_js_1.registerColor('peekViewTitleLabel.foreground', { dark: '#FFFFFF', light: '#333333', hc: '#FFFFFF' }, nls.localize('peekViewTitleForeground', 'Color of the peek view title.'));
  exports.peekViewTitleInfoForeground = colorRegistry_js_1.registerColor('peekViewTitleDescription.foreground', { dark: '#ccccccb3', light: '#6c6c6cb3', hc: '#FFFFFF99' }, nls.localize('peekViewTitleInfoForeground', 'Color of the peek view title info.'));
  exports.peekViewBorder = colorRegistry_js_1.registerColor('peekView.border', { dark: '#007acc', light: '#007acc', hc: colorRegistry_js_1.contrastBorder }, nls.localize('peekViewBorder', 'Color of the peek view borders and arrow.'));
  exports.peekViewResultsBackground = colorRegistry_js_1.registerColor('peekViewResult.background', { dark: '#252526', light: '#F3F3F3', hc: color_js_1.Color.black }, nls.localize('peekViewResultsBackground', 'Background color of the peek view result list.'));
  exports.peekViewResultsMatchForeground = colorRegistry_js_1.registerColor('peekViewResult.lineForeground', { dark: '#bbbbbb', light: '#646465', hc: color_js_1.Color.white }, nls.localize('peekViewResultsMatchForeground', 'Foreground color for line nodes in the peek view result list.'));
  exports.peekViewResultsFileForeground = colorRegistry_js_1.registerColor('peekViewResult.fileForeground', { dark: color_js_1.Color.white, light: '#1E1E1E', hc: color_js_1.Color.white }, nls.localize('peekViewResultsFileForeground', 'Foreground color for file nodes in the peek view result list.'));
  exports.peekViewResultsSelectionBackground = colorRegistry_js_1.registerColor('peekViewResult.selectionBackground', { dark: '#3399ff33', light: '#3399ff33', hc: null }, nls.localize('peekViewResultsSelectionBackground', 'Background color of the selected entry in the peek view result list.'));
  exports.peekViewResultsSelectionForeground = colorRegistry_js_1.registerColor('peekViewResult.selectionForeground', { dark: color_js_1.Color.white, light: '#6C6C6C', hc: color_js_1.Color.white }, nls.localize('peekViewResultsSelectionForeground', 'Foreground color of the selected entry in the peek view result list.'));
  exports.peekViewEditorBackground = colorRegistry_js_1.registerColor('peekViewEditor.background', { dark: '#001F33', light: '#F2F8FC', hc: color_js_1.Color.black }, nls.localize('peekViewEditorBackground', 'Background color of the peek view editor.'));
  exports.peekViewEditorGutterBackground = colorRegistry_js_1.registerColor('peekViewEditorGutter.background', { dark: exports.peekViewEditorBackground, light: exports.peekViewEditorBackground, hc: exports.peekViewEditorBackground }, nls.localize('peekViewEditorGutterBackground', 'Background color of the gutter in the peek view editor.'));
  exports.peekViewResultsMatchHighlight = colorRegistry_js_1.registerColor('peekViewResult.matchHighlightBackground', { dark: '#ea5c004d', light: '#ea5c004d', hc: null }, nls.localize('peekViewResultsMatchHighlight', 'Match highlight color in the peek view result list.'));
  exports.peekViewEditorMatchHighlight = colorRegistry_js_1.registerColor('peekViewEditor.matchHighlightBackground', { dark: '#ff8f0099', light: '#f5d802de', hc: null }, nls.localize('peekViewEditorMatchHighlight', 'Match highlight color in the peek view editor.'));
  exports.peekViewEditorMatchHighlightBorder = colorRegistry_js_1.registerColor('peekViewEditor.matchHighlightBorder', { dark: null, light: null, hc: colorRegistry_js_1.activeContrastBorder }, nls.localize('peekViewEditorMatchHighlightBorder', 'Match highlight border in the peek view editor.'));
  themeService_js_1.registerThemingParticipant(function (theme, collector) {
      ...
      var hcOutline = theme.getColor(colorRegistry_js_1.activeContrastBorder);
      if (hcOutline) {
