define('node_modules/monaco-editor/esm/vs/editor/contrib/dnd/dnd', function(require, exports, module) {
   ...
   *--------------------------------------------------------------------------------------------*/
  ''/*@require node_modules/monaco-editor/esm/vs/editor/contrib/dnd/dnd.css*/;
  ...
  var dragAndDropCommand_js_1 = require("node_modules/monaco-editor/esm/vs/editor/contrib/dnd/dragAndDropCommand");
  ...
  var DragAndDropController = /** @class */ (function () {
      ...
      DragAndDropController.prototype._onEditorMouseDrop = function (mouseEvent) {
          if (mouseEvent.target && (this._hitContent(mouseEvent.target) || this._hitMargin(mouseEvent.target)) && mouseEvent.target.position) {
              var newCursorPosition_1 = new position_js_1.Position(mouseEvent.target.position.lineNumber, mouseEvent.target.position.column);
              if (this._dragSelection === null) {
                  ...
                  if (mouseEvent.event.shiftKey) {
                      ...
                      if (primarySelection) {
                          ...
                          newSelections = [new selection_js_1.Selection(selectionStartLineNumber, selectionStartColumn, newCursorPosition_1.lineNumber, newCursorPosition_1.column)];
                      }
                  }
                  else {
                      newSelections = (this._editor.getSelections() || []).map(function (selection) {
                          if (selection.containsPosition(newCursorPosition_1)) {
                              return new selection_js_1.Selection(newCursorPosition_1.lineNumber, newCursorPosition_1.column, newCursorPosition_1.lineNumber, newCursorPosition_1.column);
                          }
                          else {
                              return selection;
                          }
                  ...
                  this._editor.executeCommand(DragAndDropController.ID, new dragAndDropCommand_js_1.DragAndDropCommand(this._dragSelection, newCursorPosition_1, hasTriggerModifier(mouseEvent.event) || this._modifierPressed));
                  this._editor.pushUndoStop();
              }
          }
          this._editor.updateOptions({
      ...
      DragAndDropController.TRIGGER_KEY_VALUE = platform_js_1.isMacintosh ? 6 /* Alt */ : 5 /* Ctrl */;
      DragAndDropController._DECORATION_OPTIONS = textModel_js_1.ModelDecorationOptions.register({
          className: 'dnd-target'
      });
      return DragAndDropController;
  }());
  exports.DragAndDropController = DragAndDropController;
  editorExtensions_js_1.registerEditorContribution(DragAndDropController);
