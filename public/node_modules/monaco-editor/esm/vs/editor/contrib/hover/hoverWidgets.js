define('node_modules/monaco-editor/esm/vs/editor/contrib/hover/hoverWidgets', function(require, exports, module) {
  ...
  var ContentHoverWidget = /** @class */ (function (_super) {
      ...
      function ContentHoverWidget(id, editor) {
          ...
          _this.scrollbar = new scrollableElement_js_1.DomScrollableElement(_this._domNode, {});
      ...
      Object.defineProperty(ContentHoverWidget.prototype, "isVisible", {
          ...
          set: function (value) {
              ...
              dom_js_1.toggleClass(this._containerDomNode, 'hidden', !this._isVisible);
          },
          enumerable: true,
          configurable: true
      });
  ...
  var GlyphHoverWidget = /** @class */ (function (_super) {
      ...
      Object.defineProperty(GlyphHoverWidget.prototype, "isVisible", {
          ...
          set: function (value) {
              this._isVisible = value;
              dom_js_1.toggleClass(this._domNode, 'hidden', !this._isVisible);
          },
          enumerable: true,
          configurable: true
      });
