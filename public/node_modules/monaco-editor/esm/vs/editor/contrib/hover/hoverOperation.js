define('node_modules/monaco-editor/esm/vs/editor/contrib/hover/hoverOperation', function(require, exports, module) {
  ...
  var HoverOperation = /** @class */ (function () {
      function HoverOperation(computer, success, error, progress, hoverTime) {
          ...
          this._firstWaitScheduler = new async_js_1.RunOnceScheduler(function () { return _this._triggerAsyncComputation(); }, 0);
          this._secondWaitScheduler = new async_js_1.RunOnceScheduler(function () { return _this._triggerSyncComputation(); }, 0);
          this._loadingMessageScheduler = new async_js_1.RunOnceScheduler(function () { return _this._showLoadingMessage(); }, 0);
      ...
      HoverOperation.prototype._triggerAsyncComputation = function () {
          ...
          if (this._computer.computeAsync) {
              this._asyncComputationPromiseDone = false;
              this._asyncComputationPromise = async_js_1.createCancelablePromise(function (token) { return _this._computer.computeAsync(token); });
