define('node_modules/monaco-editor/esm/vs/platform/commands/common/commands', function(require, exports, module) {
  ...
  exports.ICommandService = instantiation_js_1.createDecorator('commandService');
  exports.CommandsRegistry = new /** @class */ (function () {
      function class_1() {
          this._commands = new Map();
          this._onDidRegisterCommand = new event_js_1.Emitter();
      ...
      class_1.prototype.registerCommand = function (idOrCommand, handler) {
          ...
          if (idOrCommand.description) {
              ...
              idOrCommand.handler = function (accessor) {
                  ...
                  types_js_1.validateConstraints(args, constraints_1);
          ...
          if (!commands) {
              commands = new linkedList_js_1.LinkedList();
              this._commands.set(id, commands);
          }
          var removeFn = commands.unshift(idOrCommand);
          var ret = lifecycle_js_1.toDisposable(function () {
              removeFn();
