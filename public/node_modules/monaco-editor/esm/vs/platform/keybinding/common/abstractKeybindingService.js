define('node_modules/monaco-editor/esm/vs/platform/keybinding/common/abstractKeybindingService', function(require, exports, module) {
  ...
  var AbstractKeybindingService = /** @class */ (function (_super) {
      ...
      function AbstractKeybindingService(contextKeyService, commandService, telemetryService, notificationService, statusService) {
          ...
          _this._currentChordChecker = new async_js_1.IntervalTimer();
          _this._currentChordStatusMessage = null;
          _this._onDidUpdateKeybindings = _this._register(new event_js_1.Emitter());
          return _this;
      }
      ...
      AbstractKeybindingService.prototype.lookupKeybinding = function (commandId) {
          ...
          return types_js_1.withNullAsUndefined(result.resolvedKeybinding);
      };
