define('node_modules/monaco-editor/esm/vs/platform/keybinding/common/keybindingResolver', function(require, exports, module) {
  ...
  var KeybindingResolver = /** @class */ (function () {
      ...
      KeybindingResolver.whenIsEntirelyIncluded = function (a, b) {
          ...
          var aExpressions = ((a instanceof contextkey_js_1.ContextKeyAndExpr) ? a.expr : [a]);
          var bExpressions = ((b instanceof contextkey_js_1.ContextKeyAndExpr) ? b.expr : [b]);
          var aIndex = 0;
