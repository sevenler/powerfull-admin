define('node_modules/monaco-editor/esm/vs/platform/configuration/common/configurationModels', function(require, exports, module) {
  ...
  var ConfigurationModel = /** @class */ (function () {
      ...
      ConfigurationModel.prototype.getValue = function (section) {
          return section ? configuration_js_1.getConfigurationValue(this.contents, section) : this.contents;
      };
      ...
      ConfigurationModel.prototype.setValue = function (key, value) {
          this.addKey(key);
          configuration_js_1.addToValueTree(this.contents, key, value, function (e) { throw new Error(e); });
      };
      ConfigurationModel.prototype.removeValue = function (key) {
          if (this.removeKey(key)) {
              configuration_js_1.removeFromValueTree(this.contents, key);
          }
      };
  ...
  var DefaultConfigurationModel = /** @class */ (function (_super) {
      ...
      function DefaultConfigurationModel() {
          var _this = this;
          var contents = configuration_js_1.getDefaultValues();
          var keys = configuration_js_1.getConfigurationKeys();
          var overrides = [];
          for (var _i = 0, _a = Object.keys(contents); _i < _a.length; _i++) {
              var key = _a[_i];
              if (configurationRegistry_js_1.OVERRIDE_PROPERTY_PATTERN.test(key)) {
                  overrides.push({
                      identifiers: [configuration_js_1.overrideIdentifierFromKey(key).trim()],
                      contents: configuration_js_1.toValuesTree(contents[key], function (message) { return console.error("Conflict in default settings file: " + message); })
                  });
              }
          }
