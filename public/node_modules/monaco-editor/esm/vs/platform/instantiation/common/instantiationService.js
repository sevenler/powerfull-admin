define('node_modules/monaco-editor/esm/vs/platform/instantiation/common/instantiationService', function(require, exports, module) {
  ...
  var graph_js_1 = require("node_modules/monaco-editor/esm/vs/platform/instantiation/common/graph");
  var descriptors_js_1 = require("node_modules/monaco-editor/esm/vs/platform/instantiation/common/descriptors");
  ...
  var InstantiationService = /** @class */ (function () {
      function InstantiationService(services, strict, parent) {
          if (services === void 0) {
              services = new serviceCollection_js_1.ServiceCollection();
          }
          if (strict === void 0) {
              strict = false;
          }
          ...
          try {
              var accessor = {
                  get: function (id, isOptional) {
                      if (_done) {
                          throw errors_js_1.illegalState('service accessor is only valid during the invocation of its target method');
                      }
                      var result = _this._getOrCreateServiceInstance(id, _trace);
                      if (!result && isOptional !== instantiation_js_1.optional) {
      ...
      InstantiationService.prototype._createInstance = function (ctor, args, _trace) {
          ...
          var serviceDependencies = instantiation_js_1._util.getServiceDependencies(ctor).sort(function (a, b) { return a.index - b.index; });
          var serviceArgs = [];
      ...
      InstantiationService.prototype._createAndCacheServiceInstance = function (id, desc, _trace) {
          var graph = new graph_js_1.Graph(function (data) { return data.id.toString(); });
          ...
          while (stack.length) {
              ...
              var dependencies = instantiation_js_1._util.getServiceDependencies(item.desc.ctor);
      ...
      InstantiationService.prototype._createServiceInstance = function (ctor, args, _supportsDelayedInstantiation, _trace) {
          ...
          if (!_supportsDelayedInstantiation || !_canUseProxy) {
              ...
              var idle_1 = new async_js_1.IdleValue(function () { return _this._createInstance(ctor, args, _trace); });
