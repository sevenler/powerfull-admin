define('node_modules/monaco-editor/esm/vs/platform/contextkey/browser/contextKeyService', function(require, exports, module) {
      ...
      function ConfigAwareContextValuesContainer(id, _configurationService, emitter) {
          ...
          _this._listener = _this._configurationService.onDidChangeConfiguration(function (event) {
              if (event.source === 6 /* DEFAULT */) {
                  ...
                  var allKeys = map_js_1.keys(_this._values);
                  _this._values.clear();
  ...
  var AbstractContextKeyService = /** @class */ (function () {
      function AbstractContextKeyService(myContextId) {
          this._onDidChangeContext = new event_js_1.PauseableEmitter({ merge: function (input) { return new CompositeContextKeyChangeEvent(input); } });
      ...
      AbstractContextKeyService.prototype.contextMatchesRules = function (rules) {
          ...
          var result = keybindingResolver_js_1.KeybindingResolver.contextMatchesRules(context, rules);
  ...
  var ScopedContextKeyService = /** @class */ (function (_super) {
      ...
      Object.defineProperty(ScopedContextKeyService.prototype, "onDidChangeContext", {
          get: function () {
              return event_js_1.Event.any(this._parent.onDidChangeContext, this._onDidChangeContext.event);
          },
          enumerable: true,
          configurable: true
      });
  ...
  commands_js_1.CommandsRegistry.registerCommand(contextkey_js_1.SET_CONTEXT_COMMAND_ID, function (accessor, contextKey, contextValue) {
      accessor.get(contextkey_js_1.IContextKeyService).createKey(String(contextKey), contextValue);
  });
