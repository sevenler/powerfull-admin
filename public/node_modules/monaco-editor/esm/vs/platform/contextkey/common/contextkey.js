define('node_modules/monaco-editor/esm/vs/platform/contextkey/common/contextkey', function(require, exports, module) {
  ...
  var ContextKeyExpr = /** @class */ (function () {
      ...
      ContextKeyExpr._deserializeRegexValue = function (serializedValue, strict) {
          if (strings_js_1.isFalsyOrWhitespace(serializedValue)) {
              if (strict) {
  ...
  exports.IContextKeyService = instantiation_js_1.createDecorator('contextKeyService');
