define('node_modules/monaco-editor/esm/vs/platform/markers/common/markerService', function(require, exports, module) {
  ...
  (function (MapMap) {
      ...
      function remove(map, key1, key2) {
          if (map[key1] && map[key1][key2]) {
              ...
              if (types_js_1.isEmptyObject(map[key1])) {
                  delete map[key1];
              }
              return true;
          }
  ...
  var MarkerStats = /** @class */ (function () {
      ...
      MarkerStats.prototype._resourceStats = function (resource) {
          ...
          // TODO this is a hack
          if (resource.scheme === network_js_1.Schemas.inMemory || resource.scheme === network_js_1.Schemas.walkThrough || resource.scheme === network_js_1.Schemas.walkThroughSnippet) {
              return result;
          }
  ...
  var MarkerService = /** @class */ (function () {
      function MarkerService() {
          this._onMarkerChanged = new event_js_1.Emitter();
          this._onMarkerChangedEvent = event_js_1.Event.debounce(this._onMarkerChanged.event, MarkerService._debouncer, 0);
      ...
      MarkerService.prototype.changeOne = function (owner, resource, markerData) {
          if (arrays_js_1.isFalsyOrEmpty(markerData)) {
