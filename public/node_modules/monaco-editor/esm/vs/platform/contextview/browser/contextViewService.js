define('node_modules/monaco-editor/esm/vs/platform/contextview/browser/contextViewService', function(require, exports, module) {
  ...
  var contextview_js_1 = require("node_modules/monaco-editor/esm/vs/base/browser/ui/contextview/contextview");
  ...
  var ContextViewService = /** @class */ (function (_super) {
      ...
      function ContextViewService(layoutService) {
          ...
          _this.contextView = _this._register(new contextview_js_1.ContextView(layoutService.container));
          _this.layout();
