define('node_modules/monaco-editor/esm/vs/language/html/_deps/vscode-html-languageservice/services/htmlCompletion', function(require, exports, module) {
   ...
   *--------------------------------------------------------------------------------------------*/
  var main_js_1 = require("node_modules/monaco-editor/esm/vs/language/html/_deps/vscode-languageserver-types/main");
  ...
  var htmlLanguageTypes_js_1 = require("node_modules/monaco-editor/esm/vs/language/html/_deps/vscode-html-languageservice/htmlLanguageTypes");
  var htmlEntities_js_1 = require("node_modules/monaco-editor/esm/vs/language/html/_deps/vscode-html-languageservice/parser/htmlEntities");
  var nls = tslib_1.__importStar(require("node_modules/monaco-editor/esm/vs/language/html/fillers/vscode-nls"));
  var strings_js_1 = require("node_modules/monaco-editor/esm/vs/language/html/_deps/vscode-html-languageservice/utils/strings");
  ...
  var fact_js_1 = require("node_modules/monaco-editor/esm/vs/language/html/_deps/vscode-html-languageservice/languageFacts/fact");
  ...
  var HTMLCompletion = /** @class */ (function () {
      ...
      HTMLCompletion.prototype.doComplete = function (document, position, htmlDocument, settings) {
          ...
          var dataProviders = builtinDataProviders_js_1.getAllDataProviders().filter(function (p) { return p.isApplicable(document.languageId) && (!settings || settings[p.getId()] !== false); });
          ...
          var scanner = htmlScanner_js_1.createScanner(text, node.start);
          var currentTag = '';
          ...
          function collectOpenTagSuggestions(afterOpenBracket, tagNameEnd) {
              ...
              dataProviders.forEach(function (provider) {
                  provider.provideTags().forEach(function (tag) {
                      result.items.push({
                          label: tag.name,
                          kind: main_js_1.CompletionItemKind.Property,
                          documentation: tag.description,
                          textEdit: main_js_1.TextEdit.replace(range, tag.name),
                          insertTextFormat: main_js_1.InsertTextFormat.PlainText
                      });
                  });
              });
              return result;
          ...
          function collectCloseTagSuggestions(afterOpenBracket, inOpenTag, tagNameEnd) {
              ...
              var range = getReplaceRange(afterOpenBracket, tagNameEnd);
              var closeTag = isFollowedBy(text, tagNameEnd, htmlLanguageTypes_js_1.ScannerState.WithinEndTag, htmlLanguageTypes_js_1.TokenType.EndTagClose) ? '' : '>';
              var curr = node;
              if (inOpenTag) {
              ...
              while (curr) {
                  ...
                  if (tag && (!curr.closed || curr.endTagStart && (curr.endTagStart > offset))) {
                      var item = {
                          ...
                          textEdit: main_js_1.TextEdit.replace(range, '/' + tag + closeTag),
                          insertTextFormat: main_js_1.InsertTextFormat.PlainText
                      };
                      ...
                      if (startIndent !== null && endIndent !== null && startIndent !== endIndent) {
                          ...
                          item.textEdit = main_js_1.TextEdit.replace(getReplaceRange(afterOpenBracket - 1 - endIndent.length), insertText);
          ...
          function collectAutoCloseTagSuggestion(tagCloseEnd, tag) {
              ...
              if (!fact_js_1.isVoidElement(tag)) {
                  var pos = document.positionAt(tagCloseEnd);
                  result.items.push({
                      label: '</' + tag + '>',
                      kind: main_js_1.CompletionItemKind.Property,
                      filterText: '</' + tag + '>',
                      textEdit: main_js_1.TextEdit.insert(pos, '$0</' + tag + '>'),
          ...
          function collectAttributeNameSuggestions(nameStart, nameEnd) {
              ...
              var value = isFollowedBy(text, nameEnd, htmlLanguageTypes_js_1.ScannerState.AfterAttributeName, htmlLanguageTypes_js_1.TokenType.DelimiterAssign) ? '' : '="$1"';
              ...
              dataProviders.forEach(function (provider) {
                  provider.provideAttributes(tag).forEach(function (attr) {
                      ...
                      result.items.push({
                          label: attr.name,
                          kind: attr.valueSet === 'handler' ? main_js_1.CompletionItemKind.Function : main_js_1.CompletionItemKind.Value,
                          documentation: attr.description,
                          textEdit: main_js_1.TextEdit.replace(range, codeSnippet),
                          insertTextFormat: main_js_1.InsertTextFormat.Snippet,
                          command: command
                      });
                  });
          ...
          function collectDataAttributesSuggestions(range, seenAttributes) {
              ...
              function addNodeDataAttributes(node) {
                  node.attributeNames.forEach(function (attr) {
                      if (strings_js_1.startsWith(attr, dataAttr) && !dataAttributes[attr] && !seenAttributes[attr]) {
              ...
              Object.keys(dataAttributes).forEach(function (attr) {
                  return result.items.push({
                      label: attr,
                      kind: main_js_1.CompletionItemKind.Value,
                      textEdit: main_js_1.TextEdit.replace(range, dataAttributes[attr]),
                      insertTextFormat: main_js_1.InsertTextFormat.Snippet
                  });
              });
          }
              ...
              dataProviders.forEach(function (provider) {
                  provider.provideValues(tag, attribute).forEach(function (value) {
                      ...
                      result.items.push({
                          ...
                          kind: main_js_1.CompletionItemKind.Unit,
                          textEdit: main_js_1.TextEdit.replace(range, insertText),
                          insertTextFormat: main_js_1.InsertTextFormat.PlainText
                      });
                  });
              });
          ...
          function collectCharacterEntityProposals() {
              ...
              while (k >= 0 && strings_js_1.isLetterOrDigit(text, k)) {
                  k--;
                  characterStart--;
              }
              if (k >= 0 && text[k] === '&') {
                  var range = main_js_1.Range.create(main_js_1.Position.create(position.line, characterStart - 1), position);
                  for (var entity in htmlEntities_js_1.entities) {
                      if (strings_js_1.endsWith(entity, ';')) {
                          var label = '&' + entity;
                          result.items.push({
                              label: label,
                              kind: main_js_1.CompletionItemKind.Keyword,
                              documentation: localize('entity.propose', "Character entity representing '" + htmlEntities_js_1.entities[entity] + "'"),
                              textEdit: main_js_1.TextEdit.replace(range, label),
                              insertTextFormat: main_js_1.InsertTextFormat.PlainText
                          });
                      }
                  }
          ...
          function suggestDoctype(replaceStart, replaceEnd) {
              ...
              result.items.push({
                  ...
                  textEdit: main_js_1.TextEdit.replace(range, '!DOCTYPE html>'),
                  insertTextFormat: main_js_1.InsertTextFormat.PlainText
              });
          }
          var token = scanner.scan();
          while (token !== htmlLanguageTypes_js_1.TokenType.EOS && scanner.getTokenOffset() <= offset) {
              switch (token) {
                  case htmlLanguageTypes_js_1.TokenType.StartTagOpen:
                      if (scanner.getTokenEnd() === offset) {
                          var endPos = scanNextForEndPos(htmlLanguageTypes_js_1.TokenType.StartTag);
                          if (position.line === 0) {
                  ...
                  case htmlLanguageTypes_js_1.TokenType.AttributeName:
                      ...
                      break;
                  case htmlLanguageTypes_js_1.TokenType.DelimiterAssign:
                      if (scanner.getTokenEnd() === offset) {
                          var endPos = scanNextForEndPos(htmlLanguageTypes_js_1.TokenType.AttributeValue);
                  ...
                  case htmlLanguageTypes_js_1.TokenType.AttributeValue:
                      ...
                      break;
                  case htmlLanguageTypes_js_1.TokenType.Whitespace:
                      if (offset <= scanner.getTokenEnd()) {
                          switch (scanner.getScannerState()) {
                              case htmlLanguageTypes_js_1.ScannerState.AfterOpeningStartTag:
                                  var startPos = scanner.getTokenOffset();
                                  var endTagPos = scanNextForEndPos(htmlLanguageTypes_js_1.TokenType.StartTag);
                                  return collectTagSuggestions(startPos, endTagPos);
                              case htmlLanguageTypes_js_1.ScannerState.WithinTag:
                              case htmlLanguageTypes_js_1.ScannerState.AfterAttributeName:
                                  return collectAttributeNameSuggestions(scanner.getTokenEnd());
                              case htmlLanguageTypes_js_1.ScannerState.BeforeAttributeValue:
                                  return collectAttributeValueSuggestions(scanner.getTokenEnd());
                              case htmlLanguageTypes_js_1.ScannerState.AfterOpeningEndTag:
                                  return collectCloseTagSuggestions(scanner.getTokenOffset() - 1, false);
                              case htmlLanguageTypes_js_1.ScannerState.WithinContent:
                  ...
                  case htmlLanguageTypes_js_1.TokenType.EndTagOpen:
                      if (offset <= scanner.getTokenEnd()) {
                          ...
                          var endOffset = scanNextForEndPos(htmlLanguageTypes_js_1.TokenType.EndTag);
                  ...
                  case htmlLanguageTypes_js_1.TokenType.StartTagClose:
                      ...
                      break;
                  case htmlLanguageTypes_js_1.TokenType.Content:
                      if (offset <= scanner.getTokenEnd()) {
                          return collectInsideContent();
                      }
                      break;
      ...
      HTMLCompletion.prototype.doTagComplete = function (document, position, htmlDocument) {
          ...
          if (char === '>') {
              var node = htmlDocument.findNodeBefore(offset);
              if (node && node.tag && !fact_js_1.isVoidElement(node.tag) && node.start < offset && (!node.endTagStart || node.endTagStart > offset)) {
                  var scanner = htmlScanner_js_1.createScanner(document.getText(), node.start);
                  var token = scanner.scan();
                  while (token !== htmlLanguageTypes_js_1.TokenType.EOS && scanner.getTokenEnd() <= offset) {
                      if (token === htmlLanguageTypes_js_1.TokenType.StartTagClose && scanner.getTokenEnd() === offset) {
                          return "$0</" + node.tag + ">";
                      }
                      token = scanner.scan();
                  }
              ...
              if (node && node.tag) {
                  ...
                  var token = scanner.scan();
                  while (token !== htmlLanguageTypes_js_1.TokenType.EOS && scanner.getTokenEnd() <= offset) {
                      if (token === htmlLanguageTypes_js_1.TokenType.EndTagOpen && scanner.getTokenEnd() === offset) {
                          return node.tag + ">";
                      }
                      token = scanner.scan();
                  }
  ...
  function isFollowedBy(s, offset, intialState, expectedToken) {
      var scanner = htmlScanner_js_1.createScanner(s, offset, intialState);
      var token = scanner.scan();
      while (token === htmlLanguageTypes_js_1.TokenType.Whitespace) {
          token = scanner.scan();
      }
