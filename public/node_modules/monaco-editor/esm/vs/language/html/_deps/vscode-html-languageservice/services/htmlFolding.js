define('node_modules/monaco-editor/esm/vs/language/html/_deps/vscode-html-languageservice/services/htmlFolding', function(require, exports, module) {
  ...
  function getFoldingRanges(document, context) {
      var scanner = htmlScanner_js_1.createScanner(document.getText());
      ...
      while (token !== htmlLanguageTypes_js_1.TokenType.EOS) {
          switch (token) {
              ...
              case htmlLanguageTypes_js_1.TokenType.StartTagClose:
                  if (!lastTagName || !fact_js_1.isVoidElement(lastTagName)) {
                      break;
                  }
              // fallthrough
              ...
              case htmlLanguageTypes_js_1.TokenType.Comment: {
                  var startLine = document.positionAt(scanner.getTokenOffset()).line;
                  ...
                  if (m) {
                      if (m[1]) { // start pattern match
                          ...
                          if (i >= 0) {
                              ...
                              if (endLine > startLine && prevStart !== startLine) {
                                  addRange({ startLine: startLine, endLine: endLine, kind: main_js_1.FoldingRangeKind.Region });
                              }
                          }
                      }
                  }
                      ...
                      if (startLine < endLine) {
                          addRange({ startLine: startLine, endLine: endLine, kind: main_js_1.FoldingRangeKind.Comment });
                      }
                  }
                  break;
              }
