define('node_modules/monaco-editor/esm/vs/language/css/_deps/vscode-css-languageservice/services/cssFolding', function(require, exports, module) {
  ...
  var scssScanner_js_1 = require("node_modules/monaco-editor/esm/vs/language/css/_deps/vscode-css-languageservice/parser/scssScanner");
  var lessScanner_js_1 = require("node_modules/monaco-editor/esm/vs/language/css/_deps/vscode-css-languageservice/parser/lessScanner");
  ...
  function computeFoldingRanges(document) {
      ...
      function getScanner() {
          switch (document.languageId) {
              case 'scss':
                  return new scssScanner_js_1.SCSSScanner();
              case 'less':
                  return new lessScanner_js_1.LESSScanner();
              default:
                  return new cssScanner_js_1.Scanner();
          }
      }
      ...
      var _loop_1 = function () {
          switch (token.type) {
              ...
              case scssScanner_js_1.InterpolationFunction:
                  {
               ...
               */
              case cssScanner_js_1.TokenType.Comment: {
      ...
      while (token.type !== cssScanner_js_1.TokenType.EOF) {
          _loop_1();
      }
      return ranges;
  }
