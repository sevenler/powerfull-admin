define('node_modules/monaco-editor/esm/vs/language/css/_deps/vscode-css-languageservice/services/lessCompletion', function(require, exports, module) {
      ...
      LESSCompletion.prototype.createFunctionProposals = function (proposals, existingNode, sortToEnd, result) {
          for (var _i = 0, proposals_1 = proposals; _i < proposals_1.length; _i++) {
              ...
              var item = {
                  ...
                  textEdit: main_js_1.TextEdit.replace(this.getCompletionRange(existingNode), p.name + '($0)'),
