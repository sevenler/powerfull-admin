define('node_modules/monaco-editor/esm/vs/language/css/_deps/vscode-css-languageservice/parser/cssScanner', function(require, exports, module) {
  ...
  staticTokenTable[_SEM] = exports.TokenType.SemiColon;
  staticTokenTable[_COL] = exports.TokenType.Colon;
  staticTokenTable[_CUL] = exports.TokenType.CurlyL;
  staticTokenTable[_CUR] = exports.TokenType.CurlyR;
  staticTokenTable[_BRR] = exports.TokenType.BracketR;
  staticTokenTable[_BRL] = exports.TokenType.BracketL;
  staticTokenTable[_LPA] = exports.TokenType.ParenthesisL;
  staticTokenTable[_RPA] = exports.TokenType.ParenthesisR;
  staticTokenTable[_CMA] = exports.TokenType.Comma;
  var staticUnitTable = {};
  staticUnitTable['em'] = exports.TokenType.EMS;
  staticUnitTable['ex'] = exports.TokenType.EXS;
  staticUnitTable['px'] = exports.TokenType.Length;
  staticUnitTable['cm'] = exports.TokenType.Length;
  staticUnitTable['mm'] = exports.TokenType.Length;
  staticUnitTable['in'] = exports.TokenType.Length;
  staticUnitTable['pt'] = exports.TokenType.Length;
  staticUnitTable['pc'] = exports.TokenType.Length;
  staticUnitTable['deg'] = exports.TokenType.Angle;
  staticUnitTable['rad'] = exports.TokenType.Angle;
  staticUnitTable['grad'] = exports.TokenType.Angle;
  staticUnitTable['ms'] = exports.TokenType.Time;
  staticUnitTable['s'] = exports.TokenType.Time;
  staticUnitTable['hz'] = exports.TokenType.Freq;
  staticUnitTable['khz'] = exports.TokenType.Freq;
  staticUnitTable['%'] = exports.TokenType.Percentage;
  staticUnitTable['fr'] = exports.TokenType.Percentage;
  staticUnitTable['dpi'] = exports.TokenType.Resolution;
  staticUnitTable['dpcm'] = exports.TokenType.Resolution;
  var Scanner = /** @class */ (function () {
      ...
      Scanner.prototype.scanUnquotedString = function () {
          ...
          if (this._unquotedString(content)) {
              return this.finishToken(offset, exports.TokenType.UnquotedString, content.join(''));
          }
          return null;
      };
      Scanner.prototype.scan = function () {
          ...
          // End of file/input
          if (this.stream.eos()) {
              return this.finishToken(offset, exports.TokenType.EOF);
          }
      ...
      Scanner.prototype.scanNext = function (offset) {
          ...
          if (this.stream.advanceIfChars([_LAN, _BNG, _MIN, _MIN])) {
              return this.finishToken(offset, exports.TokenType.CDO);
          }
          // CDC -->
          if (this.stream.advanceIfChars([_MIN, _MIN, _RAN])) {
              return this.finishToken(offset, exports.TokenType.CDC);
          }
          var content = [];
          if (this.ident(content)) {
              return this.finishToken(offset, exports.TokenType.Ident, content.join(''));
          }
          // at-keyword
          if (this.stream.advanceIfChar(_ATS)) {
              ...
              if (this._name(content)) {
                  ...
                  if (keywordText === '@charset') {
                      return this.finishToken(offset, exports.TokenType.Charset, keywordText);
                  }
                  return this.finishToken(offset, exports.TokenType.AtKeyword, keywordText);
              }
              else {
                  return this.finishToken(offset, exports.TokenType.Delim);
              }
          }
          // hash
          if (this.stream.advanceIfChar(_HSH)) {
              content = ['#'];
              if (this._name(content)) {
                  return this.finishToken(offset, exports.TokenType.Hash, content.join(''));
              }
              else {
                  return this.finishToken(offset, exports.TokenType.Delim);
              }
          ...
          if (this.stream.advanceIfChar(_BNG)) {
              return this.finishToken(offset, exports.TokenType.Exclamation);
          }
          // Numbers
          if (this._number()) {
              ...
              if (this.stream.advanceIfChar(_PRC)) {
                  // Percentage 43%
                  return this.finishToken(offset, exports.TokenType.Percentage);
              }
                  ...
                  if (typeof tokenType_1 !== 'undefined') {
                      ...
                      return this.finishToken(offset, exports.TokenType.Dimension, content.join(''));
                  }
              }
              return this.finishToken(offset, exports.TokenType.Num);
          }
          // String, BadString
          content = [];
          ...
          if (this.stream.peekChar(0) === _TLD && this.stream.peekChar(1) === _EQS) {
              ...
              return this.finishToken(offset, exports.TokenType.Includes);
          }
          // DashMatch |=
          if (this.stream.peekChar(0) === _PIP && this.stream.peekChar(1) === _EQS) {
              this.stream.advance(2);
              return this.finishToken(offset, exports.TokenType.Dashmatch);
          }
          // Substring operator *=
          if (this.stream.peekChar(0) === _MUL && this.stream.peekChar(1) === _EQS) {
              this.stream.advance(2);
              return this.finishToken(offset, exports.TokenType.SubstringOperator);
          }
          // Substring operator ^=
          if (this.stream.peekChar(0) === _HAT && this.stream.peekChar(1) === _EQS) {
              this.stream.advance(2);
              return this.finishToken(offset, exports.TokenType.PrefixOperator);
          }
          // Substring operator $=
          if (this.stream.peekChar(0) === _DLR && this.stream.peekChar(1) === _EQS) {
              this.stream.advance(2);
              return this.finishToken(offset, exports.TokenType.SuffixOperator);
          }
          // Delim
          ...
          while (true) {
              ...
              if (this._whitespace()) {
                  if (!this.ignoreWhitespace) {
                      return this.finishToken(offset, exports.TokenType.Whitespace);
                  }
              }
              else if (this.comment()) {
                  if (!this.ignoreComment) {
                      return this.finishToken(offset, exports.TokenType.Comment);
                  }
              }
              else {
                  return null;
      ...
      Scanner.prototype._string = function (result) {
          if (this.stream.peekChar() === _SQO || this.stream.peekChar() === _DQO) {
              ...
              if (this.stream.peekChar() === closeQuote) {
                  this.stream.nextChar();
                  result.push(String.fromCharCode(closeQuote));
                  return exports.TokenType.String;
              }
              else {
                  return exports.TokenType.BadString;
              }
          }
          return null;
      };
