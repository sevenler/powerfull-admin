define('node_modules/monaco-editor/esm/vs/language/css/_deps/vscode-css-languageservice/services/lint', function(require, exports, module) {
  ...
  var languageFacts = tslib_1.__importStar(require("node_modules/monaco-editor/esm/vs/language/css/_deps/vscode-css-languageservice/languageFacts/facts"));
  var lintRules_js_1 = require("node_modules/monaco-editor/esm/vs/language/css/_deps/vscode-css-languageservice/services/lintRules");
  var nodes = tslib_1.__importStar(require("node_modules/monaco-editor/esm/vs/language/css/_deps/vscode-css-languageservice/parser/cssNodes"));
  var lintUtil_js_1 = tslib_1.__importStar(require("node_modules/monaco-editor/esm/vs/language/css/_deps/vscode-css-languageservice/services/lintUtil"));
  var arrays_js_1 = require("node_modules/monaco-editor/esm/vs/language/css/_deps/vscode-css-languageservice/utils/arrays");
  var nls = tslib_1.__importStar(require("node_modules/monaco-editor/esm/vs/language/css/fillers/vscode-nls"));
  ...
  var LintVisitor = /** @class */ (function () {
      function LintVisitor(document, settings) {
          ...
          var properties = settings.getSetting(lintRules_js_1.Settings.ValidProperties);
      ...
      LintVisitor.prototype.visitUnknownAtRule = function (node) {
          ...
          this.addEntry(atRuleName, lintRules_js_1.Rules.UnknownAtRules, "Unknown at rule " + atRuleName.getText());
          return true;
      };
              ...
              if (missingVendorSpecific || needsStandard) {
                  for (var _i = 0, _a = this.keyframes.data[name].nodes; _i < _a.length; _i++) {
                      ...
                      if (needsStandard) {
                          ...
                          this.addEntry(node, lintRules_js_1.Rules.IncludeStandardPropertyWhenUsingVendorPrefix, message);
                      }
                      if (missingVendorSpecific) {
                          ...
                          this.addEntry(node, lintRules_js_1.Rules.AllVendorPrefixes, message);
                      }
                  }
              }
          }
      ...
      LintVisitor.prototype.visitSimpleSelector = function (node) {
          ...
          if (node.length === 1 && firstChar === '*') {
              this.addEntry(node, lintRules_js_1.Rules.UniversalSelector);
          }
          /////////////////////////////////////////////////////////////
          //	Lint - Avoid id selectors
          /////////////////////////////////////////////////////////////
          if (firstChar === '#') {
              this.addEntry(node, lintRules_js_1.Rules.AvoidIdSelector);
          }
          return true;
      };
      LintVisitor.prototype.visitImport = function (node) {
          ...
          /////////////////////////////////////////////////////////////
          this.addEntry(node, lintRules_js_1.Rules.ImportStatemement);
          return true;
      };
      LintVisitor.prototype.visitRuleSet = function (node) {
          ...
          if (!declarations.hasChildren()) {
              this.addEntry(node.getSelectors(), lintRules_js_1.Rules.EmptyRuleSet);
          }
          var propertyTable = [];
          for (var _i = 0, _a = declarations.getChildren(); _i < _a.length; _i++) {
              ...
              if (element instanceof nodes.Declaration) {
                  var decl = element;
                  propertyTable.push(new lintUtil_js_1.Element(decl.getFullPropertyName().toLowerCase(), decl));
              }
          }
          /////////////////////////////////////////////////////////////
          ...
          /////////////////////////////////////////////////////////////
          var boxModel = lintUtil_js_1.default(propertyTable);
          if (boxModel.width) {
              var properties = [];
              if (boxModel.right.value) {
                  properties = arrays_js_1.union(properties, boxModel.right.properties);
              }
              if (boxModel.left.value) {
                  properties = arrays_js_1.union(properties, boxModel.left.properties);
              }
              if (properties.length !== 0) {
                  for (var _b = 0, properties_1 = properties; _b < properties_1.length; _b++) {
                      var item = properties_1[_b];
                      this.addEntry(item.node, lintRules_js_1.Rules.BewareOfBoxModelSize);
                  }
                  this.addEntry(boxModel.width.node, lintRules_js_1.Rules.BewareOfBoxModelSize);
              }
          }
          if (boxModel.height) {
              var properties = [];
              if (boxModel.top.value) {
                  properties = arrays_js_1.union(properties, boxModel.top.properties);
              }
              if (boxModel.bottom.value) {
                  properties = arrays_js_1.union(properties, boxModel.bottom.properties);
              }
              if (properties.length !== 0) {
                  ...
                  this.addEntry(boxModel.height.node, lintRules_js_1.Rules.BewareOfBoxModelSize);
              }
          }
          /////////////////////////////////////////////////////////////
          ...
          if (displayElems.length > 0) {
              for (var _d = 0, _e = ['width', 'height', 'margin-top', 'margin-bottom', 'float']; _d < _e.length; _d++) {
                  ...
                  for (var index = 0; index < elem.length; index++) {
                      ...
                      this.addEntry(node_1, lintRules_js_1.Rules.PropertyIgnoredDueToDisplay, localize('rule.propertyIgnoredDueToDisplayInline', "Property is ignored due to the display. With 'display: inline', the width, height, margin-top, margin-bottom, and float properties have no effect."));
                  }
              }
          }
          ...
          if (displayElems.length > 0) {
              ...
              for (var index = 0; index < elem.length; index++) {
                  ...
                  if (value && !value.matches('none')) {
                      this.addEntry(node_2, lintRules_js_1.Rules.PropertyIgnoredDueToDisplay, localize('rule.propertyIgnoredDueToDisplayInlineBlock', "inline-block is ignored due to the float. If 'float' has a value other than 'none', the box is floated and 'display' is treated as 'block'"));
                  }
              }
          }
          ...
          if (displayElems.length > 0) {
              ...
              for (var index = 0; index < elem.length; index++) {
                  this.addEntry(elem[index].node, lintRules_js_1.Rules.PropertyIgnoredDueToDisplay, localize('rule.propertyIgnoredDueToDisplayBlock', "Property is ignored due to the display. With 'display: block', vertical-align should not be used."));
              }
          }
          /////////////////////////////////////////////////////////////
          //	Avoid 'float'
          ...
          for (var index = 0; index < elements.length; index++) {
              ...
              if (!this.isValidPropertyDeclaration(decl)) {
                  this.addEntry(decl, lintRules_js_1.Rules.AvoidFloat);
              }
          }
          /////////////////////////////////////////////////////////////
                      ...
                      if (elements_1.length > 1) {
                          for (var k = 0; k < elements_1.length; k++) {
                              ...
                              if (value_1 && this.documentText.charAt(value_1.offset) !== '-' && elements_1[k] !== element) {
                                  this.addEntry(element.node, lintRules_js_1.Rules.DuplicateDeclarations);
                              }
                          }
                      }
                  }
                      ...
                      if (firstChar === '-') {
                          if (name.charAt(1) !== '-') { // avoid css variables
                              if (!languageFacts.cssDataManager.isKnownProperty(name) && !this.validProperties[name]) {
                                  this.addEntry(decl.getProperty(), lintRules_js_1.Rules.UnknownVendorSpecificProperty);
                              }
                          ...
                          if (firstChar === '*' || firstChar === '_') {
                              this.addEntry(decl.getProperty(), lintRules_js_1.Rules.IEStarHack);
                              name = name.substr(1);
                          }
                          ...
                          if (!languageFacts.cssDataManager.isKnownProperty(fullName) && !languageFacts.cssDataManager.isKnownProperty(name)) {
                              if (!this.validProperties[name]) {
                                  this.addEntry(decl.getProperty(), lintRules_js_1.Rules.UnknownProperty, localize('property.unknownproperty.detailed', "Unknown property: '{0}'", name));
                              }
                          }
                      ...
                      if (missingVendorSpecific || needsStandard) {
                          for (var _h = 0, _j = entry.nodes; _h < _j.length; _h++) {
                              ...
                              if (needsStandard) {
                                  ...
                                  this.addEntry(node_4, lintRules_js_1.Rules.IncludeStandardPropertyWhenUsingVendorPrefix, message);
                              }
                              if (missingVendorSpecific) {
                                  ...
                                  this.addEntry(node_4, lintRules_js_1.Rules.AllVendorPrefixes, message);
                              }
                          }
                      }
                  }
      ...
      LintVisitor.prototype.visitPrio = function (node) {
          ...
          //	Don't use !important
          /////////////////////////////////////////////////////////////
          this.addEntry(node, lintRules_js_1.Rules.AvoidImportant);
          return true;
      };
          ...
          if (decl) {
              ...
              if (declValue) {
                  ...
                  if (parseFloat(value.value) === 0.0 && !!value.unit && !this.validProperties[decl.getFullPropertyName()]) {
                      this.addEntry(node, lintRules_js_1.Rules.ZeroWithUnit);
                  }
              }
          }
          return true;
      ...
      LintVisitor.prototype.visitFontFace = function (node) {
          ...
          if (!containsUnknowns && (!definesSrc || !definesFontFamily)) {
              this.addEntry(node, lintRules_js_1.Rules.RequiredPropertiesForFontFace);
          }
          return true;
      };
      ...
      LintVisitor.prototype.visitHexColorValue = function (node) {
          ...
          if (length !== 9 && length !== 7 && length !== 5 && length !== 4) {
              this.addEntry(node, lintRules_js_1.Rules.HexColorLength);
          }
          return false;
      };
      LintVisitor.prototype.visitFunction = function (node) {
          ...
          if (expectedAttrCount !== -1) {
              ...
              if (actualAttrCount !== expectedAttrCount) {
                  this.addEntry(node, lintRules_js_1.Rules.ArgsInColorFunction);
              }
          }
          return true;
      };
