define('node_modules/monaco-editor/esm/vs/language/css/_deps/vscode-css-languageservice/services/lintUtil', function(require, exports, module) {
  ...
  function setSide(model, side, value, property) {
      ...
      state.value = value;
      if (value) {
          if (!arrays_js_1.includes(state.properties, property)) {
  ...
  function checkLineWidth(value, allowsKeywords) {
      ...
      if (allowsKeywords && arrays_js_1.includes(['initial', 'unset'], value)) {
          return false;
      }
  ...
  function checkLineStyle(value, allowsKeywords) {
      ...
      if (arrays_js_1.includes(['none', 'hidden'], value)) {
          return false;
      }
      if (allowsKeywords && arrays_js_1.includes(['initial', 'unset'], value)) {
          return false;
