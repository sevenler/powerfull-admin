define('node_modules/monaco-editor/esm/vs/language/css/_deps/vscode-css-languageservice/parser/scssScanner', function(require, exports, module) {
  ...
  var customTokenValue = cssScanner_js_1.TokenType.CustomToken;
  ...
  var SCSSScanner = /** @class */ (function (_super) {
      ...
      SCSSScanner.prototype.scanNext = function (offset) {
          ...
          if (this.stream.advanceIfChar(_LAN)) {
              ...
              return this.finishToken(offset, cssScanner_js_1.TokenType.Delim);
          }
          // ooperators >, >=
