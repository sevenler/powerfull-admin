define('node_modules/monaco-editor/esm/vs/language/css/_deps/vscode-css-languageservice/services/cssCompletion', function(require, exports, module) {
  ...
  var cssSymbolScope_js_1 = require("node_modules/monaco-editor/esm/vs/language/css/_deps/vscode-css-languageservice/parser/cssSymbolScope");
  ...
  var strings = tslib_1.__importStar(require("node_modules/monaco-editor/esm/vs/language/css/_deps/vscode-css-languageservice/utils/strings"));
  var main_js_1 = require("node_modules/monaco-editor/esm/vs/language/css/_deps/vscode-languageserver-types/main");
  var nls = tslib_1.__importStar(require("node_modules/monaco-editor/esm/vs/language/css/fillers/vscode-nls"));
  var localize = nls.loadMessageBundle();
  var SnippetFormat = main_js_1.InsertTextFormat.Snippet;
  var CSSCompletion = /** @class */ (function () {
      ...
      CSSCompletion.prototype.getSymbolContext = function () {
          if (!this.symbolContext) {
              this.symbolContext = new cssSymbolScope_js_1.Symbols(this.styleSheet);
          }
      ...
      CSSCompletion.prototype.doComplete = function (document, position, styleSheet) {
          ...
          this.defaultReplaceRange = main_js_1.Range.create(main_js_1.Position.create(this.position.line, this.position.character - this.currentWord.length), this.position);
      ...
      CSSCompletion.prototype.getCompletionsForDeclarationValue = function (node, result) {
          ...
          if (entry) {
              ...
              for (var _b = 0, _c = existingValues.getEntries(); _b < _c.length; _b++) {
                  ...
                  result.items.push({
                      label: existingValue,
                      textEdit: main_js_1.TextEdit.replace(this.getCompletionRange(existingNode), existingValue),
              ...
              for (var _i = 0, _a = entry.values; _i < _a.length; _i++) {
                  ...
                  if (languageFacts.supportedInMoreThanOneBrowser(value)) {
                      ...
                      var item = {
                          ...
                          textEdit: main_js_1.TextEdit.replace(this.getCompletionRange(existingNode), insertString),
                          kind: main_js_1.CompletionItemKind.Value,
      ...
      CSSCompletion.prototype.getCSSWideKeywordProposals = function (entry, existingNode, result) {
          for (var keywords in languageFacts.cssWideKeywords) {
              result.items.push({
                  ...
                  textEdit: main_js_1.TextEdit.replace(this.getCompletionRange(existingNode), keywords),
                  kind: main_js_1.CompletionItemKind.Value
              });
          }
          return result;
      ...
      CSSCompletion.prototype.getVariableProposals = function (existingNode, result) {
          ...
          for (var _i = 0, symbols_1 = symbols; _i < symbols_1.length; _i++) {
              ...
              var suggest = {
                  ...
                  kind: main_js_1.CompletionItemKind.Variable,
                  sortText: 'z'
              };
      ...
      CSSCompletion.prototype.getVariableProposalsForCSSVarFunction = function (result) {
          ...
          for (var _i = 0, symbols_2 = symbols; _i < symbols_2.length; _i++) {
              ...
              result.items.push({
                  label: symbol.name,
                  documentation: symbol.value ? strings.getLimitedString(symbol.value) : symbol.value,
                  textEdit: main_js_1.TextEdit.replace(this.getCompletionRange(null), symbol.name),
                  kind: main_js_1.CompletionItemKind.Variable
              });
          }
          return result;
      ...
      CSSCompletion.prototype.getCompletionRange = function (existingNode) {
          if (existingNode && existingNode.offset <= this.offset) {
              ...
              return main_js_1.Range.create(this.textDocument.positionAt(existingNode.offset), end);
          }
      ...
      CSSCompletion.prototype.getColorProposals = function (entry, existingNode, result) {
          for (var color in languageFacts.colors) {
              result.items.push({
                  ...
                  textEdit: main_js_1.TextEdit.replace(this.getCompletionRange(existingNode), color),
                  kind: main_js_1.CompletionItemKind.Color
              });
          }
          ...
          var _loop_1 = function (p) {
              ...
              result.items.push({
                  ...
                  textEdit: main_js_1.TextEdit.replace(this_1.getCompletionRange(existingNode), insertText),
                  insertTextFormat: SnippetFormat,
      ...
      CSSCompletion.prototype.getPositionProposals = function (entry, existingNode, result) {
          for (var position in languageFacts.positionKeywords) {
              result.items.push({
                  ...
                  textEdit: main_js_1.TextEdit.replace(this.getCompletionRange(existingNode), position),
                  kind: main_js_1.CompletionItemKind.Value
              });
          }
          return result;
      ...
      CSSCompletion.prototype.getRepeatStyleProposals = function (entry, existingNode, result) {
          for (var repeat in languageFacts.repeatStyleKeywords) {
              result.items.push({
                  ...
                  textEdit: main_js_1.TextEdit.replace(this.getCompletionRange(existingNode), repeat),
                  kind: main_js_1.CompletionItemKind.Value
              });
          }
          return result;
      ...
      CSSCompletion.prototype.getLineStyleProposals = function (entry, existingNode, result) {
          for (var lineStyle in languageFacts.lineStyleKeywords) {
              result.items.push({
                  ...
                  textEdit: main_js_1.TextEdit.replace(this.getCompletionRange(existingNode), lineStyle),
                  kind: main_js_1.CompletionItemKind.Value
              });
          }
          return result;
      ...
      CSSCompletion.prototype.getLineWidthProposals = function (entry, existingNode, result) {
          for (var _i = 0, _a = languageFacts.lineWidthKeywords; _i < _a.length; _i++) {
              ...
              result.items.push({
                  label: lineWidth,
                  textEdit: main_js_1.TextEdit.replace(this.getCompletionRange(existingNode), lineWidth),
                  kind: main_js_1.CompletionItemKind.Value
              });
          }
          return result;
      ...
      CSSCompletion.prototype.getGeometryBoxProposals = function (entry, existingNode, result) {
          for (var box in languageFacts.geometryBoxKeywords) {
              result.items.push({
                  ...
                  textEdit: main_js_1.TextEdit.replace(this.getCompletionRange(existingNode), box),
                  kind: main_js_1.CompletionItemKind.Value
              });
          }
          return result;
      ...
      CSSCompletion.prototype.getCompletionForTopLevel = function (result) {
          ...
          languageFacts.cssDataManager.getAtDirectives().forEach(function (entry) {
              result.items.push({
                  label: entry.name,
                  textEdit: main_js_1.TextEdit.replace(_this.getCompletionRange(null), entry.name),
                  documentation: languageFacts.getEntryDescription(entry),
      ...
      CSSCompletion.prototype.getCompletionsForSelector = function (ruleSet, isNested, result) {
          ...
          pseudoClasses.forEach(function (entry) {
              ...
              var item = {
                  label: entry.name,
                  textEdit: main_js_1.TextEdit.replace(_this.getCompletionRange(existingNode), insertText),
                  documentation: languageFacts.getEntryDescription(entry),
                  kind: main_js_1.CompletionItemKind.Function,
          ...
          if (!isNested) { // show html tags only for top level
              for (var _i = 0, _a = languageFacts.html5Tags; _i < _a.length; _i++) {
                  ...
                  result.items.push({
                      label: entry,
                      textEdit: main_js_1.TextEdit.replace(this.getCompletionRange(existingNode), entry),
                      kind: main_js_1.CompletionItemKind.Keyword
                  });
              }
          ...
          this.styleSheet.accept(function (n) {
              if (n.type === nodes.NodeType.SimpleSelector && n.length > 0) {
                  ...
                  if (selector.charAt(0) === '.' && !visited[selector]) {
                      ...
                      result.items.push({
                          label: selector,
                          textEdit: main_js_1.TextEdit.replace(_this.getCompletionRange(existingNode), selector),
                          kind: main_js_1.CompletionItemKind.Keyword
                      });
                  }
                  return false;
      ...
      CSSCompletion.prototype.getCompletionForUriLiteralValue = function (uriLiteralNode, result) {
          ...
          if (uriLiteralNode.getChildren().length === 0) {
              ...
              range = main_js_1.Range.create(emptyURIValuePosition, emptyURIValuePosition);
          }
          else {
