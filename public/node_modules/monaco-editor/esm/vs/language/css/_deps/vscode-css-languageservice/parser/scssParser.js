define('node_modules/monaco-editor/esm/vs/language/css/_deps/vscode-css-languageservice/parser/scssParser', function(require, exports, module) {
  ...
  var scssScanner = tslib_1.__importStar(require("node_modules/monaco-editor/esm/vs/language/css/_deps/vscode-css-languageservice/parser/scssScanner"));
  var cssScanner_js_1 = require("node_modules/monaco-editor/esm/vs/language/css/_deps/vscode-css-languageservice/parser/cssScanner");
  var cssParser = tslib_1.__importStar(require("node_modules/monaco-editor/esm/vs/language/css/_deps/vscode-css-languageservice/parser/cssParser"));
  ...
  var scssErrors_js_1 = require("node_modules/monaco-editor/esm/vs/language/css/_deps/vscode-css-languageservice/parser/scssErrors");
  var cssErrors_js_1 = require("node_modules/monaco-editor/esm/vs/language/css/_deps/vscode-css-languageservice/parser/cssErrors");
  /// <summary>
  /// A parser for scss
  ...
  var SCSSParser = /** @class */ (function (_super) {
      ...
      SCSSParser.prototype._parseVariableDeclaration = function (panic) {
          ...
          if (!this.accept(cssScanner_js_1.TokenType.Colon)) {
              return this.finish(node, cssErrors_js_1.ParseError.ColonExpected);
          }
          node.colonPosition = this.prevToken.offset;
          if (!node.setValue(this._parseExpr())) {
              return this.finish(node, cssErrors_js_1.ParseError.VariableValueExpected, [], panic);
          }
          while (this.accept(cssScanner_js_1.TokenType.Exclamation)) {
              if (!this.peekRegExp(cssScanner_js_1.TokenType.Ident, /^(default|global)$/)) {
                  return this.finish(node, cssErrors_js_1.ParseError.UnknownKeyword);
              }
              this.consumeToken();
          }
      ...
      SCSSParser.prototype._parseIdent = function (referenceTypes) {
          var _this = this;
          if (!this.peek(cssScanner_js_1.TokenType.Ident) && !this.peek(scssScanner.InterpolationFunction) && !this.peekDelim('-')) {
              return null;
          }
      ...
      SCSSParser.prototype._parseExtends = function () {
          if (this.peekKeyword('@extend')) {
              ...
              if (this.accept(cssScanner_js_1.TokenType.Exclamation)) {
      ...
      SCSSParser.prototype._parseElementName = function () {
          ...
          if (node && !this.hasWhitespace() && this.peek(cssScanner_js_1.TokenType.ParenthesisL)) { // for #49589
      ...
      SCSSParser.prototype._internalParseIfStatement = function (parseStatement) {
          ...
          if (this.acceptKeyword('@else')) {
              ...
              else if (this.peek(cssScanner_js_1.TokenType.CurlyL)) {
      ...
      SCSSParser.prototype._parseForStatement = function (parseStatement) {
          ...
          if (!node.setVariable(this._parseVariable())) {
              return this.finish(node, cssErrors_js_1.ParseError.VariableNameExpected, [cssScanner_js_1.TokenType.CurlyR]);
          }
          if (!this.acceptIdent('from')) {
              return this.finish(node, scssErrors_js_1.SCSSParseError.FromExpected, [cssScanner_js_1.TokenType.CurlyR]);
          }
          if (!node.addChild(this._parseBinaryExpr())) {
              return this.finish(node, cssErrors_js_1.ParseError.ExpressionExpected, [cssScanner_js_1.TokenType.CurlyR]);
          }
          if (!this.acceptIdent('to') && !this.acceptIdent('through')) {
              return this.finish(node, scssErrors_js_1.SCSSParseError.ThroughOrToExpected, [cssScanner_js_1.TokenType.CurlyR]);
          }
          if (!node.addChild(this._parseBinaryExpr())) {
              return this.finish(node, cssErrors_js_1.ParseError.ExpressionExpected, [cssScanner_js_1.TokenType.CurlyR]);
          }
      ...
      SCSSParser.prototype._parseEachStatement = function (parseStatement) {
          ...
          if (!this.acceptIdent('in')) {
              return this.finish(node, scssErrors_js_1.SCSSParseError.InExpected, [cssScanner_js_1.TokenType.CurlyR]);
          }
      ...
      SCSSParser.prototype._parseFunctionDeclaration = function () {
          ...
          if (!this.accept(cssScanner_js_1.TokenType.ParenthesisL)) {
              return this.finish(node, cssErrors_js_1.ParseError.LeftParenthesisExpected, [cssScanner_js_1.TokenType.CurlyR]);
          }
          if (node.getParameters().addChild(this._parseParameterDeclaration())) {
              while (this.accept(cssScanner_js_1.TokenType.Comma)) {
                  ...
                  if (!node.getParameters().addChild(this._parseParameterDeclaration())) {
                      return this.finish(node, cssErrors_js_1.ParseError.VariableNameExpected);
                  }
              }
          }
          if (!this.accept(cssScanner_js_1.TokenType.ParenthesisR)) {
              return this.finish(node, cssErrors_js_1.ParseError.RightParenthesisExpected, [cssScanner_js_1.TokenType.CurlyR]);
          }
      ...
      SCSSParser.prototype._parseParameterDeclaration = function () {
          ...
          if (this.accept(cssScanner_js_1.TokenType.Colon)) {
              if (!node.setDefaultValue(this._parseExpr(true))) {
                  return this.finish(node, cssErrors_js_1.ParseError.VariableValueExpected, [], [cssScanner_js_1.TokenType.Comma, cssScanner_js_1.TokenType.ParenthesisR]);
              }
          }
          return this.finish(node);
      };
      ...
      SCSSParser.prototype._parseOperation = function () {
          ...
          while (node.addChild(this._parseListElement())) {
              this.accept(cssScanner_js_1.TokenType.Comma); // optional
          }
          if (!this.accept(cssScanner_js_1.TokenType.ParenthesisR)) {
              return this.finish(node, cssErrors_js_1.ParseError.RightParenthesisExpected);
          }
