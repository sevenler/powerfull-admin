define('node_modules/monaco-editor/esm/vs/language/json/_deps/vscode-json-languageservice/jsonLanguageService', function(require, exports, module) {
  ...
  var jsonCompletion_js_1 = require("node_modules/monaco-editor/esm/vs/language/json/_deps/vscode-json-languageservice/services/jsonCompletion");
  var jsonHover_js_1 = require("node_modules/monaco-editor/esm/vs/language/json/_deps/vscode-json-languageservice/services/jsonHover");
  var jsonValidation_js_1 = require("node_modules/monaco-editor/esm/vs/language/json/_deps/vscode-json-languageservice/services/jsonValidation");
  var jsonDocumentSymbols_js_1 = require("node_modules/monaco-editor/esm/vs/language/json/_deps/vscode-json-languageservice/services/jsonDocumentSymbols");
  var jsonParser_js_1 = require("node_modules/monaco-editor/esm/vs/language/json/_deps/vscode-json-languageservice/parser/jsonParser");
  var configuration_js_1 = require("node_modules/monaco-editor/esm/vs/language/json/_deps/vscode-json-languageservice/services/configuration");
  var jsonSchemaService_js_1 = require("node_modules/monaco-editor/esm/vs/language/json/_deps/vscode-json-languageservice/services/jsonSchemaService");
  var jsonFolding_js_1 = require("node_modules/monaco-editor/esm/vs/language/json/_deps/vscode-json-languageservice/services/jsonFolding");
  var jsonSelectionRanges_js_1 = require("node_modules/monaco-editor/esm/vs/language/json/_deps/vscode-json-languageservice/services/jsonSelectionRanges");
  var main_js_2 = require("node_modules/monaco-editor/esm/vs/language/json/_deps/jsonc-parser/main");
  tslib_1.__exportStar(require("node_modules/monaco-editor/esm/vs/language/json/_deps/vscode-json-languageservice/jsonLanguageTypes"), exports);
