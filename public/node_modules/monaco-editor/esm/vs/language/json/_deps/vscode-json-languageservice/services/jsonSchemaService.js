define('node_modules/monaco-editor/esm/vs/language/json/_deps/vscode-json-languageservice/services/jsonSchemaService', function(require, exports, module) {
  ...
  var JSONSchemaService = /** @class */ (function () {
      ...
      JSONSchemaService.prototype.getRegisteredSchemaIds = function (filter) {
          return Object.keys(this.registeredSchemasIds).filter(function (id) {
              var scheme = index_js_1.default.parse(id).scheme;
      ...
      JSONSchemaService.prototype.normalizeId = function (id) {
          ...
          return index_js_1.default.parse(id).toString();
      };
  ...
  function toDisplayString(url) {
      try {
          var uri = index_js_1.default.parse(url);
          if (uri.scheme === 'file') {
              return uri.fsPath;
          }
      }
